...
### `nginx:1.22.1-bullseye` - linux; amd64
...
### `nginx:1.22.1-bullseye` - linux; arm variant v5
...
### `nginx:1.22.1-bullseye` - linux; arm variant v7
...
### `nginx:1.22.1-bullseye` - linux; mips64le
...
### `nginx:1.22.1-bullseye` - linux; ppc64le
