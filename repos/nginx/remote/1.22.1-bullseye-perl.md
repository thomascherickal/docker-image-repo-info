...
### `nginx:1.22.1-bullseye-perl` - linux; amd64
...
### `nginx:1.22.1-bullseye-perl` - linux; arm variant v5
...
### `nginx:1.22.1-bullseye-perl` - linux; arm variant v7
...
### `nginx:1.22.1-bullseye-perl` - linux; mips64le
...
### `nginx:1.22.1-bullseye-perl` - linux; ppc64le
