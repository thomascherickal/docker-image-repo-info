...
```console
$ docker pull nginx@sha256:2ba632659ce3831d8b6f7a25e4b983f849cd93c5ef057724a16f3f58322d3557
```
...
### `nginx:1.23-bullseye` - linux; amd64
...
### `nginx:1.23-bullseye` - linux; arm variant v5
...
### `nginx:1.23-bullseye` - linux; arm variant v7
...
### `nginx:1.23-bullseye` - linux; arm64 variant v8
...
### `nginx:1.23-bullseye` - linux; mips64le
...
### `nginx:1.23-bullseye` - linux; ppc64le
...
### `nginx:1.23-bullseye` - linux; s390x
