...
### `nginx:1.25.1-alpine` - linux; amd64
...
### `nginx:1.25.1-alpine` - linux; arm variant v6
...
### `nginx:1.25.1-alpine` - linux; arm variant v7
...
### `nginx:1.25.1-alpine` - linux; arm64 variant v8
...
### `nginx:1.25.1-alpine` - linux; ppc64le
