...
### `nginx:1.22-alpine3.17-perl` - linux; amd64
...
### `nginx:1.22-alpine3.17-perl` - linux; arm variant v6
...
### `nginx:1.22-alpine3.17-perl` - linux; arm variant v7
...
### `nginx:1.22-alpine3.17-perl` - linux; arm64 variant v8
...
### `nginx:1.22-alpine3.17-perl` - linux; 386
...
### `nginx:1.22-alpine3.17-perl` - linux; ppc64le
...
### `nginx:1.22-alpine3.17-perl` - linux; s390x
