...
### `nginx:1.25.1-bookworm-perl` - linux; amd64
...
### `nginx:1.25.1-bookworm-perl` - linux; arm variant v5
...
### `nginx:1.25.1-bookworm-perl` - linux; arm variant v7
...
### `nginx:1.25.1-bookworm-perl` - linux; arm64 variant v8
...
### `nginx:1.25.1-bookworm-perl` - linux; 386
...
### `nginx:1.25.1-bookworm-perl` - linux; mips64le
...
### `nginx:1.25.1-bookworm-perl` - linux; ppc64le
...
### `nginx:1.25.1-bookworm-perl` - linux; s390x
