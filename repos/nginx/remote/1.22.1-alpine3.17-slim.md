...
### `nginx:1.22.1-alpine3.17-slim` - linux; amd64
...
### `nginx:1.22.1-alpine3.17-slim` - linux; arm variant v6
...
### `nginx:1.22.1-alpine3.17-slim` - linux; arm variant v7
...
### `nginx:1.22.1-alpine3.17-slim` - linux; arm64 variant v8
...
### `nginx:1.22.1-alpine3.17-slim` - linux; 386
...
### `nginx:1.22.1-alpine3.17-slim` - linux; ppc64le
...
### `nginx:1.22.1-alpine3.17-slim` - linux; s390x
