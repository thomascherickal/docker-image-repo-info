...
```console
$ docker pull nginx@sha256:10209c8b111499541aaa83404a1a3b0915dedfc26a0af58280800229a3587317
```
...
### `nginx:1.25.1-alpine3.17-slim` - linux; amd64
...
### `nginx:1.25.1-alpine3.17-slim` - linux; arm variant v6
...
### `nginx:1.25.1-alpine3.17-slim` - linux; arm variant v7
...
### `nginx:1.25.1-alpine3.17-slim` - linux; arm64 variant v8
...
### `nginx:1.25.1-alpine3.17-slim` - linux; 386
...
### `nginx:1.25.1-alpine3.17-slim` - linux; ppc64le
...
### `nginx:1.25.1-alpine3.17-slim` - linux; s390x
