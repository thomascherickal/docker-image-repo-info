...
### `nginx:1.23.4-bullseye-perl` - linux; amd64
...
### `nginx:1.23.4-bullseye-perl` - linux; arm variant v5
...
### `nginx:1.23.4-bullseye-perl` - linux; arm variant v7
...
### `nginx:1.23.4-bullseye-perl` - linux; arm64 variant v8
...
### `nginx:1.23.4-bullseye-perl` - linux; 386
...
### `nginx:1.23.4-bullseye-perl` - linux; mips64le
...
### `nginx:1.23.4-bullseye-perl` - linux; ppc64le
...
### `nginx:1.23.4-bullseye-perl` - linux; s390x
