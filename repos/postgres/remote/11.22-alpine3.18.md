...
```console
$ docker pull postgres@sha256:bccbb9036fd5b964a10cee4e0dbae00db04b14e51df7a1f12819d07c722cf999
```
...
### `postgres:11.22-alpine3.18` - linux; amd64
...
### `postgres:11.22-alpine3.18` - unknown; unknown
...
### `postgres:11.22-alpine3.18` - linux; arm variant v6
...
### `postgres:11.22-alpine3.18` - linux; arm variant v7
...
### `postgres:11.22-alpine3.18` - linux; arm64 variant v8
...
### `postgres:11.22-alpine3.18` - linux; ppc64le
...
### `postgres:11.22-alpine3.18` - linux; s390x
