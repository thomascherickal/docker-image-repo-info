...
```console
$ docker pull postgres@sha256:f43aa65351cb1750a64e38eb9eff4f7ca2287f3fd712c79c5ea690bd536cd4be
```
...
### `postgres:16.1-alpine` - linux; arm variant v7
...
### `postgres:16.1-alpine` - linux; ppc64le
