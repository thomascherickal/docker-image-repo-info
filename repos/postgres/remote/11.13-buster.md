...
```console
$ docker pull postgres@sha256:b31d2ce240cceecae6074f5f7f2de36ece536bc9855ad24fabddbceb6943cf6a
```
...
### `postgres:11.13-buster` - linux; arm variant v5
...
### `postgres:11.13-buster` - linux; arm variant v7
...
### `postgres:11.13-buster` - linux; arm64 variant v8
...
### `postgres:11.13-buster` - linux; mips64le
...
### `postgres:11.13-buster` - linux; ppc64le
...
### `postgres:11.13-buster` - linux; s390x
