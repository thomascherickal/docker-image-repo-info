...
- Created: `2020-04-24T17:22:49.806915378Z`
- Virtual Size: ~ 149.89 Mb  
...
- Environment:
  ...
  - `PG_MAJOR=11`
  - `PG_VERSION=11.7`
  - `PG_SHA256=324ae93a8846fbb6a25d562d271bc441ffa8794654c5b2839384834de220a313`
...
### `apk` package: `llvm9-libs`

```console
llvm9-libs-9.0.0-r1 description:
LLVM 9 runtime library

llvm9-libs-9.0.0-r1 webpage:
https://llvm.org/

llvm9-libs-9.0.0-r1 installed size:
59158528

llvm9-libs-9.0.0-r1 license:
Apache-2.0
