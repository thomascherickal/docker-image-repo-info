...
- Image ID: `sha256:17a52c65eda933cdf2a1aaca3de64afc72d03593714cbc10748c32d94e7d063f`
- Created: `2022-03-19T12:54:55.358724087Z`
- Virtual Size: ~ 754.05 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Command: `["catalina.sh","run"]`
- Environment:
  - `PATH=/usr/local/tomee/bin:/usr/local/openjdk-17/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin`
