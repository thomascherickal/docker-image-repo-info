...
```console
$ docker pull tomee@sha256:f7d5102988f8fdd2a45cd8ed1efa218926450d3986bb4fcc037903bc5138cdcd
```
...
### `tomee:jre8-debian` - linux; arm64 variant v8
