...
-	[`swift:5.3`](#swift53)
-	[`swift:5.3.2`](#swift532)
-	[`swift:5.3.2-amazonlinux2`](#swift532-amazonlinux2)
-	[`swift:5.3.2-amazonlinux2-slim`](#swift532-amazonlinux2-slim)
-	[`swift:5.3.2-bionic`](#swift532-bionic)
-	[`swift:5.3.2-bionic-slim`](#swift532-bionic-slim)
-	[`swift:5.3.2-centos7`](#swift532-centos7)
-	[`swift:5.3.2-centos7-slim`](#swift532-centos7-slim)
-	[`swift:5.3.2-centos8`](#swift532-centos8)
-	[`swift:5.3.2-centos8-slim`](#swift532-centos8-slim)
-	[`swift:5.3.2-focal`](#swift532-focal)
-	[`swift:5.3.2-focal-slim`](#swift532-focal-slim)
-	[`swift:5.3.2-slim`](#swift532-slim)
-	[`swift:5.3.2-xenial`](#swift532-xenial)
-	[`swift:5.3.2-xenial-slim`](#swift532-xenial-slim)
...
```console
$ docker pull swift@sha256:62216a2bad240882241527ecd2b67665f7531bcf89bbb3768fd11587732b1b09
```
...
```console
$ docker pull swift@sha256:a795585c884919aaacef6dd9a859e7a436025b17ca13df391a8c3a3c38ae6c0d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **551.3 MB (551292654 bytes)**  
	(compressed transfer size, not on-disk size)
...
# Thu, 21 Jan 2021 09:07:08 GMT
ARG SWIFT_PLATFORM=ubuntu16.04
# Thu, 21 Jan 2021 09:18:21 GMT
ARG SWIFT_BRANCH=swift-5.2.5-release
# Thu, 21 Jan 2021 09:18:23 GMT
ARG SWIFT_VERSION=swift-5.2.5-RELEASE
# Thu, 21 Jan 2021 09:18:27 GMT
ARG SWIFT_WEBROOT=https://swift.org/builds/
# Thu, 21 Jan 2021 09:18:27 GMT
...
# Thu, 21 Jan 2021 09:19:52 GMT
RUN set -e;     SWIFT_WEBDIR="$SWIFT_WEBROOT/$SWIFT_BRANCH/$(echo $SWIFT_PLATFORM | tr -d .)/"     && SWIFT_BIN_URL="$SWIFT_WEBDIR/$SWIFT_VERSION/$SWIFT_VERSION-$SWIFT_PLATFORM.tar.gz"     && SWIFT_SIG_URL="$SWIFT_BIN_URL.sig"     && export DEBIAN_FRONTEND=noninteractive     && apt-get -q update && apt-get -q install -y curl && rm -rf /var/lib/apt/lists/*     && export GNUPGHOME="$(mktemp -d)"     && curl -fsSL "$SWIFT_BIN_URL" -o swift.tar.gz "$SWIFT_SIG_URL" -o swift.tar.gz.sig     && gpg --batch --quiet --keyserver ha.pool.sks-keyservers.net --recv-keys "$SWIFT_SIGNING_KEY"     && gpg --batch --verify swift.tar.gz.sig swift.tar.gz     && tar -xzf swift.tar.gz --directory / --strip-components=1     && chmod -R o+r /usr/lib/swift     && rm -rf "$GNUPGHOME" swift.tar.gz.sig swift.tar.gz     && apt-get purge --auto-remove -y curl
# Thu, 21 Jan 2021 09:19:54 GMT
RUN swift --version
```
...
-	Layers:
	...
	-	`sha256:55b76a2b676de062b5ca91654837facde5cd0af8a2abd5068b658d53c904b3d3`  
		...
		Size: 111.5 MB (111547170 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:630666282f73b83a06747263d319d56c62add87c0ab0b81f7ee98c9aa6605834`  
		Last Modified: Thu, 21 Jan 2021 09:52:12 GMT  
		Size: 393.8 MB (393781584 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `swift:5.3.2-centos7-slim` - linux; amd64
...
### `swift:5.3.2-centos8` - linux; amd64
...
### `swift:5.3.2-xenial-slim` - linux; amd64
