...
- Created: `2021-09-15T19:23:41.571761831Z`
...
```console
$ yumdownloader --quiet --source --urls cpp-4.8.5-44.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
...
```console
$ yumdownloader --quiet --source --urls gcc-4.8.5-44.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/gcc-4.8.5-44.el7.src.rpm
...
```console
$ yumdownloader --quiet --source --urls libgomp-4.8.5-44.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/gcc-4.8.5-44.el7.src.rpm
...
```console
$ yumdownloader --quiet --source --urls libicu-50.2-4.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
...
```console
$ yumdownloader --quiet --source --urls libicu-devel-50.2-4.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/icu-50.2-4.el7_7.src.rpm
...
```console
$ yumdownloader --quiet --source --urls libstdc++-devel-4.8.5-44.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/gcc-4.8.5-44.el7.src.rpm
...
```console
$ yumdownloader --quiet --source --urls libstdc++-static-4.8.5-44.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/gcc-4.8.5-44.el7.src.rpm
