...
- Created: `2020-09-17T22:37:42.11956421Z`
...
### `rpm` package: `cpp-4.8.5-39.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls cpp-4.8.5-39.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
...
### `rpm` package: `gcc-4.8.5-39.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls gcc-4.8.5-39.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/gcc-4.8.5-39.el7.src.rpm
...
### `rpm` package: `glibc-devel-2.17-307.el7.1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls glibc-devel-2.17-307.el7.1
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/glibc-2.17-307.el7.1.src.rpm
...
### `rpm` package: `glibc-headers-2.17-307.el7.1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls glibc-headers-2.17-307.el7.1
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/glibc-2.17-307.el7.1.src.rpm
...
### `rpm` package: `glibc-static-2.17-307.el7.1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls glibc-static-2.17-307.el7.1
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/glibc-2.17-307.el7.1.src.rpm
...
### `rpm` package: `kernel-headers-3.10.0-1127.18.2.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls kernel-headers-3.10.0-1127.18.2.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/kernel-3.10.0-1127.18.2.el7.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls libedit-devel-3.0-12.20121213cvs.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/libedit-3.0-12.20121213cvs.el7.src.rpm
...
### `rpm` package: `libgomp-4.8.5-39.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libgomp-4.8.5-39.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/gcc-4.8.5-39.el7.src.rpm
...
```console
$ yumdownloader --quiet --source --urls libmpc-1.0.1-3.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
...
### `rpm` package: `libstdc++-devel-4.8.5-39.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libstdc++-devel-4.8.5-39.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/gcc-4.8.5-39.el7.src.rpm
...
### `rpm` package: `libstdc++-static-4.8.5-39.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libstdc++-static-4.8.5-39.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/gcc-4.8.5-39.el7.src.rpm
...
```console
$ yumdownloader --quiet --source --urls mpfr-3.1.1-4.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
...
```console
$ yumdownloader --quiet --source --urls ncurses-devel-5.9-14.20130511.el7_4
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/ncurses-5.9-14.20130511.el7_4.src.rpm
