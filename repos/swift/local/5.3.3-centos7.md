...
http://mirrors.tripadvisor.com/centos/7.9.2009/os/x86_64/repodata/repomd.xml: [Errno 12] Timeout on http://mirrors.tripadvisor.com/centos/7.9.2009/os/x86_64/repodata/repomd.xml: (28, 'Operation too slow. Less than 1000 bytes/sec transferred the last 30 seconds')
Trying other mirror.
...
```console
$ yumdownloader --quiet --source --urls glibc-devel-2.17-325.el7_9
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/glibc-2.17-325.el7_9.src.rpm
...
```console
$ yumdownloader --quiet --source --urls glibc-headers-2.17-325.el7_9
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/glibc-2.17-325.el7_9.src.rpm
...
```console
$ yumdownloader --quiet --source --urls glibc-static-2.17-325.el7_9
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/glibc-2.17-325.el7_9.src.rpm
...
```console
$ yumdownloader --quiet --source --urls kernel-headers-3.10.0-1160.45.1.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
