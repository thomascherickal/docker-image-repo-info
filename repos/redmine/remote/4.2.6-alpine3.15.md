...
```console
$ docker pull redmine@sha256:39bba307349e02dd89d2c945038991b860fe48438c754fc4f6f68734404ef92e
```
...
### `redmine:4.2.6-alpine3.15` - linux; 386
...
### `redmine:4.2.6-alpine3.15` - linux; ppc64le
...
### `redmine:4.2.6-alpine3.15` - linux; s390x
