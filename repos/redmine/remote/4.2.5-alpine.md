...
```console
$ docker pull redmine@sha256:f49e6b27b6e1a9dc8c80f67278b334a9cd7d52ee2d3f33e81133f68898e234b5
```
...
### `redmine:4.2.5-alpine` - linux; amd64
...
### `redmine:4.2.5-alpine` - linux; arm variant v6
...
### `redmine:4.2.5-alpine` - linux; arm variant v7
...
### `redmine:4.2.5-alpine` - linux; arm64 variant v8
...
### `redmine:4.2.5-alpine` - linux; 386
...
### `redmine:4.2.5-alpine` - linux; ppc64le
...
### `redmine:4.2.5-alpine` - linux; s390x
