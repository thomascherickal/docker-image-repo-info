...
```console
$ docker pull redmine@sha256:a8efe5ce7921f76ff397aa89a65c93706b43275c4a92002f5efa1faf0052766e
```
...
### `redmine:4.2.8-alpine` - linux; amd64
...
### `redmine:4.2.8-alpine` - linux; arm variant v6

```console
$ docker pull redmine@sha256:0257c5f0e7cc895a6703708f707a9a6ce2fd6f6b0b91335baa1aff2ba05c56a7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.8 MB (153842045 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eebf73ff7e53a3747062637b1222fb75e3a5f57f00944374cdbf1d38d8f29776`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["rails","server","-b","0.0.0.0"]`
...
# Sat, 08 Oct 2022 03:52:30 GMT
CMD ["irb"]
# Sat, 08 Oct 2022 06:35:10 GMT
RUN addgroup -S -g 1000 redmine && adduser -S -H -G redmine -u 999 redmine
# Sat, 08 Oct 2022 06:35:28 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ca-certificates 		findutils 		su-exec 		tini 		tzdata 		wget 				breezy 		git 		mercurial 		openssh-client 		subversion 				ghostscript 		ghostscript-fonts 		imagemagick 	;
# Sat, 08 Oct 2022 06:35:28 GMT
ENV RAILS_ENV=production
# Sat, 08 Oct 2022 06:35:28 GMT
...
# Sat, 08 Oct 2022 06:35:29 GMT
ENV REDMINE_DOWNLOAD_SHA256=0b431c052d8fd36b93201dafaf3615cdb8d03460efcf2400e7d32662b2ab6272
# Sat, 08 Oct 2022 06:35:33 GMT
RUN set -eux; 	wget -O redmine.tar.gz "$REDMINE_DOWNLOAD_URL"; 	echo "$REDMINE_DOWNLOAD_SHA256 *redmine.tar.gz" | sha256sum -c -; 	tar -xf redmine.tar.gz --strip-components=1; 	rm redmine.tar.gz files/delete.me log/delete.me; 	mkdir -p log public/plugin_assets sqlite tmp/pdf tmp/pids; 	chown -R redmine:redmine ./; 	echo 'config.logger = Logger.new(STDOUT)' > config/additional_environment.rb; 	chmod -R ugo=rwX config db sqlite; 	find log tmp -type d -exec chmod 1777 '{}' +
# Sat, 08 Oct 2022 06:35:34 GMT
ENV BUNDLE_FORCE_RUBY_PLATFORM=1
# Sat, 08 Oct 2022 06:38:09 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetds-dev 		gcc 		make 		mariadb-dev 		musl-dev 		patch 		postgresql-dev 		sqlite-dev 		ttf2ufm 		zlib-dev 	; 		su-exec redmine bundle config --local without 'development test'; 	puma="$(grep -E "^[[:space:]]*gem [:'\"]puma['\",[:space:]].*\$" Gemfile)"; 	{ echo; echo "$puma"; } | sed -re 's/^[[:space:]]+//' >> Gemfile; 	echo '# the following entries only exist to force `bundle install` to pre-install all database adapter dependencies -- they can be safely removed/ignored' > ./config/database.yml; 	for adapter in mysql2 postgresql sqlserver sqlite3; do 		echo "$adapter:" >> ./config/database.yml; 		echo "  adapter: $adapter" >> ./config/database.yml; 	done; 	su-exec redmine bundle install --jobs "$(nproc)"; 	rm ./config/database.yml; 	chmod -R ugo=rwX Gemfile.lock "$GEM_HOME"; 	rm -rf ~redmine/.bundle; 		rm /usr/local/bundle/gems/rbpdf-font-1.19.*/lib/fonts/ttf2ufm/ttf2ufm; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/bundle/gems 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .redmine-rundeps $runDeps; 	apk del --no-network .build-deps
# Sat, 08 Oct 2022 06:38:10 GMT
VOLUME [/usr/src/redmine/files]
# Sat, 08 Oct 2022 06:38:10 GMT
COPY file:f2dac8fc10b4b9c85d18ffc54f3822ba7f98c858ad133cc1c0a63d9d52731204 in / 
# Sat, 08 Oct 2022 06:38:10 GMT
...
-	Layers:
	...
	-	`sha256:7e7faff2bea79d311ac991a5846d6b09d10e2a83dc21cdb31faf4ea32cc71b65`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35342f01e461df5cd38ec6f1a5e9047b88764afac03e13230f63ff27fae5f361`  
		Last Modified: Sat, 08 Oct 2022 06:40:03 GMT  
		Size: 1.2 KB (1219 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32721b3917a0d0ef9f79d30b79446e34176c6df31214e659525abc276abb08b8`  
		Last Modified: Sat, 08 Oct 2022 06:40:20 GMT  
		Size: 78.4 MB (78439349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e115aa87fd6cc589d406d148e28dfec783ec07dc6b8e5044b2aaed5b5eb4bdd`  
		Last Modified: Sat, 08 Oct 2022 06:40:00 GMT  
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d204d3bf071b8e2353d853478dc8f8fa5ed14110f0c946899aca9fb77c21ce1`  
		Last Modified: Sat, 08 Oct 2022 06:40:00 GMT  
		Size: 159.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df399fe51ea4d3b2e2a8c69ca782852b745d8ac90a1b2122d55d274a579763e8`  
		Last Modified: Sat, 08 Oct 2022 06:40:03 GMT  
		Size: 3.1 MB (3067715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8589a439ae7c5c71171e60402578b0bd5a831a2006afcf1637071d0d1dc00f9f`  
		Last Modified: Sat, 08 Oct 2022 06:40:10 GMT  
		Size: 52.8 MB (52841721 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b4c285848018b052cc7ef43d0e0d29d70a62714cab10b649bb9ac98b6e2b01e`  
		Last Modified: Sat, 08 Oct 2022 06:40:00 GMT  
		Size: 2.0 KB (2013 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `redmine:4.2.8-alpine` - linux; arm variant v7

```console
$ docker pull redmine@sha256:c3dfac332268799b18af66ebf194716c83f025cf5bb2d1953fa6a43ca4e02385
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.6 MB (149619796 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:952b4f658447b8c935aea53cdb511fb7ced1ab47b621e24c590ba4d9993b858a`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["rails","server","-b","0.0.0.0"]`
...
-	Layers:
	...
	-	`sha256:3a45c6f3069742d505cc8e77c84443b434dbfa223a485b6e19e62afcf4153d84`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0918925319eaac34a226c1dead2433b6f1b2010a9943ebfb16ecbc27580973d`  
		Last Modified: Sat, 08 Oct 2022 05:05:54 GMT  
		Size: 2.0 KB (2013 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `redmine:4.2.8-alpine` - linux; arm64 variant v8

```console
$ docker pull redmine@sha256:f6650c941faa32a8f2542913475d5cf6b44b48b2f47e42c7a60d2d690fa10557
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.1 MB (156098899 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de509c079b630d02c8e66a02c1eb492019176f6af13021038d6f8f2ad1d8fa28`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["rails","server","-b","0.0.0.0"]`
...
# Tue, 25 Oct 2022 22:55:17 GMT
CMD ["irb"]
# Wed, 26 Oct 2022 14:43:13 GMT
RUN addgroup -S -g 1000 redmine && adduser -S -H -G redmine -u 999 redmine
# Wed, 26 Oct 2022 14:43:20 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ca-certificates 		findutils 		su-exec 		tini 		tzdata 		wget 				breezy 		git 		mercurial 		openssh-client 		subversion 				ghostscript 		ghostscript-fonts 		imagemagick 	;
# Wed, 26 Oct 2022 14:43:21 GMT
ENV RAILS_ENV=production
# Wed, 26 Oct 2022 14:43:21 GMT
WORKDIR /usr/src/redmine
# Wed, 26 Oct 2022 14:43:21 GMT
ENV HOME=/home/redmine
# Wed, 26 Oct 2022 14:43:22 GMT
RUN set -eux; 	[ ! -d "$HOME" ]; 	mkdir -p "$HOME"; 	chown redmine:redmine "$HOME"; 	chmod 1777 "$HOME"
# Wed, 26 Oct 2022 14:43:22 GMT
ENV REDMINE_VERSION=4.2.8
# Wed, 26 Oct 2022 14:43:22 GMT
...
# Wed, 26 Oct 2022 14:43:22 GMT
ENV REDMINE_DOWNLOAD_SHA256=0b431c052d8fd36b93201dafaf3615cdb8d03460efcf2400e7d32662b2ab6272
# Wed, 26 Oct 2022 14:43:25 GMT
RUN set -eux; 	wget -O redmine.tar.gz "$REDMINE_DOWNLOAD_URL"; 	echo "$REDMINE_DOWNLOAD_SHA256 *redmine.tar.gz" | sha256sum -c -; 	tar -xf redmine.tar.gz --strip-components=1; 	rm redmine.tar.gz files/delete.me log/delete.me; 	mkdir -p log public/plugin_assets sqlite tmp/pdf tmp/pids; 	chown -R redmine:redmine ./; 	echo 'config.logger = Logger.new(STDOUT)' > config/additional_environment.rb; 	chmod -R ugo=rwX config db sqlite; 	find log tmp -type d -exec chmod 1777 '{}' +
# Wed, 26 Oct 2022 14:43:25 GMT
ENV BUNDLE_FORCE_RUBY_PLATFORM=1
# Wed, 26 Oct 2022 14:45:17 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetds-dev 		gcc 		make 		mariadb-dev 		musl-dev 		patch 		postgresql-dev 		sqlite-dev 		ttf2ufm 		zlib-dev 	; 		su-exec redmine bundle config --local without 'development test'; 	puma="$(grep -E "^[[:space:]]*gem [:'\"]puma['\",[:space:]].*\$" Gemfile)"; 	{ echo; echo "$puma"; } | sed -re 's/^[[:space:]]+//' >> Gemfile; 	echo '# the following entries only exist to force `bundle install` to pre-install all database adapter dependencies -- they can be safely removed/ignored' > ./config/database.yml; 	for adapter in mysql2 postgresql sqlserver sqlite3; do 		echo "$adapter:" >> ./config/database.yml; 		echo "  adapter: $adapter" >> ./config/database.yml; 	done; 	su-exec redmine bundle install --jobs "$(nproc)"; 	rm ./config/database.yml; 	chmod -R ugo=rwX Gemfile.lock "$GEM_HOME"; 	rm -rf ~redmine/.bundle; 		rm /usr/local/bundle/gems/rbpdf-font-1.19.*/lib/fonts/ttf2ufm/ttf2ufm; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/bundle/gems 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .redmine-rundeps $runDeps; 	apk del --no-network .build-deps
# Wed, 26 Oct 2022 14:45:17 GMT
VOLUME [/usr/src/redmine/files]
# Wed, 26 Oct 2022 14:45:17 GMT
...
-	Layers:
	...
	-	`sha256:8210bc7dc348c2bcd182f6d028fbc2606f5c146f779b717c2e862747cdbabaa7`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7feb6e61f3d6f202dea87cb3468424bcde59b5edb3cd86b43cbaa2cecf6d046d`  
		Last Modified: Wed, 26 Oct 2022 14:47:54 GMT  
		Size: 1.2 KB (1218 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b40fe2dc4b54c671f482f5789814072bf67ffd818355fc3a3c11757d77f3142`  
		Last Modified: Wed, 26 Oct 2022 14:48:03 GMT  
		Size: 80.2 MB (80221500 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22568cb29ad3e8c48f4f58d7983e5cea40b6dc93110a5062a447d3855ffd216f`  
		Last Modified: Wed, 26 Oct 2022 14:47:52 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a07f566261487164e301ede8fcaa3dceffd28f04fd9a4446a8c71c01370fede5`  
		Last Modified: Wed, 26 Oct 2022 14:47:52 GMT  
		Size: 160.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b45834efed121db16aa5f4e4e01095d8e85158dc54cdd6bfa514b1fb34e3ed52`  
		Last Modified: Wed, 26 Oct 2022 14:47:52 GMT  
		Size: 3.1 MB (3067751 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b272f132c068593d7126b61f893016ac3bdeab3cafe13913955a44b279834b0e`  
		Last Modified: Wed, 26 Oct 2022 14:47:56 GMT  
		Size: 52.6 MB (52614316 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f9beea187b4d8514b173a78c0ccded1a0fde4f77c8b29e547db981927979339`  
		Last Modified: Wed, 26 Oct 2022 14:47:52 GMT  
		Size: 2.0 KB (2010 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `redmine:4.2.8-alpine` - linux; 386
...
### `redmine:4.2.8-alpine` - linux; ppc64le
...
### `redmine:4.2.8-alpine` - linux; s390x
