...
```console
$ docker pull redmine@sha256:131439f06f3d07088b9cc304b7ba1064be440cc8332fb08f916159ec1d2c9442
```
...
### `redmine:5.0.1-alpine` - linux; 386
...
### `redmine:5.0.1-alpine` - linux; ppc64le
...
### `redmine:5.0.1-alpine` - linux; s390x
