...
### `redmine:4.1.5-buster` - linux; amd64
...
### `redmine:4.1.5-buster` - linux; arm variant v5
...
### `redmine:4.1.5-buster` - linux; arm variant v7
...
### `redmine:4.1.5-buster` - linux; arm64 variant v8
...
### `redmine:4.1.5-buster` - linux; 386
...
### `redmine:4.1.5-buster` - linux; ppc64le
...
### `redmine:4.1.5-buster` - linux; s390x
