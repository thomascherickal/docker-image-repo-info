...
- Created: `2022-01-06T20:52:05.569859979Z`
...
```console
imagemagick6-6.9.12.32-r0 description:
A collection of tools and libraries for many image formats (legacy version 6)

imagemagick6-6.9.12.32-r0 webpage:
https://www.imagemagick.org/

imagemagick6-6.9.12.32-r0 installed size:
192 KiB

imagemagick6-6.9.12.32-r0 license:
Apache-2.0
...
```console
imagemagick6-libs-6.9.12.32-r0 description:
A collection of tools and libraries for many image formats (legacy version 6) (libraries)

imagemagick6-libs-6.9.12.32-r0 webpage:
https://www.imagemagick.org/

imagemagick6-libs-6.9.12.32-r0 installed size:
6820 KiB

imagemagick6-libs-6.9.12.32-r0 license:
Apache-2.0
