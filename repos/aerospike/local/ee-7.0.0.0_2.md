...
- Created: `2023-11-16T01:19:48.495369068Z`
- Virtual Size: ~ 220.34 Mb  
...
- Labels:
  ...
  - `org.opencontainers.image.version=7.0.0.0`
...
### `dpkg` source package: `aerospike-server-enterprise=7.0.0.0-1`

Binary Packages:

- `aerospike-server-enterprise=7.0.0.0-1`
