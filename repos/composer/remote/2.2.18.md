...
```console
$ docker pull composer@sha256:307cb38f8d32af73721be4e81347549b0a248858ce1658a2e7c53b0e0b004178
```
...
```console
$ docker pull composer@sha256:3e07b3a9d3ec107d7463f3bd7bdbe79e42c0b6bca02473cb3badb07b1c86f666
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **64.1 MB (64076842 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39d0ff1d2a1bfe10159fd87474ee47e25c0c9bc083266426c169991188d59575`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["composer"]`
...
-	Layers:
	...
	-	`sha256:ba0f6a0fb5b7bb2372ad05459f9ab413e9d83bfd85dc0a5c4f8efd208a3bc0bb`  
		...
		Size: 260.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e31af1ac2ff4ca564d57bce8d0c95fc567b05b42eef43e0e58c8d2118eac8b4e`  
		Last Modified: Thu, 29 Sep 2022 21:53:53 GMT  
		Size: 1.2 MB (1183959 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0564438dcbe3486955ce1dc33ac17fc2ffc0fe650ce4cbf5f6f8d2bac701fe3`  
		Last Modified: Thu, 29 Sep 2022 21:53:53 GMT  
		Size: 419.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9aaf55222e0035f7b027704c584b46e8f63cb0d9485187c049d9232e229ea269`  
		Last Modified: Thu, 29 Sep 2022 21:53:53 GMT  
		Size: 126.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull composer@sha256:6656cadfad70cca96b3ab6fbfc5e7dfd334035ae6a2412cc9db47965a51a34c2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.2 MB (53173278 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d3d3756c9282f286dddb13e1fb06350132cb94559bf603de5ce40cfd1e8af40`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["composer"]`
...
ENV COMPOSER_HOME=/tmp
# Thu, 29 Sep 2022 21:16:27 GMT
ENV COMPOSER_VERSION=2.2.18
# Thu, 29 Sep 2022 21:16:46 GMT
RUN set -eux ;   curl     --silent     --fail     --location     --retry 3     --output /usr/local/bin/install-php-extensions     --url https://github.com/mlocati/docker-php-extension-installer/releases/download/1.2.58/install-php-extensions   ;   echo 182011b3dca5544a70fdeb587af44ed1760aa9a2ed37d787d0f280a99f92b008e638c37762360cd85583830a097665547849cb2293c4a0ee32c2a36ef7a349e2 /usr/local/bin/install-php-extensions | sha512sum --strict --check ;   chmod +x /usr/local/bin/install-php-extensions ;   install-php-extensions     bz2     zip   ;   curl     --silent     --fail     --location     --retry 3     --output /tmp/keys.dev.pub     --url https://raw.githubusercontent.com/composer/composer.github.io/e7f28b7200249f8e5bc912b42837d4598c74153a/snapshots.pub   ;   echo 572b963c4b7512a7de3c71a788772440b1996d918b1d2b5354bf8ba2bb057fadec6f7ac4852f2f8a8c01ab94c18141ce0422aec3619354b057216e0597db5ac2 /tmp/keys.dev.pub | sha512sum --strict --check ;   curl     --silent     --fail     --location     --retry 3     --output /tmp/keys.tags.pub     --url https://raw.githubusercontent.com/composer/composer.github.io/e7f28b7200249f8e5bc912b42837d4598c74153a/releases.pub   ;   echo 47f374b8840dcb0aa7b2327f13d24ab5f6ae9e58aa630af0d62b3d0ea114f4a315c5d97b21dcad3c7ffe2f0a95db2edec267adaba3f4f5a262abebe39aed3a28 /tmp/keys.tags.pub | sha512sum --strict --check ;   curl     --silent     --fail     --location     --retry 3     --output /tmp/installer.php     --url https://raw.githubusercontent.com/composer/getcomposer.org/f24b8f860b95b52167f91bbd3e3a7bcafe043038/web/installer   ;   echo 3137ad86bd990524ba1dedc2038309dfa6b63790d3ca52c28afea65dcc2eaead16fb33e9a72fd2a7a8240afaf26e065939a2d472f3b0eeaa575d1e8648f9bf19 /tmp/installer.php | sha512sum --strict --check ;   php /tmp/installer.php     --no-ansi     --install-dir=/usr/bin     --filename=composer     --version=${COMPOSER_VERSION}   ;   composer --ansi --version --no-interaction ;   composer diagnose ;   rm -f /tmp/installer.php ;   find /tmp -type d -exec chmod -v 1777 {} +
# Thu, 29 Sep 2022 21:16:48 GMT
COPY file:2d86469921ea86d2c1e50443fd24d98471bd3c2db7341b80a83c2d9a80c7074e in /docker-entrypoint.sh 
# Thu, 29 Sep 2022 21:16:48 GMT
WORKDIR /app
# Thu, 29 Sep 2022 21:16:49 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Thu, 29 Sep 2022 21:16:50 GMT
CMD ["composer"]
```
...
-	Layers:
	...
	-	`sha256:8a43499cadd66759486786419cd5254bf100686066f367b6d93a3e538a6805fb`  
		...
		Size: 258.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1aabd12879cbb11973e0fdc48c9e41e2ba1741c093d38b18d40badcfa685c4df`  
		Last Modified: Thu, 29 Sep 2022 21:18:26 GMT  
		Size: 1.1 MB (1149857 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c500b0c3e138a560725b979d124556f42a3b3d408a95f72c2ea5778ca1bf514`  
		Last Modified: Thu, 29 Sep 2022 21:18:26 GMT  
		Size: 419.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee1824566bd88a2da6847157beb13322ab03493b63e597de90ae00863eba0b75`  
		Last Modified: Thu, 29 Sep 2022 21:18:26 GMT  
		Size: 90.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
