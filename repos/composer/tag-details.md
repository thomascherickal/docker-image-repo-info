...
```console
$ docker pull composer@sha256:9a09a2eee15ba9266cd52744a5115b67c7278e9f7c0a850a996479cdcb12ad0e
```
...
```console
$ docker pull composer@sha256:0d70e0ba749477436092d0c95609c3baec9bbddb04f913daeb4e6e55b2092506
```
