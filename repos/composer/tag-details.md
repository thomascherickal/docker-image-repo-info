...
```console
$ docker pull composer@sha256:e6bc74b9eb904437c06dc7816e0e31bf270604239e9eed7119b26afb0340054e
```
...
```console
$ docker pull composer@sha256:33df269481a393b7e36437114bdd64ef5270779de348865816a901a68072f87f
```
