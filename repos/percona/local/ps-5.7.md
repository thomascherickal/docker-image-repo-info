...
### `rpm` package: `Percona-Server-client-57-5.7.35-38.1.el8.x86_64`
...
### `rpm` package: `Percona-Server-devel-57-5.7.35-38.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-rocksdb-57-5.7.35-38.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-server-57-5.7.35-38.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-shared-57-5.7.35-38.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-shared-compat-57-5.7.35-38.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-tokudb-57-5.7.35-38.1.el8.x86_64`
...
### `rpm` package: `compat-openssl10-1.0.2o-3.el8.x86_64`
...
### `rpm` package: `keyutils-libs-devel-1.5.10-6.el8.x86_64`
...
### `rpm` package: `krb5-devel-1.18.2-8.el8.x86_64`
...
### `rpm` package: `libcom_err-devel-1.45.6-1.el8.x86_64`
...
### `rpm` package: `libkadm5-1.18.2-8.el8.x86_64`
...
### `rpm` package: `libselinux-devel-2.9-5.el8.x86_64`
...
### `rpm` package: `libsepol-devel-2.9-2.el8.x86_64`
...
### `rpm` package: `libverto-devel-0.3.0-5.el8.x86_64`
...
### `rpm` package: `numactl-libs-2.0.12-11.el8.x86_64`
...
### `rpm` package: `openssl-1.1.1g-15.el8_3.x86_64`

Licenses (from `rpm --query`): OpenSSL and ASL 2.0

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `openssl-devel-1.1.1g-15.el8_3.x86_64`
...
### `rpm` package: `pcre2-devel-10.32-2.el8.x86_64`

Licenses (from `rpm --query`): BSD

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `pcre2-utf16-10.32-2.el8.x86_64`

Licenses (from `rpm --query`): BSD

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `pcre2-utf32-10.32-2.el8.x86_64`
...
### `rpm` package: `perl-Errno-1.28-419.el8_4.1.x86_64`
...
### `rpm` package: `perl-IO-1.38-419.el8_4.1.x86_64`
...
### `rpm` package: `perl-IO-Socket-SSL-2.066-4.module_el8.3.0+410+ff426aa3.noarch`
...
### `rpm` package: `perl-Net-SSLeay-1.88-1.module_el8.3.0+410+ff426aa3.x86_64`
...
### `rpm` package: `perl-interpreter-5.26.3-419.el8_4.1.x86_64`
...
### `rpm` package: `perl-libs-5.26.3-419.el8_4.1.x86_64`

Licenses (from `rpm --query`): (GPL+ or Artistic) and HSRL and MIT and UCD

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `perl-macros-5.26.3-419.el8_4.1.x86_64`
...
### `rpm` package: `policycoreutils-2.9-14.el8.x86_64`
...
### `rpm` package: `selinux-policy-3.14.3-67.el8.noarch`
...
### `rpm` package: `which-2.21-12.el8.x86_64`
