...
- Created: `2023-10-12T22:23:53.122505301Z`
- Virtual Size: ~ 899.14 Mb  
...
- Environment:
  ...
  - `PS_VERSION=5.7.43-47.1`
  - `OS_VER=el8`
  - `FULL_PERCONA_VERSION=5.7.43-47.1.el8`
- Labels:
  - `org.opencontainers.image.authors=info@percona.com`

## `rpm` (`.rpm`-based packages)

### `rpm` package: `Percona-Server-client-57-5.7.43-47.1.el8.x86_64`
...
### `rpm` package: `Percona-Server-devel-57-5.7.43-47.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-rocksdb-57-5.7.43-47.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-server-57-5.7.43-47.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-shared-57-5.7.43-47.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-shared-compat-57-5.7.43-47.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-tokudb-57-5.7.43-47.1.el8.x86_64`
...
### `rpm` package: `bind-export-libs-9.11.36-8.el8_8.2.x86_64`
...
```console
$ dnf --quiet download --source --url bind-export-libs-9.11.36-8.el8_8.2
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/bind-9.11.36-8.el8_8.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/bind-9.11.36-8.el8_8.2.src.rpm
```
...
### `rpm` package: `checkpolicy-2.9-1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url checkpolicy-2.9-1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/checkpolicy-2.9-1.el8.src.rpm
```
...
### `rpm` package: `dnf-plugins-core-4.0.21-19.0.2.el8_8.noarch`
...
```console
$ dnf --quiet download --source --url dnf-plugins-core-4.0.21-19.0.2.el8_8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dnf-plugins-core-4.0.21-19.0.2.el8_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.0.21-19.0.2.el8_8.src.rpm
```
...
### `rpm` package: `glibc-2.28-225.0.4.el8_8.6.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.28-225.0.4.el8_8.6
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-225.0.4.el8_8.6.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-225.0.4.el8_8.6.src.rpm
```

### `rpm` package: `glibc-common-2.28-225.0.4.el8_8.6.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.28-225.0.4.el8_8.6
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-225.0.4.el8_8.6.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-225.0.4.el8_8.6.src.rpm
```

### `rpm` package: `glibc-langpack-en-2.28-225.0.4.el8_8.6.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.28-225.0.4.el8_8.6
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-225.0.4.el8_8.6.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-225.0.4.el8_8.6.src.rpm
```
...
### `rpm` package: `krb5-devel-1.18.2-25.0.1.el8_8.x86_64`
...
```console
$ dnf --quiet download --source --url krb5-devel-1.18.2-25.0.1.el8_8
...
### `rpm` package: `libgcc-8.5.0-18.0.6.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libgcc-8.5.0-18.0.6.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gcc-8.5.0-18.0.6.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gcc-8.5.0-18.0.6.el8.src.rpm
```
...
### `rpm` package: `libkadm5-1.18.2-25.0.1.el8_8.x86_64`
...
```console
$ dnf --quiet download --source --url libkadm5-1.18.2-25.0.1.el8_8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/krb5-1.18.2-25.0.1.el8_8.src.rpm
```
...
### `rpm` package: `libselinux-devel-2.9-8.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libselinux-devel-2.9-8.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libselinux-2.9-8.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libselinux-2.9-8.el8.src.rpm
```
...
### `rpm` package: `libstdc++-8.5.0-18.0.6.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libstdc++-8.5.0-18.0.6.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gcc-8.5.0-18.0.6.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gcc-8.5.0-18.0.6.el8.src.rpm
```
...
### `rpm` package: `openssl-devel-1.1.1k-9.el8_7.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-devel-1.1.1k-9.el8_7
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/openssl-1.1.1k-9.el8_7.src.rpm
```
...
### `rpm` package: `perl-Errno-1.28-422.el8.x86_64`
...
```console
$ dnf --quiet download --source --url perl-Errno-1.28-422.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/perl-5.26.3-422.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/perl-5.26.3-422.el8.src.rpm
```
...
### `rpm` package: `perl-IO-1.38-422.el8.x86_64`
...
```console
$ dnf --quiet download --source --url perl-IO-1.38-422.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/perl-5.26.3-422.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/perl-5.26.3-422.el8.src.rpm
```
...
### `rpm` package: `perl-Mozilla-CA-20160104-7.0.1.module+el8.3.0+21136+b437fca9.noarch`
...
### `rpm` package: `perl-interpreter-5.26.3-422.el8.x86_64`
...
```console
$ dnf --quiet download --source --url perl-interpreter-5.26.3-422.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/perl-5.26.3-422.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/perl-5.26.3-422.el8.src.rpm
```
...
### `rpm` package: `perl-libs-5.26.3-422.el8.x86_64`
...
```console
$ dnf --quiet download --source --url perl-libs-5.26.3-422.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/perl-5.26.3-422.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/perl-5.26.3-422.el8.src.rpm
```

### `rpm` package: `perl-macros-5.26.3-422.el8.x86_64`
...
```console
$ dnf --quiet download --source --url perl-macros-5.26.3-422.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/perl-5.26.3-422.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/perl-5.26.3-422.el8.src.rpm
```
...
### `rpm` package: `policycoreutils-python-utils-2.9-24.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url policycoreutils-python-utils-2.9-24.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/policycoreutils-2.9-24.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/policycoreutils-2.9-24.0.1.el8.src.rpm
```
...
### `rpm` package: `python3-audit-3.0.7-4.el8.x86_64`
...
```console
$ dnf --quiet download --source --url python3-audit-3.0.7-4.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/audit-3.0.7-4.el8.src.rpm
```
...
### `rpm` package: `python3-dnf-plugins-core-4.0.21-19.0.2.el8_8.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-plugins-core-4.0.21-19.0.2.el8_8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dnf-plugins-core-4.0.21-19.0.2.el8_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.0.21-19.0.2.el8_8.src.rpm
```
...
### `rpm` package: `python3-libselinux-2.9-8.el8.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libselinux-2.9-8.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libselinux-2.9-8.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libselinux-2.9-8.el8.src.rpm
```

### `rpm` package: `python3-libsemanage-2.9-9.el8_6.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libsemanage-2.9-9.el8_6
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libsemanage-2.9-9.el8_6.src.rpm
```
...
### `rpm` package: `python3-policycoreutils-2.9-24.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url python3-policycoreutils-2.9-24.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/policycoreutils-2.9-24.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/policycoreutils-2.9-24.0.1.el8.src.rpm
```
...
### `rpm` package: `python3-setools-4.3.0-3.el8.x86_64`
...
```console
$ dnf --quiet download --source --url python3-setools-4.3.0-3.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/setools-4.3.0-3.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/setools-4.3.0-3.el8.src.rpm
```
...
### `rpm` package: `rpm-plugin-selinux-4.14.3-26.el8.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-plugin-selinux-4.14.3-26.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/rpm-4.14.3-26.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/rpm-4.14.3-26.el8.src.rpm
```
...
### `rpm` package: `selinux-policy-3.14.3-117.0.1.el8_8.3.noarch`
...
```console
$ dnf --quiet download --source --url selinux-policy-3.14.3-117.0.1.el8_8.3.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/selinux-policy-3.14.3-117.0.1.el8_8.3.src.rpm
```

### `rpm` package: `selinux-policy-minimum-3.14.3-117.0.1.el8_8.3.noarch`
...
```console
$ dnf --quiet download --source --url selinux-policy-minimum-3.14.3-117.0.1.el8_8.3.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/selinux-policy-3.14.3-117.0.1.el8_8.3.src.rpm
```
...
### `rpm` package: `systemd-239-74.0.5.el8_8.5.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-239-74.0.5.el8_8.5
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-74.0.5.el8_8.5.src.rpm
```

### `rpm` package: `systemd-libs-239-74.0.5.el8_8.5.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-239-74.0.5.el8_8.5
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-74.0.5.el8_8.5.src.rpm
```

### `rpm` package: `systemd-pam-239-74.0.5.el8_8.5.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-239-74.0.5.el8_8.5
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-74.0.5.el8_8.5.src.rpm
```
...
### `rpm` package: `yum-utils-4.0.21-19.0.2.el8_8.noarch`
...
```console
$ dnf --quiet download --source --url yum-utils-4.0.21-19.0.2.el8_8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dnf-plugins-core-4.0.21-19.0.2.el8_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.0.21-19.0.2.el8_8.src.rpm
```
