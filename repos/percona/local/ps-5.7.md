...
- Created: `2023-09-28T19:33:39.445314271Z`
- Virtual Size: ~ 901.77 Mb  
...
### `rpm` package: `selinux-policy-3.14.3-117.0.1.el8_8.2.noarch`
...
```console
$ dnf --quiet download --source --url selinux-policy-3.14.3-117.0.1.el8_8.2.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/selinux-policy-3.14.3-117.0.1.el8_8.2.src.rpm
```

### `rpm` package: `selinux-policy-minimum-3.14.3-117.0.1.el8_8.2.noarch`
...
```console
$ dnf --quiet download --source --url selinux-policy-minimum-3.14.3-117.0.1.el8_8.2.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/selinux-policy-3.14.3-117.0.1.el8_8.2.src.rpm
```
