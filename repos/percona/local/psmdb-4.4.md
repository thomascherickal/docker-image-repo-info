...
- Created: `2023-10-28T03:53:00.878898991Z`
- Virtual Size: ~ 614.10 Mb  
...
- Environment:
  ...
  - `PSMDB_VERSION=4.4.22-21`
  - `OS_VER=el8`
  - `FULL_PERCONA_VERSION=4.4.22-21.el8`
...
### `rpm` package: `percona-server-mongodb-mongos-4.4.22-21.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-server-4.4.22-21.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-shell-4.4.22-21.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-tools-4.4.22-21.el8.x86_64`
