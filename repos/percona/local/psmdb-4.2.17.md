...
### `rpm` package: `percona-server-mongodb-mongos-4.2.17-17.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-server-4.2.17-17.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-shell-4.2.17-17.el8.x86_64`
