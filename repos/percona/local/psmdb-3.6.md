...
### `rpm` package: `Percona-Server-MongoDB-36-mongos-3.6.23-13.0.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-MongoDB-36-server-3.6.23-13.0.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-MongoDB-36-shell-3.6.23-13.0.el8.x86_64`
