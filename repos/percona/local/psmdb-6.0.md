...
- Created: `2023-10-28T03:50:50.006511684Z`
- Virtual Size: ~ 719.46 Mb  
...
- Environment:
  ...
  - `PSMDB_VERSION=6.0.6-5`
  - `OS_VER=el8`
  - `FULL_PERCONA_VERSION=6.0.6-5.el8`
...
### `rpm` package: `percona-mongodb-mongosh-2.0.0-1.el8.x86_64`
...
### `rpm` package: `percona-server-mongodb-mongos-6.0.6-5.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-server-6.0.6-5.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-tools-6.0.6-5.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `platform-python-3.6.8-51.0.1.el8_8.2.x86_64`
...
```console
$ dnf --quiet download --source --url platform-python-3.6.8-51.0.1.el8_8.2
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/python3-3.6.8-51.0.1.el8_8.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/python3-3.6.8-51.0.1.el8_8.2.src.rpm
```
...
### `rpm` package: `procps-ng-3.3.15-13.0.2.el8.x86_64`
...
```console
$ dnf --quiet download --source --url procps-ng-3.3.15-13.0.2.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/procps-ng-3.3.15-13.0.2.el8.src.rpm
```
...
### `rpm` package: `python3-libs-3.6.8-51.0.1.el8_8.2.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.6.8-51.0.1.el8_8.2
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/python3-3.6.8-51.0.1.el8_8.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/python3-3.6.8-51.0.1.el8_8.2.src.rpm
```
