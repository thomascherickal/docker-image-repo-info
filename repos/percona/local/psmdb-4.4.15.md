...
- Created: `2023-07-04T18:12:14.00731048Z`
- Virtual Size: ~ 503.14 Mb  
...
- Environment:
  ...
  - `PSMDB_VERSION=4.4.15-15`
  - `OS_VER=el8`
  - `FULL_PERCONA_VERSION=4.4.15-15.el8`
...
### `rpm` package: `percona-server-mongodb-mongos-4.4.15-15.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-server-4.4.15-15.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-shell-4.4.15-15.el8.x86_64`
...
### `rpm` package: `systemd-239-74.0.2.el8_8.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-239-74.0.2.el8_8
...
### `rpm` package: `systemd-pam-239-74.0.2.el8_8.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-239-74.0.2.el8_8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-74.0.2.el8_8.src.rpm
```
