...
- Created: `2022-01-28T00:49:44.659949161Z`
...
- Environment:
  ...
  - `PS_VERSION=8.0.26-17.2`
  - `OS_VER=el8`
  - `FULL_PERCONA_VERSION=8.0.26-17.2.el8`
- Labels:
...
### `rpm` package: `openssl-pkcs11-0.4.10-2.el8.x86_64`
...
### `rpm` package: `percona-server-client-8.0.26-17.2.el8.x86_64`
...
### `rpm` package: `percona-server-devel-8.0.26-17.2.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2018, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-rocksdb-8.0.26-17.2.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2018, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-server-8.0.26-17.2.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2018, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-shared-8.0.26-17.2.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2018, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-shared-compat-8.0.26-17.2.el8.x86_64`
...
### `rpm` package: `policycoreutils-2.9-16.el8.x86_64`
