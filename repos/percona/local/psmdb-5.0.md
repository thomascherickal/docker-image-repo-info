...
### `rpm` package: `curl-7.61.1-18.el8_4.1.x86_64`
...
### `rpm` package: `cyrus-sasl-plain-2.1.27-5.el8.x86_64`
...
### `rpm` package: `libcurl-minimal-7.61.1-18.el8_4.1.x86_64`
...
### `rpm` package: `percona-server-mongodb-mongos-5.0.3-2.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-server-5.0.3-2.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-shell-5.0.3-2.el8.x86_64`
