...
```console
$ docker pull ubuntu@sha256:58499317275a1605b1d99975b7f3f11505f1c73a69574a2c5ba282d522d84758
```
...
```console
$ docker pull ubuntu@sha256:e4771b7160543c6e43968b4e9795be9ddcad9d573edd7cd7aebd3ce61326fc7a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.7 MB (26710270 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d5df41c547bd107c14368ad302efc46760940ae188df451cabc23e10f7f161b`
...
```console
$ docker pull ubuntu@sha256:d783cd7b0dcfd6b4d34f2230d6d99c0c7164f7f4d2b69c0ecc88dab67f773843
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.2 MB (27164268 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:72e79a36c0775e201d683688f30bb189257860a3a294ae9d38b4931b08014fe2`
-	Default Command: `["bash"]`
...
```console
$ docker pull ubuntu@sha256:071cc2fac989a485e38e9e1cfddb0ffa4d45705c617b56cafe9d1e59364ec1bb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.4 MB (30441470 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b9aa8d7584d8c2ef0cb4d3b34e25272ae19442705256e928c3ffe463593ec3d7`
-	Default Command: `["bash"]`
...
```console
$ docker pull ubuntu@sha256:28ccbd6869bf65f5540d94bed75eb13e16c122680444331d4aad91f9f960ba11
```
...
```console
$ docker pull ubuntu@sha256:c765dd0e657437e5c287e6df020c64aa44902c6e17c2a516644540e57d5d5aff
```
...
```console
$ docker pull ubuntu@sha256:20b75e43440ec737ee85f87f4e1a0e6b626ccf15018ac2a00374eaf5e1b84e70
```
...
### `ubuntu:bionic-20220801` - linux; amd64
...
### `ubuntu:bionic-20220801` - linux; arm64 variant v8
...
### `ubuntu:bionic-20220801` - linux; 386
...
### `ubuntu:bionic-20220801` - linux; ppc64le
...
### `ubuntu:bionic-20220801` - linux; s390x
...
```console
$ docker pull ubuntu@sha256:8fb134028e0b03dfaa56884d7bc93e30ac31397ef7c443d68309b5bc3dfa4b5d
```
...
### `ubuntu:jammy-20220801` - linux; amd64
...
### `ubuntu:jammy-20220801` - linux; arm64 variant v8
...
### `ubuntu:jammy-20220801` - linux; ppc64le
...
### `ubuntu:jammy-20220801` - linux; riscv64
...
### `ubuntu:jammy-20220801` - linux; s390x
