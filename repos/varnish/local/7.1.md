...
- Image ID: `sha256:81657f4e42021b061d02d4ec68ab037fd384223d68e212e723bc5ab5b13edb84`
- Created: `2023-03-01T18:20:33.374138166Z`
...
- Environment:
  ...
  - `VMOD_DEPS=automake curl libtool make pkg-config python3-sphinx`
  - `VARNISH_SIZE=100M`
...
### `dpkg` source package: `dns-root-data=2021011101`
...
```console
$ apt-get source -qq --print-uris dns-root-data=2021011101
'http://deb.debian.org/debian/pool/main/d/dns-root-data/dns-root-data_2021011101.dsc' dns-root-data_2021011101.dsc 1296 SHA256:33997724479aae9285b1e736dee383fef529ebffa515e0bb9485b7b8306c579d
'http://deb.debian.org/debian/pool/main/d/dns-root-data/dns-root-data_2021011101.tar.xz' dns-root-data_2021011101.tar.xz 16140 SHA256:4efe774175f329a81e798c4f718af8d9ffff6badf3ef2e8c17636445f95ff1d4
```

Other potentially useful URLs:

- https://sources.debian.net/src/dns-root-data/2021011101/ (for browsing the source)
- https://sources.debian.net/src/dns-root-data/2021011101/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/dns-root-data/2021011101/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `getdns=1.6.0-2`

Binary Packages:

- `libgetdns10:amd64=1.6.0-2`
...
```console
$ apt-get source -qq --print-uris getdns=1.6.0-2
'http://deb.debian.org/debian/pool/main/g/getdns/getdns_1.6.0-2.dsc' getdns_1.6.0-2.dsc 2337 SHA256:d340e6921c1b90ad36575ffed2bc8402642650fd6a5846dda713c3b374b52b7b
...
'http://deb.debian.org/debian/pool/main/g/getdns/getdns_1.6.0-2.debian.tar.xz' getdns_1.6.0-2.debian.tar.xz 20992 SHA256:b4380a0a115ddbd4d622a84598b2d71d67788cefe993faf3d7431310ab3f8a29
```

Other potentially useful URLs:

- https://sources.debian.net/src/getdns/1.6.0-2/ (for browsing the source)
- https://sources.debian.net/src/getdns/1.6.0-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/getdns/1.6.0-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `unbound=1.13.1-1`
...
```console
$ apt-get source -qq --print-uris unbound=1.13.1-1
'http://deb.debian.org/debian/pool/main/u/unbound/unbound_1.13.1-1.dsc' unbound_1.13.1-1.dsc 3011 SHA256:053af91ade67d0422a4ee248fd4248243c0db9493cb2906e2d0dfda7e99609bb
'http://deb.debian.org/debian/pool/main/u/unbound/unbound_1.13.1.orig.tar.gz' unbound_1.13.1.orig.tar.gz 5976957 SHA256:8504d97b8fc5bd897345c95d116e0ee0ddf8c8ff99590ab2b4bd13278c9f50b8
'http://deb.debian.org/debian/pool/main/u/unbound/unbound_1.13.1.orig.tar.gz.asc' unbound_1.13.1.orig.tar.gz.asc 833 SHA256:1ca1fb3db4baa3e831bc42fcecf3eaceb316abf7a2d816dc46d0efcd199f419e
'http://deb.debian.org/debian/pool/main/u/unbound/unbound_1.13.1-1.debian.tar.xz' unbound_1.13.1-1.debian.tar.xz 20428 SHA256:1592fe0b5e23b1870f699cf076206041ed7f748e6fdf9f5b55b5eb7c2dfea465
```

Other potentially useful URLs:

- https://sources.debian.net/src/unbound/1.13.1-1/ (for browsing the source)
- https://sources.debian.net/src/unbound/1.13.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/unbound/1.13.1-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `varnish=7.1.2`
