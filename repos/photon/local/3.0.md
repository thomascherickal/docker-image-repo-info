...
- Created: `2021-09-04T15:12:26.222684632Z`
- Virtual Size: ~ 36.54 Mb  
...
### `rpm` package: `curl-7.78.0-1.ph3.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `curl-libs-7.78.0-1.ph3.x86_64`
...
### `rpm` package: `glibc-2.28-15.ph3.x86_64`
...
### `rpm` package: `tdnf-3.1.4-2.ph3.x86_64`

Licenses (from `rpm --query`): LGPLv2.1,GPLv2

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `tdnf-cli-libs-3.1.4-2.ph3.x86_64`
