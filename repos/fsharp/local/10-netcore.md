...
- Created: `2020-09-10T05:36:34.791441218Z`
- Virtual Size: ~ 980.21 Mb  
...
Licenses: (parsed from: `/usr/share/doc/gettext/copyright`, `/usr/share/doc/gettext-base/copyright`)
...
Licenses: (parsed from: `/usr/share/doc/gnupg-l10n/copyright`, `/usr/share/doc/gnupg-utils/copyright`, `/usr/share/doc/gpg/copyright`, `/usr/share/doc/gpg-agent/copyright`, `/usr/share/doc/gpg-wks-server/copyright`, `/usr/share/doc/gpgconf/copyright`, `/usr/share/doc/gpgsm/copyright`, `/usr/share/doc/gpgv/copyright`)
...
### `dpkg` source package: `libunwind=1.2.1-10~deb10u1`

Binary Packages:

- `libunwind8:amd64=1.2.1-10~deb10u1`
...
```console
$ apt-get source -qq --print-uris libunwind=1.2.1-10~deb10u1
'http://deb.debian.org/debian/pool/main/libu/libunwind/libunwind_1.2.1-10~deb10u1.dsc' libunwind_1.2.1-10~deb10u1.dsc 2573 SHA256:6b6564f9b58c0f7e3d575f18b3581cd59368c3a632e1cbff18c1c6361d77a39b
'http://deb.debian.org/debian/pool/main/libu/libunwind/libunwind_1.2.1.orig.tar.gz' libunwind_1.2.1.orig.tar.gz 780774 SHA256:3f3ecb90e28cbe53fba7a4a27ccce7aad188d3210bb1964a923a731a27a75acb
'http://deb.debian.org/debian/pool/main/libu/libunwind/libunwind_1.2.1-10~deb10u1.debian.tar.xz' libunwind_1.2.1-10~deb10u1.debian.tar.xz 19864 SHA256:4de4cc32a3b8e3b285b7169124ad854b7e1074d3bd44b69fbcb47bde3e0eff9b
```

Other potentially useful URLs:

- https://sources.debian.net/src/libunwind/1.2.1-10~deb10u1/ (for browsing the source)
- https://sources.debian.net/src/libunwind/1.2.1-10~deb10u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libunwind/1.2.1-10~deb10u1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `liburcu=0.10.2-1`

Binary Packages:

- `liburcu6:amd64=0.10.2-1`

Licenses: (parsed from: `/usr/share/doc/liburcu6/copyright`)
...
```console
$ apt-get source -qq --print-uris liburcu=0.10.2-1
'http://deb.debian.org/debian/pool/main/libu/liburcu/liburcu_0.10.2-1.dsc' liburcu_0.10.2-1.dsc 2282 SHA256:a2a0a238086dfb440e82f730236cdd0fd199eb6e4918fb978a5c3a48cb3a4fc1
'http://deb.debian.org/debian/pool/main/libu/liburcu/liburcu_0.10.2.orig.tar.bz2' liburcu_0.10.2.orig.tar.bz2 503833 SHA256:b3f6888daf6fe02c1f8097f4a0898e41b5fe9975e121dc792b9ddef4b17261cc
'http://deb.debian.org/debian/pool/main/libu/liburcu/liburcu_0.10.2.orig.tar.bz2.asc' liburcu_0.10.2.orig.tar.bz2.asc 488 SHA256:702d9bf646830fbcaca5ebe2168a5d1e0f90a8b446dc07af068673f53af0b11f
'http://deb.debian.org/debian/pool/main/libu/liburcu/liburcu_0.10.2-1.debian.tar.xz' liburcu_0.10.2-1.debian.tar.xz 13336 SHA256:e6a8fc0ea1a05ddeb2aca820dc190853434b3ad40a5fd05c121c69ddb408eca4
```

Other potentially useful URLs:

- https://sources.debian.net/src/liburcu/0.10.2-1/ (for browsing the source)
- https://sources.debian.net/src/liburcu/0.10.2-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/liburcu/0.10.2-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `ust=2.10.3-1`
...
Licenses: (parsed from: `/usr/share/doc/liblttng-ust-ctl4/copyright`, `/usr/share/doc/liblttng-ust0/copyright`)
...
```console
$ apt-get source -qq --print-uris ust=2.10.3-1
'http://deb.debian.org/debian/pool/main/u/ust/ust_2.10.3-1.dsc' ust_2.10.3-1.dsc 2993 SHA256:483cba76fe012c13e128408d9c51010acf58a4d54c55a43955e5bfd370c54155
'http://deb.debian.org/debian/pool/main/u/ust/ust_2.10.3.orig.tar.bz2' ust_2.10.3.orig.tar.bz2 799603 SHA256:9e8420f90d5f963f7aa32bc6d44adc1e491136f687c69ffb7a3075d33b40852b
'http://deb.debian.org/debian/pool/main/u/ust/ust_2.10.3.orig.tar.bz2.asc' ust_2.10.3.orig.tar.bz2.asc 488 SHA256:09b3a0ab90f07e2ce38bf1913860485233b5e492cfd41783ba9ecd880d63f167
'http://deb.debian.org/debian/pool/main/u/ust/ust_2.10.3-1.debian.tar.xz' ust_2.10.3-1.debian.tar.xz 16848 SHA256:aa610e6a4586952edb8d6b6545c9856ffaab41cdbc4eec890e4ba3befe64f664
```

Other potentially useful URLs:

- https://sources.debian.net/src/ust/2.10.3-1/ (for browsing the source)
- https://sources.debian.net/src/ust/2.10.3-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/ust/2.10.3-1/ (for access to the source package after it no longer exists in the archive)
