...
### `node:14.2.0-stretch` - linux; amd64
...
### `node:14.2.0-stretch` - linux; arm variant v7
...
### `node:14.2.0-stretch` - linux; arm64 variant v8
...
### `node:14.2.0-stretch` - linux; ppc64le
...
### `node:14.2.0-stretch` - linux; s390x
