...
### `node:20.5.1-bullseye` - linux; amd64
...
### `node:20.5.1-bullseye` - linux; arm variant v7
...
### `node:20.5.1-bullseye` - linux; arm64 variant v8
...
### `node:20.5.1-bullseye` - linux; ppc64le
...
### `node:20.5.1-bullseye` - linux; s390x
