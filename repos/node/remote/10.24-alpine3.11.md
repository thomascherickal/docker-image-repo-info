...
### `node:10.24-alpine3.11` - linux; arm variant v6
...
### `node:10.24-alpine3.11` - linux; arm variant v7
...
### `node:10.24-alpine3.11` - linux; arm64 variant v8
...
### `node:10.24-alpine3.11` - linux; 386
...
### `node:10.24-alpine3.11` - linux; ppc64le
...
### `node:10.24-alpine3.11` - linux; s390x
