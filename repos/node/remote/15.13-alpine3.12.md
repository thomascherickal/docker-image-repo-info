...
### `node:15.13-alpine3.12` - linux; amd64
...
### `node:15.13-alpine3.12` - linux; arm variant v6
...
### `node:15.13-alpine3.12` - linux; arm variant v7
...
### `node:15.13-alpine3.12` - linux; arm64 variant v8
...
### `node:15.13-alpine3.12` - linux; ppc64le
...
### `node:15.13-alpine3.12` - linux; s390x
