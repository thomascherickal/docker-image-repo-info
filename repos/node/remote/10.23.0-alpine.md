...
```console
$ docker pull node@sha256:a104b1863171a3626b13f6f38e7c269bd0f3841989a08d24e1b2d5418997f56d
```
...
### `node:10.23.0-alpine` - linux; amd64
...
### `node:10.23.0-alpine` - linux; arm variant v6
...
### `node:10.23.0-alpine` - linux; arm variant v7
...
### `node:10.23.0-alpine` - linux; arm64 variant v8
