...
### `node:14.6.0-alpine` - linux; arm variant v6
...
### `node:14.6.0-alpine` - linux; arm variant v7
...
### `node:14.6.0-alpine` - linux; arm64 variant v8
...
### `node:14.6.0-alpine` - linux; ppc64le
...
### `node:14.6.0-alpine` - linux; s390x
