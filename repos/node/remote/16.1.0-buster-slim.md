...
### `node:16.1.0-buster-slim` - linux; amd64
...
### `node:16.1.0-buster-slim` - linux; arm variant v7
...
### `node:16.1.0-buster-slim` - linux; arm64 variant v8
...
### `node:16.1.0-buster-slim` - linux; ppc64le
...
### `node:16.1.0-buster-slim` - linux; s390x
