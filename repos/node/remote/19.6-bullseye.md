...
```console
$ docker pull node@sha256:a660fec2445d54cfe2866c8b7354a4e316c8f70d71122a578a4da7ef18cd17a7
```
...
### `node:19.6-bullseye` - linux; amd64
...
### `node:19.6-bullseye` - linux; arm64 variant v8
...
### `node:19.6-bullseye` - linux; ppc64le
