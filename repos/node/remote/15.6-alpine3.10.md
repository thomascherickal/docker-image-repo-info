...
### `node:15.6-alpine3.10` - linux; amd64
...
### `node:15.6-alpine3.10` - linux; arm variant v6
...
### `node:15.6-alpine3.10` - linux; arm variant v7
...
### `node:15.6-alpine3.10` - linux; arm64 variant v8
...
### `node:15.6-alpine3.10` - linux; ppc64le
...
### `node:15.6-alpine3.10` - linux; s390x
