...
```console
$ docker pull node@sha256:53cd04d947b6c097fde5ea031622f917e8a61378890effd8d548b1204628a3fc
```
...
### `node:12.18.0-alpine3.11` - linux; amd64
...
### `node:12.18.0-alpine3.11` - linux; arm variant v6
...
### `node:12.18.0-alpine3.11` - linux; arm variant v7
...
### `node:12.18.0-alpine3.11` - linux; arm64 variant v8
...
### `node:12.18.0-alpine3.11` - linux; ppc64le

```console
$ docker pull node@sha256:bec3d8634685cd0113f4d5360663c321cf308baa39ada5371421044c01eac362
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.2 MB (32154753 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91f12a97cc18aa214ae189a0c2601847568f98bc39eee72ae32b4e10e040d737`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
### `node:12.18.0-alpine3.11` - linux; s390x
