...
```console
$ docker pull node@sha256:6319aa2c5a22900cd01223e6aada50b7af25134f3f03b87b0b8effee873b9bb8
```
...
### `node:21.3-bullseye` - linux; amd64
...
### `node:21.3-bullseye` - linux; arm64 variant v8
...
### `node:21.3-bullseye` - linux; ppc64le
...
### `node:21.3-bullseye` - linux; s390x
