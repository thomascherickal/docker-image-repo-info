...
### `node:18.18.0-bookworm` - linux; amd64
...
### `node:18.18.0-bookworm` - linux; arm variant v7
...
### `node:18.18.0-bookworm` - linux; arm64 variant v8
...
### `node:18.18.0-bookworm` - linux; ppc64le
...
### `node:18.18.0-bookworm` - linux; s390x
