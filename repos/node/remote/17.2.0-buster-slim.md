...
```console
$ docker pull node@sha256:10da0090b2157335c769e26762862349009532d29c02f2b3989011ce1ae4bd34
```
...
### `node:17.2.0-buster-slim` - linux; arm variant v7
...
### `node:17.2.0-buster-slim` - linux; arm64 variant v8
...
### `node:17.2.0-buster-slim` - linux; ppc64le
...
### `node:17.2.0-buster-slim` - linux; s390x
