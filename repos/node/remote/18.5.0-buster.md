...
```console
$ docker pull node@sha256:65da38c6c877e3fe147e1b8e5c712a22892df348aead8702f6266e32cdd8b4d9
```
...
### `node:18.5.0-buster` - linux; amd64
...
### `node:18.5.0-buster` - linux; arm variant v7
...
### `node:18.5.0-buster` - linux; arm64 variant v8
...
### `node:18.5.0-buster` - linux; ppc64le
...
### `node:18.5.0-buster` - linux; s390x
