...
### `node:8.17.0-onbuild` - linux; amd64
...
### `node:8.17.0-onbuild` - linux; arm variant v7
...
### `node:8.17.0-onbuild` - linux; arm64 variant v8
...
### `node:8.17.0-onbuild` - linux; ppc64le
...
### `node:8.17.0-onbuild` - linux; s390x
