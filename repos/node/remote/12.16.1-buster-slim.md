...
### `node:12.16.1-buster-slim` - linux; amd64
...
### `node:12.16.1-buster-slim` - linux; arm variant v7
...
### `node:12.16.1-buster-slim` - linux; arm64 variant v8
...
### `node:12.16.1-buster-slim` - linux; ppc64le
...
### `node:12.16.1-buster-slim` - linux; s390x
