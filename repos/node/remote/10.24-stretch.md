...
```console
$ docker pull node@sha256:f5a1e9a5ac52edb3e4afc035f513320a973b11da2d7c4c68998fca53b8f6d195
```
...
### `node:10.24-stretch` - linux; amd64
...
### `node:10.24-stretch` - linux; arm variant v7
...
### `node:10.24-stretch` - linux; arm64 variant v8
