...
### `node:10.23.3-buster-slim` - linux; arm variant v7
...
### `node:10.23.3-buster-slim` - linux; arm64 variant v8
...
### `node:10.23.3-buster-slim` - linux; ppc64le
...
### `node:10.23.3-buster-slim` - linux; s390x
