...
### `node:16.15.0-alpine3.15` - linux; amd64
...
### `node:16.15.0-alpine3.15` - linux; arm variant v6
...
### `node:16.15.0-alpine3.15` - linux; arm variant v7
...
### `node:16.15.0-alpine3.15` - linux; arm64 variant v8
...
### `node:16.15.0-alpine3.15` - linux; ppc64le
...
### `node:16.15.0-alpine3.15` - linux; s390x
