...
```console
$ docker pull node@sha256:cd1356d1a57ae31d6ae06ec7bd8b16c2fef80a670210d12c3f824bb5b382e0df
```
...
```console
$ docker pull node@sha256:f580945d3be580ceff9071fa104df1b2f9d3ce50dd4ce57b91526348b30a82f7
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **69.5 MB (69500918 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3e22aeaad4a8bfa60065d9fbaf362054dbacd4f01a70f653c35f0759c4fe973`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
