...
```console
$ docker pull node@sha256:1682e3702081f96a52d77879cf836a3e924273ae62a2c6abb54fbbbbf0f4e427
```
...
### `node:14.15.3-buster` - linux; amd64
...
### `node:14.15.3-buster` - linux; arm variant v7
...
### `node:14.15.3-buster` - linux; arm64 variant v8
