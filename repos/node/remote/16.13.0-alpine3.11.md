...
```console
$ docker pull node@sha256:a7330056cbe7c1282624150080afa256bad09c3fa76be7f06ef0add43910c156
```
...
### `node:16.13.0-alpine3.11` - linux; arm variant v6
...
### `node:16.13.0-alpine3.11` - linux; arm variant v7
...
### `node:16.13.0-alpine3.11` - linux; arm64 variant v8
...
### `node:16.13.0-alpine3.11` - linux; s390x
