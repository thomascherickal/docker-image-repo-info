...
```console
$ docker pull node@sha256:d5eb91954660d7fc1c9201cac6a5266249cda5669d07e5dae2cc8c6d074a54c8
```
...
### `node:10.19-buster` - linux; arm variant v7
...
### `node:10.19-buster` - linux; arm64 variant v8
...
### `node:10.19-buster` - linux; ppc64le
