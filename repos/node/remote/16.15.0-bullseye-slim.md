...
```console
$ docker pull node@sha256:2e5e0553256b9cdf53bfd5dbd07cb175e0b2d1da72196b28859664b5e18f735c
```
...
### `node:16.15.0-bullseye-slim` - linux; arm64 variant v8
...
### `node:16.15.0-bullseye-slim` - linux; s390x
