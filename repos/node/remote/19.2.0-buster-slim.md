...
```console
$ docker pull node@sha256:4af1a8ad86919cf64dc5919d4be513468220c351c38fe6332291339142dac594
```
...
### `node:19.2.0-buster-slim` - linux; amd64
...
### `node:19.2.0-buster-slim` - linux; arm variant v7
...
### `node:19.2.0-buster-slim` - linux; arm64 variant v8
