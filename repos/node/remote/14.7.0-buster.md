...
```console
$ docker pull node@sha256:e3763c9303555f6fa24128d047892577f4e91ad132ec18073d50358ad6f5e03d
```
...
### `node:14.7.0-buster` - linux; amd64
...
### `node:14.7.0-buster` - linux; arm variant v7
...
### `node:14.7.0-buster` - linux; arm64 variant v8
...
### `node:14.7.0-buster` - linux; ppc64le
...
### `node:14.7.0-buster` - linux; s390x
