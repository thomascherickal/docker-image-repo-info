...
```console
$ docker pull node@sha256:6e8a6e1ba5395c1a4958a73a6233bb80f429227430c6f32d21e37573f135ef47
```
...
### `node:16.9-alpine3.11` - linux; arm variant v6
...
### `node:16.9-alpine3.11` - linux; arm variant v7
...
### `node:16.9-alpine3.11` - linux; arm64 variant v8
...
### `node:16.9-alpine3.11` - linux; ppc64le
