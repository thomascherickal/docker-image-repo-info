...
```console
$ docker pull node@sha256:71cbc62c247630c5ee215242dc1b157c6fe588a100f9fd66a877ef1c1a94ea93
```
...
### `node:16.13.0-bullseye` - linux; arm variant v7
...
### `node:16.13.0-bullseye` - linux; arm64 variant v8
...
### `node:16.13.0-bullseye` - linux; s390x
