...
```console
$ docker pull node@sha256:6e6d60196d86852a797e94d7201a61933df0f3b172f250c485fc58d124ff3476
```
...
### `node:20.0-bullseye` - linux; amd64
...
### `node:20.0-bullseye` - linux; arm variant v7
...
### `node:20.0-bullseye` - linux; arm64 variant v8
...
### `node:20.0-bullseye` - linux; ppc64le
...
### `node:20.0-bullseye` - linux; s390x
