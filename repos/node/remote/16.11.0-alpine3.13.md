...
### `node:16.11.0-alpine3.13` - linux; arm variant v6
...
### `node:16.11.0-alpine3.13` - linux; arm variant v7
...
### `node:16.11.0-alpine3.13` - linux; arm64 variant v8
...
### `node:16.11.0-alpine3.13` - linux; ppc64le
...
### `node:16.11.0-alpine3.13` - linux; s390x
