...
### `node:20.5-bookworm` - linux; amd64
...
### `node:20.5-bookworm` - linux; arm variant v7
...
### `node:20.5-bookworm` - linux; arm64 variant v8
...
### `node:20.5-bookworm` - linux; ppc64le
...
### `node:20.5-bookworm` - linux; s390x
