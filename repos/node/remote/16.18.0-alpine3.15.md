...
```console
$ docker pull node@sha256:12eccfd431c5aea43165c9f44e66d756952fbb4c06b9766feb43ce43b20e0837
```
...
### `node:16.18.0-alpine3.15` - linux; amd64
...
### `node:16.18.0-alpine3.15` - linux; arm variant v6
...
### `node:16.18.0-alpine3.15` - linux; arm64 variant v8
...
### `node:16.18.0-alpine3.15` - linux; ppc64le
...
### `node:16.18.0-alpine3.15` - linux; s390x
