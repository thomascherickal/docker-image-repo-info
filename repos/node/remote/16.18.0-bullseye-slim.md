...
### `node:16.18.0-bullseye-slim` - linux; amd64
...
### `node:16.18.0-bullseye-slim` - linux; arm variant v7
...
### `node:16.18.0-bullseye-slim` - linux; arm64 variant v8
...
### `node:16.18.0-bullseye-slim` - linux; ppc64le
...
### `node:16.18.0-bullseye-slim` - linux; s390x
