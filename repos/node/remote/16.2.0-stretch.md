...
```console
$ docker pull node@sha256:5ec69942d25f94fd60a9579959d0cd52fafa9c8cc5cc1a0a8adbf1b66f76c2ef
```
...
### `node:16.2.0-stretch` - linux; amd64
...
### `node:16.2.0-stretch` - linux; arm variant v7
