...
### `node:14.1-buster-slim` - linux; amd64
...
### `node:14.1-buster-slim` - linux; arm variant v7
...
### `node:14.1-buster-slim` - linux; arm64 variant v8
...
### `node:14.1-buster-slim` - linux; ppc64le
...
### `node:14.1-buster-slim` - linux; s390x
