...
```console
$ docker pull node@sha256:1ee9ec6130f0ae6b7b9d54d4ee0d0e2aab82cedbba9fecf2a4ddba535d247bd7
```
...
### `node:14.13.1-stretch-slim` - linux; amd64
...
### `node:14.13.1-stretch-slim` - linux; arm64 variant v8
