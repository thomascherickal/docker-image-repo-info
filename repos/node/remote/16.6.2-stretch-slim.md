...
```console
$ docker pull node@sha256:09a06d0fc38d72f0dbbbe8d91a536b7ffe7f1da01f8a9655ef14079987fa0dfb
```
...
### `node:16.6.2-stretch-slim` - linux; amd64
...
### `node:16.6.2-stretch-slim` - linux; arm variant v7
