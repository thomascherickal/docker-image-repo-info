...
### `node:16.12.0-alpine3.11` - linux; arm variant v6
...
### `node:16.12.0-alpine3.11` - linux; arm variant v7
...
### `node:16.12.0-alpine3.11` - linux; arm64 variant v8
...
### `node:16.12.0-alpine3.11` - linux; ppc64le
...
### `node:16.12.0-alpine3.11` - linux; s390x
