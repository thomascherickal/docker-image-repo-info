...
### `node:21.4.0-bookworm` - linux; amd64
...
### `node:21.4.0-bookworm` - linux; arm variant v7
...
### `node:21.4.0-bookworm` - linux; arm64 variant v8
...
### `node:21.4.0-bookworm` - linux; ppc64le
...
### `node:21.4.0-bookworm` - linux; s390x
