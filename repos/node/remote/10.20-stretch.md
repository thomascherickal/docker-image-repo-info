...
### `node:10.20-stretch` - linux; amd64
...
### `node:10.20-stretch` - linux; arm variant v7
...
### `node:10.20-stretch` - linux; arm64 variant v8
...
### `node:10.20-stretch` - linux; ppc64le
...
### `node:10.20-stretch` - linux; s390x
