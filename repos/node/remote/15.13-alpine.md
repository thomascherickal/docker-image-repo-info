...
### `node:15.13-alpine` - linux; arm variant v6
...
### `node:15.13-alpine` - linux; arm variant v7
...
### `node:15.13-alpine` - linux; arm64 variant v8
...
### `node:15.13-alpine` - linux; ppc64le
