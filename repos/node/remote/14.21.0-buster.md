...
```console
$ docker pull node@sha256:768de2ed03a469f086aeb737196d559427a7b313afa363597e6ef0e337a17855
```
...
### `node:14.21.0-buster` - linux; amd64
...
### `node:14.21.0-buster` - linux; arm variant v7
...
### `node:14.21.0-buster` - linux; arm64 variant v8
