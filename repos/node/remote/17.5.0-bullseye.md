...
### `node:17.5.0-bullseye` - linux; amd64
...
### `node:17.5.0-bullseye` - linux; arm variant v7
...
### `node:17.5.0-bullseye` - linux; arm64 variant v8
...
### `node:17.5.0-bullseye` - linux; ppc64le
...
### `node:17.5.0-bullseye` - linux; s390x
