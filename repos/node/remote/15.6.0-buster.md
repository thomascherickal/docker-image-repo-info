...
### `node:15.6.0-buster` - linux; amd64
...
### `node:15.6.0-buster` - linux; arm variant v7
...
### `node:15.6.0-buster` - linux; arm64 variant v8
...
### `node:15.6.0-buster` - linux; ppc64le
...
### `node:15.6.0-buster` - linux; s390x
