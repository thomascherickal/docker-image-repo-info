...
```console
$ docker pull node@sha256:850abb20806876004326fda6df987dce573d98e4df06f38f1ef7c02d46225072
```
...
### `node:16.9.0-bullseye` - linux; amd64
...
### `node:16.9.0-bullseye` - linux; arm variant v7
...
### `node:16.9.0-bullseye` - linux; arm64 variant v8
...
### `node:16.9.0-bullseye` - linux; ppc64le
