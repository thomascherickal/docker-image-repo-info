...
```console
$ docker pull node@sha256:66bdae102b404e41ce27551bd195d1e0deb418184fd23dc39502add85e4cbac8
```
...
### `node:12.19.1-alpine3.12` - linux; arm variant v6
...
### `node:12.19.1-alpine3.12` - linux; arm variant v7
...
### `node:12.19.1-alpine3.12` - linux; arm64 variant v8
