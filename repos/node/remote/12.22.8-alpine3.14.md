...
### `node:12.22.8-alpine3.14` - linux; amd64
...
### `node:12.22.8-alpine3.14` - linux; arm variant v6
...
### `node:12.22.8-alpine3.14` - linux; arm variant v7
...
### `node:12.22.8-alpine3.14` - linux; arm64 variant v8
...
### `node:12.22.8-alpine3.14` - linux; ppc64le
...
### `node:12.22.8-alpine3.14` - linux; s390x
