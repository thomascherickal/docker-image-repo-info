...
### `node:12.16.0-buster` - linux; amd64
...
### `node:12.16.0-buster` - linux; arm variant v7
...
### `node:12.16.0-buster` - linux; arm64 variant v8
...
### `node:12.16.0-buster` - linux; ppc64le
...
### `node:12.16.0-buster` - linux; s390x
