...
```console
$ docker pull node@sha256:309bf09dadfac4c60615794fc500072d1df675cd24c772a9a619d510823a716c
```
...
### `node:16.7-stretch-slim` - linux; amd64
...
### `node:16.7-stretch-slim` - linux; arm64 variant v8
