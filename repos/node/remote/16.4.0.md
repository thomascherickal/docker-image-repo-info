...
```console
$ docker pull node@sha256:11db60c3af888436847c698532b94372432cbb6ef75ea318fce7fa8e2a59a657
```
...
### `node:16.4.0` - linux; arm variant v7
...
### `node:16.4.0` - linux; arm64 variant v8
