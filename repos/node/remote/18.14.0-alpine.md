...
### `node:18.14.0-alpine` - linux; amd64
...
### `node:18.14.0-alpine` - linux; arm variant v6
...
### `node:18.14.0-alpine` - linux; arm variant v7
...
### `node:18.14.0-alpine` - linux; arm64 variant v8
...
### `node:18.14.0-alpine` - linux; ppc64le
...
### `node:18.14.0-alpine` - linux; s390x
