...
### `node:18.3-bullseye` - linux; amd64
...
### `node:18.3-bullseye` - linux; arm variant v7
...
### `node:18.3-bullseye` - linux; arm64 variant v8
...
### `node:18.3-bullseye` - linux; ppc64le
...
### `node:18.3-bullseye` - linux; s390x
