...
```console
$ docker pull node@sha256:78be4f61c7a0f00cc9da47e3ba2f1bacf9ba85410e8ad2e7de16e1fc4be1b962
```
...
### `node:12.22.4-alpine` - linux; amd64
...
### `node:12.22.4-alpine` - linux; arm variant v6
...
### `node:12.22.4-alpine` - linux; arm variant v7
...
### `node:12.22.4-alpine` - linux; arm64 variant v8
...
### `node:12.22.4-alpine` - linux; ppc64le
...
### `node:12.22.4-alpine` - linux; s390x
