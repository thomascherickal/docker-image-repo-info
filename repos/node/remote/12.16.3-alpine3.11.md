...
### `node:12.16.3-alpine3.11` - linux; amd64
...
### `node:12.16.3-alpine3.11` - linux; arm variant v6
...
### `node:12.16.3-alpine3.11` - linux; arm variant v7
...
### `node:12.16.3-alpine3.11` - linux; arm64 variant v8
...
### `node:12.16.3-alpine3.11` - linux; 386
...
### `node:12.16.3-alpine3.11` - linux; ppc64le
...
### `node:12.16.3-alpine3.11` - linux; s390x
