...
### `node:13.8.0-stretch` - linux; amd64
...
### `node:13.8.0-stretch` - linux; arm variant v7
...
### `node:13.8.0-stretch` - linux; arm64 variant v8
...
### `node:13.8.0-stretch` - linux; ppc64le
...
### `node:13.8.0-stretch` - linux; s390x
