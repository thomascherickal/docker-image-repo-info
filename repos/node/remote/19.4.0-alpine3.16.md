...
```console
$ docker pull node@sha256:9cb039537daf7ee7028dda7ecb4c53c4b84f00fef15642d852326bdcdcef830e
```
...
### `node:19.4.0-alpine3.16` - linux; amd64
...
### `node:19.4.0-alpine3.16` - linux; arm variant v6
...
### `node:19.4.0-alpine3.16` - linux; arm variant v7
...
### `node:19.4.0-alpine3.16` - linux; arm64 variant v8
...
### `node:19.4.0-alpine3.16` - linux; ppc64le
