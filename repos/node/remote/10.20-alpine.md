...
### `node:10.20-alpine` - linux; arm variant v6
...
### `node:10.20-alpine` - linux; arm variant v7
...
### `node:10.20-alpine` - linux; arm64 variant v8
...
### `node:10.20-alpine` - linux; ppc64le
