...
### `node:10.18.0-stretch` - linux; arm variant v7
...
### `node:10.18.0-stretch` - linux; arm64 variant v8
...
### `node:10.18.0-stretch` - linux; ppc64le
...
### `node:10.18.0-stretch` - linux; s390x
