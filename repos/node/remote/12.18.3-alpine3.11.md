...
### `node:12.18.3-alpine3.11` - linux; arm variant v6
...
### `node:12.18.3-alpine3.11` - linux; arm variant v7
...
### `node:12.18.3-alpine3.11` - linux; arm64 variant v8
...
### `node:12.18.3-alpine3.11` - linux; ppc64le
...
### `node:12.18.3-alpine3.11` - linux; s390x
