...
### `node:12.16.0-stretch-slim` - linux; amd64
...
### `node:12.16.0-stretch-slim` - linux; arm variant v7
...
### `node:12.16.0-stretch-slim` - linux; arm64 variant v8
...
### `node:12.16.0-stretch-slim` - linux; ppc64le
...
### `node:12.16.0-stretch-slim` - linux; s390x
