...
```console
$ docker pull node@sha256:68c62e94814094dc27a85e443982da0d1c03ef75e2ee12cb5a1915054d2d8ed4
```
...
### `node:15.10-buster` - linux; arm variant v7
...
### `node:15.10-buster` - linux; arm64 variant v8
...
### `node:15.10-buster` - linux; ppc64le
