...
```console
$ docker pull node@sha256:f268e6e5d889157de82fa878c70033a77c7cea5cffefcdce02b0f4c1e74c574b
```
...
### `node:18.14.2-alpine` - linux; arm variant v7
...
### `node:18.14.2-alpine` - linux; s390x
