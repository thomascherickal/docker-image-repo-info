...
```console
$ docker pull node@sha256:4fa1b06fd93b545c4d5192473d95350448372931314ceed1b1761f5ba1161211
```
...
### `node:12.22.7-alpine3.12` - linux; amd64

```console
$ docker pull node@sha256:99eaf1312b1926bc6db27d7230c8b3118d4ad2db64cc6a8a8304adeb8bad283b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.9 MB (29912197 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c90bc38476096d0fb3295b50b5762e082717f58fe0b887fe066560f9f7b05030`
...
### `node:12.22.7-alpine3.12` - linux; arm variant v6
...
### `node:12.22.7-alpine3.12` - linux; arm variant v7

```console
$ docker pull node@sha256:92961f0f78933b320bafe9f58e024dc04a65ff34af938d84a0d423e220efe1c1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.6 MB (28557200 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00c3e4b76ce3bc20e35f64dc3a530bc20c8126a3cdaf7955303e901331b4df02`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
### `node:12.22.7-alpine3.12` - linux; arm64 variant v8

```console
$ docker pull node@sha256:24cf2ecc209be7e3fd5bead3fafbf0b393bd436b6559d52994bb05fd6cb52b0b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.0 MB (30022484 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17315fa2d418fc204d40610eb63b5b64a89ca3343265f27090b8e2ba8936ef43`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
### `node:12.22.7-alpine3.12` - linux; ppc64le
...
### `node:12.22.7-alpine3.12` - linux; s390x

```console
$ docker pull node@sha256:db428f1a9b9e08018f9fb008cd630c7fdbd5455b62f0da3083d351b83faf7d68
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.8 MB (29782704 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e95c416181d713bef90e0eb66e1a937ca0b05fba6c1eee31e22513602adad2a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
RUN apk add --no-cache --virtual .build-deps-yarn curl gnupg tar   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" ||     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && mkdir -p /opt   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarnpkg /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && apk del .build-deps-yarn   && yarn --version
# Fri, 22 Oct 2021 17:46:38 GMT
COPY file:4d192565a7220e135cab6c77fbc1c73211b69f3d9fb37e62857b2c6eb9363d51 in /usr/local/bin/ 
# Fri, 22 Oct 2021 17:46:39 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 22 Oct 2021 17:46:39 GMT
CMD ["node"]
```
...
-	Layers:
	...
	-	`sha256:f3525aa88e3b3a8c42c6df6f5ab0e25fdeba4934283e3510d43cb3c30484b6cf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:099840fb943130f8593e48d8caa443e51b26194858da7a786285fa9816c21a13`  
		Last Modified: Fri, 22 Oct 2021 17:58:08 GMT  
		Size: 449.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
