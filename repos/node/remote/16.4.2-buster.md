...
### `node:16.4.2-buster` - linux; amd64
...
### `node:16.4.2-buster` - linux; arm variant v7
...
### `node:16.4.2-buster` - linux; arm64 variant v8
...
### `node:16.4.2-buster` - linux; ppc64le
...
### `node:16.4.2-buster` - linux; s390x
