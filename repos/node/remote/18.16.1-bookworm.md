...
```console
$ docker pull node@sha256:ad4e66ea59ae0d718be416296f606a3aebaaa616ce81f9f3e8286c391257bb52
```
...
### `node:18.16.1-bookworm` - linux; arm variant v7
...
### `node:18.16.1-bookworm` - linux; arm64 variant v8
...
### `node:18.16.1-bookworm` - linux; ppc64le
