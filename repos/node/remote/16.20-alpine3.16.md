...
```console
$ docker pull node@sha256:e9ac3e714853fa95e062a27c23cc31b99b62c9c07d1b9cd967d0ba128aa9c0d6
```
...
### `node:16.20-alpine3.16` - linux; arm variant v6
...
### `node:16.20-alpine3.16` - linux; arm variant v7
...
### `node:16.20-alpine3.16` - linux; arm64 variant v8
