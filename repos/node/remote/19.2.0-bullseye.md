...
### `node:19.2.0-bullseye` - linux; amd64
...
### `node:19.2.0-bullseye` - linux; arm variant v7
...
### `node:19.2.0-bullseye` - linux; arm64 variant v8
...
### `node:19.2.0-bullseye` - linux; ppc64le
...
### `node:19.2.0-bullseye` - linux; s390x
