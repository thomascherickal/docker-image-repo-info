...
### `node:14.6.0-alpine3.11` - linux; arm variant v6
...
### `node:14.6.0-alpine3.11` - linux; arm variant v7
...
### `node:14.6.0-alpine3.11` - linux; arm64 variant v8
...
### `node:14.6.0-alpine3.11` - linux; ppc64le
...
### `node:14.6.0-alpine3.11` - linux; s390x
