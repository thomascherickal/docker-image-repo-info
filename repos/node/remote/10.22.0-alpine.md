...
### `node:10.22.0-alpine` - linux; amd64
...
### `node:10.22.0-alpine` - linux; arm variant v6
...
### `node:10.22.0-alpine` - linux; arm variant v7
...
### `node:10.22.0-alpine` - linux; arm64 variant v8
...
### `node:10.22.0-alpine` - linux; s390x
