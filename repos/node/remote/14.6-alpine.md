...
```console
$ docker pull node@sha256:7cd4742b8c8fc8e632617d1f488376a057a424878a3328971c1fcea65bb5d454
```
...
### `node:14.6-alpine` - linux; arm variant v6
...
### `node:14.6-alpine` - linux; arm variant v7
...
### `node:14.6-alpine` - linux; arm64 variant v8
...
### `node:14.6-alpine` - linux; ppc64le
