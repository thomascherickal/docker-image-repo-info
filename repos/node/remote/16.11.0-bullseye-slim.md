...
```console
$ docker pull node@sha256:970a72b520df3c243a095994e9e5ad0a08e9401bcea8d2433f2ccb3d7a7f384b
```
...
### `node:16.11.0-bullseye-slim` - linux; arm variant v7
...
### `node:16.11.0-bullseye-slim` - linux; ppc64le
...
### `node:16.11.0-bullseye-slim` - linux; s390x
