...
```console
$ docker pull node@sha256:6972449d92c64b3620dcd757625d256dabab60631f4e481d2c1efc99ea1fbde1
```
...
### `node:16.7.0-alpine3.11` - linux; amd64
...
### `node:16.7.0-alpine3.11` - linux; arm64 variant v8
...
### `node:16.7.0-alpine3.11` - linux; ppc64le
...
### `node:16.7.0-alpine3.11` - linux; s390x
