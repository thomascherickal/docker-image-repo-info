...
- Created: `2022-07-07T09:20:52.793899401Z`
...
http://repo.almalinux.org/vault/9/BaseOS/Source/Packages/ca-certificates-2020.2.50-94.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9/BaseOS/Source/Packages/dbus-broker-28-5.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9/BaseOS/Source/Packages/glibc-2.34-28.el9_0.src.rpm
```
...
http://repo.almalinux.org/vault/9/BaseOS/Source/Packages/gnupg2-2.3.3-1.el9.src.rpm
```
...
### `rpm` package: `libdnf-0.65.0-5.el9_0.alma.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.65.0-5.el9_0.alma
http://repo.almalinux.org/vault/9/BaseOS/Source/Packages/libdnf-0.65.0-5.el9_0.alma.src.rpm
```
...
http://repo.almalinux.org/vault/9/BaseOS/Source/Packages/libgcrypt-1.10.0-4.el9_0.src.rpm
```
...
http://repo.almalinux.org/vault/9/BaseOS/Source/Packages/pam-1.5.1-9.el9.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.65.0-5.el9_0.alma.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.65.0-5.el9_0.alma
http://repo.almalinux.org/vault/9/BaseOS/Source/Packages/libdnf-0.65.0-5.el9_0.alma.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.65.0-5.el9_0.alma.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.65.0-5.el9_0.alma
http://repo.almalinux.org/vault/9/BaseOS/Source/Packages/libdnf-0.65.0-5.el9_0.alma.src.rpm
```
...
http://repo.almalinux.org/vault/9/BaseOS/Source/Packages/vim-8.2.2637-16.el9_0.2.src.rpm
```
