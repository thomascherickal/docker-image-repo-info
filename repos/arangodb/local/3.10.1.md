...
- Created: `2022-11-10T20:21:17.243190377Z`
- Virtual Size: ~ 476.04 Mb  
...
```console
binutils-2.38-r3 description:
Tools necessary to build programs

binutils-2.38-r3 webpage:
https://www.gnu.org/software/binutils/

binutils-2.38-r3 installed size:
9708 KiB

binutils-2.38-r3 license:
...
```console
c-ares-1.18.1-r0 description:
An asynchronously DNS/names resolver library

c-ares-1.18.1-r0 webpage:
https://c-ares.haxx.se/

c-ares-1.18.1-r0 installed size:
96 KiB

c-ares-1.18.1-r0 license:
MIT
