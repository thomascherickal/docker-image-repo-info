...
- Created: `2022-08-09T17:48:30.816700166Z`
...
- Environment:
  ...
  - `ARANGO_VERSION=3.7.18`
  - `ARANGO_URL=https://download.arangodb.com/arangodb37/DEBIAN/amd64`
  - `ARANGO_PACKAGE=arangodb3_3.7.18-1_amd64.deb`
  - `ARANGO_PACKAGE_URL=https://download.arangodb.com/arangodb37/DEBIAN/amd64/arangodb3_3.7.18-1_amd64.deb`
  - `ARANGO_SIGNATURE_URL=https://download.arangodb.com/arangodb37/DEBIAN/amd64/arangodb3_3.7.18-1_amd64.deb.asc`
  - `GLIBCXX_FORCE_NEW=1`
...
```console
nodejs-14.20.0-r0 description:
JavaScript runtime built on V8 engine - LTS version

nodejs-14.20.0-r0 webpage:
https://nodejs.org/

nodejs-14.20.0-r0 installed size:
35 MiB

nodejs-14.20.0-r0 license:
MIT
