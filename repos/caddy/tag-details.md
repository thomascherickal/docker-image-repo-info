...
```console
$ docker pull caddy@sha256:cca8546dbba55fbb5986bfd1ae1d338e458e3c25b9cb47b5e81d527883e72a1e
```
...
```console
$ docker pull caddy@sha256:ebfc569d0177b4e4b9f8729158b88c7152a3de5286821cd62bd7ea7259093f6e
```
