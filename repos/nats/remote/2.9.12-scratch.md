...
### `nats:2.9.12-scratch` - linux; amd64
...
### `nats:2.9.12-scratch` - linux; arm variant v6
...
### `nats:2.9.12-scratch` - linux; arm variant v7
...
### `nats:2.9.12-scratch` - linux; arm64 variant v8
