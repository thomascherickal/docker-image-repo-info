...
```console
$ docker pull open-liberty@sha256:3d087e79955e1a93863273da9808da4caf18a59897ea776affd4d2ff624e308e
```
...
```console
$ docker pull open-liberty@sha256:0bb5bda2a7d6f46992615506b8c34527549277022504eb9fe592460e1e6a5d4a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **218.3 MB (218281891 bytes)**  
