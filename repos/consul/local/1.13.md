...
- Created: `2023-12-01T06:58:26.688263968Z`
...
- Labels:
  ...
  - `org.opencontainers.image.version=1.13.9`
...
```console
nghttp2-libs-1.46.0-r2 description:
Experimental HTTP/2 client, server and proxy (libraries)

nghttp2-libs-1.46.0-r2 webpage:
https://nghttp2.org

nghttp2-libs-1.46.0-r2 installed size:
160 KiB

nghttp2-libs-1.46.0-r2 license:
MIT
