...
```console
$ docker pull znc@sha256:fd0ac8267aa2426c0593dffbb86393bb088361ff725e3fc03739cc398f8c0d56
```
...
```console
$ docker pull znc@sha256:1ae2ae7ff43b69be69738753cad9630554972b1e60c21bc00c8dcfd15ed1ac09
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.1 MB (47119715 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:652708cb4e35d6ab3ac913c482dfb2cc2af0047ecf1c9829b1782fc8f7889bef`
-	Entrypoint: `["\/entrypoint.sh"]`
