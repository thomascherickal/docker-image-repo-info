...
```console
$ docker pull haproxy@sha256:114e0f6d0dfaf23b323a2a2de5cee955533f550984669fe1fc33d5b4c8e8b01b
```
...
### `haproxy:2.6.12` - linux; arm variant v5
...
### `haproxy:2.6.12` - linux; arm variant v7
...
### `haproxy:2.6.12` - linux; arm64 variant v8
