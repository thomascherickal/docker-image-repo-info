...
### `haproxy:2.4.4-alpine` - linux; amd64
...
### `haproxy:2.4.4-alpine` - linux; arm variant v6
...
### `haproxy:2.4.4-alpine` - linux; arm variant v7
...
### `haproxy:2.4.4-alpine` - linux; arm64 variant v8
...
### `haproxy:2.4.4-alpine` - linux; 386
...
### `haproxy:2.4.4-alpine` - linux; ppc64le
...
### `haproxy:2.4.4-alpine` - linux; s390x
