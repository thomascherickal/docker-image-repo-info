...
### `haproxy:2.4.4-bullseye` - linux; amd64
...
### `haproxy:2.4.4-bullseye` - linux; arm variant v7
...
### `haproxy:2.4.4-bullseye` - linux; arm64 variant v8
...
### `haproxy:2.4.4-bullseye` - linux; 386
...
### `haproxy:2.4.4-bullseye` - linux; ppc64le
...
### `haproxy:2.4.4-bullseye` - linux; s390x
