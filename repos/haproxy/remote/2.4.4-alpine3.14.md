...
### `haproxy:2.4.4-alpine3.14` - linux; amd64
...
### `haproxy:2.4.4-alpine3.14` - linux; arm variant v7
...
### `haproxy:2.4.4-alpine3.14` - linux; arm64 variant v8
...
### `haproxy:2.4.4-alpine3.14` - linux; 386
...
### `haproxy:2.4.4-alpine3.14` - linux; ppc64le
...
### `haproxy:2.4.4-alpine3.14` - linux; s390x
