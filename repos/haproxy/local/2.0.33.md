...
- Created: `2023-09-07T03:41:27.618268891Z`
- Virtual Size: ~ 91.55 Mb  
...
- Environment:
  ...
  - `HAPROXY_URL=https://www.haproxy.org/download/2.0/src/haproxy-2.0.33.tar.gz`
  - `HAPROXY_SHA256=32f80854d89ce8bbe95f58be0b933b97daa78fe0ec5d7d8315ba5e6bdc718ee7`
...
### `dpkg` source package: `lua5.3=5.3.3-1.1+deb10u1`

Binary Packages:

- `liblua5.3-0:amd64=5.3.3-1.1+deb10u1`
...
```console
$ apt-get source -qq --print-uris lua5.3=5.3.3-1.1+deb10u1
'http://deb.debian.org/debian-security/pool/updates/main/l/lua5.3/lua5.3_5.3.3-1.1%2bdeb10u1.dsc' lua5.3_5.3.3-1.1+deb10u1.dsc 2100 SHA256:c7d520895234fa7a3f2a7eac256815e0599bd0ab4bdd653cd6b57766eb51bd55
'http://deb.debian.org/debian-security/pool/updates/main/l/lua5.3/lua5.3_5.3.3.orig.tar.gz' lua5.3_5.3.3.orig.tar.gz 294290 SHA256:5113c06884f7de453ce57702abaac1d618307f33f6789fa870e87a59d772aca2
'http://deb.debian.org/debian-security/pool/updates/main/l/lua5.3/lua5.3_5.3.3-1.1%2bdeb10u1.debian.tar.xz' lua5.3_5.3.3-1.1+deb10u1.debian.tar.xz 9384 SHA256:fd6f0591e34ceb217e5d647b2a884aefa7bfc9f449e425e349f72b3be43178fd
```

Other potentially useful URLs:

- https://sources.debian.net/src/lua5.3/5.3.3-1.1+deb10u1/ (for browsing the source)
- https://sources.debian.net/src/lua5.3/5.3.3-1.1+deb10u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/lua5.3/5.3.3-1.1+deb10u1/ (for access to the source package after it no longer exists in the archive)
...
- `libpcre2-posix0:amd64=10.32-5+deb10u1`
