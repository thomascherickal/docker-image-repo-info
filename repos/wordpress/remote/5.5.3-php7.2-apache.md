...
```console
$ docker pull wordpress@sha256:392980a68e30cfcf76b9d795392403fdd93e5e8170ccb6f444a26c3db2393e4d
```
...
### `wordpress:5.5.3-php7.2-apache` - linux; amd64
...
### `wordpress:5.5.3-php7.2-apache` - linux; 386
...
### `wordpress:5.5.3-php7.2-apache` - linux; ppc64le
...
### `wordpress:5.5.3-php7.2-apache` - linux; s390x
