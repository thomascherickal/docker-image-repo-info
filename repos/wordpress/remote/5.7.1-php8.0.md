...
### `wordpress:5.7.1-php8.0` - linux; amd64
...
### `wordpress:5.7.1-php8.0` - linux; arm variant v5
...
### `wordpress:5.7.1-php8.0` - linux; arm variant v7
...
### `wordpress:5.7.1-php8.0` - linux; arm64 variant v8
...
### `wordpress:5.7.1-php8.0` - linux; 386
...
### `wordpress:5.7.1-php8.0` - linux; mips64le
...
### `wordpress:5.7.1-php8.0` - linux; ppc64le
...
### `wordpress:5.7.1-php8.0` - linux; s390x
