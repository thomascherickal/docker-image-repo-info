## `wordpress:beta-6.4-beta2-php8.2-fpm`

```console
$ docker pull wordpress@sha256:ecf5e62a0f1dee237535e177ba44d45079dbfef73de71d8a7c721cf3c2e37d08
```
...
### `wordpress:beta-6.4-beta2-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-6.4-beta2-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.4-beta2-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.4-beta2-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.4-beta2-php8.2-fpm` - linux; 386
...
### `wordpress:beta-6.4-beta2-php8.2-fpm` - linux; mips64le
...
### `wordpress:beta-6.4-beta2-php8.2-fpm` - linux; ppc64le
