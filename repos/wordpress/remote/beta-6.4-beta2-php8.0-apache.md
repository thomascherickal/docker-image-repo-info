...
### `wordpress:beta-6.4-beta2-php8.0-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.4-beta2-php8.0-apache` - linux; ppc64le
...
### `wordpress:beta-6.4-beta2-php8.0-apache` - linux; s390x
