...
```console
$ docker pull wordpress@sha256:df9600b829e1f4a9ca958a9fb21e7ff6d2c01024efb5e56ebf3204c0595b7a00
```
...
### `wordpress:beta-6.4-RC1-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.4-RC1-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.4-RC1-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.4-RC1-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.4-RC1-php8.1-apache` - linux; mips64le
...
### `wordpress:beta-6.4-RC1-php8.1-apache` - linux; s390x
