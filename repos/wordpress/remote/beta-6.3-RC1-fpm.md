...
```console
$ docker pull wordpress@sha256:516b08d102a4b46a8348ff2c8b87fc215173160814fcc327578e8fd1c5052927
```
...
### `wordpress:beta-6.3-RC1-fpm` - linux; amd64
...
### `wordpress:beta-6.3-RC1-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.3-RC1-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC1-fpm` - linux; 386
...
### `wordpress:beta-6.3-RC1-fpm` - linux; mips64le
...
### `wordpress:beta-6.3-RC1-fpm` - linux; ppc64le
