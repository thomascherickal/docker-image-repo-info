...
### `wordpress:5.4.0-fpm` - linux; amd64
...
### `wordpress:5.4.0-fpm` - linux; arm variant v5
...
### `wordpress:5.4.0-fpm` - linux; arm variant v7
...
### `wordpress:5.4.0-fpm` - linux; arm64 variant v8
...
### `wordpress:5.4.0-fpm` - linux; ppc64le
...
### `wordpress:5.4.0-fpm` - linux; s390x
