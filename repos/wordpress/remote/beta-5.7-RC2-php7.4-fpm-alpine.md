## `wordpress:beta-5.7-RC2-php7.4-fpm-alpine`

```console
$ docker pull wordpress@sha256:98aa9195ee47fc67181b5d13bb915500413724564f88315f9f4d8bd9e1694806
```
...
### `wordpress:beta-5.7-RC2-php7.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.7-RC2-php7.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-5.7-RC2-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-5.7-RC2-php7.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-5.7-RC2-php7.4-fpm-alpine` - linux; s390x
