...
```console
$ docker pull wordpress@sha256:d83f741a23feaf14da342663702695f66c879921b916c964d1bd92c6140e7f91
```
...
### `wordpress:beta-5.8.1-RC1-fpm` - linux; amd64
...
### `wordpress:beta-5.8.1-RC1-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.8.1-RC1-fpm` - linux; arm variant v7
...
### `wordpress:beta-5.8.1-RC1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.8.1-RC1-fpm` - linux; 386
...
### `wordpress:beta-5.8.1-RC1-fpm` - linux; mips64le
...
### `wordpress:beta-5.8.1-RC1-fpm` - linux; ppc64le
...
### `wordpress:beta-5.8.1-RC1-fpm` - linux; s390x
