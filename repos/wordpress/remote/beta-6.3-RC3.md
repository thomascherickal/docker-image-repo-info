...
```console
$ docker pull wordpress@sha256:63aa11267294235c6f1d7e983092a5523a7619f913cba0475fdd092db0da379d
```
...
### `wordpress:beta-6.3-RC3` - linux; amd64
...
### `wordpress:beta-6.3-RC3` - linux; arm variant v5
...
### `wordpress:beta-6.3-RC3` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC3` - linux; 386
...
### `wordpress:beta-6.3-RC3` - linux; mips64le
...
### `wordpress:beta-6.3-RC3` - linux; ppc64le
