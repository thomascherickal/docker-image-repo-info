...
```console
$ docker pull wordpress@sha256:de10b5985fb41b6cfc7464135bbf8abc73d01bc5476b62e28cfa74834743894d
```
...
### `wordpress:beta-6.3-beta3-php8.0-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.3-beta3-php8.0-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.3-beta3-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-beta3-php8.0-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.3-beta3-php8.0-fpm-alpine` - linux; s390x
