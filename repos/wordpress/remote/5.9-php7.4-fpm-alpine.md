...
### `wordpress:5.9-php7.4-fpm-alpine` - linux; amd64
...
### `wordpress:5.9-php7.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:5.9-php7.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:5.9-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:5.9-php7.4-fpm-alpine` - linux; 386
...
### `wordpress:5.9-php7.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:5.9-php7.4-fpm-alpine` - linux; s390x
