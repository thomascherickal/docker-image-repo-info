...
### `wordpress:beta-6.0.1-php8.1-apache` - linux; amd64
...
### `wordpress:beta-6.0.1-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.0.1-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.0.1-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.0.1-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.0.1-php8.1-apache` - linux; mips64le
...
### `wordpress:beta-6.0.1-php8.1-apache` - linux; ppc64le
...
### `wordpress:beta-6.0.1-php8.1-apache` - linux; s390x
