...
```console
$ docker pull wordpress@sha256:d078122d494bd83e0b168c920dc5681447e2369469d7863f8e648118fc94c57b
```
...
### `wordpress:5.6.2-php7.3` - linux; amd64
...
### `wordpress:5.6.2-php7.3` - linux; arm variant v5
...
### `wordpress:5.6.2-php7.3` - linux; arm variant v7
...
### `wordpress:5.6.2-php7.3` - linux; arm64 variant v8
...
### `wordpress:5.6.2-php7.3` - linux; 386
...
### `wordpress:5.6.2-php7.3` - linux; mips64le
...
### `wordpress:5.6.2-php7.3` - linux; s390x
