...
### `wordpress:beta-6.0.2-RC1-php8.0-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.0.2-RC1-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.0.2-RC1-php8.0-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.0.2-RC1-php8.0-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.0.2-RC1-php8.0-fpm-alpine` - linux; s390x
