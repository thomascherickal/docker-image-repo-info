## `wordpress:beta-6.0-RC3-php8.0`

```console
$ docker pull wordpress@sha256:94de8edbd667a094c92f22d0db9d867e224f0251a38b5575eefcdc1228371a29
```
...
### `wordpress:beta-6.0-RC3-php8.0` - linux; amd64
...
### `wordpress:beta-6.0-RC3-php8.0` - linux; arm variant v5
...
### `wordpress:beta-6.0-RC3-php8.0` - linux; arm variant v7
...
### `wordpress:beta-6.0-RC3-php8.0` - linux; arm64 variant v8
...
### `wordpress:beta-6.0-RC3-php8.0` - linux; 386
...
### `wordpress:beta-6.0-RC3-php8.0` - linux; mips64le
...
### `wordpress:beta-6.0-RC3-php8.0` - linux; ppc64le
...
### `wordpress:beta-6.0-RC3-php8.0` - linux; s390x
