...
```console
$ docker pull wordpress@sha256:7a8b3e7eb9d106520291ae4c347ce7e9f811c1fe0a6230a5674df37675e506cf
```
...
### `wordpress:5.8.3-php8.1` - linux; amd64
...
### `wordpress:5.8.3-php8.1` - linux; arm variant v5
...
### `wordpress:5.8.3-php8.1` - linux; arm variant v7
...
### `wordpress:5.8.3-php8.1` - linux; 386
...
### `wordpress:5.8.3-php8.1` - linux; mips64le
...
### `wordpress:5.8.3-php8.1` - linux; ppc64le
...
### `wordpress:5.8.3-php8.1` - linux; s390x
