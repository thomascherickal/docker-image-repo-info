...
```console
$ docker pull wordpress@sha256:e9062739456f332cf1c4b78077b3da79a516ae187ea457c8ec0d969bd8806c25
```
...
### `wordpress:beta-5.9-beta4-php8.0` - linux; amd64
...
### `wordpress:beta-5.9-beta4-php8.0` - linux; arm64 variant v8
...
### `wordpress:beta-5.9-beta4-php8.0` - linux; 386
...
### `wordpress:beta-5.9-beta4-php8.0` - linux; ppc64le
...
### `wordpress:beta-5.9-beta4-php8.0` - linux; s390x
