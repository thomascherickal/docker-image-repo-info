...
```console
$ docker pull wordpress@sha256:0f01b719f17e16c4aa9d68cfb94cc86c139238300e101ea5a32cbadba8e0c2f2
```
...
### `wordpress:5.7.2-php7.4` - linux; amd64
...
### `wordpress:5.7.2-php7.4` - linux; arm variant v5
...
### `wordpress:5.7.2-php7.4` - linux; arm variant v7
...
### `wordpress:5.7.2-php7.4` - linux; 386
...
### `wordpress:5.7.2-php7.4` - linux; mips64le
...
### `wordpress:5.7.2-php7.4` - linux; s390x
