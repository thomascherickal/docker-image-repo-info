...
```console
$ docker pull wordpress@sha256:836446a1da756259aa4a8ddfef0886f106e70f61a08d8c4205c3260f4e99e8a0
```
...
### `wordpress:beta-5.9-RC1-php8.0-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.9-RC1-php8.0-fpm` - linux; mips64le
...
### `wordpress:beta-5.9-RC1-php8.0-fpm` - linux; s390x
