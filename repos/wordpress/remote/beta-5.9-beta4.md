...
### `wordpress:beta-5.9-beta4` - linux; amd64
...
### `wordpress:beta-5.9-beta4` - linux; arm64 variant v8
...
### `wordpress:beta-5.9-beta4` - linux; 386
...
### `wordpress:beta-5.9-beta4` - linux; ppc64le
...
### `wordpress:beta-5.9-beta4` - linux; s390x
