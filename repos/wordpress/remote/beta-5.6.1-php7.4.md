## `wordpress:beta-5.6.1-php7.4`

```console
$ docker pull wordpress@sha256:00b2f8c588080fe04ce9215e7c6c621588b91d754862cc5825a028e72762dfd5
```
...
### `wordpress:beta-5.6.1-php7.4` - linux; arm variant v5
...
### `wordpress:beta-5.6.1-php7.4` - linux; arm variant v7
...
### `wordpress:beta-5.6.1-php7.4` - linux; arm64 variant v8
...
### `wordpress:beta-5.6.1-php7.4` - linux; mips64le
...
### `wordpress:beta-5.6.1-php7.4` - linux; s390x
