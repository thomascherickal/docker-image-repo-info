...
```console
$ docker pull wordpress@sha256:cc40e228d6c6c6aad74ea51cf8a26bc56f14fe5db79217c13668011c7fe7c52c
```
...
### `wordpress:beta-6.0-beta2-php8.0-apache` - linux; amd64
...
### `wordpress:beta-6.0-beta2-php8.0-apache` - linux; arm variant v5
...
### `wordpress:beta-6.0-beta2-php8.0-apache` - linux; arm variant v7
...
### `wordpress:beta-6.0-beta2-php8.0-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.0-beta2-php8.0-apache` - linux; 386
...
### `wordpress:beta-6.0-beta2-php8.0-apache` - linux; mips64le
...
### `wordpress:beta-6.0-beta2-php8.0-apache` - linux; ppc64le
...
### `wordpress:beta-6.0-beta2-php8.0-apache` - linux; s390x
