...
### `wordpress:6.3.1-php8.0-fpm-alpine` - linux; amd64
...
### `wordpress:6.3.1-php8.0-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.3.1-php8.0-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.3.1-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.3.1-php8.0-fpm-alpine` - linux; 386
...
### `wordpress:6.3.1-php8.0-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.3.1-php8.0-fpm-alpine` - linux; s390x
