...
### `wordpress:5.4.1-php7.3` - linux; amd64
...
### `wordpress:5.4.1-php7.3` - linux; arm variant v5
...
### `wordpress:5.4.1-php7.3` - linux; arm variant v7
...
### `wordpress:5.4.1-php7.3` - linux; arm64 variant v8
...
### `wordpress:5.4.1-php7.3` - linux; 386
...
### `wordpress:5.4.1-php7.3` - linux; mips64le
...
### `wordpress:5.4.1-php7.3` - linux; ppc64le
...
### `wordpress:5.4.1-php7.3` - linux; s390x
