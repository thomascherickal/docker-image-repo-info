...
```console
$ docker pull wordpress@sha256:4d9574fdaa287619278db4c725d0b06c70304878c47f6188fa47434167dab695
```
...
### `wordpress:beta-5.8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-5.8.1-fpm-alpine` - linux; ppc64le
