...
### `wordpress:beta-6.2-beta5` - linux; amd64
...
### `wordpress:beta-6.2-beta5` - linux; arm variant v5
...
### `wordpress:beta-6.2-beta5` - linux; arm variant v7
...
### `wordpress:beta-6.2-beta5` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-beta5` - linux; mips64le
...
### `wordpress:beta-6.2-beta5` - linux; ppc64le
...
### `wordpress:beta-6.2-beta5` - linux; s390x
