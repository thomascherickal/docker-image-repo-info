...
```console
$ docker pull wordpress@sha256:abf2e1cffc8ea0ae6253411b2f2caa90ec8075a24437500e4e7d2856f4e30c92
```
...
### `wordpress:beta-6.1-RC1-php7.4-fpm` - linux; amd64
...
### `wordpress:beta-6.1-RC1-php7.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.1-RC1-php7.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.1-RC1-php7.4-fpm` - linux; 386
...
### `wordpress:beta-6.1-RC1-php7.4-fpm` - linux; mips64le
...
### `wordpress:beta-6.1-RC1-php7.4-fpm` - linux; ppc64le
...
### `wordpress:beta-6.1-RC1-php7.4-fpm` - linux; s390x
