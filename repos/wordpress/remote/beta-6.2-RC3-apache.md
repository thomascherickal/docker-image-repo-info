...
### `wordpress:beta-6.2-RC3-apache` - linux; arm variant v5
...
### `wordpress:beta-6.2-RC3-apache` - linux; arm variant v7
...
### `wordpress:beta-6.2-RC3-apache` - linux; 386
...
### `wordpress:beta-6.2-RC3-apache` - linux; ppc64le
...
### `wordpress:beta-6.2-RC3-apache` - linux; s390x
