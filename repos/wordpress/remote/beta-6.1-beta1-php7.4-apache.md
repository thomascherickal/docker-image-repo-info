...
### `wordpress:beta-6.1-beta1-php7.4-apache` - linux; amd64
...
### `wordpress:beta-6.1-beta1-php7.4-apache` - linux; mips64le
...
### `wordpress:beta-6.1-beta1-php7.4-apache` - linux; ppc64le
