...
```console
$ docker pull wordpress@sha256:d69e7eba07d14790db32921606d818047cfeedc4ef967eb9836d0a1e0bc68a15
```
...
### `wordpress:6.0.3-php7.4-fpm-alpine` - linux; amd64
...
### `wordpress:6.0.3-php7.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.0.3-php7.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.0.3-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.0.3-php7.4-fpm-alpine` - linux; 386
...
### `wordpress:6.0.3-php7.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.0.3-php7.4-fpm-alpine` - linux; s390x
