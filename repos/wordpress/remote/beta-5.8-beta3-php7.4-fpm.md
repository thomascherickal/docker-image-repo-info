## `wordpress:beta-5.8-beta3-php7.4-fpm`

```console
$ docker pull wordpress@sha256:0beb4af60cd723de4202842cf1e081e3ab27408d134052402c33a14bc9ec7033
```
...
### `wordpress:beta-5.8-beta3-php7.4-fpm` - linux; amd64
...
### `wordpress:beta-5.8-beta3-php7.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.8-beta3-php7.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.8-beta3-php7.4-fpm` - linux; 386
...
### `wordpress:beta-5.8-beta3-php7.4-fpm` - linux; mips64le
...
### `wordpress:beta-5.8-beta3-php7.4-fpm` - linux; ppc64le
...
### `wordpress:beta-5.8-beta3-php7.4-fpm` - linux; s390x
