...
```console
$ docker pull wordpress@sha256:b246a9d7045483c3581d0d6bc5b8ec2a77671b2791482650e74dcb74abe32a0f
```
...
### `wordpress:beta-5.8-beta3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.8-beta3-fpm-alpine` - linux; ppc64le
