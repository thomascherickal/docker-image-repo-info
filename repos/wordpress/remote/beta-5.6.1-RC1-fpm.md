...
### `wordpress:beta-5.6.1-RC1-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.6.1-RC1-fpm` - linux; arm variant v7
...
### `wordpress:beta-5.6.1-RC1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.6.1-RC1-fpm` - linux; mips64le
...
### `wordpress:beta-5.6.1-RC1-fpm` - linux; s390x
