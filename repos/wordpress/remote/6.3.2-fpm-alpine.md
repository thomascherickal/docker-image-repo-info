...
### `wordpress:6.3.2-fpm-alpine` - linux; amd64
...
### `wordpress:6.3.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.3.2-fpm-alpine` - linux; 386
...
### `wordpress:6.3.2-fpm-alpine` - linux; s390x
