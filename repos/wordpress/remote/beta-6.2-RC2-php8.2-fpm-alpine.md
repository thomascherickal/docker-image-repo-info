...
```console
$ docker pull wordpress@sha256:b8b47e1637a2666a1250608db890ea4412548ee7c4f173d595361035a3255b03
```
...
### `wordpress:beta-6.2-RC2-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.2-RC2-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.2-RC2-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-RC2-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.2-RC2-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.2-RC2-php8.2-fpm-alpine` - linux; s390x
