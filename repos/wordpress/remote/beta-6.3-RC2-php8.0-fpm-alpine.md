...
### `wordpress:beta-6.3-RC2-php8.0-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.3-RC2-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC2-php8.0-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.3-RC2-php8.0-fpm-alpine` - linux; s390x
