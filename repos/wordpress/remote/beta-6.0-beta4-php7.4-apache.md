...
### `wordpress:beta-6.0-beta4-php7.4-apache` - linux; amd64
...
### `wordpress:beta-6.0-beta4-php7.4-apache` - linux; arm variant v5
...
### `wordpress:beta-6.0-beta4-php7.4-apache` - linux; arm variant v7
...
### `wordpress:beta-6.0-beta4-php7.4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.0-beta4-php7.4-apache` - linux; 386
...
### `wordpress:beta-6.0-beta4-php7.4-apache` - linux; mips64le
...
### `wordpress:beta-6.0-beta4-php7.4-apache` - linux; ppc64le
...
### `wordpress:beta-6.0-beta4-php7.4-apache` - linux; s390x
