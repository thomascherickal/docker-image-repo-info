...
```console
$ docker pull wordpress@sha256:e308c603b294089bb555d4421868102b2ae16f6f365db614842f1f5a1abaacdb
```
...
### `wordpress:beta-6.3-RC2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.3-RC2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC2-fpm-alpine` - linux; ppc64le
