...
### `wordpress:6.4.0-php8.1-fpm` - linux; amd64
...
### `wordpress:6.4.0-php8.1-fpm` - linux; arm variant v5
...
### `wordpress:6.4.0-php8.1-fpm` - linux; arm variant v7
...
### `wordpress:6.4.0-php8.1-fpm` - linux; arm64 variant v8
...
### `wordpress:6.4.0-php8.1-fpm` - linux; 386
...
### `wordpress:6.4.0-php8.1-fpm` - linux; mips64le
...
### `wordpress:6.4.0-php8.1-fpm` - linux; ppc64le
...
### `wordpress:6.4.0-php8.1-fpm` - linux; s390x
