## `wordpress:beta-5.6.1-RC1-php7.4-fpm`

```console
$ docker pull wordpress@sha256:4622d7863e743c1e3fe4aec25b31f3eb4c6faa1aac4b790b290cc9d364bcfc9e
```
...
### `wordpress:beta-5.6.1-RC1-php7.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.6.1-RC1-php7.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-5.6.1-RC1-php7.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.6.1-RC1-php7.4-fpm` - linux; mips64le
...
### `wordpress:beta-5.6.1-RC1-php7.4-fpm` - linux; s390x
