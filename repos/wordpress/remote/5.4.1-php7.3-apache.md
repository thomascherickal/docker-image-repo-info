...
### `wordpress:5.4.1-php7.3-apache` - linux; amd64
...
### `wordpress:5.4.1-php7.3-apache` - linux; arm variant v5
...
### `wordpress:5.4.1-php7.3-apache` - linux; arm variant v7
...
### `wordpress:5.4.1-php7.3-apache` - linux; arm64 variant v8
...
### `wordpress:5.4.1-php7.3-apache` - linux; 386
...
### `wordpress:5.4.1-php7.3-apache` - linux; mips64le
...
### `wordpress:5.4.1-php7.3-apache` - linux; ppc64le
...
### `wordpress:5.4.1-php7.3-apache` - linux; s390x
