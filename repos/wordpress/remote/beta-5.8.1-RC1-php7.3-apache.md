...
```console
$ docker pull wordpress@sha256:48b1728d66582a196799e698d6c7ef473efc780089b32b86d7dce4e72bdc9e49
```
...
### `wordpress:beta-5.8.1-RC1-php7.3-apache` - linux; amd64
...
### `wordpress:beta-5.8.1-RC1-php7.3-apache` - linux; arm variant v5
...
### `wordpress:beta-5.8.1-RC1-php7.3-apache` - linux; arm variant v7
...
### `wordpress:beta-5.8.1-RC1-php7.3-apache` - linux; arm64 variant v8
...
### `wordpress:beta-5.8.1-RC1-php7.3-apache` - linux; 386
...
### `wordpress:beta-5.8.1-RC1-php7.3-apache` - linux; mips64le
...
### `wordpress:beta-5.8.1-RC1-php7.3-apache` - linux; ppc64le
...
### `wordpress:beta-5.8.1-RC1-php7.3-apache` - linux; s390x
