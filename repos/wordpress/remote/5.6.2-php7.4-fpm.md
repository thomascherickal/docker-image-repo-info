...
```console
$ docker pull wordpress@sha256:904a643c020efddacbb795b85d3e2675bab921874c3b8a46fb2c2f75491ad64b
```
...
### `wordpress:5.6.2-php7.4-fpm` - linux; amd64
...
### `wordpress:5.6.2-php7.4-fpm` - linux; arm variant v5
...
### `wordpress:5.6.2-php7.4-fpm` - linux; arm variant v7
...
### `wordpress:5.6.2-php7.4-fpm` - linux; arm64 variant v8
...
### `wordpress:5.6.2-php7.4-fpm` - linux; 386
...
### `wordpress:5.6.2-php7.4-fpm` - linux; mips64le
...
### `wordpress:5.6.2-php7.4-fpm` - linux; ppc64le
...
### `wordpress:5.6.2-php7.4-fpm` - linux; s390x
