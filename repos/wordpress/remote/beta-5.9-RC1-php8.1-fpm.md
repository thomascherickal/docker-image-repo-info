## `wordpress:beta-5.9-RC1-php8.1-fpm`

```console
$ docker pull wordpress@sha256:b18aebf79382121c975a49798ec1ea9579b5e221f958a1779460c2176b5c4c8a
```
...
### `wordpress:beta-5.9-RC1-php8.1-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.9-RC1-php8.1-fpm` - linux; mips64le
...
### `wordpress:beta-5.9-RC1-php8.1-fpm` - linux; s390x
