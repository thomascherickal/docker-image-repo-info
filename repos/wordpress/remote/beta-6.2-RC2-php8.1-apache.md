...
```console
$ docker pull wordpress@sha256:0aea867bf4610fffab5e3c8386d9441845e95ec68807632413abe146a41dffe1
```
...
### `wordpress:beta-6.2-RC2-php8.1-apache` - linux; amd64
...
### `wordpress:beta-6.2-RC2-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.2-RC2-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.2-RC2-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-RC2-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.2-RC2-php8.1-apache` - linux; mips64le
...
### `wordpress:beta-6.2-RC2-php8.1-apache` - linux; ppc64le
...
### `wordpress:beta-6.2-RC2-php8.1-apache` - linux; s390x
