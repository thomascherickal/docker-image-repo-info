...
### `wordpress:beta-6.0-beta1-php8.0-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.0-beta1-php8.0-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.0-beta1-php8.0-fpm-alpine` - linux; 386
