...
```console
$ docker pull wordpress@sha256:f68cdfaaeadc48754dceca64d713915185dfa7aebf58b1f23ee55772f93d990f
```
...
### `wordpress:beta-6.2.1-php8.0-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.2.1-php8.0-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.2.1-php8.0-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.2.1-php8.0-fpm` - linux; 386
...
### `wordpress:beta-6.2.1-php8.0-fpm` - linux; mips64le
...
### `wordpress:beta-6.2.1-php8.0-fpm` - linux; s390x
