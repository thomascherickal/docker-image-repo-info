...
```console
$ docker pull wordpress@sha256:22b7cc078c2ea2701913ad77b039b783b58bc9f890ac3eb79571bfc43d81ff58
```
...
### `wordpress:beta-5.9-beta2-php7.4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.9-beta2-php7.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.9-beta2-php7.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-5.9-beta2-php7.4-fpm-alpine` - linux; 386
...
### `wordpress:beta-5.9-beta2-php7.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-5.9-beta2-php7.4-fpm-alpine` - linux; s390x
