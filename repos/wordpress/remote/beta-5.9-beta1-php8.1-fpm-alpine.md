...
```console
$ docker pull wordpress@sha256:f9f4553ecb70ccde8a8b4ea89fd016013be0b665552b286f1952859c96a80423
```
...
### `wordpress:beta-5.9-beta1-php8.1-fpm-alpine` - linux; arm variant v6
