...
```console
$ docker pull wordpress@sha256:db585b98543eff3b62ed94df6ae143634184d0d1a160ad9b88ab1b885b655e76
```
...
### `wordpress:5.9.0-php8.0` - linux; arm variant v5
...
### `wordpress:5.9.0-php8.0` - linux; arm variant v7
...
### `wordpress:5.9.0-php8.0` - linux; arm64 variant v8
...
### `wordpress:5.9.0-php8.0` - linux; 386
...
### `wordpress:5.9.0-php8.0` - linux; mips64le
...
### `wordpress:5.9.0-php8.0` - linux; ppc64le
...
### `wordpress:5.9.0-php8.0` - linux; s390x
