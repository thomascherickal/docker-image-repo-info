...
```console
$ docker pull wordpress@sha256:fb410657a231792d29a51985c60f78d4d60adcc24b0faefdb1b79c7069271944
```
...
### `wordpress:5.8.3-fpm` - linux; amd64
...
### `wordpress:5.8.3-fpm` - linux; arm variant v5
...
### `wordpress:5.8.3-fpm` - linux; arm variant v7
...
### `wordpress:5.8.3-fpm` - linux; mips64le
...
### `wordpress:5.8.3-fpm` - linux; ppc64le
...
### `wordpress:5.8.3-fpm` - linux; s390x
