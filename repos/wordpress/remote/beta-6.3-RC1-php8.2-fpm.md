...
```console
$ docker pull wordpress@sha256:d5112fb7a5e385b1fb896cbb7befe180a5332e781931a277efe56a086f2ccca4
```
...
### `wordpress:beta-6.3-RC1-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-6.3-RC1-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.3-RC1-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC1-php8.2-fpm` - linux; 386
...
### `wordpress:beta-6.3-RC1-php8.2-fpm` - linux; mips64le
...
### `wordpress:beta-6.3-RC1-php8.2-fpm` - linux; ppc64le
