...
```console
$ docker pull wordpress@sha256:1bcbdd7943ff6bb5ccf56313e091444285336e12aa47dd6b1516ab6eb2a3e20f
```
...
### `wordpress:beta-6.2.1-RC1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.2.1-RC1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.2.1-RC1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.2.1-RC1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.2.1-RC1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.2.1-RC1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.2.1-RC1-fpm-alpine` - linux; s390x
