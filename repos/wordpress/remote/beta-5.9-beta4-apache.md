...
```console
$ docker pull wordpress@sha256:bed87caea18c3373a04648eda259d9f2788ba5af6b3a57dc8c84d7254514f4e4
```
...
### `wordpress:beta-5.9-beta4-apache` - linux; amd64
...
### `wordpress:beta-5.9-beta4-apache` - linux; arm variant v5
...
### `wordpress:beta-5.9-beta4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-5.9-beta4-apache` - linux; 386
...
### `wordpress:beta-5.9-beta4-apache` - linux; ppc64le
...
### `wordpress:beta-5.9-beta4-apache` - linux; s390x
