...
```console
$ docker pull wordpress@sha256:98893a5e72f17b7c8c366b739958fecc2309f54e13cdb63afa7aea7912524663
```
...
### `wordpress:beta-6.4-beta2-php8.1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.4-beta2-php8.1-fpm` - linux; ppc64le
