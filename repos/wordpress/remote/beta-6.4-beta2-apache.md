...
### `wordpress:beta-6.4-beta2-apache` - linux; amd64
...
### `wordpress:beta-6.4-beta2-apache` - linux; arm variant v5
...
### `wordpress:beta-6.4-beta2-apache` - linux; arm variant v7
...
### `wordpress:beta-6.4-beta2-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.4-beta2-apache` - linux; 386
...
### `wordpress:beta-6.4-beta2-apache` - linux; mips64le
...
### `wordpress:beta-6.4-beta2-apache` - linux; ppc64le
...
### `wordpress:beta-6.4-beta2-apache` - linux; s390x
