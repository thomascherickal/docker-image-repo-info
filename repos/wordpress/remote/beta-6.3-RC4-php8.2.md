...
```console
$ docker pull wordpress@sha256:16e75297f303416ddbcda460d35698e28f1c44a34e54f542b620c73761dd2bbe
```
...
### `wordpress:beta-6.3-RC4-php8.2` - linux; amd64
...
### `wordpress:beta-6.3-RC4-php8.2` - linux; arm variant v5
...
### `wordpress:beta-6.3-RC4-php8.2` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC4-php8.2` - linux; 386
...
### `wordpress:beta-6.3-RC4-php8.2` - linux; mips64le
...
### `wordpress:beta-6.3-RC4-php8.2` - linux; ppc64le
