...
### `wordpress:5.9.0-php8.0-apache` - linux; arm variant v5
...
### `wordpress:5.9.0-php8.0-apache` - linux; arm variant v7
...
### `wordpress:5.9.0-php8.0-apache` - linux; 386
...
### `wordpress:5.9.0-php8.0-apache` - linux; mips64le
...
### `wordpress:5.9.0-php8.0-apache` - linux; ppc64le
