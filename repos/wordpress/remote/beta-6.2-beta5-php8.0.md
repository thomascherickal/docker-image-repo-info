...
```console
$ docker pull wordpress@sha256:1d80fa13c7e7d4cf576cbf8069f0ffb4cf74d1898dde5ee0ef1bad8c413328dc
```
...
### `wordpress:beta-6.2-beta5-php8.0` - linux; amd64
...
### `wordpress:beta-6.2-beta5-php8.0` - linux; arm variant v5
...
### `wordpress:beta-6.2-beta5-php8.0` - linux; arm variant v7
...
### `wordpress:beta-6.2-beta5-php8.0` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-beta5-php8.0` - linux; mips64le
...
### `wordpress:beta-6.2-beta5-php8.0` - linux; ppc64le
...
### `wordpress:beta-6.2-beta5-php8.0` - linux; s390x
