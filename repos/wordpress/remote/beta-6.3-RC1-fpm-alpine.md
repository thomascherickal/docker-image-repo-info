...
```console
$ docker pull wordpress@sha256:6544fbf4d244e50c1ea7852933537432d0314e381682c1025f87d1a1c6c2993d
```
...
### `wordpress:beta-6.3-RC1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC1-fpm-alpine` - linux; ppc64le
