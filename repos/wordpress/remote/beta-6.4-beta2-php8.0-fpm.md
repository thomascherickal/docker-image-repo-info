...
```console
$ docker pull wordpress@sha256:d40f19674879f6d7f9a1cc0dd3498dba8f9efb1f17139ba343b68522be34047a
```
...
### `wordpress:beta-6.4-beta2-php8.0-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.4-beta2-php8.0-fpm` - linux; ppc64le
