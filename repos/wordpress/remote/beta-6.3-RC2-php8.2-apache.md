...
```console
$ docker pull wordpress@sha256:d19db63524e8ec9e4a2d62c5bae61f418bf7ead43f64841187184531174a770f
```
...
### `wordpress:beta-6.3-RC2-php8.2-apache` - linux; amd64
...
### `wordpress:beta-6.3-RC2-php8.2-apache` - linux; arm variant v5
...
### `wordpress:beta-6.3-RC2-php8.2-apache` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC2-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC2-php8.2-apache` - linux; 386
...
### `wordpress:beta-6.3-RC2-php8.2-apache` - linux; mips64le
...
### `wordpress:beta-6.3-RC2-php8.2-apache` - linux; ppc64le
