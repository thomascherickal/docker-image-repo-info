...
```console
$ docker pull wordpress@sha256:04f58ddf0f8d82ee286afed84ee4c1d0f226cf4d259764add4e76c34a3149f55
```
...
### `wordpress:beta-5.9-beta2-php8.0-apache` - linux; arm variant v5
...
### `wordpress:beta-5.9-beta2-php8.0-apache` - linux; arm variant v7
...
### `wordpress:beta-5.9-beta2-php8.0-apache` - linux; 386
...
### `wordpress:beta-5.9-beta2-php8.0-apache` - linux; ppc64le
...
### `wordpress:beta-5.9-beta2-php8.0-apache` - linux; s390x
