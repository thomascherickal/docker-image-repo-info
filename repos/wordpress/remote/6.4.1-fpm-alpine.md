...
```console
$ docker pull wordpress@sha256:81829045d60e73fbc29440d52363c37dda6001fd6a9b75a00746f5ee084904f3
```
...
### `wordpress:6.4.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.4.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.4.1-fpm-alpine` - linux; ppc64le
