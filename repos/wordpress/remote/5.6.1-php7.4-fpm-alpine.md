## `wordpress:5.6.1-php7.4-fpm-alpine`

```console
$ docker pull wordpress@sha256:2e3c83a8532ada7d1b3c53bbfc7c00fd9780785c1364280688f2ceeba245e569
```
...
### `wordpress:5.6.1-php7.4-fpm-alpine` - linux; amd64
...
### `wordpress:5.6.1-php7.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:5.6.1-php7.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:5.6.1-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:5.6.1-php7.4-fpm-alpine` - linux; 386
...
### `wordpress:5.6.1-php7.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:5.6.1-php7.4-fpm-alpine` - linux; s390x
