...
### `wordpress:5.6.0-php8.0-apache` - linux; amd64
...
### `wordpress:5.6.0-php8.0-apache` - linux; arm variant v7
...
### `wordpress:5.6.0-php8.0-apache` - linux; arm64 variant v8
...
### `wordpress:5.6.0-php8.0-apache` - linux; 386
...
### `wordpress:5.6.0-php8.0-apache` - linux; ppc64le
...
### `wordpress:5.6.0-php8.0-apache` - linux; s390x
