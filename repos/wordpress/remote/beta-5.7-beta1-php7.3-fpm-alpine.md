...
### `wordpress:beta-5.7-beta1-php7.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.7-beta1-php7.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-5.7-beta1-php7.3-fpm-alpine` - linux; ppc64le
