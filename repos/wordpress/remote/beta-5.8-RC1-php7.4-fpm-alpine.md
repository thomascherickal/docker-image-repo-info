## `wordpress:beta-5.8-RC1-php7.4-fpm-alpine`

```console
$ docker pull wordpress@sha256:f256648ed40b4068bd0b1483674d6b597210de759ed09a6bb2644c016d51b848
```
...
### `wordpress:beta-5.8-RC1-php7.4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.8-RC1-php7.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.8-RC1-php7.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-5.8-RC1-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-5.8-RC1-php7.4-fpm-alpine` - linux; 386
...
### `wordpress:beta-5.8-RC1-php7.4-fpm-alpine` - linux; s390x
