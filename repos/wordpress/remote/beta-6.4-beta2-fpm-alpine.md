...
### `wordpress:beta-6.4-beta2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.4-beta2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.4-beta2-fpm-alpine` - linux; s390x
