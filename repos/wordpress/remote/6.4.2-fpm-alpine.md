...
```console
$ docker pull wordpress@sha256:64e698cb018c14cdf96642daebd0c9b2217e49cca73907abbb7148e62e4330da
```
...
### `wordpress:6.4.2-fpm-alpine` - linux; amd64
...
### `wordpress:6.4.2-fpm-alpine` - unknown; unknown
...
### `wordpress:6.4.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.4.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.4.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.4.2-fpm-alpine` - linux; 386
...
### `wordpress:6.4.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.4.2-fpm-alpine` - linux; s390x
