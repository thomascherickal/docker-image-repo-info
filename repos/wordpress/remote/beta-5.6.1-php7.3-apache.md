## `wordpress:beta-5.6.1-php7.3-apache`

```console
$ docker pull wordpress@sha256:06537859fbc32edb2b4ece00fcccdf5173ffa2d3b943e585f8d27f1d8f47fd8d
```
...
### `wordpress:beta-5.6.1-php7.3-apache` - linux; arm variant v5
...
### `wordpress:beta-5.6.1-php7.3-apache` - linux; arm variant v7
...
### `wordpress:beta-5.6.1-php7.3-apache` - linux; arm64 variant v8
...
### `wordpress:beta-5.6.1-php7.3-apache` - linux; mips64le
...
### `wordpress:beta-5.6.1-php7.3-apache` - linux; s390x
