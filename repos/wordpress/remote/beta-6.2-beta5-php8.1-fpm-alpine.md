...
```console
$ docker pull wordpress@sha256:4a178adf5a9397a37ea8f2a8ff8dc8b844e6c0863454cf616d607502a88161e7
```
...
### `wordpress:beta-6.2-beta5-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.2-beta5-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.2-beta5-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-beta5-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.2-beta5-php8.1-fpm-alpine` - linux; s390x
