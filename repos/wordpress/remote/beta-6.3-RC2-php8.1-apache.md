...
```console
$ docker pull wordpress@sha256:637184e0ece1a89c2b2efae335a67ef218d04a6610c16349a8a2624f64234da4
```
...
### `wordpress:beta-6.3-RC2-php8.1-apache` - linux; amd64
...
### `wordpress:beta-6.3-RC2-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.3-RC2-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC2-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC2-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.3-RC2-php8.1-apache` - linux; mips64le
...
### `wordpress:beta-6.3-RC2-php8.1-apache` - linux; ppc64le
