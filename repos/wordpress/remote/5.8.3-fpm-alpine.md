...
```console
$ docker pull wordpress@sha256:1e2f0a65158c30e1ecd6579dbeee545d0925a02468fe4a593efaf6e34fd61925
```
...
### `wordpress:5.8.3-fpm-alpine` - linux; amd64
...
### `wordpress:5.8.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:5.8.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:5.8.3-fpm-alpine` - linux; 386
...
### `wordpress:5.8.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:5.8.3-fpm-alpine` - linux; s390x
