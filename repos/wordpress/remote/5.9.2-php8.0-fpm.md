...
```console
$ docker pull wordpress@sha256:f5feb848149c3c3c67158d1883a9c024db529d4a49d184fd4ba04c0322ce5da5
```
...
### `wordpress:5.9.2-php8.0-fpm` - linux; amd64
...
### `wordpress:5.9.2-php8.0-fpm` - linux; arm variant v5
...
### `wordpress:5.9.2-php8.0-fpm` - linux; arm variant v7
...
### `wordpress:5.9.2-php8.0-fpm` - linux; arm64 variant v8
...
### `wordpress:5.9.2-php8.0-fpm` - linux; 386
...
### `wordpress:5.9.2-php8.0-fpm` - linux; mips64le
...
### `wordpress:5.9.2-php8.0-fpm` - linux; ppc64le
...
### `wordpress:5.9.2-php8.0-fpm` - linux; s390x
