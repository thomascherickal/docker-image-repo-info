...
### `wordpress:beta-6.0-RC1` - linux; arm variant v5
...
### `wordpress:beta-6.0-RC1` - linux; arm64 variant v8
...
### `wordpress:beta-6.0-RC1` - linux; 386
...
### `wordpress:beta-6.0-RC1` - linux; mips64le
...
### `wordpress:beta-6.0-RC1` - linux; s390x
