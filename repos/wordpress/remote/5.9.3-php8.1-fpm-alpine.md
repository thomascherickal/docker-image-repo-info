...
```console
$ docker pull wordpress@sha256:cb0f4af4e6e62edc6589d9cddee4c0b7e79549446b41f1e2e78abbd7b08fce3f
```
...
### `wordpress:5.9.3-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:5.9.3-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:5.9.3-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:5.9.3-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:5.9.3-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:5.9.3-php8.1-fpm-alpine` - linux; s390x
