...
```console
$ docker pull wordpress@sha256:33803fcdb03df9c6418026be930f4a75defbbf87273fa27b0758d76845edfc8d
```
...
### `wordpress:beta-6.2-beta5-php8.2` - linux; amd64
...
### `wordpress:beta-6.2-beta5-php8.2` - linux; arm variant v5
...
### `wordpress:beta-6.2-beta5-php8.2` - linux; arm variant v7
...
### `wordpress:beta-6.2-beta5-php8.2` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-beta5-php8.2` - linux; mips64le
...
### `wordpress:beta-6.2-beta5-php8.2` - linux; ppc64le
...
### `wordpress:beta-6.2-beta5-php8.2` - linux; s390x
