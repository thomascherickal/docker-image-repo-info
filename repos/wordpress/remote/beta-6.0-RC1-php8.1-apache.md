...
```console
$ docker pull wordpress@sha256:cba1dbe5b6ccd66b6c991dcddc98de6676b9eba5d8b6610d797b5352af758183
```
...
### `wordpress:beta-6.0-RC1-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.0-RC1-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.0-RC1-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.0-RC1-php8.1-apache` - linux; mips64le
...
### `wordpress:beta-6.0-RC1-php8.1-apache` - linux; s390x
