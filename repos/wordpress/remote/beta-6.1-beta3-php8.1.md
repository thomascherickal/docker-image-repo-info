...
```console
$ docker pull wordpress@sha256:334f895bae44fff7e838b13e459ea38f3368430be7462bf9ece23f4417458dd9
```
...
### `wordpress:beta-6.1-beta3-php8.1` - linux; amd64
...
### `wordpress:beta-6.1-beta3-php8.1` - linux; arm variant v5
...
### `wordpress:beta-6.1-beta3-php8.1` - linux; arm64 variant v8
...
### `wordpress:beta-6.1-beta3-php8.1` - linux; 386
...
### `wordpress:beta-6.1-beta3-php8.1` - linux; mips64le
...
### `wordpress:beta-6.1-beta3-php8.1` - linux; ppc64le
...
### `wordpress:beta-6.1-beta3-php8.1` - linux; s390x
