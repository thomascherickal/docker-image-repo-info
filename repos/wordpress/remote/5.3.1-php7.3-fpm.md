...
### `wordpress:5.3.1-php7.3-fpm` - linux; amd64
...
### `wordpress:5.3.1-php7.3-fpm` - linux; arm variant v5
...
### `wordpress:5.3.1-php7.3-fpm` - linux; arm variant v7
...
### `wordpress:5.3.1-php7.3-fpm` - linux; arm64 variant v8
...
### `wordpress:5.3.1-php7.3-fpm` - linux; 386
...
### `wordpress:5.3.1-php7.3-fpm` - linux; ppc64le
