...
```console
$ docker pull wordpress@sha256:66c57aaff48bfd7b44e51bc3dafec4a53ca07834c06b943638251287af359347
```
...
### `wordpress:beta-5.8-RC2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.8-RC2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.8-RC2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-5.8-RC2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-5.8-RC2-fpm-alpine` - linux; 386
...
### `wordpress:beta-5.8-RC2-fpm-alpine` - linux; s390x
