...
```console
$ docker pull wordpress@sha256:96f24a76764847f7c73781c789e30a83819ac5eaf4dcbda85ae8ed412e027e6c
```
...
### `wordpress:beta-6.2-beta3-php8.2-apache` - linux; amd64
...
### `wordpress:beta-6.2-beta3-php8.2-apache` - linux; arm variant v5
...
### `wordpress:beta-6.2-beta3-php8.2-apache` - linux; arm variant v7
...
### `wordpress:beta-6.2-beta3-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-beta3-php8.2-apache` - linux; 386
...
### `wordpress:beta-6.2-beta3-php8.2-apache` - linux; mips64le
...
### `wordpress:beta-6.2-beta3-php8.2-apache` - linux; ppc64le
...
### `wordpress:beta-6.2-beta3-php8.2-apache` - linux; s390x
