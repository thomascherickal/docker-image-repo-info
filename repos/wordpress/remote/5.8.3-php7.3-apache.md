...
```console
$ docker pull wordpress@sha256:0deb9ba4a4e7f35c16dc72674c75626442bf9b241d9ce9fa434330ba7068df85
```
...
### `wordpress:5.8.3-php7.3-apache` - linux; amd64
...
### `wordpress:5.8.3-php7.3-apache` - linux; arm variant v5
...
### `wordpress:5.8.3-php7.3-apache` - linux; arm variant v7
...
### `wordpress:5.8.3-php7.3-apache` - linux; 386
...
### `wordpress:5.8.3-php7.3-apache` - linux; mips64le
...
### `wordpress:5.8.3-php7.3-apache` - linux; ppc64le
...
### `wordpress:5.8.3-php7.3-apache` - linux; s390x
