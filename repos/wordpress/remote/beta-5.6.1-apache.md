...
### `wordpress:beta-5.6.1-apache` - linux; arm variant v5
...
### `wordpress:beta-5.6.1-apache` - linux; arm variant v7
...
### `wordpress:beta-5.6.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-5.6.1-apache` - linux; mips64le
...
### `wordpress:beta-5.6.1-apache` - linux; s390x
