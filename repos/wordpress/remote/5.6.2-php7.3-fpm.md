...
```console
$ docker pull wordpress@sha256:ef514ab7c7951437d107e1b06a5f542e50bef1fbe9684062dd80d6d49ef90c3a
```
...
### `wordpress:5.6.2-php7.3-fpm` - linux; amd64
...
### `wordpress:5.6.2-php7.3-fpm` - linux; arm variant v5
...
### `wordpress:5.6.2-php7.3-fpm` - linux; arm variant v7
...
### `wordpress:5.6.2-php7.3-fpm` - linux; arm64 variant v8
...
### `wordpress:5.6.2-php7.3-fpm` - linux; 386
...
### `wordpress:5.6.2-php7.3-fpm` - linux; mips64le
...
### `wordpress:5.6.2-php7.3-fpm` - linux; s390x
