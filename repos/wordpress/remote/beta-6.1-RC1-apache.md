...
```console
$ docker pull wordpress@sha256:d6dc4ce2536f453243fd4f5892bdfefebe5aa1a056d69772bf68fad0209f9f90
```
...
### `wordpress:beta-6.1-RC1-apache` - linux; amd64
...
### `wordpress:beta-6.1-RC1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.1-RC1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.1-RC1-apache` - linux; 386
...
### `wordpress:beta-6.1-RC1-apache` - linux; mips64le
...
### `wordpress:beta-6.1-RC1-apache` - linux; ppc64le
...
### `wordpress:beta-6.1-RC1-apache` - linux; s390x
