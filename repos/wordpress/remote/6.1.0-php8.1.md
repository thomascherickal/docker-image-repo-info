...
### `wordpress:6.1.0-php8.1` - linux; amd64
...
### `wordpress:6.1.0-php8.1` - linux; arm variant v5
...
### `wordpress:6.1.0-php8.1` - linux; arm variant v7
...
### `wordpress:6.1.0-php8.1` - linux; arm64 variant v8
...
### `wordpress:6.1.0-php8.1` - linux; 386
...
### `wordpress:6.1.0-php8.1` - linux; mips64le
...
### `wordpress:6.1.0-php8.1` - linux; ppc64le
...
### `wordpress:6.1.0-php8.1` - linux; s390x
