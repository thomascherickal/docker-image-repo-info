...
```console
$ docker pull wordpress@sha256:9c8d8d62bcad01abbc7537963a4b4c09250efcdf19ccd0937cbdf7ea7628c8c3
```
...
### `wordpress:beta-6.3-RC4-php8.1-apache` - linux; amd64
...
### `wordpress:beta-6.3-RC4-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.3-RC4-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC4-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.3-RC4-php8.1-apache` - linux; mips64le
...
### `wordpress:beta-6.3-RC4-php8.1-apache` - linux; ppc64le
