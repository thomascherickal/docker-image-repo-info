...
```console
$ docker pull wordpress@sha256:e4c078b90398d861865051a01ad4e95a700554afd22762747950f2df4b1dc673
```
...
### `wordpress:beta-6.0-beta2-php8.0-fpm` - linux; amd64
...
### `wordpress:beta-6.0-beta2-php8.0-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.0-beta2-php8.0-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.0-beta2-php8.0-fpm` - linux; 386
...
### `wordpress:beta-6.0-beta2-php8.0-fpm` - linux; ppc64le
...
### `wordpress:beta-6.0-beta2-php8.0-fpm` - linux; s390x
