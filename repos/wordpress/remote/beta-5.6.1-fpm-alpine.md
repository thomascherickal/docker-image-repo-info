## `wordpress:beta-5.6.1-fpm-alpine`

```console
$ docker pull wordpress@sha256:d3e8cc5b10d6dd52b707a7889676e5e1cbe3a14eb6356492381247c4174249d9
```
...
### `wordpress:beta-5.6.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.6.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-5.6.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-5.6.1-fpm-alpine` - linux; s390x
