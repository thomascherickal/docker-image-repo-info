...
```console
$ docker pull wordpress@sha256:c22f800a495fc745947681536888b67445161cb48f55518fbdf9046e11beab5e
```
...
### `wordpress:beta-6.3-RC1` - linux; amd64
...
### `wordpress:beta-6.3-RC1` - linux; arm variant v5
...
### `wordpress:beta-6.3-RC1` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC1` - linux; 386
...
### `wordpress:beta-6.3-RC1` - linux; mips64le
...
### `wordpress:beta-6.3-RC1` - linux; ppc64le
