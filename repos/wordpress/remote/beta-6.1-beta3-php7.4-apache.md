...
```console
$ docker pull wordpress@sha256:5ef8389797587ae790b72f0743561d5a4f3c1bd185afeb8286f2c237bfd25a15
```
...
### `wordpress:beta-6.1-beta3-php7.4-apache` - linux; amd64
...
### `wordpress:beta-6.1-beta3-php7.4-apache` - linux; arm variant v5
...
### `wordpress:beta-6.1-beta3-php7.4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.1-beta3-php7.4-apache` - linux; 386
...
### `wordpress:beta-6.1-beta3-php7.4-apache` - linux; mips64le
...
### `wordpress:beta-6.1-beta3-php7.4-apache` - linux; ppc64le
...
### `wordpress:beta-6.1-beta3-php7.4-apache` - linux; s390x
