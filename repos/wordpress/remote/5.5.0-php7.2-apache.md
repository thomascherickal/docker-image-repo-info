...
### `wordpress:5.5.0-php7.2-apache` - linux; amd64
...
### `wordpress:5.5.0-php7.2-apache` - linux; arm variant v5
...
### `wordpress:5.5.0-php7.2-apache` - linux; arm variant v7
...
### `wordpress:5.5.0-php7.2-apache` - linux; arm64 variant v8
...
### `wordpress:5.5.0-php7.2-apache` - linux; 386
...
### `wordpress:5.5.0-php7.2-apache` - linux; ppc64le
...
### `wordpress:5.5.0-php7.2-apache` - linux; s390x
