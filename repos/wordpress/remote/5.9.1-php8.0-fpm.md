...
### `wordpress:5.9.1-php8.0-fpm` - linux; amd64
...
### `wordpress:5.9.1-php8.0-fpm` - linux; arm variant v7
...
### `wordpress:5.9.1-php8.0-fpm` - linux; arm64 variant v8
...
### `wordpress:5.9.1-php8.0-fpm` - linux; 386
...
### `wordpress:5.9.1-php8.0-fpm` - linux; s390x
