...
```console
$ docker pull wordpress@sha256:2062fcf3a85a07c84fd6497da5679108e688ceb0d02f91507c5d309a24b90255
```
...
```console
$ docker pull wordpress@sha256:da4ae6f894200e94c77eb783275b58b46603968a5a254a8390e1ddf0a70ae780
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v1+json`
-	Total Size: **159.7 MB (159737469 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `027eafa35afd5100228ba59e79ec38d63653c29728b1948dacbbc7fa617fda07`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
