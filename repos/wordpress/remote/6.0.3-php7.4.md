...
### `wordpress:6.0.3-php7.4` - linux; amd64
...
### `wordpress:6.0.3-php7.4` - linux; arm variant v5
...
### `wordpress:6.0.3-php7.4` - linux; arm variant v7
...
### `wordpress:6.0.3-php7.4` - linux; arm64 variant v8
...
### `wordpress:6.0.3-php7.4` - linux; 386
...
### `wordpress:6.0.3-php7.4` - linux; mips64le
...
### `wordpress:6.0.3-php7.4` - linux; ppc64le
...
### `wordpress:6.0.3-php7.4` - linux; s390x
