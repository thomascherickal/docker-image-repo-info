## `wordpress:beta-5.6.1-RC1-php8.0`
...
### `wordpress:beta-5.6.1-RC1-php8.0` - linux; arm variant v5
...
### `wordpress:beta-5.6.1-RC1-php8.0` - linux; arm variant v7
...
### `wordpress:beta-5.6.1-RC1-php8.0` - linux; arm64 variant v8
...
### `wordpress:beta-5.6.1-RC1-php8.0` - linux; mips64le
...
### `wordpress:beta-5.6.1-RC1-php8.0` - linux; s390x
