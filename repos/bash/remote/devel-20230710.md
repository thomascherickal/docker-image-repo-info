...
### `bash:devel-20230710` - linux; amd64
...
### `bash:devel-20230710` - linux; arm variant v6
...
### `bash:devel-20230710` - linux; arm variant v7
...
### `bash:devel-20230710` - linux; arm64 variant v8
...
### `bash:devel-20230710` - linux; ppc64le
...
### `bash:devel-20230710` - linux; s390x
