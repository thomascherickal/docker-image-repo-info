## `bash:devel-20220815-alpine3.15`

```console
$ docker pull bash@sha256:2811a0dd4baa4321d9f21b155ea62843f655ab1b252a0878db5e7bd6b9236ebd
```
...
### `bash:devel-20220815-alpine3.15` - linux; arm variant v6
...
### `bash:devel-20220815-alpine3.15` - linux; arm variant v7
...
### `bash:devel-20220815-alpine3.15` - linux; arm64 variant v8
...
### `bash:devel-20220815-alpine3.15` - linux; 386
...
### `bash:devel-20220815-alpine3.15` - linux; s390x
