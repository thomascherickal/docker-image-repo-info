## `bash:devel-20231125-alpine3.18`
...
### `bash:devel-20231125-alpine3.18` - linux; amd64
...
### `bash:devel-20231125-alpine3.18` - linux; arm variant v6
...
### `bash:devel-20231125-alpine3.18` - linux; arm variant v7
...
### `bash:devel-20231125-alpine3.18` - linux; arm64 variant v8
...
### `bash:devel-20231125-alpine3.18` - linux; 386
...
### `bash:devel-20231125-alpine3.18` - linux; ppc64le
...
### `bash:devel-20231125-alpine3.18` - linux; s390x
