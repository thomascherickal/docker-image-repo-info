...
### `bash:devel-20200327` - linux; amd64
...
### `bash:devel-20200327` - linux; arm variant v6
...
### `bash:devel-20200327` - linux; arm variant v7
...
### `bash:devel-20200327` - linux; arm64 variant v8
...
### `bash:devel-20200327` - linux; ppc64le
...
### `bash:devel-20200327` - linux; s390x
