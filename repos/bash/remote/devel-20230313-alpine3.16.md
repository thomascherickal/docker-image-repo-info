...
```console
$ docker pull bash@sha256:1729d3ff7911d18ad9c583f2160fe28b4b3fcd82e62bb3a517b0f6419e97aa91
```
...
### `bash:devel-20230313-alpine3.16` - linux; arm64 variant v8
...
### `bash:devel-20230313-alpine3.16` - linux; s390x
