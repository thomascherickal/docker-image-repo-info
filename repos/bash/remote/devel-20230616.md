...
```console
$ docker pull bash@sha256:b81bd7c4af4a06123ed1d5fc1aa95dd7cc97976efa8cb452c46bdccf86eb9eb2
```
...
### `bash:devel-20230616` - linux; amd64
...
### `bash:devel-20230616` - linux; arm variant v6
...
### `bash:devel-20230616` - linux; arm variant v7
...
### `bash:devel-20230616` - linux; arm64 variant v8
...
### `bash:devel-20230616` - linux; ppc64le
