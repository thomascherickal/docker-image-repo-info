...
### `bash:devel-20230911` - linux; arm variant v6
...
### `bash:devel-20230911` - linux; arm variant v7
...
### `bash:devel-20230911` - linux; arm64 variant v8
...
### `bash:devel-20230911` - linux; s390x
