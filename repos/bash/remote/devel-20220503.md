...
### `bash:devel-20220503` - linux; amd64
...
### `bash:devel-20220503` - linux; arm variant v6
...
### `bash:devel-20220503` - linux; arm variant v7
...
### `bash:devel-20220503` - linux; arm64 variant v8
...
### `bash:devel-20220503` - linux; ppc64le
...
### `bash:devel-20220503` - linux; s390x
