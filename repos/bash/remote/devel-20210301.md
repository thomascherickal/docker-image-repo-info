...
### `bash:devel-20210301` - linux; amd64
...
### `bash:devel-20210301` - linux; arm64 variant v8
...
### `bash:devel-20210301` - linux; ppc64le
...
### `bash:devel-20210301` - linux; s390x
