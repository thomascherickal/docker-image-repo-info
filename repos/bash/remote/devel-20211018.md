...
```console
$ docker pull bash@sha256:2517746e49360f575b97f138863f1e6d8a9f11b656f20350ebd786759be987e9
```
...
### `bash:devel-20211018` - linux; amd64
...
### `bash:devel-20211018` - linux; ppc64le
