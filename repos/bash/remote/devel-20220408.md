...
### `bash:devel-20220408` - linux; amd64
...
### `bash:devel-20220408` - linux; arm variant v6
...
### `bash:devel-20220408` - linux; arm variant v7
...
### `bash:devel-20220408` - linux; arm64 variant v8
...
### `bash:devel-20220408` - linux; ppc64le
...
### `bash:devel-20220408` - linux; s390x
