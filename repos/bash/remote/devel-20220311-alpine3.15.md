...
```console
$ docker pull bash@sha256:773d173c87f3ca40983ed2ca864ee1d302a7b59df33dee77d145f39c5b0fb115
```
...
### `bash:devel-20220311-alpine3.15` - linux; amd64
...
### `bash:devel-20220311-alpine3.15` - linux; arm variant v6
...
### `bash:devel-20220311-alpine3.15` - linux; arm variant v7
...
### `bash:devel-20220311-alpine3.15` - linux; arm64 variant v8
...
### `bash:devel-20220311-alpine3.15` - linux; 386
...
### `bash:devel-20220311-alpine3.15` - linux; ppc64le
...
### `bash:devel-20220311-alpine3.15` - linux; s390x
