...
```console
$ docker pull bash@sha256:6f6aa1644ceeb0bc2c6534a489a3ede1e76e24fc124d391738407706677dc3db
```
...
### `bash:devel-20220221-alpine3.15` - linux; arm variant v6
...
### `bash:devel-20220221-alpine3.15` - linux; arm variant v7
...
### `bash:devel-20220221-alpine3.15` - linux; arm64 variant v8
...
### `bash:devel-20220221-alpine3.15` - linux; 386
...
### `bash:devel-20220221-alpine3.15` - linux; s390x
