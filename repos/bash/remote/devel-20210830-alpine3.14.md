...
```console
$ docker pull bash@sha256:b3d45fd450cdecb96b0ef97fca73090660ae7cfb7b40416f3c15e58119f60bf0
```
...
### `bash:devel-20210830-alpine3.14` - linux; arm variant v6
...
### `bash:devel-20210830-alpine3.14` - linux; arm variant v7
...
### `bash:devel-20210830-alpine3.14` - linux; ppc64le
...
### `bash:devel-20210830-alpine3.14` - linux; s390x
