...
### `bash:devel-20231030` - linux; amd64
...
### `bash:devel-20231030` - linux; arm variant v6
...
### `bash:devel-20231030` - linux; arm variant v7
...
### `bash:devel-20231030` - linux; arm64 variant v8
...
### `bash:devel-20231030` - linux; s390x
