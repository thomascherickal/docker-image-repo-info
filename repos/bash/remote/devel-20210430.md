...
### `bash:devel-20210430` - linux; amd64
...
### `bash:devel-20210430` - linux; arm64 variant v8
...
### `bash:devel-20210430` - linux; ppc64le
...
### `bash:devel-20210430` - linux; s390x
