...
### `bash:devel-alpine3.12` - linux; amd64
...
### `bash:devel-alpine3.12` - linux; arm variant v6
...
### `bash:devel-alpine3.12` - linux; arm variant v7
...
### `bash:devel-alpine3.12` - linux; arm64 variant v8
...
### `bash:devel-alpine3.12` - linux; 386
...
### `bash:devel-alpine3.12` - linux; ppc64le
...
### `bash:devel-alpine3.12` - linux; s390x
