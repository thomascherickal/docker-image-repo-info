## `bash:devel-20221219-alpine3.16`

```console
$ docker pull bash@sha256:285ba0518cb803a11e7ce10286d6ca9fbb7db76711f3d57492d4646d1f6f5dd6
```
...
### `bash:devel-20221219-alpine3.16` - linux; amd64
...
### `bash:devel-20221219-alpine3.16` - linux; arm variant v6
...
### `bash:devel-20221219-alpine3.16` - linux; arm64 variant v8
...
### `bash:devel-20221219-alpine3.16` - linux; 386
...
### `bash:devel-20221219-alpine3.16` - linux; ppc64le
...
### `bash:devel-20221219-alpine3.16` - linux; s390x
