...
### `bash:devel-20220111-alpine3.14` - linux; amd64
...
### `bash:devel-20220111-alpine3.14` - linux; arm variant v6
...
### `bash:devel-20220111-alpine3.14` - linux; arm variant v7
...
### `bash:devel-20220111-alpine3.14` - linux; arm64 variant v8
...
### `bash:devel-20220111-alpine3.14` - linux; 386
...
### `bash:devel-20220111-alpine3.14` - linux; ppc64le
...
### `bash:devel-20220111-alpine3.14` - linux; s390x
