...
### `bash:devel-20230403` - linux; amd64
...
### `bash:devel-20230403` - linux; arm variant v6
...
### `bash:devel-20230403` - linux; arm variant v7
...
### `bash:devel-20230403` - linux; arm64 variant v8
...
### `bash:devel-20230403` - linux; ppc64le
...
### `bash:devel-20230403` - linux; s390x
