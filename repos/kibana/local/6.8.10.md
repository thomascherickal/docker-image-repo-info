...
- Created: `2020-05-28T15:44:35.200843671Z`
- Virtual Size: ~ 712.04 Mb  
...
### `rpm` package: `bind-license-9.11.4-16.P2.el7_8.3.noarch`
...
```console
$ yumdownloader --quiet --source --urls bind-license-9.11.4-16.P2.el7_8.3.noarch
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/bind-9.11.4-16.P2.el7_8.3.src.rpm
```
