...
### `drupal:10.0.0-alpha4-php8.1-fpm-alpine3.16` - linux; amd64
...
### `drupal:10.0.0-alpha4-php8.1-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:10.0.0-alpha4-php8.1-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:10.0.0-alpha4-php8.1-fpm-alpine3.16` - linux; 386
...
### `drupal:10.0.0-alpha4-php8.1-fpm-alpine3.16` - linux; ppc64le
