...
```console
$ docker pull drupal@sha256:bd37c92eb43befa7b1d5913b75512cc70c93860ad2ac0adfc9ad8d2a4dbd6aa5
```
...
### `drupal:9.4.1-fpm-alpine3.15` - linux; amd64
...
### `drupal:9.4.1-fpm-alpine3.15` - linux; arm variant v6
...
### `drupal:9.4.1-fpm-alpine3.15` - linux; arm64 variant v8
...
### `drupal:9.4.1-fpm-alpine3.15` - linux; 386
...
### `drupal:9.4.1-fpm-alpine3.15` - linux; ppc64le
...
### `drupal:9.4.1-fpm-alpine3.15` - linux; s390x
