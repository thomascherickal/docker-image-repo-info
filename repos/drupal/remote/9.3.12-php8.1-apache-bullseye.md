...
```console
$ docker pull drupal@sha256:9d0eae777c867c53bc278d05c2dbcb4e095289a2970b2dbcc34b9c024d4751ac
```
...
### `drupal:9.3.12-php8.1-apache-bullseye` - linux; arm variant v7
...
### `drupal:9.3.12-php8.1-apache-bullseye` - linux; ppc64le
