...
```console
$ docker pull drupal@sha256:c83680438010f93d6caa0da338086133e8a50049ae5f3571510a2f3c855b3ae8
```
...
### `drupal:8.9.2-apache` - linux; amd64
...
### `drupal:8.9.2-apache` - linux; arm64 variant v8
...
### `drupal:8.9.2-apache` - linux; ppc64le
