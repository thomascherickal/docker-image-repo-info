...
```console
$ docker pull drupal@sha256:e2e8991039d452978c5483675ecd2d00e94414add44d92e4dd6691c18c8b5fbc
```
...
### `drupal:9.3.14-php8.0` - linux; amd64
...
### `drupal:9.3.14-php8.0` - linux; 386
...
### `drupal:9.3.14-php8.0` - linux; ppc64le
