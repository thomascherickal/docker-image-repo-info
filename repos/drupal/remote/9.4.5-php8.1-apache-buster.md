...
```console
$ docker pull drupal@sha256:4b87b8d06c627bc94c5f82f160a767a9b6230e91efefc9c4f51ffeb8c502b693
```
...
### `drupal:9.4.5-php8.1-apache-buster` - linux; amd64
...
### `drupal:9.4.5-php8.1-apache-buster` - linux; arm variant v7
...
### `drupal:9.4.5-php8.1-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.4.5-php8.1-apache-buster` - linux; 386
...
### `drupal:9.4.5-php8.1-apache-buster` - linux; ppc64le
...
### `drupal:9.4.5-php8.1-apache-buster` - linux; s390x
