...
### `drupal:9.4.1-php7.4-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.4.1-php7.4-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.4.1-php7.4-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.4.1-php7.4-fpm-alpine3.16` - linux; 386
...
### `drupal:9.4.1-php7.4-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.4.1-php7.4-fpm-alpine3.16` - linux; s390x
