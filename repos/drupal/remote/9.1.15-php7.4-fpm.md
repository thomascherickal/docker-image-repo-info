...
```console
$ docker pull drupal@sha256:90a965e4abdf7c33f15a19fae3f8384d4ce5de8e9bb63430a50e5938b8899d18
```
...
### `drupal:9.1.15-php7.4-fpm` - linux; amd64

```console
$ docker pull drupal@sha256:ae4fb4c78137e1b52e5a670b94401439598a0ebb3fac870d6a9b9cb77b2380eb
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.3 MB (164275118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a829aab47bd3e18fdfd7cb7aaabdd9da71c849960b5305f97decf691c09a063`
...
# Wed, 24 Nov 2021 20:25:52 GMT
ENV DRUPAL_VERSION=9.1.15
# Wed, 24 Nov 2021 20:25:53 GMT
WORKDIR /opt/drupal
# Wed, 24 Nov 2021 20:26:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 24 Nov 2021 20:26:13 GMT
...
-	Layers:
	...
	-	`sha256:b784aa42e04e170bb9ac90b91cb873c5ee7fff31c6fd17958fabc01713a3d9fa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49e6966c0205fe05b7ed02a39a8aea19b0f41521ffa7242082326172905c4d08`  
		Last Modified: Wed, 24 Nov 2021 20:40:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8946f8dbbb7860fbe096d8222e97c96365c1cf257a3685b3d9d799d70e5b87e1`  
		Last Modified: Wed, 24 Nov 2021 20:40:13 GMT  
		Size: 18.9 MB (18879879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.15-php7.4-fpm` - linux; arm variant v7
...
### `drupal:9.1.15-php7.4-fpm` - linux; arm64 variant v8
...
### `drupal:9.1.15-php7.4-fpm` - linux; ppc64le
...
### `drupal:9.1.15-php7.4-fpm` - linux; s390x
