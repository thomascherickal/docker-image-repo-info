...
### `drupal:10.0.1-apache-buster` - linux; amd64
...
### `drupal:10.0.1-apache-buster` - linux; arm variant v7
...
### `drupal:10.0.1-apache-buster` - linux; arm64 variant v8
...
### `drupal:10.0.1-apache-buster` - linux; 386
