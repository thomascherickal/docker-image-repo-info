...
```console
$ docker pull drupal@sha256:a60e20ac7e6bf86bc5b1bff134f544ec2fa3679f2546b645e6d2d4c058492960
```
...
### `drupal:9.3.17-php8.0-fpm-buster` - linux; amd64
...
### `drupal:9.3.17-php8.0-fpm-buster` - linux; arm variant v7
...
### `drupal:9.3.17-php8.0-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.3.17-php8.0-fpm-buster` - linux; 386
...
### `drupal:9.3.17-php8.0-fpm-buster` - linux; ppc64le
...
### `drupal:9.3.17-php8.0-fpm-buster` - linux; s390x
