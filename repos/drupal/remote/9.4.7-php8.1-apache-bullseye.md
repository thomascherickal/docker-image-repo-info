...
```console
$ docker pull drupal@sha256:98cb722f5c02ac1b5ffa2c7ff0658845cd4d361080023eff56c0583692019441
```
...
### `drupal:9.4.7-php8.1-apache-bullseye` - linux; amd64
...
### `drupal:9.4.7-php8.1-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.4.7-php8.1-apache-bullseye` - linux; 386
...
### `drupal:9.4.7-php8.1-apache-bullseye` - linux; ppc64le
...
### `drupal:9.4.7-php8.1-apache-bullseye` - linux; s390x
