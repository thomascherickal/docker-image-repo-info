...
### `drupal:9.5.5-apache-bullseye` - linux; amd64
...
### `drupal:9.5.5-apache-bullseye` - linux; arm variant v7
...
### `drupal:9.5.5-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.5.5-apache-bullseye` - linux; 386
...
### `drupal:9.5.5-apache-bullseye` - linux; ppc64le
...
### `drupal:9.5.5-apache-bullseye` - linux; s390x
