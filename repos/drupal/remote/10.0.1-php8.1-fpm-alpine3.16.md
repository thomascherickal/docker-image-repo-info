...
```console
$ docker pull drupal@sha256:42d8169689fbac2897231db6aadb15b092bab818e2f3c086d73ed97bb738cad5
```
...
### `drupal:10.0.1-php8.1-fpm-alpine3.16` - linux; amd64
...
### `drupal:10.0.1-php8.1-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:10.0.1-php8.1-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:10.0.1-php8.1-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:10.0.1-php8.1-fpm-alpine3.16` - linux; 386
...
### `drupal:10.0.1-php8.1-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:10.0.1-php8.1-fpm-alpine3.16` - linux; s390x
