...
```console
$ docker pull drupal@sha256:05a23e75ce4b9c5ba5d6d06a97b197145f81a5cd0fd5e9e82b39cf7e2da31062
```
...
### `drupal:10.0.0-alpha5-php8.1-apache-buster` - linux; amd64
...
### `drupal:10.0.0-alpha5-php8.1-apache-buster` - linux; arm variant v7
...
### `drupal:10.0.0-alpha5-php8.1-apache-buster` - linux; arm64 variant v8
...
### `drupal:10.0.0-alpha5-php8.1-apache-buster` - linux; 386
...
### `drupal:10.0.0-alpha5-php8.1-apache-buster` - linux; ppc64le
...
### `drupal:10.0.0-alpha5-php8.1-apache-buster` - linux; s390x
