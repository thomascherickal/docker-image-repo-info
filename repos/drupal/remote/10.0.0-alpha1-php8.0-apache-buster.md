...
### `drupal:10.0.0-alpha1-php8.0-apache-buster` - linux; amd64
...
### `drupal:10.0.0-alpha1-php8.0-apache-buster` - linux; arm variant v7
...
### `drupal:10.0.0-alpha1-php8.0-apache-buster` - linux; arm64 variant v8
...
### `drupal:10.0.0-alpha1-php8.0-apache-buster` - linux; 386
...
### `drupal:10.0.0-alpha1-php8.0-apache-buster` - linux; ppc64le
...
### `drupal:10.0.0-alpha1-php8.0-apache-buster` - linux; s390x
