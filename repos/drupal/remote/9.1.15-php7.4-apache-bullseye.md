...
```console
$ docker pull drupal@sha256:e2f93cc2cb08424d5bcbb3178f7bf5074dee446309ebe7cc4c233fa7d9839432
```
...
### `drupal:9.1.15-php7.4-apache-bullseye` - linux; amd64
...
### `drupal:9.1.15-php7.4-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.1.15-php7.4-apache-bullseye` - linux; 386
...
### `drupal:9.1.15-php7.4-apache-bullseye` - linux; ppc64le
...
### `drupal:9.1.15-php7.4-apache-bullseye` - linux; s390x
