...
### `drupal:8.8.1-apache` - linux; amd64
...
### `drupal:8.8.1-apache` - linux; arm variant v5
...
### `drupal:8.8.1-apache` - linux; arm variant v7
...
### `drupal:8.8.1-apache` - linux; arm64 variant v8
...
### `drupal:8.8.1-apache` - linux; ppc64le
