...
```console
$ docker pull drupal@sha256:8b4ed2f99331189b0711d1a9c746dc9fee67cd2713eac2827949bb098bb78fa2
```
...
### `drupal:9.4.12-php8.1-apache-bullseye` - linux; amd64
...
### `drupal:9.4.12-php8.1-apache-bullseye` - linux; arm variant v7
...
### `drupal:9.4.12-php8.1-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.4.12-php8.1-apache-bullseye` - linux; 386
...
### `drupal:9.4.12-php8.1-apache-bullseye` - linux; ppc64le
...
### `drupal:9.4.12-php8.1-apache-bullseye` - linux; s390x
