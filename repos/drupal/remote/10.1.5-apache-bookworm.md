...
### `drupal:10.1.5-apache-bookworm` - linux; amd64
...
### `drupal:10.1.5-apache-bookworm` - linux; arm variant v7
...
### `drupal:10.1.5-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:10.1.5-apache-bookworm` - linux; 386
...
### `drupal:10.1.5-apache-bookworm` - linux; ppc64le
...
### `drupal:10.1.5-apache-bookworm` - linux; s390x
