...
```console
$ docker pull drupal@sha256:a1e42dede95c819c2f144b1e34a1016fb73218cf696b078d6f249548042ccc59
```
...
### `drupal:9.2.17-php7.4` - linux; arm variant v7
...
### `drupal:9.2.17-php7.4` - linux; ppc64le
