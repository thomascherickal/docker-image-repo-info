...
```console
$ docker pull drupal@sha256:abb2e7fb7e0fefabc96e322c0948f0f77d1d27ecf21509f18d8377bbe8babc04
```
...
### `drupal:9.1.10-php8.0-fpm-alpine` - linux; amd64
...
### `drupal:9.1.10-php8.0-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.1.10-php8.0-fpm-alpine` - linux; arm variant v7
...
### `drupal:9.1.10-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.1.10-php8.0-fpm-alpine` - linux; 386
...
### `drupal:9.1.10-php8.0-fpm-alpine` - linux; ppc64le
...
### `drupal:9.1.10-php8.0-fpm-alpine` - linux; s390x
