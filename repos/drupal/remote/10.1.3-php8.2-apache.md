...
### `drupal:10.1.3-php8.2-apache` - linux; arm variant v7
...
### `drupal:10.1.3-php8.2-apache` - linux; arm64 variant v8
...
### `drupal:10.1.3-php8.2-apache` - linux; 386
...
### `drupal:10.1.3-php8.2-apache` - linux; s390x
