...
```console
$ docker pull drupal@sha256:0caaa7bfa100bd78859ee7edb97c245e321c4ef949d91acbfffdd6572710d51b
```
...
### `drupal:10.0.0-alpha4-php8.1-apache-buster` - linux; amd64
...
### `drupal:10.0.0-alpha4-php8.1-apache-buster` - linux; arm variant v7
...
### `drupal:10.0.0-alpha4-php8.1-apache-buster` - linux; arm64 variant v8
...
### `drupal:10.0.0-alpha4-php8.1-apache-buster` - linux; 386
...
### `drupal:10.0.0-alpha4-php8.1-apache-buster` - linux; ppc64le
...
### `drupal:10.0.0-alpha4-php8.1-apache-buster` - linux; s390x
