...
### `drupal:9.5.9-php8.1-fpm-bookworm` - linux; amd64
...
### `drupal:9.5.9-php8.1-fpm-bookworm` - linux; arm variant v7
...
### `drupal:9.5.9-php8.1-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:9.5.9-php8.1-fpm-bookworm` - linux; 386
...
### `drupal:9.5.9-php8.1-fpm-bookworm` - linux; ppc64le
...
### `drupal:9.5.9-php8.1-fpm-bookworm` - linux; s390x
