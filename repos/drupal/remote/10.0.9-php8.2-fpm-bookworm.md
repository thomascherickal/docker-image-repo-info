...
```console
$ docker pull drupal@sha256:0e4ad5cc3281507f351482b7818fa8d169825ebc4c62879cd8d253e1c3357f76
```
...
### `drupal:10.0.9-php8.2-fpm-bookworm` - linux; amd64
...
### `drupal:10.0.9-php8.2-fpm-bookworm` - linux; arm variant v7
...
### `drupal:10.0.9-php8.2-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:10.0.9-php8.2-fpm-bookworm` - linux; 386
...
### `drupal:10.0.9-php8.2-fpm-bookworm` - linux; ppc64le
...
### `drupal:10.0.9-php8.2-fpm-bookworm` - linux; s390x
