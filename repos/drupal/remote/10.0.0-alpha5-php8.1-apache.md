## `drupal:10.0.0-alpha5-php8.1-apache`
...
### `drupal:10.0.0-alpha5-php8.1-apache` - linux; amd64
...
### `drupal:10.0.0-alpha5-php8.1-apache` - linux; arm variant v7
...
### `drupal:10.0.0-alpha5-php8.1-apache` - linux; arm64 variant v8
...
### `drupal:10.0.0-alpha5-php8.1-apache` - linux; 386
...
### `drupal:10.0.0-alpha5-php8.1-apache` - linux; ppc64le
...
### `drupal:10.0.0-alpha5-php8.1-apache` - linux; s390x
