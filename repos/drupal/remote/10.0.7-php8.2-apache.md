...
```console
$ docker pull drupal@sha256:412f03c7c8855920ddfa650107d67cbc624376764477dbab7e96fd00e8a5e63f
```
...
### `drupal:10.0.7-php8.2-apache` - linux; amd64
...
### `drupal:10.0.7-php8.2-apache` - linux; arm variant v7
...
### `drupal:10.0.7-php8.2-apache` - linux; arm64 variant v8
...
### `drupal:10.0.7-php8.2-apache` - linux; 386
...
### `drupal:10.0.7-php8.2-apache` - linux; ppc64le
...
### `drupal:10.0.7-php8.2-apache` - linux; s390x
