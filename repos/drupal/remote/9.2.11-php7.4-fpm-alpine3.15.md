...
```console
$ docker pull drupal@sha256:eebf120f94303a62110fd78637a9fa0021177effa1b04e47963e06cf3c6da465
```
...
### `drupal:9.2.11-php7.4-fpm-alpine3.15` - linux; amd64
...
### `drupal:9.2.11-php7.4-fpm-alpine3.15` - linux; arm variant v6
...
### `drupal:9.2.11-php7.4-fpm-alpine3.15` - linux; arm variant v7
...
### `drupal:9.2.11-php7.4-fpm-alpine3.15` - linux; arm64 variant v8
...
### `drupal:9.2.11-php7.4-fpm-alpine3.15` - linux; 386
...
### `drupal:9.2.11-php7.4-fpm-alpine3.15` - linux; ppc64le
...
### `drupal:9.2.11-php7.4-fpm-alpine3.15` - linux; s390x
