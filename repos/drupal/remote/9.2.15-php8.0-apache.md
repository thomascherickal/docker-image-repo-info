...
### `drupal:9.2.15-php8.0-apache` - linux; amd64
...
### `drupal:9.2.15-php8.0-apache` - linux; arm variant v7
...
### `drupal:9.2.15-php8.0-apache` - linux; 386
...
### `drupal:9.2.15-php8.0-apache` - linux; ppc64le
