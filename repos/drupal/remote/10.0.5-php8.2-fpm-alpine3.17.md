...
### `drupal:10.0.5-php8.2-fpm-alpine3.17` - linux; amd64
...
### `drupal:10.0.5-php8.2-fpm-alpine3.17` - linux; arm variant v7
...
### `drupal:10.0.5-php8.2-fpm-alpine3.17` - linux; arm64 variant v8
...
### `drupal:10.0.5-php8.2-fpm-alpine3.17` - linux; 386
...
### `drupal:10.0.5-php8.2-fpm-alpine3.17` - linux; ppc64le
...
### `drupal:10.0.5-php8.2-fpm-alpine3.17` - linux; s390x
