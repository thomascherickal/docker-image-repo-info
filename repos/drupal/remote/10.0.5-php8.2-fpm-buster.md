...
### `drupal:10.0.5-php8.2-fpm-buster` - linux; amd64
...
### `drupal:10.0.5-php8.2-fpm-buster` - linux; arm variant v7
...
### `drupal:10.0.5-php8.2-fpm-buster` - linux; arm64 variant v8
...
### `drupal:10.0.5-php8.2-fpm-buster` - linux; 386
