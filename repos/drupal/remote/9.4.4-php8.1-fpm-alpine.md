...
```console
$ docker pull drupal@sha256:106b9907fda9e8428ac6ecd8d48f6327dce15abede8f2018465e2fe07bd61de7
```
...
### `drupal:9.4.4-php8.1-fpm-alpine` - linux; amd64
...
### `drupal:9.4.4-php8.1-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.4.4-php8.1-fpm-alpine` - linux; arm variant v7
...
### `drupal:9.4.4-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.4.4-php8.1-fpm-alpine` - linux; 386
...
### `drupal:9.4.4-php8.1-fpm-alpine` - linux; ppc64le
...
### `drupal:9.4.4-php8.1-fpm-alpine` - linux; s390x
