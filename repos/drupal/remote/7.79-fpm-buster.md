## `drupal:7.79-fpm-buster`

```console
$ docker pull drupal@sha256:09102e2c52c686c1d1118bf1f4515ac22d8072809a8ff4af0817d6b16bcacf2e
```
...
### `drupal:7.79-fpm-buster` - linux; amd64
...
### `drupal:7.79-fpm-buster` - linux; arm variant v5
...
### `drupal:7.79-fpm-buster` - linux; arm variant v7
...
### `drupal:7.79-fpm-buster` - linux; arm64 variant v8
...
### `drupal:7.79-fpm-buster` - linux; 386
...
### `drupal:7.79-fpm-buster` - linux; mips64le
...
### `drupal:7.79-fpm-buster` - linux; ppc64le
...
### `drupal:7.79-fpm-buster` - linux; s390x
