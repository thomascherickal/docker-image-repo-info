...
```console
$ docker pull drupal@sha256:a2f314e1f876b53786eb2eccfd15a33532fe939ac054cf2c969201c3f026aa95
```
...
### `drupal:7.83-fpm-buster` - linux; amd64
...
### `drupal:7.83-fpm-buster` - linux; arm variant v5
...
### `drupal:7.83-fpm-buster` - linux; arm64 variant v8
...
### `drupal:7.83-fpm-buster` - linux; ppc64le
