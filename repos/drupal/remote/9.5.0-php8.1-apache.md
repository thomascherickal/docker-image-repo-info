...
### `drupal:9.5.0-php8.1-apache` - linux; amd64
...
### `drupal:9.5.0-php8.1-apache` - linux; arm variant v7
...
### `drupal:9.5.0-php8.1-apache` - linux; arm64 variant v8
...
### `drupal:9.5.0-php8.1-apache` - linux; 386
...
### `drupal:9.5.0-php8.1-apache` - linux; ppc64le
...
### `drupal:9.5.0-php8.1-apache` - linux; s390x
