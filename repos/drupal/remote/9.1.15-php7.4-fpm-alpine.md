...
```console
$ docker pull drupal@sha256:c659c567f6fcff09a0ff5ef40dfd61ea16cfdbb79fec653c1e13b1f3c8525a33
```
...
### `drupal:9.1.15-php7.4-fpm-alpine` - linux; amd64
...
### `drupal:9.1.15-php7.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.1.15-php7.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:9.1.15-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.1.15-php7.4-fpm-alpine` - linux; ppc64le
...
### `drupal:9.1.15-php7.4-fpm-alpine` - linux; s390x
