## `drupal:10.0.0-beta2-php8.1-apache-bullseye`

```console
$ docker pull drupal@sha256:80bab65d133b25a905a17558136515375b275eb7014e5a54ba80ee72cfba8220
```
...
### `drupal:10.0.0-beta2-php8.1-apache-bullseye` - linux; amd64
...
### `drupal:10.0.0-beta2-php8.1-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:10.0.0-beta2-php8.1-apache-bullseye` - linux; 386
...
### `drupal:10.0.0-beta2-php8.1-apache-bullseye` - linux; ppc64le
...
### `drupal:10.0.0-beta2-php8.1-apache-bullseye` - linux; s390x
