## `drupal:7.81-fpm-alpine3.14`

```console
$ docker pull drupal@sha256:07e2a027fa0245919395902a890a0132f804382fe042036f4a26ec2aef862719
```
...
### `drupal:7.81-fpm-alpine3.14` - linux; amd64
...
### `drupal:7.81-fpm-alpine3.14` - linux; arm variant v6
...
### `drupal:7.81-fpm-alpine3.14` - linux; arm variant v7
...
### `drupal:7.81-fpm-alpine3.14` - linux; arm64 variant v8
...
### `drupal:7.81-fpm-alpine3.14` - linux; 386
