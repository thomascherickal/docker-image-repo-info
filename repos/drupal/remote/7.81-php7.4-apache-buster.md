...
```console
$ docker pull drupal@sha256:281140688de05189277ebe8d36d60050ae8e929fd87f04b28f6c5bd76e583aaf
```
...
### `drupal:7.81-php7.4-apache-buster` - linux; amd64
...
### `drupal:7.81-php7.4-apache-buster` - linux; arm variant v5
...
### `drupal:7.81-php7.4-apache-buster` - linux; arm variant v7
...
### `drupal:7.81-php7.4-apache-buster` - linux; arm64 variant v8
...
### `drupal:7.81-php7.4-apache-buster` - linux; 386
...
### `drupal:7.81-php7.4-apache-buster` - linux; mips64le
...
### `drupal:7.81-php7.4-apache-buster` - linux; ppc64le
...
### `drupal:7.81-php7.4-apache-buster` - linux; s390x
