...
### `drupal:7.83-php7.4-apache` - linux; amd64
...
### `drupal:7.83-php7.4-apache` - linux; arm variant v5
...
### `drupal:7.83-php7.4-apache` - linux; arm64 variant v8
...
### `drupal:7.83-php7.4-apache` - linux; 386
...
### `drupal:7.83-php7.4-apache` - linux; ppc64le
...
### `drupal:7.83-php7.4-apache` - linux; s390x
