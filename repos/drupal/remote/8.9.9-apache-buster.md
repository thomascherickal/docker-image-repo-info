...
```console
$ docker pull drupal@sha256:eb94e0d30ccef1f020e30ddda9d8e751e901c0f359ae4b4392341d15eee274f0
```
...
### `drupal:8.9.9-apache-buster` - linux; amd64
...
### `drupal:8.9.9-apache-buster` - linux; arm variant v7
...
### `drupal:8.9.9-apache-buster` - linux; arm64 variant v8
...
### `drupal:8.9.9-apache-buster` - linux; 386
...
### `drupal:8.9.9-apache-buster` - linux; ppc64le
...
### `drupal:8.9.9-apache-buster` - linux; s390x
