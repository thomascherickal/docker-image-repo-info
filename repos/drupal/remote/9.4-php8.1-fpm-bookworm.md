...
```console
$ docker pull drupal@sha256:59f1136f670fc2e1219c50abf1a6059cc590ec78991a7e8645722b265e7ad50e
```
...
### `drupal:9.4-php8.1-fpm-bookworm` - linux; amd64
...
### `drupal:9.4-php8.1-fpm-bookworm` - linux; arm variant v7
...
### `drupal:9.4-php8.1-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:9.4-php8.1-fpm-bookworm` - linux; 386
...
### `drupal:9.4-php8.1-fpm-bookworm` - linux; ppc64le
...
### `drupal:9.4-php8.1-fpm-bookworm` - linux; s390x
