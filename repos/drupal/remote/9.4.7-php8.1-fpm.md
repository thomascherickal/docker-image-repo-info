...
```console
$ docker pull drupal@sha256:1dc4d9e2f992b67b665020a51db652fa86b465a74a175fa3fdf58eaeda81f255
```
...
### `drupal:9.4.7-php8.1-fpm` - linux; amd64
...
### `drupal:9.4.7-php8.1-fpm` - linux; arm64 variant v8
...
### `drupal:9.4.7-php8.1-fpm` - linux; 386
...
### `drupal:9.4.7-php8.1-fpm` - linux; ppc64le
...
### `drupal:9.4.7-php8.1-fpm` - linux; s390x
