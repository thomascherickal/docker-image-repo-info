## `drupal:9.2.18-apache-bullseye`

```console
$ docker pull drupal@sha256:44ac9180abe5c9bb021fb4b730211d6b2618bb89303853d6da30ca91f3756bfb
```
...
### `drupal:9.2.18-apache-bullseye` - linux; amd64
...
### `drupal:9.2.18-apache-bullseye` - linux; arm variant v7
...
### `drupal:9.2.18-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.2.18-apache-bullseye` - linux; 386
...
### `drupal:9.2.18-apache-bullseye` - linux; ppc64le
...
### `drupal:9.2.18-apache-bullseye` - linux; s390x
