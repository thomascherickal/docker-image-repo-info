...
```console
$ docker pull drupal@sha256:b57f8e0fb5c0ad3c7921116283e5a7a59799ccea43515f3aa41c6d65c036fde1
```
...
### `drupal:9.3.15-php8.1-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.3.15-php8.1-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.3.15-php8.1-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:9.3.15-php8.1-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.3.15-php8.1-fpm-alpine3.16` - linux; 386
...
### `drupal:9.3.15-php8.1-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.3.15-php8.1-fpm-alpine3.16` - linux; s390x
