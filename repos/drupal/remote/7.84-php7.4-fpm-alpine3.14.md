...
```console
$ docker pull drupal@sha256:855614c9493190262e43f8f139680c027c80b049c71d952ccb38806306582cd7
```
...
### `drupal:7.84-php7.4-fpm-alpine3.14` - linux; amd64
...
### `drupal:7.84-php7.4-fpm-alpine3.14` - linux; arm variant v6
...
### `drupal:7.84-php7.4-fpm-alpine3.14` - linux; arm variant v7
...
### `drupal:7.84-php7.4-fpm-alpine3.14` - linux; arm64 variant v8
...
### `drupal:7.84-php7.4-fpm-alpine3.14` - linux; 386
...
### `drupal:7.84-php7.4-fpm-alpine3.14` - linux; ppc64le
...
### `drupal:7.84-php7.4-fpm-alpine3.14` - linux; s390x
