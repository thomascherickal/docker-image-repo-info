...
```console
$ docker pull drupal@sha256:522f507307aad42be0d076424bf2e33bb0984a47b7fddd2ff4c52ef8dbf3a2ac
```
...
### `drupal:9.4.13-php8.0-fpm` - linux; amd64
...
### `drupal:9.4.13-php8.0-fpm` - linux; arm variant v7
...
### `drupal:9.4.13-php8.0-fpm` - linux; arm64 variant v8
...
### `drupal:9.4.13-php8.0-fpm` - linux; 386
...
### `drupal:9.4.13-php8.0-fpm` - linux; ppc64le
...
### `drupal:9.4.13-php8.0-fpm` - linux; s390x
