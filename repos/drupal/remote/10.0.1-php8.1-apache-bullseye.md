...
```console
$ docker pull drupal@sha256:c8283604cebdf47cfee8771fb77b67be884a22bf98410ce1334e46522b82ab1d
```
...
### `drupal:10.0.1-php8.1-apache-bullseye` - linux; amd64
...
### `drupal:10.0.1-php8.1-apache-bullseye` - linux; arm variant v7
...
### `drupal:10.0.1-php8.1-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:10.0.1-php8.1-apache-bullseye` - linux; 386
...
### `drupal:10.0.1-php8.1-apache-bullseye` - linux; ppc64le
...
### `drupal:10.0.1-php8.1-apache-bullseye` - linux; s390x
