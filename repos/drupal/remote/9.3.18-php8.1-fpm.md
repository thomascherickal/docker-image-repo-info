...
```console
$ docker pull drupal@sha256:e96a0f57b89b5efb162c4465f8f1c1bf46ec5dded523f291ca5759115e43a843
```
...
### `drupal:9.3.18-php8.1-fpm` - linux; amd64
...
### `drupal:9.3.18-php8.1-fpm` - linux; arm variant v7
...
### `drupal:9.3.18-php8.1-fpm` - linux; arm64 variant v8
...
### `drupal:9.3.18-php8.1-fpm` - linux; 386
...
### `drupal:9.3.18-php8.1-fpm` - linux; ppc64le
...
### `drupal:9.3.18-php8.1-fpm` - linux; s390x
