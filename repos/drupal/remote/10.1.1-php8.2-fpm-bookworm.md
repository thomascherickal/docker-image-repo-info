...
### `drupal:10.1.1-php8.2-fpm-bookworm` - linux; amd64
...
### `drupal:10.1.1-php8.2-fpm-bookworm` - linux; arm variant v7
...
### `drupal:10.1.1-php8.2-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:10.1.1-php8.2-fpm-bookworm` - linux; 386
...
### `drupal:10.1.1-php8.2-fpm-bookworm` - linux; ppc64le
...
### `drupal:10.1.1-php8.2-fpm-bookworm` - linux; s390x
