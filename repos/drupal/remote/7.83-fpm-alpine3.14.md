...
```console
$ docker pull drupal@sha256:86f562368b30d8591b4f5260aa3645666f00f5a9d1b18a4f8deb2770dbe50dd7
```
...
### `drupal:7.83-fpm-alpine3.14` - linux; amd64
...
### `drupal:7.83-fpm-alpine3.14` - linux; arm64 variant v8
...
### `drupal:7.83-fpm-alpine3.14` - linux; 386
...
### `drupal:7.83-fpm-alpine3.14` - linux; ppc64le
...
### `drupal:7.83-fpm-alpine3.14` - linux; s390x
