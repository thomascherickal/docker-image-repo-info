...
```console
$ docker pull drupal@sha256:b7e46bca05a64fce76827607b8efa84548a8befec5908fd3badd6f724728a7f8
```
...
### `drupal:9.4-php8.2-apache` - linux; amd64
...
### `drupal:9.4-php8.2-apache` - linux; arm variant v7
...
### `drupal:9.4-php8.2-apache` - linux; arm64 variant v8
...
### `drupal:9.4-php8.2-apache` - linux; 386
...
### `drupal:9.4-php8.2-apache` - linux; ppc64le
...
### `drupal:9.4-php8.2-apache` - linux; s390x
