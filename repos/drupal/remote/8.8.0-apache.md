...
### `drupal:8.8.0-apache` - linux; amd64
...
### `drupal:8.8.0-apache` - linux; arm variant v7
...
### `drupal:8.8.0-apache` - linux; arm64 variant v8
...
### `drupal:8.8.0-apache` - linux; ppc64le
