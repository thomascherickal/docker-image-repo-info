...
### `drupal:9.2.12-php8.0-fpm` - linux; amd64
...
### `drupal:9.2.12-php8.0-fpm` - linux; arm variant v7
...
### `drupal:9.2.12-php8.0-fpm` - linux; arm64 variant v8
...
### `drupal:9.2.12-php8.0-fpm` - linux; 386
...
### `drupal:9.2.12-php8.0-fpm` - linux; ppc64le
...
### `drupal:9.2.12-php8.0-fpm` - linux; s390x
