...
### `drupal:8.9.8-fpm-alpine` - linux; amd64
...
### `drupal:8.9.8-fpm-alpine` - linux; arm variant v6
...
### `drupal:8.9.8-fpm-alpine` - linux; arm variant v7
...
### `drupal:8.9.8-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:8.9.8-fpm-alpine` - linux; 386
...
### `drupal:8.9.8-fpm-alpine` - linux; ppc64le
...
### `drupal:8.9.8-fpm-alpine` - linux; s390x
