...
### `drupal:7.85-php7.4-fpm-buster` - linux; arm variant v5
...
### `drupal:7.85-php7.4-fpm-buster` - linux; arm variant v7
...
### `drupal:7.85-php7.4-fpm-buster` - linux; arm64 variant v8
...
### `drupal:7.85-php7.4-fpm-buster` - linux; 386
...
### `drupal:7.85-php7.4-fpm-buster` - linux; ppc64le
...
### `drupal:7.85-php7.4-fpm-buster` - linux; s390x
