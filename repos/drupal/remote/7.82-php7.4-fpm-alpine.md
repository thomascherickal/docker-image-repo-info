...
```console
$ docker pull drupal@sha256:d5900eda072bb2a60d5e6afd2741bd4cb7924bec43dac3f40ed3fd1b3795be67
```
...
```console
$ docker pull drupal@sha256:1aefec01436e5eaa814b134741a333c6076e428fb697373504e836c1b999b625
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.8 MB (34800512 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:546200f99956a10618f690a4510e57fa59db5b887dba2379f278f1dbb47ffd92`
...
-	Layers:
	...
	-	`sha256:bb4804b51e59ecf6a6f9de88bd7357af4c9c44958a615dc937f25955d5242b0c`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6cc130642e922475493e3c2b920ede609603f4feba2d063975df82e43c6be98`  
		Last Modified: Thu, 21 Oct 2021 18:43:31 GMT  
...
```console
$ docker pull drupal@sha256:e6b7d6cd200f005b6c26bd36743363067750e023185f294b68bdeae6112c5ac6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.2 MB (34227928 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c68ce02cc6422f259966d0d399ebf4a84e7b1dba60a051d8e1c84dbdf646086a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Oct 2021 17:26:57 GMT
ENV DRUPAL_VERSION=7.82
# Thu, 21 Oct 2021 17:26:57 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Thu, 21 Oct 2021 17:26:59 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:149e97919f01dd1bbb5ad85f8ddd4d1f1968d1a7dba604b84c3123fef89003fd`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5a65ba7730c50f75866c98253cd4bc02c9a39765cf6877691e65645c5fe567b`  
		Last Modified: Thu, 21 Oct 2021 17:47:13 GMT  
		Size: 3.4 MB (3373677 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
