...
### `drupal:10.0.7-apache-bullseye` - linux; amd64
...
### `drupal:10.0.7-apache-bullseye` - linux; arm variant v7
...
### `drupal:10.0.7-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:10.0.7-apache-bullseye` - linux; 386
...
### `drupal:10.0.7-apache-bullseye` - linux; ppc64le
...
### `drupal:10.0.7-apache-bullseye` - linux; s390x
