...
### `drupal:7.80-php7.4-fpm` - linux; amd64
...
### `drupal:7.80-php7.4-fpm` - linux; arm variant v5
...
### `drupal:7.80-php7.4-fpm` - linux; arm variant v7
...
### `drupal:7.80-php7.4-fpm` - linux; arm64 variant v8
...
### `drupal:7.80-php7.4-fpm` - linux; 386
...
### `drupal:7.80-php7.4-fpm` - linux; mips64le
...
### `drupal:7.80-php7.4-fpm` - linux; ppc64le
...
### `drupal:7.80-php7.4-fpm` - linux; s390x
