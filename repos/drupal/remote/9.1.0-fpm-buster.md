...
```console
$ docker pull drupal@sha256:27035f34a754f7bac23878d32ead867d6f3c41fb100f0b83f7150fd1269d7c74
```
...
### `drupal:9.1.0-fpm-buster` - linux; amd64
...
### `drupal:9.1.0-fpm-buster` - linux; arm variant v7
...
### `drupal:9.1.0-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.1.0-fpm-buster` - linux; 386
...
### `drupal:9.1.0-fpm-buster` - linux; ppc64le
...
### `drupal:9.1.0-fpm-buster` - linux; s390x
