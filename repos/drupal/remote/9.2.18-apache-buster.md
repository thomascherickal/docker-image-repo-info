...
### `drupal:9.2.18-apache-buster` - linux; amd64
...
### `drupal:9.2.18-apache-buster` - linux; arm variant v7
...
### `drupal:9.2.18-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.2.18-apache-buster` - linux; 386
...
### `drupal:9.2.18-apache-buster` - linux; ppc64le
...
### `drupal:9.2.18-apache-buster` - linux; s390x
