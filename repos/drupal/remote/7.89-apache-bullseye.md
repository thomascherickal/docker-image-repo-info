...
### `drupal:7.89-apache-bullseye` - linux; amd64
...
### `drupal:7.89-apache-bullseye` - linux; arm variant v5
...
### `drupal:7.89-apache-bullseye` - linux; arm variant v7
...
### `drupal:7.89-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:7.89-apache-bullseye` - linux; 386
...
### `drupal:7.89-apache-bullseye` - linux; mips64le
...
### `drupal:7.89-apache-bullseye` - linux; ppc64le
...
### `drupal:7.89-apache-bullseye` - linux; s390x
