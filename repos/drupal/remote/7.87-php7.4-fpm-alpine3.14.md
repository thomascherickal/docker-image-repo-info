...
### `drupal:7.87-php7.4-fpm-alpine3.14` - linux; amd64
...
### `drupal:7.87-php7.4-fpm-alpine3.14` - linux; arm variant v6
...
### `drupal:7.87-php7.4-fpm-alpine3.14` - linux; arm variant v7
...
### `drupal:7.87-php7.4-fpm-alpine3.14` - linux; 386
...
### `drupal:7.87-php7.4-fpm-alpine3.14` - linux; ppc64le
