...
```console
$ docker pull drupal@sha256:86a9895100d902838d9b5d2c0cae330f849c7a4aac81795ec4915378ecea6481
```
...
### `drupal:9.3.11-fpm-bullseye` - linux; amd64
...
### `drupal:9.3.11-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:9.3.11-fpm-bullseye` - linux; 386
...
### `drupal:9.3.11-fpm-bullseye` - linux; s390x
