...
### `drupal:10.1.3-fpm-bookworm` - linux; arm variant v7
...
### `drupal:10.1.3-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:10.1.3-fpm-bookworm` - linux; 386
...
### `drupal:10.1.3-fpm-bookworm` - linux; s390x
