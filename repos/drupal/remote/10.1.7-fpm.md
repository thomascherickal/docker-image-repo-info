...
```console
$ docker pull drupal@sha256:01a1dec0adf64fffe031e6c2788addf95455bd78d81384a91f4b9957e7485549
```
...
### `drupal:10.1.7-fpm` - unknown; unknown
...
### `drupal:10.1.7-fpm` - linux; arm variant v7
...
### `drupal:10.1.7-fpm` - linux; arm64 variant v8
...
### `drupal:10.1.7-fpm` - linux; ppc64le
