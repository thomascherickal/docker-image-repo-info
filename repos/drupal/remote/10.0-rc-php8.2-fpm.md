...
```console
$ docker pull drupal@sha256:700028b835176e90001c2afbb35433ee1b0818f3b671d21406563b5e54268294
```
...
### `drupal:10.0-rc-php8.2-fpm` - linux; amd64
...
### `drupal:10.0-rc-php8.2-fpm` - linux; arm variant v7
...
### `drupal:10.0-rc-php8.2-fpm` - linux; arm64 variant v8
...
### `drupal:10.0-rc-php8.2-fpm` - linux; 386
...
### `drupal:10.0-rc-php8.2-fpm` - linux; ppc64le
...
### `drupal:10.0-rc-php8.2-fpm` - linux; s390x
