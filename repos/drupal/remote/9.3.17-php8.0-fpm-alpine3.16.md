...
### `drupal:9.3.17-php8.0-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.3.17-php8.0-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.3.17-php8.0-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.3.17-php8.0-fpm-alpine3.16` - linux; 386
...
### `drupal:9.3.17-php8.0-fpm-alpine3.16` - linux; s390x
