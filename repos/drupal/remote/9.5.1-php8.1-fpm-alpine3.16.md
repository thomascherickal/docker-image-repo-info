...
```console
$ docker pull drupal@sha256:b7e12bd8f48f0088324b37c2f60747d81a62188896b5b3f82cb2d494899429b9
```
...
### `drupal:9.5.1-php8.1-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.5.1-php8.1-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.5.1-php8.1-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:9.5.1-php8.1-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.5.1-php8.1-fpm-alpine3.16` - linux; 386
...
### `drupal:9.5.1-php8.1-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.5.1-php8.1-fpm-alpine3.16` - linux; s390x
