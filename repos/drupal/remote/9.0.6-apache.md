...
```console
$ docker pull drupal@sha256:71a09d4e281a999b94b5969b2613fd1232cbb5a640a0e1781236733b86390d58
```
...
### `drupal:9.0.6-apache` - linux; amd64
...
### `drupal:9.0.6-apache` - linux; arm variant v7
...
### `drupal:9.0.6-apache` - linux; arm64 variant v8
...
### `drupal:9.0.6-apache` - linux; ppc64le
...
### `drupal:9.0.6-apache` - linux; s390x
