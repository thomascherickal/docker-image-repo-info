...
```console
$ docker pull drupal@sha256:a1d20f81933e2f40aa7daf75a832b15d025e9aec3cdccff5c2def47c492841d9
```
...
### `drupal:9.2.3-php8.0-fpm-alpine3.14` - linux; amd64
...
### `drupal:9.2.3-php8.0-fpm-alpine3.14` - linux; arm variant v6
...
### `drupal:9.2.3-php8.0-fpm-alpine3.14` - linux; arm64 variant v8
...
### `drupal:9.2.3-php8.0-fpm-alpine3.14` - linux; 386
