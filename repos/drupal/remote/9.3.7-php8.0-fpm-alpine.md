...
### `drupal:9.3.7-php8.0-fpm-alpine` - linux; amd64
...
### `drupal:9.3.7-php8.0-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.3.7-php8.0-fpm-alpine` - linux; arm variant v7
...
### `drupal:9.3.7-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.3.7-php8.0-fpm-alpine` - linux; 386
...
### `drupal:9.3.7-php8.0-fpm-alpine` - linux; ppc64le
...
### `drupal:9.3.7-php8.0-fpm-alpine` - linux; s390x
