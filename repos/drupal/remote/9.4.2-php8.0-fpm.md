...
```console
$ docker pull drupal@sha256:57ef6d63db6afecac02c4d9e128ac86d1cfa1630dfca53fb7b3d1b3e981c9324
```
...
### `drupal:9.4.2-php8.0-fpm` - linux; arm variant v7
...
### `drupal:9.4.2-php8.0-fpm` - linux; ppc64le
