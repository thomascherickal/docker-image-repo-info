...
```console
$ docker pull drupal@sha256:7554c17ce0b1eca99b1c7e82018e9724c0760a0f90f71fb7ebfd2052ac47057b
```
...
### `drupal:9.1.12-php8.0-fpm-alpine` - linux; amd64
...
### `drupal:9.1.12-php8.0-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.1.12-php8.0-fpm-alpine` - linux; arm variant v7
...
### `drupal:9.1.12-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.1.12-php8.0-fpm-alpine` - linux; 386
...
### `drupal:9.1.12-php8.0-fpm-alpine` - linux; ppc64le
...
### `drupal:9.1.12-php8.0-fpm-alpine` - linux; s390x
