...
```console
$ docker pull drupal@sha256:6894afbff59c9e860b6815cc17ca7417e49279906664b57108a96b6896939380
```
...
### `drupal:9.1.15-apache-buster` - linux; amd64
...
### `drupal:9.1.15-apache-buster` - linux; arm variant v7
...
### `drupal:9.1.15-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.1.15-apache-buster` - linux; 386
...
### `drupal:9.1.15-apache-buster` - linux; ppc64le
...
### `drupal:9.1.15-apache-buster` - linux; s390x
