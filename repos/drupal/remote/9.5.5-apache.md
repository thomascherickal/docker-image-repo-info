...
### `drupal:9.5.5-apache` - linux; amd64
...
### `drupal:9.5.5-apache` - linux; arm variant v7
...
### `drupal:9.5.5-apache` - linux; arm64 variant v8
...
### `drupal:9.5.5-apache` - linux; ppc64le
...
### `drupal:9.5.5-apache` - linux; s390x
