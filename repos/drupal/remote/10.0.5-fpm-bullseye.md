...
### `drupal:10.0.5-fpm-bullseye` - linux; amd64
...
### `drupal:10.0.5-fpm-bullseye` - linux; arm variant v7
...
### `drupal:10.0.5-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:10.0.5-fpm-bullseye` - linux; 386
...
### `drupal:10.0.5-fpm-bullseye` - linux; ppc64le
...
### `drupal:10.0.5-fpm-bullseye` - linux; s390x
