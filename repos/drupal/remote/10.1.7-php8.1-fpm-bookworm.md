...
```console
$ docker pull drupal@sha256:e5b24446cd7ab2249b763e173c8e37a855f07a15999dfe64dc0eb4d23614fcfd
```
...
### `drupal:10.1.7-php8.1-fpm-bookworm` - linux; amd64
...
### `drupal:10.1.7-php8.1-fpm-bookworm` - unknown; unknown
...
### `drupal:10.1.7-php8.1-fpm-bookworm` - linux; arm variant v7
...
### `drupal:10.1.7-php8.1-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:10.1.7-php8.1-fpm-bookworm` - linux; ppc64le
...
### `drupal:10.1.7-php8.1-fpm-bookworm` - linux; s390x
