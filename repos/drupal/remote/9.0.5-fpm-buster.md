...
### `drupal:9.0.5-fpm-buster` - linux; amd64
...
### `drupal:9.0.5-fpm-buster` - linux; arm variant v7
...
### `drupal:9.0.5-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.0.5-fpm-buster` - linux; 386
...
### `drupal:9.0.5-fpm-buster` - linux; ppc64le
...
### `drupal:9.0.5-fpm-buster` - linux; s390x
