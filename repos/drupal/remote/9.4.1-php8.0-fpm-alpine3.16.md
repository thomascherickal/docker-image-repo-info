...
```console
$ docker pull drupal@sha256:9dc567eff7db1e1b37de0ed011545d5b3c62ac80746345dd0c41e2d12d5d00e4
```
...
### `drupal:9.4.1-php8.0-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.4.1-php8.0-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.4.1-php8.0-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.4.1-php8.0-fpm-alpine3.16` - linux; 386
...
### `drupal:9.4.1-php8.0-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.4.1-php8.0-fpm-alpine3.16` - linux; s390x
