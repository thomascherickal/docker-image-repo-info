...
### `drupal:8.8.8-apache-buster` - linux; amd64
...
### `drupal:8.8.8-apache-buster` - linux; arm variant v7
...
### `drupal:8.8.8-apache-buster` - linux; arm64 variant v8
...
### `drupal:8.8.8-apache-buster` - linux; 386
...
### `drupal:8.8.8-apache-buster` - linux; ppc64le
...
### `drupal:8.8.8-apache-buster` - linux; s390x
