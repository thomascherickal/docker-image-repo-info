...
```console
$ docker pull drupal@sha256:2f0de6c4bde4560a09a0aaf629cbefdce34c53f5842b87ab4d8055e950fe8354
```
...
### `drupal:9.4.8-php8.0-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.4.8-php8.0-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.4.8-php8.0-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:9.4.8-php8.0-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.4.8-php8.0-fpm-alpine3.16` - linux; 386
...
### `drupal:9.4.8-php8.0-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.4.8-php8.0-fpm-alpine3.16` - linux; s390x
