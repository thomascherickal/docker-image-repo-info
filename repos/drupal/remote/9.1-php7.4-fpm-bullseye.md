...
```console
$ docker pull drupal@sha256:65d9d1f1b6d395df0ba3428550b5defd613699eea79bf21a3cb008475a528c43
```
...
### `drupal:9.1-php7.4-fpm-bullseye` - linux; amd64

```console
$ docker pull drupal@sha256:ca8482373801fdc761f21548c7c422e1c91135b1718add9270aa2b04fc6c3d3f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.0 MB (183967562 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:391aa21a7534ca3a519fe9e31e6ecdfd8facb212544d40cfe96cd47ac5e34555`
...
# Fri, 03 Dec 2021 17:53:44 GMT
ENV DRUPAL_VERSION=9.1.15
# Fri, 03 Dec 2021 17:53:44 GMT
WORKDIR /opt/drupal
# Fri, 03 Dec 2021 17:53:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 03 Dec 2021 17:53:55 GMT
...
-	Layers:
	...
	-	`sha256:069c3ee71ec786d04d83618eca1d2ae51eddabf7fb85146c0cb5bdfe1561c210`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:593dba9375d9c96238e1bf5bdd2387c1abfb940e2323d213af5e144561d9d27b`  
		Last Modified: Fri, 03 Dec 2021 18:09:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10527761d05bfce414042d88d424a30dec96e639f91b56234f7de41bc72bfdc1`  
		Last Modified: Fri, 03 Dec 2021 18:09:25 GMT  
		Size: 18.9 MB (18880153 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-php7.4-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:9.1-php7.4-fpm-bullseye` - linux; 386
...
### `drupal:9.1-php7.4-fpm-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:cfcc2d540cbf9970d8fe2422d05d154019d6b5de1d647f5505dc5e2f56bda626
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.8 MB (184772676 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:54fa5162bbcce9385f282d6bc4c5a8f302c2abccaa6877aa79820237598ed8aa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Fri, 03 Dec 2021 16:42:30 GMT
ENV DRUPAL_VERSION=9.1.15
# Fri, 03 Dec 2021 16:42:32 GMT
WORKDIR /opt/drupal
# Fri, 03 Dec 2021 16:42:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:f746a2c5633376884d5612cb5b9ccbd53a45c1737187ca919afb7e6fb69d6ccc`  
		...
		Size: 564.7 KB (564657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:073d53b60f570ecd97c3aba3a01cf37f12d65fb381cd0a2bdd196f9852c6ff9c`  
		Last Modified: Fri, 03 Dec 2021 17:27:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59ce5db9117a19f555a45bd1143032dc8f98f1fe3d58ddf7b15de3a394945fc5`  
		Last Modified: Fri, 03 Dec 2021 17:29:41 GMT  
		Size: 18.9 MB (18879965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-php7.4-fpm-bullseye` - linux; s390x
