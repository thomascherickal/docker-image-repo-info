...
```console
$ docker pull drupal@sha256:3f26c91ec877698287c0ce86a0bef4a798baa1e42a0f8cfe1ab73c380f8de8e2
```
...
### `drupal:9.1-php8.0` - linux; arm variant v7
...
### `drupal:9.1-php8.0` - linux; arm64 variant v8
...
### `drupal:9.1-php8.0` - linux; ppc64le
