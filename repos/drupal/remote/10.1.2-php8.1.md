...
```console
$ docker pull drupal@sha256:4971d737d6fa82ec6881544d0434b4d3e81ed73a24843e177c300b5034040da6
```
...
### `drupal:10.1.2-php8.1` - linux; amd64
...
### `drupal:10.1.2-php8.1` - linux; arm variant v7
...
### `drupal:10.1.2-php8.1` - linux; arm64 variant v8
...
### `drupal:10.1.2-php8.1` - linux; s390x
