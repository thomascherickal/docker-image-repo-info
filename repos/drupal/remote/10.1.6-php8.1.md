...
### `drupal:10.1.6-php8.1` - linux; amd64
...
### `drupal:10.1.6-php8.1` - unknown; unknown
...
### `drupal:10.1.6-php8.1` - linux; arm variant v7
...
### `drupal:10.1.6-php8.1` - linux; arm64 variant v8
...
### `drupal:10.1.6-php8.1` - linux; 386
...
### `drupal:10.1.6-php8.1` - linux; ppc64le
...
### `drupal:10.1.6-php8.1` - linux; s390x
