...
```console
$ docker pull drupal@sha256:f598d4432f17e288b4381eb1a9438297e482840f730a32047d9ab7da27045b04
```
...
### `drupal:7.83-php7.4-fpm-alpine3.15` - linux; amd64
...
### `drupal:7.83-php7.4-fpm-alpine3.15` - linux; arm variant v6
...
### `drupal:7.83-php7.4-fpm-alpine3.15` - linux; arm64 variant v8
...
### `drupal:7.83-php7.4-fpm-alpine3.15` - linux; 386
...
### `drupal:7.83-php7.4-fpm-alpine3.15` - linux; ppc64le
...
### `drupal:7.83-php7.4-fpm-alpine3.15` - linux; s390x
