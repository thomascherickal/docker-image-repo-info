...
```console
$ docker pull drupal@sha256:8c6298c90f6494096c6559af6ee60c5664517f52a30bc4aa811695bb27bca154
```
...
### `drupal:7.83-php7.4` - linux; amd64
...
### `drupal:7.83-php7.4` - linux; arm variant v5
...
### `drupal:7.83-php7.4` - linux; arm64 variant v8
...
### `drupal:7.83-php7.4` - linux; ppc64le
...
### `drupal:7.83-php7.4` - linux; s390x
