## `drupal:9.3.13-php7.4-fpm-alpine`

```console
$ docker pull drupal@sha256:010bc186bd9e36ef1c9297993d2a7e8457808178cfaa8461bd7e4233b800b49e
```
...
### `drupal:9.3.13-php7.4-fpm-alpine` - linux; amd64
...
### `drupal:9.3.13-php7.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.3.13-php7.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:9.3.13-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.3.13-php7.4-fpm-alpine` - linux; 386
...
### `drupal:9.3.13-php7.4-fpm-alpine` - linux; s390x
