...
### `drupal:8.9.8-apache` - linux; amd64
...
### `drupal:8.9.8-apache` - linux; arm variant v7
...
### `drupal:8.9.8-apache` - linux; arm64 variant v8
...
### `drupal:8.9.8-apache` - linux; ppc64le
...
### `drupal:8.9.8-apache` - linux; s390x
