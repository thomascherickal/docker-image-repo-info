...
### `drupal:9.3.12-php7.4-apache-bullseye` - linux; arm variant v7
...
### `drupal:9.3.12-php7.4-apache-bullseye` - linux; 386
...
### `drupal:9.3.12-php7.4-apache-bullseye` - linux; ppc64le
...
### `drupal:9.3.12-php7.4-apache-bullseye` - linux; s390x
