## `drupal:9.2.19-php7.4-fpm-alpine`

```console
$ docker pull drupal@sha256:cb276f7fffacf42a550c96fdd3b32ea9b287bc0d438e066ccf435668e2008653
```
...
### `drupal:9.2.19-php7.4-fpm-alpine` - linux; amd64
...
### `drupal:9.2.19-php7.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.2.19-php7.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:9.2.19-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.2.19-php7.4-fpm-alpine` - linux; 386
...
### `drupal:9.2.19-php7.4-fpm-alpine` - linux; s390x
