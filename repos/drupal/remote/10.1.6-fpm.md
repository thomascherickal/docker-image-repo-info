...
### `drupal:10.1.6-fpm` - unknown; unknown
...
### `drupal:10.1.6-fpm` - linux; arm variant v7
...
### `drupal:10.1.6-fpm` - linux; arm64 variant v8
...
### `drupal:10.1.6-fpm` - linux; ppc64le
