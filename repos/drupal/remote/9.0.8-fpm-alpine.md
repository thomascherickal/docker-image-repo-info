...
```console
$ docker pull drupal@sha256:9c12e10d908744fc8e2b7fc333ebfe6799f7d3acad17e7df2fd5558e5c3154fe
```
...
### `drupal:9.0.8-fpm-alpine` - linux; amd64
...
### `drupal:9.0.8-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.0.8-fpm-alpine` - linux; arm variant v7
...
### `drupal:9.0.8-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.0.8-fpm-alpine` - linux; 386
...
### `drupal:9.0.8-fpm-alpine` - linux; ppc64le
...
### `drupal:9.0.8-fpm-alpine` - linux; s390x
