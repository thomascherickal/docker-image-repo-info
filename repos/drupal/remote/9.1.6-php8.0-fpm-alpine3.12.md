...
```console
$ docker pull drupal@sha256:16b19e1654c433a4bccf4f8d63dbff14df346e05a686546d686a0f238c370492
```
...
### `drupal:9.1.6-php8.0-fpm-alpine3.12` - linux; amd64
...
### `drupal:9.1.6-php8.0-fpm-alpine3.12` - linux; arm variant v6
...
### `drupal:9.1.6-php8.0-fpm-alpine3.12` - linux; arm variant v7
...
### `drupal:9.1.6-php8.0-fpm-alpine3.12` - linux; arm64 variant v8
...
### `drupal:9.1.6-php8.0-fpm-alpine3.12` - linux; 386
