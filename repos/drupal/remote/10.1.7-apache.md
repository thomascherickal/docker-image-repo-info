...
### `drupal:10.1.7-apache` - linux; amd64
...
### `drupal:10.1.7-apache` - unknown; unknown
...
### `drupal:10.1.7-apache` - linux; arm variant v7
...
### `drupal:10.1.7-apache` - linux; arm64 variant v8
...
### `drupal:10.1.7-apache` - linux; 386
...
### `drupal:10.1.7-apache` - linux; ppc64le
...
### `drupal:10.1.7-apache` - linux; s390x
