...
### `drupal:9.2.1-fpm-alpine` - linux; amd64
...
### `drupal:9.2.1-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.2.1-fpm-alpine` - linux; arm variant v7
...
### `drupal:9.2.1-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.2.1-fpm-alpine` - linux; 386
