## `drupal:9.2.13-php7.4-fpm`

```console
$ docker pull drupal@sha256:37b129339af560caff1854e9703c9061525492ce8b2f6fdc9c4f50dec8076542
```
...
### `drupal:9.2.13-php7.4-fpm` - linux; amd64

```console
$ docker pull drupal@sha256:487f928165f3ea82d58ffa703bb5aab8478fcf46227e5db3296a72865c3fe4af
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.7 MB (180718543 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a854cdd8a83c9a47d9c697086a61e6641277b7f6b69766853d70edde5f7d6c40`
...
# Fri, 11 Mar 2022 12:22:11 GMT
ENV DRUPAL_VERSION=9.2.13
# Fri, 11 Mar 2022 12:22:11 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 12:22:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 12:22:21 GMT
...
-	Layers:
	...
	-	`sha256:fb2db694cb88f564825435597ed7c34e6a064d66a56b0354f79d2e746fb4eaa7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16e3ccae6f782d48a035a9fcd37f7e27acddce85363baf288fd82ffd8622e220`  
		Last Modified: Fri, 11 Mar 2022 12:41:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:106a01496b58fb8f3e7d015f8e0109cfba70fd2c102aab8638625c59c957ebcc`  
		Last Modified: Fri, 11 Mar 2022 12:41:36 GMT  
		Size: 19.1 MB (19110018 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.13-php7.4-fpm` - linux; arm variant v7
...
### `drupal:9.2.13-php7.4-fpm` - linux; arm64 variant v8
...
### `drupal:9.2.13-php7.4-fpm` - linux; 386
...
### `drupal:9.2.13-php7.4-fpm` - linux; ppc64le

```console
$ docker pull drupal@sha256:31941a9971bb0d7270c12952ec4c4cf35b336c2c350b926110f6813e83b62f63
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.2 MB (181200753 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e07f21349a6541ac39c082736bd60b499385b8ca8f6f4a646463d80b13ba2f9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 12:18:23 GMT
ENV DRUPAL_VERSION=9.2.13
# Fri, 11 Mar 2022 12:18:27 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 12:19:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 12:19:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:47eca57c574138b266731911d4dba40c73ad699b8c5cd1e5a95e65b67680876c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46026f186a8be78e60cfa87a495e8e928f8398c7d651006812ee75a1617fe3f2`  
		Last Modified: Fri, 11 Mar 2022 13:51:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d964de39204d72f66c355b33260a71f54113792d2b2f2eef4622d05518c89a2f`  
		Last Modified: Fri, 11 Mar 2022 13:53:24 GMT  
		Size: 19.1 MB (19109929 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.13-php7.4-fpm` - linux; s390x
