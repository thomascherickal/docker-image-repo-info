...
```console
$ docker pull drupal@sha256:5d26aa8332d6c753483a9345de139bfd85bc7d05f7a26297e3347c244cfff04a
```
...
### `drupal:9.1.15-php8.0-fpm-alpine` - linux; amd64
...
### `drupal:9.1.15-php8.0-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.1.15-php8.0-fpm-alpine` - linux; arm variant v7
...
### `drupal:9.1.15-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.1.15-php8.0-fpm-alpine` - linux; ppc64le
...
### `drupal:9.1.15-php8.0-fpm-alpine` - linux; s390x
