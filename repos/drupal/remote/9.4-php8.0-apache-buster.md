...
```console
$ docker pull drupal@sha256:a57d55a3f48cddfd3f866b926106af8481d4e62fa905d3322219bd9c6ee93252
```
...
### `drupal:9.4-php8.0-apache-buster` - linux; ppc64le
...
### `drupal:9.4-php8.0-apache-buster` - linux; s390x
