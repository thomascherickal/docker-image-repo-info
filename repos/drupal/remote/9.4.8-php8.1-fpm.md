...
```console
$ docker pull drupal@sha256:a713b691dbc47aa075f24a7019f5af03e0f26623915f8f1bc6a1fc6c4912a070
```
...
### `drupal:9.4.8-php8.1-fpm` - linux; amd64
...
### `drupal:9.4.8-php8.1-fpm` - linux; arm variant v7
...
### `drupal:9.4.8-php8.1-fpm` - linux; arm64 variant v8
...
### `drupal:9.4.8-php8.1-fpm` - linux; 386
...
### `drupal:9.4.8-php8.1-fpm` - linux; ppc64le
...
### `drupal:9.4.8-php8.1-fpm` - linux; s390x
