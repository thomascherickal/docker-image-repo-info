...
```console
$ docker pull drupal@sha256:b2f41b8e10ff677f295d8b1e3bb1b0a9947c9b9317c4e20f7a15083222ddb929
```
...
### `drupal:9.3.6-fpm-alpine3.15` - linux; amd64
...
### `drupal:9.3.6-fpm-alpine3.15` - linux; arm variant v6
...
### `drupal:9.3.6-fpm-alpine3.15` - linux; arm variant v7
...
### `drupal:9.3.6-fpm-alpine3.15` - linux; arm64 variant v8
...
### `drupal:9.3.6-fpm-alpine3.15` - linux; 386
...
### `drupal:9.3.6-fpm-alpine3.15` - linux; ppc64le
...
### `drupal:9.3.6-fpm-alpine3.15` - linux; s390x
