...
### `drupal:10.0.0-beta2-fpm` - linux; amd64
...
### `drupal:10.0.0-beta2-fpm` - linux; arm variant v7
...
### `drupal:10.0.0-beta2-fpm` - linux; arm64 variant v8
...
### `drupal:10.0.0-beta2-fpm` - linux; 386
...
### `drupal:10.0.0-beta2-fpm` - linux; ppc64le
...
### `drupal:10.0.0-beta2-fpm` - linux; s390x
