...
```console
$ docker pull drupal@sha256:4c6137be9a8f7d0961a491defbadc256229f3ece96259d9a00071c4efd56a0c7
```
...
### `drupal:7.83-php7.4-apache-buster` - linux; amd64
...
### `drupal:7.83-php7.4-apache-buster` - linux; arm variant v5
...
### `drupal:7.83-php7.4-apache-buster` - linux; arm64 variant v8
...
### `drupal:7.83-php7.4-apache-buster` - linux; ppc64le
