...
```console
$ docker pull drupal@sha256:8bfde819f08ca112b9e005be0721c11ca1e9fea02f210d14a128509146393a7f
```
...
### `drupal:9.1.15-php7.4-apache` - linux; amd64
...
### `drupal:9.1.15-php7.4-apache` - linux; arm variant v7
...
### `drupal:9.1.15-php7.4-apache` - linux; arm64 variant v8
...
### `drupal:9.1.15-php7.4-apache` - linux; 386
...
### `drupal:9.1.15-php7.4-apache` - linux; ppc64le
...
### `drupal:9.1.15-php7.4-apache` - linux; s390x
