...
### `drupal:7.90-apache-buster` - linux; arm variant v7
...
### `drupal:7.90-apache-buster` - linux; arm64 variant v8
...
### `drupal:7.90-apache-buster` - linux; ppc64le
...
### `drupal:7.90-apache-buster` - linux; s390x
