...
```console
$ docker pull drupal@sha256:40b0e18eafb4a6703706b9f796dfe8fdf872c665dc9659dd4c0fa97d4c89a43e
```
...
### `drupal:9.3.14-php8.0-fpm` - linux; amd64
...
### `drupal:9.3.14-php8.0-fpm` - linux; 386
