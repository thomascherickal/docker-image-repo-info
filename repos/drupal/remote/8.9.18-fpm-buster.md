...
```console
$ docker pull drupal@sha256:2f9cb048f49b1a9e23d48ea6391d2ded9e1adef58fe5434c3adde90ad991445a
```
...
### `drupal:8.9.18-fpm-buster` - linux; amd64
...
### `drupal:8.9.18-fpm-buster` - linux; 386
...
### `drupal:8.9.18-fpm-buster` - linux; ppc64le
...
### `drupal:8.9.18-fpm-buster` - linux; s390x
