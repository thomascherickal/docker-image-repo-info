...
```console
$ docker pull drupal@sha256:d1eae6d8b1b197131fad2c6ff884fe5cb1611ca15ca82e247776767299176d51
```
...
```console
$ docker pull drupal@sha256:c32626399e4c8d7d3993b230fd583e4e1c5a9c3775742518f11fdabc0d9b5277
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.5 MB (154539992 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bdcac4924d11fea11e57469e13fe9431e03b2f964c22f1316e829c5f8145de07`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Mon, 02 Nov 2020 23:01:43 GMT
ENV DRUPAL_VERSION=9.0.7
# Mon, 02 Nov 2020 23:01:44 GMT
WORKDIR /opt/drupal
# Mon, 02 Nov 2020 23:02:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 02 Nov 2020 23:02:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:24dc62e7fbedfcce97ae637cdc1686b733f442e1a992f761c8634afb979e81cc`  
		...
		Size: 508.3 KB (508287 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e6c4e87bacbaac1d0ed6df947dc7ac7a59b2f9da005352a4d1a2c8ed95e3425`  
		Last Modified: Mon, 02 Nov 2020 23:09:38 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:018a92ed4cac86b9ce5737b61b97bfeaa68e297bf8f5d741d650703ac881ad20`  
		Last Modified: Mon, 02 Nov 2020 23:09:46 GMT  
		Size: 17.2 MB (17227789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:bbada663083baf505773ce5b7c0fcf8049b1702dfe637d38e3dce550866e9261
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.3 MB (173293777 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d5cc1b0f22de4aa3aa843633d11b41d241e2a8c723f6fda394f42848f03e4ad5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Mon, 02 Nov 2020 23:42:21 GMT
ENV DRUPAL_VERSION=9.0.7
# Mon, 02 Nov 2020 23:42:24 GMT
WORKDIR /opt/drupal
# Mon, 02 Nov 2020 23:43:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 02 Nov 2020 23:43:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:29f63d4ba3bd17b17beb7776ba30644fd8c405e6efc856519c09ae3b1fc4fbee`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de4a9321b697f4e75962298b380fcaf0fe19cd388fc85204a6133de7a136d257`  
		Last Modified: Mon, 02 Nov 2020 23:56:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d31ecd00ba4226f0f5274c238d9adf83c61fb6455914c199ff30d6453d5eb5cd`  
		Last Modified: Mon, 02 Nov 2020 23:57:18 GMT  
		Size: 17.2 MB (17227594 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:62cdc6702bbce75f8dc71309e34a21d83e409cfdfc5659d30b9e7c7dcac4d2f2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.1 MB (148129805 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ae663fef1988c2c790f61ba95fe492c3af23db559b9d42b9bc0016200b91c8d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Mon, 02 Nov 2020 22:58:34 GMT
ENV DRUPAL_VERSION=9.0.7
# Mon, 02 Nov 2020 22:58:34 GMT
WORKDIR /opt/drupal
# Mon, 02 Nov 2020 22:59:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 02 Nov 2020 22:59:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:17811caae21539e89c53d4514dcb5b77b147b9a83c184ff022f19521253f6396`  
		...
		Size: 508.3 KB (508282 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7121b1c29ca3e8f8b2a7e9f8ae5507902a7c9ccb21a178f665a2469863d88a8c`  
		Last Modified: Mon, 02 Nov 2020 23:05:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e2d9a63e178ade591ce670acebaf5898e83c5f3f7d220c9757abe2cb55a2ffa`  
		Last Modified: Mon, 02 Nov 2020 23:05:39 GMT  
		Size: 17.2 MB (17227955 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
