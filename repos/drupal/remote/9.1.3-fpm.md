...
```console
$ docker pull drupal@sha256:20ecd0b82a1cddef9bc2ec1cf2feb73141a1843c9ba79fcb5839af5dc1a68ca9
```
...
### `drupal:9.1.3-fpm` - linux; arm variant v7
...
### `drupal:9.1.3-fpm` - linux; arm64 variant v8
...
### `drupal:9.1.3-fpm` - linux; ppc64le
