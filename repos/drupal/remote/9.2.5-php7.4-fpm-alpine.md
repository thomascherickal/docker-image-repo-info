...
```console
$ docker pull drupal@sha256:03c450a42fd693202dffbf259b8a74269ab084f9378eb3771d96182363234b68
```
...
### `drupal:9.2.5-php7.4-fpm-alpine` - linux; amd64
...
### `drupal:9.2.5-php7.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.2.5-php7.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:9.2.5-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.2.5-php7.4-fpm-alpine` - linux; 386
...
### `drupal:9.2.5-php7.4-fpm-alpine` - linux; ppc64le
...
### `drupal:9.2.5-php7.4-fpm-alpine` - linux; s390x
