...
```console
$ docker pull drupal@sha256:13cc9b97dcf92e542f7796327da3f783a1918ba0edb6c7a4a32666ef017058a0
```
...
### `drupal:10.1.5-php8.2-apache-bullseye` - linux; amd64
...
### `drupal:10.1.5-php8.2-apache-bullseye` - linux; arm variant v7
...
### `drupal:10.1.5-php8.2-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:10.1.5-php8.2-apache-bullseye` - linux; 386
...
### `drupal:10.1.5-php8.2-apache-bullseye` - linux; ppc64le
...
### `drupal:10.1.5-php8.2-apache-bullseye` - linux; s390x
