## `drupal:7.88-php7.4-apache`

```console
$ docker pull drupal@sha256:994ebf16704011da23f13aa38ea0891843a30c830fde31d185cd5a0d410cc185
```
...
### `drupal:7.88-php7.4-apache` - linux; amd64

```console
$ docker pull drupal@sha256:9eb42f35a9e6f21d7b67e2c4ebb9da9c0111199a0d89f6d2e6e295b2659d3f98
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.2 MB (172212950 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc0a731352808b07f80b7b511db32f7c8f8fd06bdb323a5caab6387a8698d435`
...
-	Layers:
	...
	-	`sha256:0a278aebc86773a647f7611a6cd906f0fb597b90dd3994e4483a8d472031cd5c`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c4a9ab93e92ec552d2729920b95a3bd05bd4ec0275baec798455cfa60738d50`  
		Last Modified: Thu, 03 Mar 2022 02:24:38 GMT  
		Size: 3.4 MB (3380481 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.88-php7.4-apache` - linux; arm variant v5
...
### `drupal:7.88-php7.4-apache` - linux; arm variant v7

```console
$ docker pull drupal@sha256:66caf791620db3a705e9c212eaf1b41438a7fcb9353920fc09130fc6eaaa167a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.9 MB (141938414 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58e4d18ef960048729278ce23d56ff3f7e99e81c54d850d441b7da2ff6ec27f7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Mar 2022 03:54:02 GMT
ENV DRUPAL_VERSION=7.88
# Thu, 03 Mar 2022 03:54:03 GMT
ENV DRUPAL_MD5=ff1a687492ea18e22cfb009198a7dafc
# Thu, 03 Mar 2022 03:54:06 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:02dd22c82605b7f3fc287f70d8a46824def1fc9bab875cdaa4b7f9f9e7d7ff4e`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa590d415cf396d8dee5f36cea810c7df58bfb871b086298581feaf9206af7d0`  
		Last Modified: Thu, 03 Mar 2022 04:38:43 GMT  
		Size: 3.4 MB (3380481 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.88-php7.4-apache` - linux; arm64 variant v8
...
### `drupal:7.88-php7.4-apache` - linux; 386
...
### `drupal:7.88-php7.4-apache` - linux; mips64le
...
### `drupal:7.88-php7.4-apache` - linux; ppc64le
...
### `drupal:7.88-php7.4-apache` - linux; s390x
