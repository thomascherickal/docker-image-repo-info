...
```console
$ docker pull drupal@sha256:164801a7ded9d08a1d82f2eb6ebf16bf2b41278535e0ecda14a70e2f3e3df9c6
```
...
### `drupal:9.2-php8.0-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.2-php8.0-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:9.2-php8.0-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.2-php8.0-fpm-alpine3.16` - linux; 386
...
### `drupal:9.2-php8.0-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.2-php8.0-fpm-alpine3.16` - linux; s390x
