...
```console
$ docker pull drupal@sha256:25f48b7d6b6bee7a554b66b3b4fb430a291324a9b63075e2f8920d471df18047
```
...
### `drupal:9.2.17-php8.0-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.2.17-php8.0-fpm-alpine` - linux; arm variant v7
...
### `drupal:9.2.17-php8.0-fpm-alpine` - linux; ppc64le
