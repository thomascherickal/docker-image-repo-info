...
### `drupal:10.1.5-php8.2-fpm-alpine3.18` - linux; amd64
...
### `drupal:10.1.5-php8.2-fpm-alpine3.18` - linux; arm variant v6
...
### `drupal:10.1.5-php8.2-fpm-alpine3.18` - linux; arm variant v7
...
### `drupal:10.1.5-php8.2-fpm-alpine3.18` - linux; arm64 variant v8
...
### `drupal:10.1.5-php8.2-fpm-alpine3.18` - linux; 386
...
### `drupal:10.1.5-php8.2-fpm-alpine3.18` - linux; ppc64le
...
### `drupal:10.1.5-php8.2-fpm-alpine3.18` - linux; s390x
