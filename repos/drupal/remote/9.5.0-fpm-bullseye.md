...
### `drupal:9.5.0-fpm-bullseye` - linux; amd64
...
### `drupal:9.5.0-fpm-bullseye` - linux; arm variant v7
...
### `drupal:9.5.0-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:9.5.0-fpm-bullseye` - linux; 386
...
### `drupal:9.5.0-fpm-bullseye` - linux; ppc64le
...
### `drupal:9.5.0-fpm-bullseye` - linux; s390x
