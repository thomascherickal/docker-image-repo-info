...
### `drupal:10.0.0-rc3-apache` - linux; amd64
...
### `drupal:10.0.0-rc3-apache` - linux; arm variant v7
...
### `drupal:10.0.0-rc3-apache` - linux; arm64 variant v8
...
### `drupal:10.0.0-rc3-apache` - linux; 386
...
### `drupal:10.0.0-rc3-apache` - linux; ppc64le
...
### `drupal:10.0.0-rc3-apache` - linux; s390x
