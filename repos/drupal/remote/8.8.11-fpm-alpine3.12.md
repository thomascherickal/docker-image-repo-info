...
```console
$ docker pull drupal@sha256:270525eeb837e85d6f8265f0ab219bf51f2544dd5532b98ffea402e1b12fecf9
```
...
### `drupal:8.8.11-fpm-alpine3.12` - linux; amd64
...
### `drupal:8.8.11-fpm-alpine3.12` - linux; arm variant v7
...
### `drupal:8.8.11-fpm-alpine3.12` - linux; arm64 variant v8
...
### `drupal:8.8.11-fpm-alpine3.12` - linux; ppc64le
