...
### `drupal:10.0.3-fpm-alpine3.17` - linux; amd64
...
### `drupal:10.0.3-fpm-alpine3.17` - linux; arm variant v7
...
### `drupal:10.0.3-fpm-alpine3.17` - linux; 386
...
### `drupal:10.0.3-fpm-alpine3.17` - linux; ppc64le
