...
```console
$ docker pull drupal@sha256:a2533058bba0535b2c05fbfbc86bc1a945bed90c70120991e9675189f828ad32
```
...
### `drupal:9.3.17-php8.1-apache` - linux; amd64
...
### `drupal:9.3.17-php8.1-apache` - linux; arm variant v7
...
### `drupal:9.3.17-php8.1-apache` - linux; arm64 variant v8
...
### `drupal:9.3.17-php8.1-apache` - linux; 386
...
### `drupal:9.3.17-php8.1-apache` - linux; ppc64le
...
### `drupal:9.3.17-php8.1-apache` - linux; s390x
