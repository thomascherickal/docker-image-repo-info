...
```console
$ docker pull drupal@sha256:bcfc3f566a9f34fba02dcf28a2538cdf7ed56dc9a9a430aced3e525c25774abf
```
...
### `drupal:10.1.5-php8.1-fpm-alpine3.17` - linux; amd64
...
### `drupal:10.1.5-php8.1-fpm-alpine3.17` - linux; arm variant v6
...
### `drupal:10.1.5-php8.1-fpm-alpine3.17` - linux; arm variant v7
...
### `drupal:10.1.5-php8.1-fpm-alpine3.17` - linux; arm64 variant v8
...
### `drupal:10.1.5-php8.1-fpm-alpine3.17` - linux; 386
...
### `drupal:10.1.5-php8.1-fpm-alpine3.17` - linux; ppc64le
...
### `drupal:10.1.5-php8.1-fpm-alpine3.17` - linux; s390x
