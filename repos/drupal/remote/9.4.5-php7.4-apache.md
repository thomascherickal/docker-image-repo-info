...
```console
$ docker pull drupal@sha256:3375d3a507dde18346c2ecc03a8f789fc9225bbb4fe7acf66a0201c219f32bb9
```
...
### `drupal:9.4.5-php7.4-apache` - linux; amd64
...
### `drupal:9.4.5-php7.4-apache` - linux; arm variant v7
...
### `drupal:9.4.5-php7.4-apache` - linux; arm64 variant v8
...
### `drupal:9.4.5-php7.4-apache` - linux; 386
...
### `drupal:9.4.5-php7.4-apache` - linux; ppc64le
...
### `drupal:9.4.5-php7.4-apache` - linux; s390x
