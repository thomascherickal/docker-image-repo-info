## `drupal:10.0.0-alpha5-php8.1-fpm-alpine3.16`

```console
$ docker pull drupal@sha256:3985bdcfe2761620ed0501d8fc8adf12ad888262206bd23502f84a5a851557d0
```
...
### `drupal:10.0.0-alpha5-php8.1-fpm-alpine3.16` - linux; amd64
...
### `drupal:10.0.0-alpha5-php8.1-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:10.0.0-alpha5-php8.1-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:10.0.0-alpha5-php8.1-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:10.0.0-alpha5-php8.1-fpm-alpine3.16` - linux; 386
...
### `drupal:10.0.0-alpha5-php8.1-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:10.0.0-alpha5-php8.1-fpm-alpine3.16` - linux; s390x
