...
```console
$ docker pull drupal@sha256:c3448947d21e8f2b50915349b934d86972526c846c7a9e4d2087f6a502bc90a2
```
...
### `drupal:9.1-php8.0-apache-bullseye` - linux; amd64
...
### `drupal:9.1-php8.0-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.1-php8.0-apache-bullseye` - linux; 386
...
### `drupal:9.1-php8.0-apache-bullseye` - linux; ppc64le
