...
```console
$ docker pull rabbitmq@sha256:f9a7564a0a0c94287289bb680444ef5ff2645bc732279bc96e0e6ebb5a52ffaf
```
...
### `rabbitmq:3.8.28` - linux; arm variant v7

```console
$ docker pull rabbitmq@sha256:492b836b799b573d8be8e3098f002b1e31501339c48aa0dcd277299fbb4abcc4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **85.1 MB (85065939 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f11e201ffd2b5b2a8a00951442974532de3a1121d64e362fcab3621b28b68d19`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
### `rabbitmq:3.8.28` - linux; arm64 variant v8

```console
$ docker pull rabbitmq@sha256:173aac96833388a3a9136c3e0fbd61c5e19b32c435eb99c1d10c01793d78fc34
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **89.0 MB (89033714 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a6fd105eccf36a37441708f61f5bca12dafa84d8eaa14a64d1a69995532d239`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
### `rabbitmq:3.8.28` - linux; ppc64le

```console
$ docker pull rabbitmq@sha256:b690f01be80910ef8efeb204332cdd567887669741fa60fb9ed74056bc0e283c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.9 MB (96860546 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:911b2af2dd1c6ba482538bc688392d52c161d9554859dfc9066505d3ce5b9448`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
### `rabbitmq:3.8.28` - linux; s390x

```console
$ docker pull rabbitmq@sha256:22b7176a20095f7e9437b29956be03f4ee89309aca5aec3d3f0b951366826711
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **88.6 MB (88617811 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6db7a51d4ff4d22c91f011b0e534f622f883cd0185413e2c634a9676ad002747`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
