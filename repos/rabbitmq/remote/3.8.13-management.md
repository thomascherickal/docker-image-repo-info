...
```console
$ docker pull rabbitmq@sha256:1cc07524320345e225b047bd82c61bafee0bcf5d2946396b430576e8c439eda9
```
...
### `rabbitmq:3.8.13-management` - linux; amd64
...
### `rabbitmq:3.8.13-management` - linux; arm variant v7
...
### `rabbitmq:3.8.13-management` - linux; 386
...
### `rabbitmq:3.8.13-management` - linux; s390x
