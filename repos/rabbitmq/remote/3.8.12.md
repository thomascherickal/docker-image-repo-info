...
```console
$ docker pull rabbitmq@sha256:bbd86b54a03a437e67d160462a12dd949746c3f1cdd82add64aa258c292fca29
```
...
### `rabbitmq:3.8.12` - linux; arm64 variant v8
