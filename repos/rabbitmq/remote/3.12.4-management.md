...
```console
$ docker pull rabbitmq@sha256:fca74616440a8946177d29903cd0be802f88bd6c72071bfb59604a551a7b3212
```
...
### `rabbitmq:3.12.4-management` - linux; arm64 variant v8
...
### `rabbitmq:3.12.4-management` - linux; ppc64le
