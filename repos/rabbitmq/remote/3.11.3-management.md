...
### `rabbitmq:3.11.3-management` - linux; amd64
...
### `rabbitmq:3.11.3-management` - linux; arm variant v7
...
### `rabbitmq:3.11.3-management` - linux; arm64 variant v8
...
### `rabbitmq:3.11.3-management` - linux; ppc64le
...
### `rabbitmq:3.11.3-management` - linux; riscv64
...
### `rabbitmq:3.11.3-management` - linux; s390x
