...
```console
$ docker pull rabbitmq@sha256:ce5a97b0db12d09b8f7392805ed688b9c7b69737ac6df38cad35d2c3a2595e0b
```
...
### `rabbitmq:3.9.9-management` - linux; amd64
...
### `rabbitmq:3.9.9-management` - linux; arm variant v7
...
### `rabbitmq:3.9.9-management` - linux; arm64 variant v8
...
### `rabbitmq:3.9.9-management` - linux; riscv64
...
### `rabbitmq:3.9.9-management` - linux; s390x
