...
### `rabbitmq:3.11.4-alpine` - linux; amd64
...
### `rabbitmq:3.11.4-alpine` - linux; arm variant v6
...
### `rabbitmq:3.11.4-alpine` - linux; arm64 variant v8
...
### `rabbitmq:3.11.4-alpine` - linux; ppc64le
...
### `rabbitmq:3.11.4-alpine` - linux; s390x
