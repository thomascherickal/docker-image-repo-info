...
### `rabbitmq:3.11.4-management` - linux; amd64
...
### `rabbitmq:3.11.4-management` - linux; arm64 variant v8
...
### `rabbitmq:3.11.4-management` - linux; ppc64le
...
### `rabbitmq:3.11.4-management` - linux; riscv64
...
### `rabbitmq:3.11.4-management` - linux; s390x
