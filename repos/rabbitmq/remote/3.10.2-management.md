...
```console
$ docker pull rabbitmq@sha256:859802f08640bcd5f12568f6802b995d66df0e25619dc0732b1b19d4bd39277c
```
...
### `rabbitmq:3.10.2-management` - linux; amd64
...
### `rabbitmq:3.10.2-management` - linux; arm variant v7
...
### `rabbitmq:3.10.2-management` - linux; arm64 variant v8
...
### `rabbitmq:3.10.2-management` - linux; riscv64
...
### `rabbitmq:3.10.2-management` - linux; s390x
