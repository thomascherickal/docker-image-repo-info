...
```console
$ docker pull rabbitmq@sha256:c40011f407095bb8860bbf1273ff72639665ff7430d4dfb691e2c852c7d7ee77
```
...
### `rabbitmq:3.8.13-management-alpine` - linux; amd64
...
### `rabbitmq:3.8.13-management-alpine` - linux; arm variant v6
...
### `rabbitmq:3.8.13-management-alpine` - linux; arm variant v7
...
### `rabbitmq:3.8.13-management-alpine` - linux; 386
...
### `rabbitmq:3.8.13-management-alpine` - linux; ppc64le
...
### `rabbitmq:3.8.13-management-alpine` - linux; s390x
