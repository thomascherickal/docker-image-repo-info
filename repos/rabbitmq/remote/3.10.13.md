...
```console
$ docker pull rabbitmq@sha256:aff0402c6cfaf4b70822f26de6c6183a57d5fc7293154ef72335faac2bb035dc
```
...
### `rabbitmq:3.10.13` - linux; arm variant v7
...
### `rabbitmq:3.10.13` - linux; arm64 variant v8
...
### `rabbitmq:3.10.13` - linux; ppc64le
