...
- Created: `2020-09-10T21:31:00.970352109Z`
...
### `dpkg` source package: `net-snmp=5.7.3+dfsg-1.7+deb9u3`

Binary Packages:

- `libsnmp-base=5.7.3+dfsg-1.7+deb9u3`
- `libsnmp30:amd64=5.7.3+dfsg-1.7+deb9u3`
- `snmp=5.7.3+dfsg-1.7+deb9u3`
...
```console
$ apt-get source -qq --print-uris net-snmp=5.7.3+dfsg-1.7+deb9u3
'http://security.debian.org/debian-security/pool/updates/main/n/net-snmp/net-snmp_5.7.3+dfsg-1.7+deb9u3.dsc' net-snmp_5.7.3+dfsg-1.7+deb9u3.dsc 3161 SHA256:33f560243e6dc6ea6fe3922ce06e3b5e8a85e69a13f044c63aa48d37d0d0dbb8
...
'http://security.debian.org/debian-security/pool/updates/main/n/net-snmp/net-snmp_5.7.3+dfsg-1.7+deb9u3.debian.tar.xz' net-snmp_5.7.3+dfsg-1.7+deb9u3.debian.tar.xz 77868 SHA256:2d619003d2b6b005d0941d6d9bfd877730aa73260802a2ccca9a7a9e652a44c4
```

Other potentially useful URLs:

- https://sources.debian.net/src/net-snmp/5.7.3+dfsg-1.7+deb9u3/ (for browsing the source)
- https://sources.debian.net/src/net-snmp/5.7.3+dfsg-1.7+deb9u3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/net-snmp/5.7.3+dfsg-1.7+deb9u3/ (for access to the source package after it no longer exists in the archive)
