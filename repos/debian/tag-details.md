...
-	[`debian:bookworm-20210927`](#debianbookworm-20210927)
-	[`debian:bookworm-20210927-slim`](#debianbookworm-20210927-slim)
-	[`debian:bookworm-backports`](#debianbookworm-backports)
-	[`debian:bookworm-slim`](#debianbookworm-slim)
-	[`debian:bullseye`](#debianbullseye)
-	[`debian:bullseye-20210927`](#debianbullseye-20210927)
-	[`debian:bullseye-20210927-slim`](#debianbullseye-20210927-slim)
-	[`debian:bullseye-backports`](#debianbullseye-backports)
-	[`debian:bullseye-slim`](#debianbullseye-slim)
-	[`debian:buster`](#debianbuster)
-	[`debian:buster-20210927`](#debianbuster-20210927)
-	[`debian:buster-20210927-slim`](#debianbuster-20210927-slim)
-	[`debian:buster-backports`](#debianbuster-backports)
-	[`debian:buster-slim`](#debianbuster-slim)
-	[`debian:experimental`](#debianexperimental)
-	[`debian:experimental-20210927`](#debianexperimental-20210927)
-	[`debian:latest`](#debianlatest)
-	[`debian:oldoldstable`](#debianoldoldstable)
-	[`debian:oldoldstable-20210927`](#debianoldoldstable-20210927)
-	[`debian:oldoldstable-20210927-slim`](#debianoldoldstable-20210927-slim)
...
-	[`debian:oldstable-20210927`](#debianoldstable-20210927)
-	[`debian:oldstable-20210927-slim`](#debianoldstable-20210927-slim)
...
-	[`debian:rc-buggy-20210927`](#debianrc-buggy-20210927)
-	[`debian:sid`](#debiansid)
-	[`debian:sid-20210927`](#debiansid-20210927)
-	[`debian:sid-20210927-slim`](#debiansid-20210927-slim)
-	[`debian:sid-slim`](#debiansid-slim)
-	[`debian:stable`](#debianstable)
-	[`debian:stable-20210927`](#debianstable-20210927)
-	[`debian:stable-20210927-slim`](#debianstable-20210927-slim)
-	[`debian:stable-backports`](#debianstable-backports)
-	[`debian:stable-slim`](#debianstable-slim)
-	[`debian:stretch`](#debianstretch)
-	[`debian:stretch-20210927`](#debianstretch-20210927)
-	[`debian:stretch-20210927-slim`](#debianstretch-20210927-slim)
-	[`debian:stretch-backports`](#debianstretch-backports)
-	[`debian:stretch-slim`](#debianstretch-slim)
-	[`debian:testing`](#debiantesting)
-	[`debian:testing-20210927`](#debiantesting-20210927)
-	[`debian:testing-20210927-slim`](#debiantesting-20210927-slim)
-	[`debian:testing-backports`](#debiantesting-backports)
-	[`debian:testing-slim`](#debiantesting-slim)
-	[`debian:unstable`](#debianunstable)
-	[`debian:unstable-20210927`](#debianunstable-20210927)
-	[`debian:unstable-20210927-slim`](#debianunstable-20210927-slim)
...
```console
$ docker pull debian@sha256:d885b2500552d9baae632e9e1b90c9cfed942cb8a15da5efa382e18877a29c95
```
...
```console
$ docker pull debian@sha256:7cb5e99e9e9f353ecbf32e5a67ec613981e975a1e81bc31aaa2f948a4375736a
```
...
```console
$ docker pull debian@sha256:ba50804efe6be16483d98385aca22956bf513695a0d56fc73b0706d6b285bf3b
```
...
### `debian:bullseye-20210927-slim` - linux; amd64
...
### `debian:bullseye-20210927-slim` - linux; arm variant v5
...
### `debian:bullseye-20210927-slim` - linux; arm variant v7
...
### `debian:bullseye-20210927-slim` - linux; arm64 variant v8
...
### `debian:bullseye-20210927-slim` - linux; 386
...
### `debian:bullseye-20210927-slim` - linux; mips64le
...
### `debian:bullseye-20210927-slim` - linux; s390x
...
```console
$ docker pull debian@sha256:08be76e37158d9b2cf5c4309413f728d2655e00fac670310f34945b51641d2d7
```
...
```console
$ docker pull debian@sha256:08c3080f443ebec29187cada12832da918ed38918d38ac17034c986adf785796
```
...
```console
$ docker pull debian@sha256:59afa7468945edd086f7a6602db3f32d675aae2bdfcbcef1a98980e8db5eee76
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.4 MB (45379669 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:362701e01fbc2ef6ff661eefca57955c2dca3677a0e3c15a3bb359e797de29a2`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:9f0909675a3502c1ba19a393b9bf4169bc3a05c80636cb2dcdd10205e93e89f1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.1 MB (44091930 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7aad6cb3cb2426a9a89899446718389eab60ae8e0bcb77915ce8ec2055cc598`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:ae702f7ed6a356472f7a1b7038348fd4800b22693ed94fcfa39c12fde131c311
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **42.1 MB (42119399 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:938b60af1afdf029d4123f69ec01cf84f6c33e58edd2afdac276850c88e2476b`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:93fc95808343b97b077acddcd7716b9548401f2fb7eb9844d0dab117ac7a2ce2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **43.2 MB (43176880 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a5c583bf09bdecdc3c1c37468c0fccef99ac1dc0aec471086a185d0ba099284`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:5dd252f1ed1cd36d0d73844faa2cb98c12f443288e3c6f847e2cc1f29d65a000
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.1 MB (46097074 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6663f9cc3f55cadfda6ad8ff445acb16d3a0b71b3553e14c9113732e672ba0d1`
-	Default Command: `["bash"]`
...
### `debian:oldoldstable-20210927` - linux; amd64
...
### `debian:oldoldstable-20210927` - linux; arm variant v5
...
### `debian:oldoldstable-20210927` - linux; arm variant v7
...
### `debian:oldoldstable-20210927` - linux; arm64 variant v8
...
### `debian:oldoldstable-20210927` - linux; 386
...
```console
$ docker pull debian@sha256:fc1829ede498eaa0f9ad049eaaa4c920d308d6b5f5ce73aa2c4c0c545217c1ee
```
...
### `debian:oldoldstable-20210927-slim` - linux; arm variant v7

```console
$ docker pull debian@sha256:defa5b547768d31af047e551438405b609ddde437a40b300a605f207a776ce4c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **19.3 MB (19316413 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4fe58615954a8a8dbf1156bf958d0f9c208ba10c468776ad9ac6c48ed1fd77b5`
-	Default Command: `["bash"]`

```dockerfile
# Thu, 30 Sep 2021 18:05:17 GMT
ADD file:16af99c6e82fb69cd64df8f6bbbd59a5f29d56c293a8562122693d7eb87d4e64 in / 
# Thu, 30 Sep 2021 18:05:18 GMT
CMD ["bash"]
```

-	Layers:
	-	`sha256:33e273f449dbd688b35476381919d0fc3aaf049659a1611a1bdd0f4c1d82ec80`  
		Last Modified: Thu, 30 Sep 2021 18:22:07 GMT  
		Size: 19.3 MB (19316413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull debian@sha256:03296f1a6566804e7f6f519f0cc969993a591e602cd11bd662752f6b890acbe3
```
...
```console
$ docker pull debian@sha256:00399ba8583932493f6ee52a595032a940d7cbe181ce50846a608c3c65244747
```
...
```console
$ docker pull debian@sha256:06d6e60c1d96d6d984142b1cfbb1d9d0ff862cf585b7dea9d0eb6bebcaf427c9
```
...
```console
$ docker pull debian@sha256:220f95f4476d33ca39694f730dcd1dceb4753c65dca79887e662fb3a60eb4561
```
...
```console
$ docker pull debian@sha256:18a7a85c1f46c38f8bca9f9a1e17034dd01a4dc3330a99a8f28a71bb8867d347
```
...
```console
$ docker pull debian@sha256:486941a6a2b3693350d4eb645235d1f48577289b1dd9e94ecafc9fb66352f813
```
...
```console
$ docker pull debian@sha256:cc4fac97128353a7304591cc3f0749d0960efdae1ce7bbc98aaf20d801084b60
```
...
### `debian:stretch-20210927-slim` - linux; arm variant v7
...
```console
$ docker pull debian@sha256:b467e92797f3cd2ed23b3a11784e79b6cee87701599d36d817123ee3587cab97
```
...
```console
$ docker pull debian@sha256:819f2d1663af6ff08ed10ff8a00001360b8153bd71939353b4ac237055136b08
```
...
### `debian:testing-20210927` - linux; amd64
...
### `debian:testing-20210927` - linux; arm variant v5
...
### `debian:testing-20210927` - linux; arm variant v7
...
### `debian:testing-20210927` - linux; arm64 variant v8
...
### `debian:testing-20210927` - linux; 386
...
### `debian:testing-20210927` - linux; mips64le
...
### `debian:testing-20210927` - linux; s390x
...
```console
$ docker pull debian@sha256:4a8a55c33bbbdd3e65d51b11b3f1d75c7b537f4f79c99a2bc9ddf6f05620b422
```
...
```console
$ docker pull debian@sha256:93435cfd6e67220f17a2ba324e986056205155f34e3fa51e81c52e73e5edff5e
```
...
```console
$ docker pull debian@sha256:7632142bc5ac8adee806d6590a658c730a609862d5c6adba198850c4fac1f84e
```
...
```console
$ docker pull debian@sha256:b53de93aac953ccc3ed5cd0e2b73ae5dbbbe7e09eb9d8e0a6908ea736bb33d16
```
...
```console
$ docker pull debian@sha256:7c9407924c5f0c745cd82c58e3058b70713779aaf87e2c35ceb539646174bf49
```
