...
```console
$ docker pull gcc@sha256:aa37e0ecd216c0a920a2df53f8b5677cd7022cdab85f89728f7398a9774e06bd
```
...
### `gcc:11-bookworm` - linux; arm variant v5
...
### `gcc:11-bookworm` - linux; arm variant v7
...
### `gcc:11-bookworm` - linux; arm64 variant v8
