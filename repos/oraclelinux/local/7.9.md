...
- Created: `2022-03-24T22:26:32.628108055Z`
...
```console
$ dnf --quiet download --source --url initscripts-9.49.53-1.0.1.el7_9.1
...
```console
$ dnf --quiet download --source --url rsyslog-8.24.0-57.0.1.el7_9.1
