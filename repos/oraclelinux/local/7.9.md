...
- Created: `2021-03-09T20:36:46.686163379Z`
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/bind-9.11.4-26.P2.el7_9.4.src.rpm
```
...
### `rpm` package: `libgudev1-219-78.0.1.el7_9.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libgudev1-219-78.0.1.el7_9.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.1.el7_9.3.src.rpm
```
...
### `rpm` package: `systemd-219-78.0.1.el7_9.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-219-78.0.1.el7_9.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.1.el7_9.3.src.rpm
```

### `rpm` package: `systemd-libs-219-78.0.1.el7_9.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-libs-219-78.0.1.el7_9.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.1.el7_9.3.src.rpm
```
