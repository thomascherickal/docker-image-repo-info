...
- Created: `2022-09-01T18:20:16.92215517Z`
- Virtual Size: ~ 217.28 Mb  
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/audit-3.0.7-101.el9_0.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/audit-3.0.7-101.el9_0.2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/bash-5.1.8-4.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/ca-certificates-2020.2.50-94.el9.src.rpm
```
...
### `rpm` package: `coreutils-8.32-31.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-8.32-31.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/coreutils-8.32-31.0.1.el9.src.rpm
```

### `rpm` package: `coreutils-common-8.32-31.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-common-8.32-31.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/coreutils-8.32-31.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/crypto-policies-20220223-1.git5203b41.el9_0.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/cryptsetup-2.4.3-4.el9.src.rpm
```

### `rpm` package: `curl-7.76.1-14.el9_0.5.x86_64`
...
```console
$ dnf --quiet download --source --url curl-7.76.1-14.el9_0.5
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-14.el9_0.5.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-14.el9_0.5.src.rpm
```
...
### `rpm` package: `dbus-1.12.20-5.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-1.12.20-5.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dbus-1.12.20-5.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dbus-1.12.20-5.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dbus-broker-28-5.el9.src.rpm
```

### `rpm` package: `dbus-common-1.12.20-5.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url dbus-common-1.12.20-5.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dbus-1.12.20-5.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dbus-1.12.20-5.0.1.el9.src.rpm
```

### `rpm` package: `dbus-libs-1.12.20-5.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-libs-1.12.20-5.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dbus-1.12.20-5.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dbus-1.12.20-5.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/lvm2-2.03.14-4.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/lvm2-2.03.14-4.el9.src.rpm
```
...
### `rpm` package: `dhcp-client-4.4.2-15.b1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url dhcp-client-4.4.2-15.b1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dhcp-4.4.2-15.b1.el9.src.rpm
```

### `rpm` package: `dhcp-common-4.4.2-15.b1.el9.noarch`
...
```console
$ dnf --quiet download --source --url dhcp-common-4.4.2-15.b1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dhcp-4.4.2-15.b1.el9.src.rpm
```
...
### `rpm` package: `dnf-4.10.0-5.0.3.el9_0.noarch`
...
```console
$ dnf --quiet download --source --url dnf-4.10.0-5.0.3.el9_0.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.10.0-5.0.3.el9_0.src.rpm
```

### `rpm` package: `dnf-data-4.10.0-5.0.3.el9_0.noarch`
...
```console
$ dnf --quiet download --source --url dnf-data-4.10.0-5.0.3.el9_0.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.10.0-5.0.3.el9_0.src.rpm
```

### `rpm` package: `dnf-plugins-core-4.0.24-4.0.1.el9_0.noarch`
...
```console
$ dnf --quiet download --source --url dnf-plugins-core-4.0.24-4.0.1.el9_0.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.0.24-4.0.1.el9_0.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/elfutils-0.186-1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/elfutils-0.186-1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/expat-2.2.10-12.el9_0.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/expat-2.2.10-12.el9_0.2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/file-5.39-8.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/file-5.39-8.el9.src.rpm
```
...
### `rpm` package: `glibc-2.34-28.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.34-28.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-28.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-28.0.1.el9_0.src.rpm
```

### `rpm` package: `glibc-common-2.34-28.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.34-28.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-28.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-28.0.1.el9_0.src.rpm
```

### `rpm` package: `glibc-langpack-en-2.34-28.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-28.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-28.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-28.0.1.el9_0.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gnupg2-2.3.3-1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gnupg2-2.3.3-1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gnutls-3.7.3-9.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gnutls-3.7.3-9.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gzip-1.10-9.el9_0.src.rpm
```
...
### `rpm` package: `initscripts-10.11.4-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url initscripts-10.11.4-1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/initscripts-10.11.4-1.el9.src.rpm
```

### `rpm` package: `initscripts-rename-device-10.11.4-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url initscripts-rename-device-10.11.4-1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/initscripts-10.11.4-1.el9.src.rpm
```

### `rpm` package: `initscripts-service-10.11.4-1.el9.noarch`
...
```console
$ dnf --quiet download --source --url initscripts-service-10.11.4-1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/initscripts-10.11.4-1.el9.src.rpm
```
...
### `rpm` package: `iproute-5.15.0-2.2.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url iproute-5.15.0-2.2.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/iproute-5.15.0-2.2.0.1.el9_0.src.rpm
```
...
### `rpm` package: `krb5-libs-1.19.1-15.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url krb5-libs-1.19.1-15.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/krb5-1.19.1-15.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/krb5-1.19.1-15.0.1.el9_0.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libarchive-3.5.3-2.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libarchive-3.5.3-2.el9_0.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-3.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-3.el9.src.rpm
```

### `rpm` package: `libbpf-0.5.0-4.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libbpf-0.5.0-4.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libbpf-0.5.0-4.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/e2fsprogs-1.46.5-2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/e2fsprogs-1.46.5-2.el9.src.rpm
```
...
### `rpm` package: `libcurl-7.76.1-14.el9_0.5.x86_64`
...
```console
$ dnf --quiet download --source --url libcurl-7.76.1-14.el9_0.5
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-14.el9_0.5.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-14.el9_0.5.src.rpm
```
...
### `rpm` package: `libdnf-0.65.0-5.0.3.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.65.0-5.0.3.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.65.0-5.0.3.el9_0.src.rpm
```
...
### `rpm` package: `libestr-0.1.11-3.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libestr-0.1.11-3.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libestr-0.1.11-3.el9.src.rpm
```
...
### `rpm` package: `libgcc-11.2.1-9.4.0.2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libgcc-11.2.1-9.4.0.2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.2.1-9.4.0.2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.2.1-9.4.0.2.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libgcrypt-1.10.0-4.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libgcrypt-1.10.0-4.el9_0.src.rpm
```

### `rpm` package: `libgomp-11.2.1-9.4.0.2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libgomp-11.2.1-9.4.0.2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.2.1-9.4.0.2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.2.1-9.4.0.2.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libksba-1.5.1-4.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/librepo-1.14.2-1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libselinux-3.3-2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libselinux-3.3-2.el9.src.rpm
```

### `rpm` package: `libselinux-utils-3.3-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libselinux-utils-3.3-2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libselinux-3.3-2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libselinux-3.3-2.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libsemanage-3.3-2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libsemanage-3.3-2.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libsepol-3.3-2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libsepol-3.3-2.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libsolv-0.7.20-2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libsolv-0.7.20-2.el9.src.rpm
```
...
### `rpm` package: `libstdc++-11.2.1-9.4.0.2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libstdc++-11.2.1-9.4.0.2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.2.1-9.4.0.2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.2.1-9.4.0.2.el9.src.rpm
```
...
### `rpm` package: `libuser-0.63-10.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libuser-0.63-10.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libuser-0.63-10.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libxml2-2.9.13-1.el9_0.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libxml2-2.9.13-1.el9_0.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/lua-5.4.2-4.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/lua-5.4.2-4.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/nettle-3.7.3-2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/nettle-3.7.3-2.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openldap-2.4.59-4.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openldap-2.4.59-4.el9_0.src.rpm
```

### `rpm` package: `openssh-8.7p1-8.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-8.7p1-8.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-8.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-8.el9.src.rpm
```

### `rpm` package: `openssh-clients-8.7p1-8.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-8.7p1-8.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-8.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-8.el9.src.rpm
```

### `rpm` package: `openssh-server-8.7p1-8.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-8.7p1-8.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-8.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-8.el9.src.rpm
```

### `rpm` package: `openssl-3.0.1-41.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-3.0.1-41.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.0.1-41.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.0.1-41.0.1.el9_0.src.rpm
```

### `rpm` package: `openssl-libs-3.0.1-41.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-libs-3.0.1-41.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.0.1-41.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.0.1-41.0.1.el9_0.src.rpm
```

### `rpm` package: `oraclelinux-release-9.0-1.0.16.el9.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-9.0-1.0.16.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/oraclelinux-release-9.0-1.0.16.el9.src.rpm
```

### `rpm` package: `oraclelinux-release-el9-1.0-6.el9.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-el9-1.0-6.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/oraclelinux-release-el9-1.0-6.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/pam-1.5.1-9.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/pam-1.5.1-9.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/pcre2-10.37-5.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/pcre2-10.37-5.el9_0.src.rpm
```
...
### `rpm` package: `policycoreutils-3.3-6.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url policycoreutils-3.3-6.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/policycoreutils-3.3-6.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/policycoreutils-3.3-6.el9_0.src.rpm
```
...
### `rpm` package: `procps-ng-3.3.17-4.el9.x86_64`
...
```console
$ dnf --quiet download --source --url procps-ng-3.3.17-4.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/procps-ng-3.3.17-4.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.10-2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.10-2.el9.src.rpm
```
...
### `rpm` package: `python3-dnf-4.10.0-5.0.3.el9_0.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-4.10.0-5.0.3.el9_0.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.10.0-5.0.3.el9_0.src.rpm
```

### `rpm` package: `python3-dnf-plugins-core-4.0.24-4.0.1.el9_0.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-plugins-core-4.0.24-4.0.1.el9_0.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.0.24-4.0.1.el9_0.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.65.0-5.0.3.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.65.0-5.0.3.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.65.0-5.0.3.el9_0.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.65.0-5.0.3.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.65.0-5.0.3.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.65.0-5.0.3.el9_0.src.rpm
```
...
### `rpm` package: `python3-rpm-4.16.1.3-12.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url python3-rpm-4.16.1.3-12.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python-six-1.15.0-9.el9.src.rpm
```
...
### `rpm` package: `redhat-release-9.0-2.17.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url redhat-release-9.0-2.17.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/redhat-release-9.0-2.17.0.1.el9.src.rpm
```
...
### `rpm` package: `rpm-4.16.1.3-12.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-4.16.1.3-12.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.src.rpm
```

### `rpm` package: `rpm-build-libs-4.16.1.3-12.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-build-libs-4.16.1.3-12.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.src.rpm
```

### `rpm` package: `rpm-libs-4.16.1.3-12.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-libs-4.16.1.3-12.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.src.rpm
```

### `rpm` package: `rpm-sign-libs-4.16.1.3-12.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-sign-libs-4.16.1.3-12.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.src.rpm
```

### `rpm` package: `rsyslog-8.2102.0-101.el9_0.1.x86_64`
...
```console
$ dnf --quiet download --source --url rsyslog-8.2102.0-101.el9_0.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rsyslog-8.2102.0-101.el9_0.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/setup-2.13.7-6.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/shadow-utils-4.9-3.el9.src.rpm
```
...
### `rpm` package: `systemd-250-6.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-250-6.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-6.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-6.0.1.el9_0.src.rpm
```

### `rpm` package: `systemd-libs-250-6.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-250-6.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-6.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-6.0.1.el9_0.src.rpm
```

### `rpm` package: `systemd-pam-250-6.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-250-6.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-6.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-6.0.1.el9_0.src.rpm
```

### `rpm` package: `systemd-rpm-macros-250-6.0.1.el9_0.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-250-6.0.1.el9_0.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-6.0.1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-6.0.1.el9_0.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/tpm2-tss-3.0.3-7.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/tzdata-2022c-1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/tzdata-2022c-1.el9_0.src.rpm
```
...
### `rpm` package: `yum-4.10.0-5.0.3.el9_0.noarch`
...
```console
$ dnf --quiet download --source --url yum-4.10.0-5.0.3.el9_0.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.10.0-5.0.3.el9_0.src.rpm
```

### `rpm` package: `yum-utils-4.0.24-4.0.1.el9_0.noarch`
...
```console
$ dnf --quiet download --source --url yum-utils-4.0.24-4.0.1.el9_0.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.0.24-4.0.1.el9_0.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/zlib-1.2.11-31.el9_0.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/zlib-1.2.11-31.el9_0.1.src.rpm
```
