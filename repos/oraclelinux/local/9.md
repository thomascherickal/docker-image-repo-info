...
- Created: `2023-02-08T19:26:51.860033322Z`
- Virtual Size: ~ 226.97 Mb  
...
### `rpm` package: `curl-7.76.1-19.el9_1.1.x86_64`
...
```console
$ dnf --quiet download --source --url curl-7.76.1-19.el9_1.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-19.el9_1.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-19.el9_1.1.src.rpm
```
...
### `rpm` package: `libcurl-7.76.1-19.el9_1.1.x86_64`
...
```console
$ dnf --quiet download --source --url libcurl-7.76.1-19.el9_1.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-19.el9_1.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-19.el9_1.1.src.rpm
```
...
### `rpm` package: `systemd-250-12.0.2.el9_1.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-250-12.0.2.el9_1.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-12.0.2.el9_1.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-12.0.2.el9_1.1.src.rpm
```

### `rpm` package: `systemd-libs-250-12.0.2.el9_1.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-250-12.0.2.el9_1.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-12.0.2.el9_1.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-12.0.2.el9_1.1.src.rpm
```

### `rpm` package: `systemd-pam-250-12.0.2.el9_1.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-250-12.0.2.el9_1.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-12.0.2.el9_1.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-12.0.2.el9_1.1.src.rpm
```

### `rpm` package: `systemd-rpm-macros-250-12.0.2.el9_1.1.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-250-12.0.2.el9_1.1.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-12.0.2.el9_1.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-12.0.2.el9_1.1.src.rpm
```
