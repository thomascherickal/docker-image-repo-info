...
- Created: `2022-10-12T21:20:11.885988431Z`
...
```console
$ dnf --quiet download --source --url cryptsetup-libs-2.4.3-4.el9_0.1
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/cryptsetup-2.4.3-4.el9_0.1.src.rpm
```
...
```console
$ dnf --quiet download --source --url dbus-broker-28-5.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dbus-broker-28-5.1.el9_0.src.rpm
```
...
```console
$ dnf --quiet download --source --url expat-2.2.10-12.el9_0.3
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/expat-2.2.10-12.el9_0.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/expat-2.2.10-12.el9_0.3.src.rpm
```
...
### `rpm` package: `glibc-2.34-28.0.1.el9_0.2.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.34-28.0.1.el9_0.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-28.0.1.el9_0.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-28.0.1.el9_0.2.src.rpm
```

### `rpm` package: `glibc-common-2.34-28.0.1.el9_0.2.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.34-28.0.1.el9_0.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-28.0.1.el9_0.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-28.0.1.el9_0.2.src.rpm
```

### `rpm` package: `glibc-langpack-en-2.34-28.0.1.el9_0.2.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-28.0.1.el9_0.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-28.0.1.el9_0.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-28.0.1.el9_0.2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gnutls-3.7.6-12.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gnutls-3.7.6-12.el9_0.src.rpm
```
...
### `rpm` package: `libdnf-0.65.0-5.1.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.65.0-5.1.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.65.0-5.1.0.1.el9_0.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libgcrypt-1.10.0-5.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libgcrypt-1.10.0-5.el9_0.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openldap-2.6.2-1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openldap-2.6.2-1.el9_0.src.rpm
```
...
### `rpm` package: `openssh-8.7p1-10.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-8.7p1-10.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-10.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-10.el9_0.src.rpm
```

### `rpm` package: `openssh-clients-8.7p1-10.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-8.7p1-10.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-10.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-10.el9_0.src.rpm
```

### `rpm` package: `openssh-server-8.7p1-10.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-8.7p1-10.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-10.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-10.el9_0.src.rpm
```
...
```console
$ dnf --quiet download --source --url pam-1.5.1-9.el9_0.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/pam-1.5.1-9.el9_0.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/pam-1.5.1-9.el9_0.1.src.rpm
```
...
### `rpm` package: `procps-ng-3.3.17-5.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url procps-ng-3.3.17-5.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/procps-ng-3.3.17-5.el9_0.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.65.0-5.1.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.65.0-5.1.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.65.0-5.1.0.1.el9_0.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.65.0-5.1.0.1.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.65.0-5.1.0.1.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.65.0-5.1.0.1.el9_0.src.rpm
```
...
### `rpm` package: `systemd-250-6.0.3.el9_0.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-250-6.0.3.el9_0.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-6.0.3.el9_0.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-6.0.3.el9_0.1.src.rpm
```

### `rpm` package: `systemd-libs-250-6.0.3.el9_0.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-250-6.0.3.el9_0.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-6.0.3.el9_0.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-6.0.3.el9_0.1.src.rpm
```

### `rpm` package: `systemd-pam-250-6.0.3.el9_0.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-250-6.0.3.el9_0.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-6.0.3.el9_0.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-6.0.3.el9_0.1.src.rpm
```

### `rpm` package: `systemd-rpm-macros-250-6.0.3.el9_0.1.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-250-6.0.3.el9_0.1.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-250-6.0.3.el9_0.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-250-6.0.3.el9_0.1.src.rpm
```
...
### `rpm` package: `tzdata-2022d-1.el9_0.noarch`
...
```console
$ dnf --quiet download --source --url tzdata-2022d-1.el9_0.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/tzdata-2022d-1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/tzdata-2022d-1.el9_0.src.rpm
```
