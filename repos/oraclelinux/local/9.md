...
- Created: `2022-07-07T01:20:06.852121633Z`
- Virtual Size: ~ 216.72 Mb  
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-14.el9_0.4.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-14.el9_0.4.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.0.1-23.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.0.1-23.el9_0.src.rpm
```
...
### `rpm` package: `oraclelinux-release-9.0-1.0.15.el9.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-9.0-1.0.15.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/oraclelinux-release-9.0-1.0.15.el9.src.rpm
```

### `rpm` package: `oraclelinux-release-el9-1.0-5.el9.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-el9-1.0-5.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/oraclelinux-release-el9-1.0-5.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/tzdata-2022a-1.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/tzdata-2022a-1.el9_0.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-16.0.1.el9_0.2.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-16.0.1.el9_0.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/vim-8.2.2637-16.0.1.el9_0.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/vim-8.2.2637-16.0.1.el9_0.2.src.rpm
```
