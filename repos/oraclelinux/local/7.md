...
- Created: `2022-01-12T22:34:18.501391366Z`
...
```console
$ yumdownloader --quiet --source --urls libsmartcols-2.23.2-65.0.3.el7_9.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/util-linux-2.23.2-65.0.3.el7_9.1.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls util-linux-2.23.2-65.0.3.el7_9.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/util-linux-2.23.2-65.0.3.el7_9.1.src.rpm
```
