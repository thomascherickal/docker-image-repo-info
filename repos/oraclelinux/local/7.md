...
- Created: `2021-11-03T00:20:08.058783973Z`
...
### `rpm` package: `bind-export-libs-9.11.4-26.P2.el7_9.7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls bind-export-libs-9.11.4-26.P2.el7_9.7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/bind-9.11.4-26.P2.el7_9.7.src.rpm
```
