...
- Created: `2020-07-16T16:20:58.895243889Z`
- Virtual Size: ~ 254.63 Mb  
...
### `rpm` package: `dbus-1.10.24-14.0.1.el7_8.x86_64`
...
```console
$ yumdownloader --quiet --source --urls dbus-1.10.24-14.0.1.el7_8
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/dbus-1.10.24-14.0.1.el7_8.src.rpm
```
...
### `rpm` package: `dbus-libs-1.10.24-14.0.1.el7_8.x86_64`
...
```console
$ yumdownloader --quiet --source --urls dbus-libs-1.10.24-14.0.1.el7_8
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/dbus-1.10.24-14.0.1.el7_8.src.rpm
```
...
### `rpm` package: `libgudev1-219-73.0.1.el7_8.8.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libgudev1-219-73.0.1.el7_8.8
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-73.0.1.el7_8.8.src.rpm
```
...
### `rpm` package: `rsyslog-8.24.0-52.el7_8.2.x86_64`
...
```console
$ yumdownloader --quiet --source --urls rsyslog-8.24.0-52.el7_8.2
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/rsyslog-8.24.0-52.el7_8.2.src.rpm
```
...
### `rpm` package: `systemd-219-73.0.1.el7_8.8.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-219-73.0.1.el7_8.8
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-73.0.1.el7_8.8.src.rpm
```

### `rpm` package: `systemd-libs-219-73.0.1.el7_8.8.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-libs-219-73.0.1.el7_8.8
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-73.0.1.el7_8.8.src.rpm
```
