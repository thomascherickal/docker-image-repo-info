## `tomcat:10.0.11-jdk16-openjdk-slim-buster`
...
### `tomcat:10.0.11-jdk16-openjdk-slim-buster` - linux; amd64
...
### `tomcat:10.0.11-jdk16-openjdk-slim-buster` - linux; arm64 variant v8
