## `tomcat:10.0.16-jre8-openjdk-slim-bullseye`
...
### `tomcat:10.0.16-jre8-openjdk-slim-bullseye` - linux; amd64
...
### `tomcat:10.0.16-jre8-openjdk-slim-bullseye` - linux; arm64 variant v8
