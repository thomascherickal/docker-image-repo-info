## `tomcat:9.0.46-jdk16-openjdk-slim-buster`
...
### `tomcat:9.0.46-jdk16-openjdk-slim-buster` - linux; amd64
...
### `tomcat:9.0.46-jdk16-openjdk-slim-buster` - linux; arm64 variant v8
