...
```console
$ docker pull tomcat@sha256:a572a6662032ac01bcf6f0d5474d94e190606a9af4ada4696e284ea749974e93
```
...
```console
$ docker pull tomcat@sha256:a6d60d2fa42f7b460d5f6dd417a19d4e6de9346f5352a94be0845bc8480fb5b6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **248.2 MB (248247617 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:178688009d11b74fdf96d9d0bff94d6350fb05c7ff6b57c63ea404b4ee2f8dbd`
-	Default Command: `["catalina.sh","run"]`
