...
```console
$ docker pull tomcat@sha256:13188f2d64113d3bb947f09bdaa25db86fe8aae8a07673e110dd9b003644f967
```
...
```console
$ docker pull tomcat@sha256:d9b256affad46239f33385cdd5ac27c82511979b71d35a7a41fa98bea32cc13d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.7 MB (245677983 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f30b1620fc6bbfcbfaf76499785269f265489e6075072a7f48f92cf728c4341`
-	Default Command: `["catalina.sh","run"]`
