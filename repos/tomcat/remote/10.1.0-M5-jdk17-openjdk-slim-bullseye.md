## `tomcat:10.1.0-M5-jdk17-openjdk-slim-bullseye`

```console
$ docker pull tomcat@sha256:349955d37fa318f0b03bca838fbbbf7606657001297ae4371327ca1cee96e673
```
...
### `tomcat:10.1.0-M5-jdk17-openjdk-slim-bullseye` - linux; amd64
