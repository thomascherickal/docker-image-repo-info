## `tomcat:10.1.0-M11-jdk11-openjdk-slim-buster`
...
### `tomcat:10.1.0-M11-jdk11-openjdk-slim-buster` - linux; amd64
...
### `tomcat:10.1.0-M11-jdk11-openjdk-slim-buster` - linux; arm64 variant v8
