...
```console
$ docker pull tomcat@sha256:3593fef10852f51c1243c4e275ea6acba1441413271a04b6047da19259458b24
```
...
```console
$ docker pull tomcat@sha256:fba3f32d312fd15d804e937426c4e1bfbcca87f82e1eff1ac0fa5372b4997b6b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **343.6 MB (343589165 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4070fdb373119a0eb9b00cb411ae88d3557c8378d192b19c12d128efd8da6596`
-	Default Command: `["catalina.sh","run"]`
