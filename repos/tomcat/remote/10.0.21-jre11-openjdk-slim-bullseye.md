...
```console
$ docker pull tomcat@sha256:3bf0df15f8f7067b0acd4e34cc8009b902e11df6e10f9c834cd4c1a792c6d5ae
```
...
### `tomcat:10.0.21-jre11-openjdk-slim-bullseye` - linux; amd64
...
### `tomcat:10.0.21-jre11-openjdk-slim-bullseye` - linux; arm64 variant v8
