...
- Created: `2021-07-13T21:20:17.107902158Z`
- Virtual Size: ~ 141.00 Mb  
...
- Environment:
  ...
  - `ASSET=ce`
  - `KONG_VERSION=2.5.0`
  - `KONG_AMD64_SHA=ebe0cf3a3e71d202774ede5083c98e2ae39fae0459d11140f53401a66527e1b7`
  - `KONG_ARM64_SHA=131964ce443f2d08dc98191fcc442867f2dee2f741ccee9cc519bb99c765f3cf`
- Labels:
...
```console
git-perl-2.30.2-r0 description:
Additional Git commands that requires perl

git-perl-2.30.2-r0 webpage:
https://www.git-scm.com/

git-perl-2.30.2-r0 installed size:
132 KiB

git-perl-2.30.2-r0 license:
GPL-2.0-or-later
...
```console
perl-git-2.30.2-r0 description:
Perl interface to Git

perl-git-2.30.2-r0 webpage:
https://www.git-scm.com/

perl-git-2.30.2-r0 installed size:
152 KiB

perl-git-2.30.2-r0 license:
GPL-2.0-or-later
