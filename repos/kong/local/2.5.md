...
- Created: `2022-06-14T23:22:10.530365995Z`
...
```console
git-perl-2.34.2-r0 description:
Additional Git commands that requires perl

git-perl-2.34.2-r0 webpage:
https://www.git-scm.com/

git-perl-2.34.2-r0 installed size:
132 KiB

git-perl-2.34.2-r0 license:
GPL-2.0-or-later
...
```console
perl-git-2.34.2-r0 description:
Perl interface to Git

perl-git-2.34.2-r0 webpage:
https://www.git-scm.com/

perl-git-2.34.2-r0 installed size:
152 KiB

perl-git-2.34.2-r0 license:
GPL-2.0-or-later
