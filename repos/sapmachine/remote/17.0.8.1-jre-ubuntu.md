## `sapmachine:17.0.8.1-jre-ubuntu`
...
### `sapmachine:17.0.8.1-jre-ubuntu` - linux; amd64
...
### `sapmachine:17.0.8.1-jre-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:17.0.8.1-jre-ubuntu` - linux; ppc64le
