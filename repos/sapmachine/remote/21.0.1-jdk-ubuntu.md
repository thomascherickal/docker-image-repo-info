...
### `sapmachine:21.0.1-jdk-ubuntu` - linux; amd64
...
### `sapmachine:21.0.1-jdk-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:21.0.1-jdk-ubuntu` - linux; ppc64le
