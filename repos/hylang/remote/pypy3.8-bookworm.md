...
```console
$ docker pull hylang@sha256:e8d1e86ba02c868cbf5fea53e6aea547dfd659333325eb0e877e05ceff833a83
```
...
### `hylang:pypy3.8-bookworm` - linux; amd64
...
### `hylang:pypy3.8-bookworm` - linux; arm64 variant v8
...
### `hylang:pypy3.8-bookworm` - linux; 386
