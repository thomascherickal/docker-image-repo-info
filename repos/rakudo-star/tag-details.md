...
```console
$ docker pull rakudo-star@sha256:a05c65a30fb74a05890de9c33c4b6f2e50bfe61849be3d44628b888b42ac1ea6
```
...
```console
$ docker pull rakudo-star@sha256:1cb986685745b6b12460e6c0676381c12233b1092e1b86a71891e0ae40b0f385
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.9 MB (161901606 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:832a26c76f88f8b16540aa6d670b771dc3abea931d6fa4534c79e0d863326de8`
...
# Thu, 31 Mar 2022 00:54:05 GMT
MAINTAINER Rob Hoelz
# Thu, 31 Mar 2022 00:54:05 GMT
RUN groupadd -r raku && useradd -m -r -g raku raku
# Thu, 31 Mar 2022 00:54:06 GMT
ARG rakudo_version=2021.04
# Thu, 31 Mar 2022 00:54:06 GMT
ENV rakudo_version=2021.04
# Thu, 31 Mar 2022 01:03:20 GMT
...
-	Layers:
	...
	-	`sha256:e98d6bb51c7ccadb2f72a1498db713088ec7c3f449b3c810d95dbca6ba7511ba`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:287b432e9ae492664bf45a61bf18e9b2b2258d63141d66ea3d8298db4f28e282`  
		Last Modified: Thu, 31 Mar 2022 01:03:39 GMT  
		Size: 4.1 KB (4132 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69f3f6dbc8b6ed57d4a20c4a0bec70a213f76804666532a9ffb412981992477c`  
		Last Modified: Thu, 31 Mar 2022 01:03:46 GMT  
		Size: 41.8 MB (41762520 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `rakudo-star:2021.04` - linux; arm64 variant v8

```console
$ docker pull rakudo-star@sha256:42f8e9022f21db712bee7379641c6c3b88464bad19418eb2cc1544c7200ab257
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.0 MB (159973231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e1b43b7ae374ab5b686298cea8c8b74c20b9d0b4fb1fe288f13125c3a90ed69`
-	Default Command: `["raku"]`
...
RUN apt-get update && apt-get install -y --no-install-recommends 		git 		mercurial 		openssh-client 		subversion 				procps 	&& rm -rf /var/lib/apt/lists/*
# Wed, 30 Mar 2022 23:24:51 GMT
MAINTAINER Rob Hoelz
# Wed, 30 Mar 2022 23:24:52 GMT
RUN groupadd -r raku && useradd -m -r -g raku raku
# Wed, 30 Mar 2022 23:24:53 GMT
ARG rakudo_version=2021.04
# Wed, 30 Mar 2022 23:24:54 GMT
ENV rakudo_version=2021.04
# Wed, 30 Mar 2022 23:37:32 GMT
RUN buildDeps='         gcc         libc6-dev         make     '         url="https://rakudo.org/dl/star/rakudo-star-${rakudo_version}.tar.gz"     keyserver='ha.pool.sks-keyservers.net'     keyfp='B6F697742EFCAF5F23CE51D5031D65902E840821'     tmpdir="$(mktemp -d)"     && set -eux     && export GNUPGHOME="$tmpdir"     && apt-get update     && apt-get install -y --no-install-recommends $buildDeps     && rm -rf /var/lib/apt/lists/*     && mkdir ${tmpdir}/rakudo         && curl -fsSL ${url}.asc -o ${tmpdir}/rakudo.tar.gz.asc     && curl -fsSL $url -o ${tmpdir}/rakudo.tar.gz     && gpg --batch --keyserver $keyserver --recv-keys $keyfp     && gpg --batch --verify ${tmpdir}/rakudo.tar.gz.asc ${tmpdir}/rakudo.tar.gz         && tar xzf ${tmpdir}/rakudo.tar.gz --strip-components=1 -C ${tmpdir}/rakudo     && (         cd ${tmpdir}/rakudo         && bash bin/rstar install -p /usr     )     && rm -rf $tmpdir     && apt-get purge -y --auto-remove $buildDeps
# Wed, 30 Mar 2022 23:37:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/share/perl6/core/bin:/usr/share/perl6/site/bin:/usr/share/perl6/vendor/bin
# Wed, 30 Mar 2022 23:37:33 GMT
CMD ["raku"]
```
...
-	Layers:
	...
	-	`sha256:66bff08cf9734159a77ecf001874bfd910561517c9c87811003564d4a2f00421`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9db2f47a47b73dc6e73dba08b76c4816a700f1e6582cce734d767de41630122a`  
		Last Modified: Wed, 30 Mar 2022 23:38:03 GMT  
		Size: 4.0 KB (4008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c80a133002b9b71f6b4e93b35c72fd6a49c5fdc2d5eefb731e66236d8af817d`  
		Last Modified: Wed, 30 Mar 2022 23:38:11 GMT  
		Size: 41.1 MB (41081582 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
