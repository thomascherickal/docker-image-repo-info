...
```console
$ docker pull rakudo-star@sha256:7257cabc2c38c995747e3a33ea5ac02707f133bfb961b89cbf0147995abfe3f3
```
...
```console
$ docker pull rakudo-star@sha256:a65bfdc2c127902992297a28908dd0bf93de7a4a1046a5575433c6be6eccff36
```
