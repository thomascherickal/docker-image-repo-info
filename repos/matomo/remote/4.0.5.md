...
```console
$ docker pull matomo@sha256:393a14531ecb45b03a3e7261471afd8e3f2d5b7475fc64cd1d48f2e2ac721adf
```
...
### `matomo:4.0.5` - linux; arm variant v5
...
### `matomo:4.0.5` - linux; arm variant v7
...
### `matomo:4.0.5` - linux; arm64 variant v8
