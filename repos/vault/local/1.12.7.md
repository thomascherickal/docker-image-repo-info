...
- Created: `2023-09-29T00:07:01.686322812Z`
...
```console
dumb-init-1.2.5-r2 description:
minimal init system for Linux containers

dumb-init-1.2.5-r2 webpage:
https://github.com/Yelp/dumb-init

dumb-init-1.2.5-r2 installed size:
68 KiB

dumb-init-1.2.5-r2 license:
MIT
