...
```console
$ docker pull python@sha256:b9af7bbd27565680dfde058bcff079e041ccf296928eaadbc8e73092f8c1fcb7
```
...
### `python:windowsservercore` - windows version 10.0.20348.524; amd64
...
### `python:windowsservercore` - windows version 10.0.17763.2565; amd64
