...
```console
$ docker pull python@sha256:1516fd3297fd5542766ade6f9df86c4c92edaec0068372e876be2ee9b74404e6
```
...
### `python:windowsservercore` - windows version 10.0.20348.469; amd64
...
### `python:windowsservercore` - windows version 10.0.17763.2452; amd64
