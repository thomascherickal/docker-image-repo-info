...
```console
$ docker pull python@sha256:ddd85d0e04e3be8a06184f0f450c343de711d335233a683e7f47ae87616fdb78
```
...
### `python:3.9.0a2-windowsservercore-1809` - windows version 10.0.17763.914; amd64
