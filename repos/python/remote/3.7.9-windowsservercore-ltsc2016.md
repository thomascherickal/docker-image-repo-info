...
```console
$ docker pull python@sha256:d2974f6e7642618647a33e9fdf103b806b41c7b6e2f6a82099530985192e518b
```
...
### `python:3.7.9-windowsservercore-ltsc2016` - windows version 10.0.14393.4046; amd64
