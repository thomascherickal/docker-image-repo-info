...
```console
$ docker pull docker@sha256:42d7e86d1a1a3796564a28044b24a975ff98ecc602ebb43bad5dcb5e82451a1c
```
...
```console
$ docker pull docker@sha256:f6e89a5e66bcbb7d9bed6dec4edf54483425d6f4d847a3c1b27947feba28d080
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **125.7 MB (125669530 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a984df9507efbbba9d14c72ab2517aa5f10450e769657b4d1636cd2d89d1ed62`
...
-	Layers:
	...
	-	`sha256:a26a4aa1be3ea38b5b432a920c5675f02e2ccd60fc389e2923d9f74d8b149a1f`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1b162e9dac32efdebca9e002254d73ac75a34a78dd633863a020f90a218a397e`  
		Last Modified: Wed, 27 Sep 2023 02:51:00 GMT  
		Size: 4.9 MB (4944457 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `docker:git` - unknown; unknown

```console
$ docker pull docker@sha256:4c22f862e77249524ef8327d23b88e9652c31294ca428d284d4277ba289ba57c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **990.7 KB (990690 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:414386805054cc2b98fb8c4513b373271403e88c759d7105717f3fc8ab547711`

```dockerfile
```

-	Layers:
	-	`sha256:763adb224edc62a357991bcae03a3992b5c1c98f6225fd366b2c52076850dc9b`  
		Last Modified: Wed, 27 Sep 2023 02:50:59 GMT  
		Size: 977.8 KB (977761 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:df98330d2bd34f77643c3a93ee083efd0d1191206562f0ee7af5bdd93248c729`  
		Last Modified: Wed, 27 Sep 2023 02:50:59 GMT  
...
```console
$ docker pull docker@sha256:d770bc7ecea591ddb43d54d16d1a1336e7ca91fde5787c10597ec93c691cb106
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **116.9 MB (116941154 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3fb106e57e40e5fd44c25c2a74d7e57db3bf549691541a7e71a4913cb4843379`
-	Entrypoint: `["dockerd-entrypoint.sh"]`
...
-	Layers:
	...
	-	`sha256:f06cf636ece24e41e358eee9f4d191a58ff476a8c57e8dc47ab56207720ac32c`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3f94a45483ef5f4942c0e7583080a4350d676878192e7682dbe1fea9ba49a5f3`  
		Last Modified: Wed, 27 Sep 2023 02:51:44 GMT  
		Size: 5.0 MB (5037283 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `docker:git` - unknown; unknown

```console
$ docker pull docker@sha256:27476fd1a1ba157c5ccf56fd37a821036d5fcc08f5dbf2c474cfb33d04047772
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **988.8 KB (988768 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:805d4ae2eedfee0c87e63b86b06934aa784629147478810cb379fb2503a1f484`

```dockerfile
```

-	Layers:
	-	`sha256:ca245b03a7f6d6186091c9d91e3ba072eb33492daf19b87d3f0c27579127f3b3`  
		Last Modified: Wed, 27 Sep 2023 02:51:43 GMT  
		Size: 978.0 KB (978004 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:4299cc56a7a3d3d20feedbcd1b545ef738d393e36e1e457cd2f21c1be78bcea4`  
		Last Modified: Wed, 27 Sep 2023 02:51:42 GMT  
