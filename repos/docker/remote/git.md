...
```console
$ docker pull docker@sha256:6170dfd63e78de91eb904aa540e3f9b793b6e19678417b8f94ff404d9d53e370
```
...
```console
$ docker pull docker@sha256:d5ddec3b74cedf9b1265727a1b0afd4349b18a11461db0526edea3deec87c7d0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.0 MB (45974286 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:040ed3eefd1ef4512c3ddee5b4248d427ec9efb9955139a0d8f8fc09a1f6a76e`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["sh"]`
...
-	Layers:
	...
	-	`sha256:9d3e76e75bf71bca2dcac7f6242c22b88eb138c0a744d24903479f4e7cb78a48`  
		...
		Size: 117.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e32c9d47700894655d4b8f2231c573f8ed9bd87949d16e2c4cda86ab8a62ac8`  
		Last Modified: Tue, 09 Aug 2022 18:31:43 GMT  
