...
```console
$ docker pull docker@sha256:f7a90c24f30bc61336fe464b0c96e7d5e6b52990ef14a5daf4f21a8f8b1ff4a4
```
...
### `docker:19.03.13-beta1` - linux; amd64
...
### `docker:19.03.13-beta1` - linux; arm64 variant v8
