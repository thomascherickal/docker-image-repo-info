...
### `docker:25.0.0-beta.1-dind-alpine3.18` - linux; amd64
...
### `docker:25.0.0-beta.1-dind-alpine3.18` - unknown; unknown
...
### `docker:25.0.0-beta.1-dind-alpine3.18` - linux; arm64 variant v8
