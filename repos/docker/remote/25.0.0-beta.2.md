...
### `docker:25.0.0-beta.2` - linux; amd64
...
### `docker:25.0.0-beta.2` - unknown; unknown
...
### `docker:25.0.0-beta.2` - linux; arm variant v6
...
### `docker:25.0.0-beta.2` - linux; arm variant v7
...
### `docker:25.0.0-beta.2` - linux; arm64 variant v8
