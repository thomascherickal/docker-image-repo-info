...
```console
$ docker pull docker@sha256:bc94fbd481873f570d525d3d74eb62b0ba0c2d3cc9ff2262a08dab9079b59061
```
...
```console
$ docker pull docker@sha256:8d9e7539bbe44a4b366e7fc79888c8ff8f8ea3d625b409166f40eea616bf7a29
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.3 MB (104300244 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a38cc6a250ede7cad47b7ec83e1d6927e6094a3d45deaf2921342c6eb21ac75`
...
```console
$ docker pull docker@sha256:fb67c39df1d078af51c39ca8ce5f6df9b7ea1e66137eada6a605c6fd04f96f23
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.4 MB (96424890 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e2f19e9622fd266b7242186571bb595d78c4461020e4a79bc1a37630cdacc53`
-	Entrypoint: `["dockerd-entrypoint.sh"]`
-	Default Command: `[]`
...
# Tue, 29 Nov 2022 01:42:20 GMT
CMD ["sh"]
# Tue, 29 Nov 2022 01:42:35 GMT
RUN set -eux; 	apk add --no-cache 		btrfs-progs 		e2fsprogs 		e2fsprogs-extra 		ip6tables 		iptables 		openssl 		shadow-uidmap 		xfsprogs 		xz 		pigz 	; 	if zfs="$(apk info --no-cache --quiet zfs)" && [ -n "$zfs" ]; then 		apk add --no-cache zfs; 	fi
# Tue, 29 Nov 2022 01:42:35 GMT
RUN set -eux; 	addgroup -S dockremap; 	adduser -S -G dockremap dockremap; 	echo 'dockremap:165536:65536' >> /etc/subuid; 	echo 'dockremap:165536:65536' >> /etc/subgid
# Tue, 29 Nov 2022 01:42:39 GMT
RUN set -eux; 		apkArch="$(apk --print-arch)"; 	case "$apkArch" in 		'x86_64') 			url='https://download.docker.com/linux/static/test/x86_64/docker-22.06.0-beta.0.tgz'; 			;; 		'armhf') 			url='https://download.docker.com/linux/static/test/armel/docker-22.06.0-beta.0.tgz'; 			;; 		'armv7') 			url='https://download.docker.com/linux/static/test/armhf/docker-22.06.0-beta.0.tgz'; 			;; 		'aarch64') 			url='https://download.docker.com/linux/static/test/aarch64/docker-22.06.0-beta.0.tgz'; 			;; 		*) echo >&2 "error: unsupported 'docker.tgz' architecture ($apkArch)"; exit 1 ;; 	esac; 		wget -O 'docker.tgz' "$url"; 		tar --extract 		--file docker.tgz 		--strip-components 1 		--directory /usr/local/bin/ 		--no-same-owner 		--exclude 'docker/docker' 	; 	rm docker.tgz; 		dockerd --version; 	containerd --version; 	ctr --version; 	runc --version
# Tue, 29 Nov 2022 01:42:39 GMT
ENV DIND_COMMIT=1f32e3c95d72a29b3eaacba156ed675dba976cb5
# Tue, 29 Nov 2022 01:42:40 GMT
RUN set -eux; 	wget -O /usr/local/bin/dind "https://raw.githubusercontent.com/docker/docker/${DIND_COMMIT}/hack/dind"; 	chmod +x /usr/local/bin/dind
# Tue, 29 Nov 2022 01:42:40 GMT
COPY file:45c7926c5d79023b457ad24274c893b1fc21f241bed46421dc901b8237045f17 in /usr/local/bin/ 
# Tue, 29 Nov 2022 01:42:40 GMT
...
-	Layers:
	...
	-	`sha256:24cd408bf04685f6ea022294a828d274eac495e938b608fb407ea3b2be0b5cfc`  
		...
		Size: 150.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15c9113df2d9cd20b8e5dc39057daa614590a019cd6b8edc47937ddc8e7fd775`  
		Last Modified: Tue, 29 Nov 2022 01:44:28 GMT  
		Size: 7.0 MB (6990648 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:526f723470a2cdd5614b932d99b2cf5ad2f7c36626eb0c2ba2284af055ac7661`  
		Last Modified: Tue, 29 Nov 2022 01:44:27 GMT  
		Size: 1.3 KB (1321 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcc3aef003fc2db9bc77e61c9cb5a2920c48d7151a86c1cca98a113fbb75c324`  
		Last Modified: Tue, 29 Nov 2022 01:44:33 GMT  
		Size: 49.0 MB (48977154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dca10cf8d968863ccf55e6e1fd4e2c5659ad58d262b87fceb34afe0498cc5641`  
		Last Modified: Tue, 29 Nov 2022 01:44:27 GMT  
		Size: 1.0 KB (1044 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5846ce6b57ecff941781ffff28491f236ca0994192be7ae5a56feb8abaf62e3`  
		Last Modified: Tue, 29 Nov 2022 01:44:27 GMT  
