...
### `docker:25.0.0-beta.2-dind-alpine3.19` - linux; amd64
...
### `docker:25.0.0-beta.2-dind-alpine3.19` - unknown; unknown
...
### `docker:25.0.0-beta.2-dind-alpine3.19` - linux; arm variant v6
...
### `docker:25.0.0-beta.2-dind-alpine3.19` - linux; arm variant v7
...
### `docker:25.0.0-beta.2-dind-alpine3.19` - linux; arm64 variant v8
