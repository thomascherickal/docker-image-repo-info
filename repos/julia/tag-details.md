...
```console
$ docker pull julia@sha256:3e2165471296896dc5c4bc0ac6fb8099e6d8d22fe29c2cc92d4287d9821b0a32
```
...
```console
$ docker pull julia@sha256:f77c2ab82add6ea11167655aba6fd3e1a8d2cec6345533b9f91a80096119ceac
```
