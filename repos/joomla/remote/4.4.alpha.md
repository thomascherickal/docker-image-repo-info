...
```console
$ docker pull joomla@sha256:18e62703c1073d7304e49ac88f7642867b32c520796163c502c6893b2c145254
```
...
### `joomla:4.4.alpha` - linux; arm variant v5
...
### `joomla:4.4.alpha` - linux; arm variant v7
...
### `joomla:4.4.alpha` - linux; arm64 variant v8
...
### `joomla:4.4.alpha` - linux; mips64le
...
### `joomla:4.4.alpha` - linux; ppc64le
