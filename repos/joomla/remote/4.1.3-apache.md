...
### `joomla:4.1.3-apache` - linux; amd64
...
### `joomla:4.1.3-apache` - linux; arm variant v5
...
### `joomla:4.1.3-apache` - linux; arm variant v7
...
### `joomla:4.1.3-apache` - linux; arm64 variant v8
...
### `joomla:4.1.3-apache` - linux; ppc64le
...
### `joomla:4.1.3-apache` - linux; s390x
