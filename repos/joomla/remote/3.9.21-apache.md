...
### `joomla:3.9.21-apache` - linux; arm variant v5
...
### `joomla:3.9.21-apache` - linux; arm variant v7
...
### `joomla:3.9.21-apache` - linux; arm64 variant v8
...
### `joomla:3.9.21-apache` - linux; mips64le
...
### `joomla:3.9.21-apache` - linux; ppc64le
...
### `joomla:3.9.21-apache` - linux; s390x
