...
```console
$ docker pull joomla@sha256:048e3694bf691288b8b9c6717323f383a7791615ffadd2a41aed29dd03e415d1
```
...
### `joomla:5.0.0-beta1-apache` - linux; amd64
...
### `joomla:5.0.0-beta1-apache` - linux; arm variant v5
...
### `joomla:5.0.0-beta1-apache` - linux; arm variant v7
...
### `joomla:5.0.0-beta1-apache` - linux; arm64 variant v8
...
### `joomla:5.0.0-beta1-apache` - linux; 386
...
### `joomla:5.0.0-beta1-apache` - linux; mips64le
...
### `joomla:5.0.0-beta1-apache` - linux; ppc64le
...
### `joomla:5.0.0-beta1-apache` - linux; s390x
