...
```console
$ docker pull joomla@sha256:1316aa9f7ae8cfd9e3bccee997ba425dd80d81bc9f9df1b3e85620db12139ba9
```
...
### `joomla:4.4.0-alpha` - linux; amd64
...
### `joomla:4.4.0-alpha` - linux; arm variant v5
...
### `joomla:4.4.0-alpha` - linux; arm variant v7
...
### `joomla:4.4.0-alpha` - linux; arm64 variant v8
...
### `joomla:4.4.0-alpha` - linux; mips64le
...
### `joomla:4.4.0-alpha` - linux; ppc64le
...
### `joomla:4.4.0-alpha` - linux; s390x
