...
```console
$ docker pull joomla@sha256:6e0a6943b69b14e2df3f5d495999e732e939dee3bcde4ec20ca613fe4a746969
```
...
### `joomla:4.4.0-alpha2-php8.0-apache` - linux; amd64
...
### `joomla:4.4.0-alpha2-php8.0-apache` - linux; arm variant v5
...
### `joomla:4.4.0-alpha2-php8.0-apache` - linux; arm variant v7
...
### `joomla:4.4.0-alpha2-php8.0-apache` - linux; arm64 variant v8
...
### `joomla:4.4.0-alpha2-php8.0-apache` - linux; 386
...
### `joomla:4.4.0-alpha2-php8.0-apache` - linux; ppc64le
...
### `joomla:4.4.0-alpha2-php8.0-apache` - linux; s390x
