## `joomla:4.4.0-rc-php8.0-fpm-alpine`

```console
$ docker pull joomla@sha256:741c4ff969fb3999b7032ccfd1ea7ee5ccb71f6ed4992aac7a591e379ad33313
```
...
### `joomla:4.4.0-rc-php8.0-fpm-alpine` - linux; amd64
...
### `joomla:4.4.0-rc-php8.0-fpm-alpine` - linux; arm variant v6
...
### `joomla:4.4.0-rc-php8.0-fpm-alpine` - linux; arm variant v7
...
### `joomla:4.4.0-rc-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:4.4.0-rc-php8.0-fpm-alpine` - linux; 386
...
### `joomla:4.4.0-rc-php8.0-fpm-alpine` - linux; ppc64le
