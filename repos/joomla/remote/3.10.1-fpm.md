...
```console
$ docker pull joomla@sha256:66939813963a2c04a8df98d9616277edd8d82f47a8555aafd1f7da53aeac4161
```
...
### `joomla:3.10.1-fpm` - linux; arm variant v5
...
### `joomla:3.10.1-fpm` - linux; arm variant v7
...
### `joomla:3.10.1-fpm` - linux; arm64 variant v8
...
### `joomla:3.10.1-fpm` - linux; mips64le
...
### `joomla:3.10.1-fpm` - linux; ppc64le
