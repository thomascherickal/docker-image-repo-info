...
### `joomla:3.9.14-php7.2-fpm-alpine` - linux; amd64
...
### `joomla:3.9.14-php7.2-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:3.9.14-php7.2-fpm-alpine` - linux; 386
...
### `joomla:3.9.14-php7.2-fpm-alpine` - linux; ppc64le
