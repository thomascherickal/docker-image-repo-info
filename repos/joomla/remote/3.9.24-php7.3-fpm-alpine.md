...
### `joomla:3.9.24-php7.3-fpm-alpine` - linux; amd64
...
### `joomla:3.9.24-php7.3-fpm-alpine` - linux; arm variant v7
...
### `joomla:3.9.24-php7.3-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:3.9.24-php7.3-fpm-alpine` - linux; 386
...
### `joomla:3.9.24-php7.3-fpm-alpine` - linux; ppc64le
...
### `joomla:3.9.24-php7.3-fpm-alpine` - linux; s390x
