...
```console
$ docker pull joomla@sha256:48ab7b7aaac2b055c96d999b83a6b25d6ffeecb5282ea725c529e6ca8babab60
```
...
### `joomla:3.9.27-fpm-alpine` - linux; amd64
...
### `joomla:3.9.27-fpm-alpine` - linux; arm variant v6
...
### `joomla:3.9.27-fpm-alpine` - linux; arm variant v7
...
### `joomla:3.9.27-fpm-alpine` - linux; 386
...
### `joomla:3.9.27-fpm-alpine` - linux; ppc64le
