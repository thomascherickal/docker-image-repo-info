...
```console
$ docker pull joomla@sha256:060af2108c5f81fcd7a42813727dc65953f5e09c11e46be7b97b47b927f0749f
```
...
### `joomla:4.4.0-beta1-php8.0-fpm-alpine` - linux; amd64
...
### `joomla:4.4.0-beta1-php8.0-fpm-alpine` - linux; arm variant v6
...
### `joomla:4.4.0-beta1-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:4.4.0-beta1-php8.0-fpm-alpine` - linux; 386
...
### `joomla:4.4.0-beta1-php8.0-fpm-alpine` - linux; s390x
