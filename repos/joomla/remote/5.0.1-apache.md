...
### `joomla:5.0.1-apache` - linux; amd64
...
### `joomla:5.0.1-apache` - linux; arm variant v5
...
### `joomla:5.0.1-apache` - linux; arm variant v7
...
### `joomla:5.0.1-apache` - linux; arm64 variant v8
...
### `joomla:5.0.1-apache` - linux; mips64le
...
### `joomla:5.0.1-apache` - linux; ppc64le
...
### `joomla:5.0.1-apache` - linux; s390x
