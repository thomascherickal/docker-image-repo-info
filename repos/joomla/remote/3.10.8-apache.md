...
```console
$ docker pull joomla@sha256:000b8853e2af4c791e83026e59d13f32e61251833e165c652b6fe9717634976a
```
...
### `joomla:3.10.8-apache` - linux; amd64
...
### `joomla:3.10.8-apache` - linux; arm variant v5
...
### `joomla:3.10.8-apache` - linux; arm64 variant v8
...
### `joomla:3.10.8-apache` - linux; 386
...
### `joomla:3.10.8-apache` - linux; mips64le
...
### `joomla:3.10.8-apache` - linux; ppc64le
...
### `joomla:3.10.8-apache` - linux; s390x
