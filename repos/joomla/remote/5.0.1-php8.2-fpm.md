...
```console
$ docker pull joomla@sha256:e7a6e2ed26a0bc8e1392203a983e37c35c969496acf19caac2568d84c7121c63
```
...
### `joomla:5.0.1-php8.2-fpm` - linux; amd64
...
### `joomla:5.0.1-php8.2-fpm` - linux; arm variant v5
...
### `joomla:5.0.1-php8.2-fpm` - linux; arm variant v7
...
### `joomla:5.0.1-php8.2-fpm` - linux; arm64 variant v8
...
### `joomla:5.0.1-php8.2-fpm` - linux; 386
...
### `joomla:5.0.1-php8.2-fpm` - linux; mips64le
...
### `joomla:5.0.1-php8.2-fpm` - linux; ppc64le
...
### `joomla:5.0.1-php8.2-fpm` - linux; s390x
