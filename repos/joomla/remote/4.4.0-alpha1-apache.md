...
### `joomla:4.4.0-alpha1-apache` - linux; amd64
...
### `joomla:4.4.0-alpha1-apache` - linux; arm variant v5
...
### `joomla:4.4.0-alpha1-apache` - linux; arm variant v7
...
### `joomla:4.4.0-alpha1-apache` - linux; arm64 variant v8
...
### `joomla:4.4.0-alpha1-apache` - linux; 386
...
### `joomla:4.4.0-alpha1-apache` - linux; mips64le
...
### `joomla:4.4.0-alpha1-apache` - linux; ppc64le
...
### `joomla:4.4.0-alpha1-apache` - linux; s390x
