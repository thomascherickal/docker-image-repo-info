...
```console
$ docker pull joomla@sha256:24c5feed71b6765680f56228aad4dcc527bd6e76b5a252e749f42b222458bb42
```
...
### `joomla:4.4.0-beta1-php8.0-fpm` - linux; amd64
...
### `joomla:4.4.0-beta1-php8.0-fpm` - linux; arm variant v5
...
### `joomla:4.4.0-beta1-php8.0-fpm` - linux; arm variant v7
...
### `joomla:4.4.0-beta1-php8.0-fpm` - linux; arm64 variant v8
...
### `joomla:4.4.0-beta1-php8.0-fpm` - linux; 386
...
### `joomla:4.4.0-beta1-php8.0-fpm` - linux; mips64le
...
### `joomla:4.4.0-beta1-php8.0-fpm` - linux; ppc64le
...
### `joomla:4.4.0-beta1-php8.0-fpm` - linux; s390x

```console
$ docker pull joomla@sha256:a8e0993953c4dc3b905387f82da7aafdb5679b7d1abf76ee14ec336824c3f500
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.9 MB (192893473 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4798fe3c27cf3425b524b108e80ad939dfef1dbfc86ad1fba4c11ff91564e79d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 19:30:05 GMT
VOLUME [/var/www/html]
# Wed, 06 Sep 2023 00:25:50 GMT
ENV JOOMLA_VERSION=4.4.0-beta1
# Wed, 06 Sep 2023 00:25:51 GMT
ENV JOOMLA_SHA512=0b4b375aa220b0943488213a2f0560d517403e0bc287739b6478f4f3aab65851e50ebf24c12f89a2d1234a31cb238b0bb4031fd0bcf76b83c6ee8ec4024efaed
# Wed, 06 Sep 2023 00:26:02 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.0-beta1/Joomla_4.4.0-beta1-Beta-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 06 Sep 2023 00:26:08 GMT
COPY file:ef363e892ed567a09d21138100f211c7065e8869c035615041fd679aebad2d73 in /entrypoint.sh 
# Wed, 06 Sep 2023 00:26:08 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 06 Sep 2023 00:26:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 06 Sep 2023 00:26:09 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:dc3856a35c383d7b047df826211ab8a84042ad010d5b7665e50210ca4adeeae7`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88e1d5a1369ba94b745336b279aeb63314b5b4ebba47722b82caea3f6032bb26`  
		Last Modified: Wed, 06 Sep 2023 00:33:30 GMT  
		Size: 25.1 MB (25087329 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2b05e23475e967aabf410ad059390ea6b2ae80946b54af2a9e208bb59cd448f`  
		Last Modified: Wed, 06 Sep 2023 00:33:26 GMT  
		Size: 1.8 KB (1840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:673c3571209466f8cbc622cd43f352e1f15498450c0560c126be8ab3999d531d`  
		Last Modified: Wed, 06 Sep 2023 00:33:26 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
