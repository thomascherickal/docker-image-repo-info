...
```console
$ docker pull joomla@sha256:5b437120fd873aecf3057fb9482587276ea2e6464407d3d93cf5b84117a64dce
```
...
### `joomla:3.9.15-php7.3` - linux; amd64
...
### `joomla:3.9.15-php7.3` - linux; arm variant v5
...
### `joomla:3.9.15-php7.3` - linux; arm variant v7
...
### `joomla:3.9.15-php7.3` - linux; arm64 variant v8
...
### `joomla:3.9.15-php7.3` - linux; 386
...
### `joomla:3.9.15-php7.3` - linux; ppc64le
