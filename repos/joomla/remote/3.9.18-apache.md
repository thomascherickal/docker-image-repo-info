...
```console
$ docker pull joomla@sha256:f62b12e5c167f19befb0dc33247e5ea80d1c57610e94dc42fdbec6fe8dbca83b
```
...
### `joomla:3.9.18-apache` - linux; amd64
...
### `joomla:3.9.18-apache` - linux; arm variant v5
...
### `joomla:3.9.18-apache` - linux; arm variant v7
...
### `joomla:3.9.18-apache` - linux; arm64 variant v8
...
### `joomla:3.9.18-apache` - linux; 386
...
### `joomla:3.9.18-apache` - linux; mips64le
...
### `joomla:3.9.18-apache` - linux; ppc64le
...
### `joomla:3.9.18-apache` - linux; s390x
