...
```console
$ docker pull joomla@sha256:e12ae369dd3c25d9ca3e1b165163a1dcdc7b7cb43baacc5038dbb276b5ef7c0a
```
...
### `joomla:4.2.3-php7.4-fpm` - linux; arm variant v5
...
### `joomla:4.2.3-php7.4-fpm` - linux; arm64 variant v8
...
### `joomla:4.2.3-php7.4-fpm` - linux; 386
...
### `joomla:4.2.3-php7.4-fpm` - linux; mips64le
...
### `joomla:4.2.3-php7.4-fpm` - linux; ppc64le
...
### `joomla:4.2.3-php7.4-fpm` - linux; s390x
