## `joomla:4.4.rc-php8.1-fpm-alpine`

```console
$ docker pull joomla@sha256:233064b5aebcc4b96ec5b3258f896f16a9e6f35291927054be37200225dacae3
```
...
### `joomla:4.4.rc-php8.1-fpm-alpine` - linux; amd64
...
### `joomla:4.4.rc-php8.1-fpm-alpine` - linux; arm variant v6
...
### `joomla:4.4.rc-php8.1-fpm-alpine` - linux; arm variant v7
...
### `joomla:4.4.rc-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:4.4.rc-php8.1-fpm-alpine` - linux; 386
...
### `joomla:4.4.rc-php8.1-fpm-alpine` - linux; ppc64le
...
### `joomla:4.4.rc-php8.1-fpm-alpine` - linux; s390x

```console
$ docker pull joomla@sha256:0526278a409d1b7c443a4d4b8ca80961ffd71a1aa7586ceb683f002f1362b2fe
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **106.3 MB (106313897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d686bdfea7f52fcb767610a2db38d958ebbabf94320ef0145a0c1646c63dc5c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Wed, 04 Oct 2023 23:21:03 GMT
ENV JOOMLA_VERSION=4.4.0-rc1
# Wed, 04 Oct 2023 23:21:03 GMT
ENV JOOMLA_SHA512=f71fd1fd1ba32630b6fb26854b7bb7bc09a9985407cd6138d57e0f7c91afb6f92c3ac3169f13323f144ebe89e7eb1d85b1ad0aa950812f23347224fe2037bca1
# Wed, 04 Oct 2023 23:21:15 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.0-rc1/Joomla_4.4.0-rc1-Release_Candidate-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 04 Oct 2023 23:21:20 GMT
COPY file:75d4151822bf32487f27c3996faec3e2842350001f3cabdee80506df7825dc96 in /entrypoint.sh 
# Wed, 04 Oct 2023 23:21:20 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 04 Oct 2023 23:21:20 GMT
...
-	Layers:
	...
	-	`sha256:4ff8c0e1e91e0482dde214b9f1e473d93d9079dace265c0f6f5511a16380e2c8`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5e9f733ac4902155e83a80ebe8ddb98b29005bbf0e2863bb58bd25e24008a8e`  
		Last Modified: Wed, 04 Oct 2023 23:40:22 GMT  
		Size: 25.3 MB (25256117 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e98b2ee421b1af9cd21306bfd39b2316e31defae43009ad43368d0e48c20622`  
		Last Modified: Wed, 04 Oct 2023 23:40:18 GMT  
		Size: 2.6 KB (2619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4b2c26815059f905d0699a7b14422a350a19a49249cf1b1d4103a097df92e45`  
		Last Modified: Wed, 04 Oct 2023 23:40:18 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
