...
### `joomla:4.0.5-php8.0-apache` - linux; amd64
...
### `joomla:4.0.5-php8.0-apache` - linux; arm variant v5
...
### `joomla:4.0.5-php8.0-apache` - linux; arm variant v7
...
### `joomla:4.0.5-php8.0-apache` - linux; arm64 variant v8
...
### `joomla:4.0.5-php8.0-apache` - linux; 386
...
### `joomla:4.0.5-php8.0-apache` - linux; mips64le
...
### `joomla:4.0.5-php8.0-apache` - linux; ppc64le
...
### `joomla:4.0.5-php8.0-apache` - linux; s390x
