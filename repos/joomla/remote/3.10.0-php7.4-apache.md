...
```console
$ docker pull joomla@sha256:d226e56ff2f3fc76dcf010553f654038910bc123a7de66d50e84b994fab55678
```
...
### `joomla:3.10.0-php7.4-apache` - linux; amd64
...
### `joomla:3.10.0-php7.4-apache` - linux; arm variant v5
...
### `joomla:3.10.0-php7.4-apache` - linux; arm64 variant v8
...
### `joomla:3.10.0-php7.4-apache` - linux; 386
...
### `joomla:3.10.0-php7.4-apache` - linux; mips64le
...
### `joomla:3.10.0-php7.4-apache` - linux; s390x
