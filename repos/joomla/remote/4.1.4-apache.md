...
### `joomla:4.1.4-apache` - linux; amd64
...
### `joomla:4.1.4-apache` - linux; arm64 variant v8
...
### `joomla:4.1.4-apache` - linux; mips64le
...
### `joomla:4.1.4-apache` - linux; ppc64le
...
### `joomla:4.1.4-apache` - linux; s390x
