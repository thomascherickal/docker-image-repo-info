...
### `joomla:4.4.0-beta-php8.0-fpm` - linux; arm variant v5
...
### `joomla:4.4.0-beta-php8.0-fpm` - linux; arm variant v7
...
### `joomla:4.4.0-beta-php8.0-fpm` - linux; mips64le
...
### `joomla:4.4.0-beta-php8.0-fpm` - linux; ppc64le
...
### `joomla:4.4.0-beta-php8.0-fpm` - linux; s390x
