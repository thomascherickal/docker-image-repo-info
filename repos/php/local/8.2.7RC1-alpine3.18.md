...
- Created: `2023-05-27T01:53:38.183657985Z`
- Virtual Size: ~ 97.11 Mb  
...
- Environment:
  ...
  - `PHP_VERSION=8.2.7RC1`
  - `PHP_URL=https://downloads.php.net/~pierrick/php-8.2.7RC1.tar.xz`
  - `PHP_ASC_URL=https://downloads.php.net/~pierrick/php-8.2.7RC1.tar.xz.asc`
  - `PHP_SHA256=af19cc4c5b50034e59186c369fd152c47f86b8eb921b41d67b61e64b42217ce9`
...
```console
curl-8.1.1-r1 description:
URL retrival utility and library

curl-8.1.1-r1 webpage:
https://curl.se/

curl-8.1.1-r1 installed size:
236 KiB

curl-8.1.1-r1 license:
curl
...
```console
libcurl-8.1.1-r1 description:
The multiprotocol file transfer library

libcurl-8.1.1-r1 webpage:
https://curl.se/

libcurl-8.1.1-r1 installed size:
552 KiB

libcurl-8.1.1-r1 license:
curl
