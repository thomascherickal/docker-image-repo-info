...
- Environment:
  ...
  - `PHP_VERSION=8.1.17RC1`
  - `PHP_URL=https://downloads.php.net/~patrickallaert/php-8.1.17RC1.tar.xz`
  - `PHP_ASC_URL=https://downloads.php.net/~patrickallaert/php-8.1.17RC1.tar.xz.asc`
  - `PHP_SHA256=ba7a4e15e6d778121d869fd6a417cfcdb72856afb3364cb4b0ebfe88eaaaed47`
