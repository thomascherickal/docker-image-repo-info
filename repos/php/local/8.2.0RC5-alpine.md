...
- Environment:
  ...
  - `PHP_URL=https://downloads.php.net/~pierrick/php-8.2.0RC5.tar.xz`
  - `PHP_ASC_URL=https://downloads.php.net/~pierrick/php-8.2.0RC5.tar.xz.asc`
  - `PHP_SHA256=5dbd72106664b3588a047da557b6a99a3cdfcb83de9890cc3be9db5af8e4aa0e`
