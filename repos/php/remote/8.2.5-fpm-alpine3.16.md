...
```console
$ docker pull php@sha256:9657c0a34d5ab86f1f57bafafe9b1e95edd1405bdeb1c3a96c4d3e09e7587632
```
...
### `php:8.2.5-fpm-alpine3.16` - linux; amd64
...
### `php:8.2.5-fpm-alpine3.16` - linux; arm variant v6
...
### `php:8.2.5-fpm-alpine3.16` - linux; arm variant v7
...
### `php:8.2.5-fpm-alpine3.16` - linux; arm64 variant v8
...
### `php:8.2.5-fpm-alpine3.16` - linux; 386

```console
$ docker pull php@sha256:3e4242cd3f9b42d00b51070db6166a17aae9cb97e4a8f27a902a40e52312db37
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.0 MB (29989332 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:42f00dc2e4f0694bae781262e1fd8543fa0508bcd877a02dae03bf2863e00136`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.2.5-fpm-alpine3.16` - linux; ppc64le
...
### `php:8.2.5-fpm-alpine3.16` - linux; s390x

```console
$ docker pull php@sha256:9e40222a9818c3ce3b012a93c9d77d0354808fadd254204bc535a48f13808d42
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.6 MB (28574855 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3538ac5c95a5252e93e51931b40ded2219062738bfbe697c4e6a9860fb32d5c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
