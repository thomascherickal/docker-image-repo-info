...
### `php:8.0.0beta4-buster` - linux; amd64
...
### `php:8.0.0beta4-buster` - linux; arm variant v5
...
### `php:8.0.0beta4-buster` - linux; arm variant v7
...
### `php:8.0.0beta4-buster` - linux; arm64 variant v8
...
### `php:8.0.0beta4-buster` - linux; 386
...
### `php:8.0.0beta4-buster` - linux; mips64le
...
### `php:8.0.0beta4-buster` - linux; ppc64le
...
### `php:8.0.0beta4-buster` - linux; s390x
