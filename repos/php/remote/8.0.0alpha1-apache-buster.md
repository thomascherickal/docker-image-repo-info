...
### `php:8.0.0alpha1-apache-buster` - linux; amd64
...
### `php:8.0.0alpha1-apache-buster` - linux; arm variant v7
...
### `php:8.0.0alpha1-apache-buster` - linux; arm64 variant v8
...
### `php:8.0.0alpha1-apache-buster` - linux; 386
...
### `php:8.0.0alpha1-apache-buster` - linux; mips64le
...
### `php:8.0.0alpha1-apache-buster` - linux; s390x
