...
```console
$ docker pull php@sha256:a3642b28e6423fb6071efcdcd237bd3794c286e9a4aa7e917332b261812d4e4d
```
...
### `php:7.4.13-fpm` - linux; arm variant v5
...
### `php:7.4.13-fpm` - linux; arm variant v7
...
### `php:7.4.13-fpm` - linux; arm64 variant v8
