...
### `php:7.4.28-bullseye` - linux; amd64
...
### `php:7.4.28-bullseye` - linux; arm variant v5
...
### `php:7.4.28-bullseye` - linux; arm variant v7
...
### `php:7.4.28-bullseye` - linux; arm64 variant v8
...
### `php:7.4.28-bullseye` - linux; mips64le
...
### `php:7.4.28-bullseye` - linux; ppc64le
...
### `php:7.4.28-bullseye` - linux; s390x
