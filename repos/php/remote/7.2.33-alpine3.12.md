...
```console
$ docker pull php@sha256:8c4137185f8f004710428c760c5f8a2dfd6142be45e22d2230b799236a62d6ae
```
...
### `php:7.2.33-alpine3.12` - linux; arm variant v6
...
### `php:7.2.33-alpine3.12` - linux; arm64 variant v8
...
### `php:7.2.33-alpine3.12` - linux; ppc64le
...
### `php:7.2.33-alpine3.12` - linux; s390x
