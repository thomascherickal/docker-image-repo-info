...
```console
$ docker pull php@sha256:e5b69631f8e899dc52b11b1675996293a18b595901c7ee299dcc1cef14e8ae37
```
...
### `php:7.2.34-alpine3.12` - linux; amd64
...
### `php:7.2.34-alpine3.12` - linux; arm variant v6
...
### `php:7.2.34-alpine3.12` - linux; arm variant v7
...
### `php:7.2.34-alpine3.12` - linux; arm64 variant v8
...
### `php:7.2.34-alpine3.12` - linux; 386

```console
$ docker pull php@sha256:8dbbd36452bcbf79f8c486accaad5398fcde6045b93ba190336127fefe13b8a1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.1 MB (31124677 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a517638f9315ee6f254d0995b16bf5c90da88e5f8165870df673819557f5ff6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.2.34-alpine3.12` - linux; ppc64le
...
### `php:7.2.34-alpine3.12` - linux; s390x
