...
```console
$ docker pull php@sha256:a35b526decf5d836e4bc8b182b2b85d165301c156aa3451af6f7e18b8e73e893
```
...
### `php:7.3.26-apache` - linux; arm variant v5
...
### `php:7.3.26-apache` - linux; arm variant v7

```console
$ docker pull php@sha256:985c20e797dd7fdce6b2bac606b5e5682f6fe6e1ed36666f6e4929698891d1a0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **124.6 MB (124557856 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db8f144e3c57fe32733eda4c21e6c7451c69bd50eb03f47a459f5427117c2a31`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:7.3.26-apache` - linux; arm64 variant v8
...
### `php:7.3.26-apache` - linux; mips64le
...
### `php:7.3.26-apache` - linux; ppc64le
