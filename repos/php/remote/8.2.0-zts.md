...
```console
$ docker pull php@sha256:c61ef5ddbf0eff5a0bd97d39dfc9839c339afcb65d050aca4a40da4a5407c42b
```
...
### `php:8.2.0-zts` - linux; arm variant v5
...
### `php:8.2.0-zts` - linux; arm variant v7
...
### `php:8.2.0-zts` - linux; arm64 variant v8
