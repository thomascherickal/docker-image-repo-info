...
```console
$ docker pull php@sha256:223eda338481602b41c8fdf2b0725657d6d742d7f1b5e087cdc2033d3271cdca
```
...
### `php:7.3.29-fpm-bullseye` - linux; arm variant v5
...
### `php:7.3.29-fpm-bullseye` - linux; arm64 variant v8
...
### `php:7.3.29-fpm-bullseye` - linux; mips64le
...
### `php:7.3.29-fpm-bullseye` - linux; ppc64le
...
### `php:7.3.29-fpm-bullseye` - linux; s390x
