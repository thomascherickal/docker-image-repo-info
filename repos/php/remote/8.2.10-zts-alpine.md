...
```console
$ docker pull php@sha256:8179016d540a6d9c23176fed85d392eeceec94aacb7f29082bde1fd4488f6847
```
...
### `php:8.2.10-zts-alpine` - linux; arm variant v6
...
### `php:8.2.10-zts-alpine` - linux; arm variant v7
...
### `php:8.2.10-zts-alpine` - linux; arm64 variant v8
...
### `php:8.2.10-zts-alpine` - linux; 386
...
### `php:8.2.10-zts-alpine` - linux; s390x
