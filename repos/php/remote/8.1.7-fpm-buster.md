...
### `php:8.1.7-fpm-buster` - linux; amd64
...
### `php:8.1.7-fpm-buster` - linux; arm variant v5
...
### `php:8.1.7-fpm-buster` - linux; arm variant v7
...
### `php:8.1.7-fpm-buster` - linux; arm64 variant v8
...
### `php:8.1.7-fpm-buster` - linux; 386
...
### `php:8.1.7-fpm-buster` - linux; mips64le
...
### `php:8.1.7-fpm-buster` - linux; ppc64le
...
### `php:8.1.7-fpm-buster` - linux; s390x
