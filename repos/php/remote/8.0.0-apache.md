...
```console
$ docker pull php@sha256:ef68ce07768b0bb28fc86825f4a822980d8688d39f5d97447c4d55e82e7920f0
```
...
### `php:8.0.0-apache` - linux; arm variant v7
...
### `php:8.0.0-apache` - linux; arm64 variant v8
...
### `php:8.0.0-apache` - linux; mips64le
...
### `php:8.0.0-apache` - linux; ppc64le
