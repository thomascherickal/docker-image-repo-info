...
### `php:7.4.12-fpm-buster` - linux; amd64
...
### `php:7.4.12-fpm-buster` - linux; arm variant v5
...
### `php:7.4.12-fpm-buster` - linux; arm variant v7
...
### `php:7.4.12-fpm-buster` - linux; arm64 variant v8
...
### `php:7.4.12-fpm-buster` - linux; 386
...
### `php:7.4.12-fpm-buster` - linux; mips64le
...
### `php:7.4.12-fpm-buster` - linux; ppc64le
...
### `php:7.4.12-fpm-buster` - linux; s390x
