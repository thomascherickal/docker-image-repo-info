...
### `php:8.1.22-cli-bookworm` - linux; amd64
...
### `php:8.1.22-cli-bookworm` - linux; arm variant v7
...
### `php:8.1.22-cli-bookworm` - linux; arm64 variant v8
...
### `php:8.1.22-cli-bookworm` - linux; 386
...
### `php:8.1.22-cli-bookworm` - linux; mips64le
...
### `php:8.1.22-cli-bookworm` - linux; ppc64le
...
### `php:8.1.22-cli-bookworm` - linux; s390x
