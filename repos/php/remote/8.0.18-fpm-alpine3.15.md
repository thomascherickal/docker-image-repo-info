...
```console
$ docker pull php@sha256:3a8035766198f4b20def2f84b5af1beada4497d4907de49e6edfb9280849f74e
```
...
### `php:8.0.18-fpm-alpine3.15` - linux; amd64
...
### `php:8.0.18-fpm-alpine3.15` - linux; arm variant v6
...
### `php:8.0.18-fpm-alpine3.15` - linux; arm variant v7
...
### `php:8.0.18-fpm-alpine3.15` - linux; arm64 variant v8
...
### `php:8.0.18-fpm-alpine3.15` - linux; 386
...
### `php:8.0.18-fpm-alpine3.15` - linux; ppc64le
...
### `php:8.0.18-fpm-alpine3.15` - linux; s390x
