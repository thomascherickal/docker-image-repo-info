...
```console
$ docker pull php@sha256:23a62af240b4b08802d90fa3750778842630081638726dcaf308b3fd8bafdef7
```
...
### `php:8.0.0RC5-alpine` - linux; amd64
...
### `php:8.0.0RC5-alpine` - linux; arm variant v6
...
### `php:8.0.0RC5-alpine` - linux; arm variant v7
...
### `php:8.0.0RC5-alpine` - linux; arm64 variant v8
...
### `php:8.0.0RC5-alpine` - linux; s390x
