...
```console
$ docker pull php@sha256:37ee81dd066d6a3e496e124f13da44414b654bb79b32b873bdcdf3bb886ffb0f
```
...
### `php:7.3.29-apache-bullseye` - linux; arm variant v5
...
### `php:7.3.29-apache-bullseye` - linux; arm64 variant v8
...
### `php:7.3.29-apache-bullseye` - linux; mips64le
...
### `php:7.3.29-apache-bullseye` - linux; ppc64le
...
### `php:7.3.29-apache-bullseye` - linux; s390x
