...
```console
$ docker pull php@sha256:62dd83e36a0d3ace189bc9c89490de75e74406c7991fc88981033981c2f23ade
```
...
### `php:7.3.18-cli-alpine3.11` - linux; arm variant v6
...
### `php:7.3.18-cli-alpine3.11` - linux; s390x
