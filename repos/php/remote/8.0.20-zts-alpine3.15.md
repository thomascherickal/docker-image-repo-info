...
```console
$ docker pull php@sha256:3549acf1db93143e2fc2a355d664e7c83a284928d92923b432f9d2cbd8309030
```
...
### `php:8.0.20-zts-alpine3.15` - linux; arm variant v7
...
### `php:8.0.20-zts-alpine3.15` - linux; arm64 variant v8
...
### `php:8.0.20-zts-alpine3.15` - linux; s390x
