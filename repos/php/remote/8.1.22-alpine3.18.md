...
```console
$ docker pull php@sha256:8167e1052e5b39c53730d28e98c85cd8646852a5016c6b49ee4ddd3c1bc7e92d
```
...
### `php:8.1.22-alpine3.18` - linux; amd64
...
### `php:8.1.22-alpine3.18` - linux; arm variant v7
...
### `php:8.1.22-alpine3.18` - linux; arm64 variant v8
...
### `php:8.1.22-alpine3.18` - linux; ppc64le
...
### `php:8.1.22-alpine3.18` - linux; s390x
