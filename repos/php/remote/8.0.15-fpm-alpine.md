...
```console
$ docker pull php@sha256:276435416b88901b98fb9e0b533dce330c59b0ffecb0eda10515073c5c85ad3d
```
...
### `php:8.0.15-fpm-alpine` - linux; amd64
...
### `php:8.0.15-fpm-alpine` - linux; arm variant v6
...
### `php:8.0.15-fpm-alpine` - linux; arm variant v7
...
### `php:8.0.15-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.0.15-fpm-alpine` - linux; 386
...
### `php:8.0.15-fpm-alpine` - linux; s390x
