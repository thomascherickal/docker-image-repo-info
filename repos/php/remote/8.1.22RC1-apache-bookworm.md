...
### `php:8.1.22RC1-apache-bookworm` - linux; arm variant v7
...
### `php:8.1.22RC1-apache-bookworm` - linux; arm64 variant v8
...
### `php:8.1.22RC1-apache-bookworm` - linux; 386
...
### `php:8.1.22RC1-apache-bookworm` - linux; mips64le
...
### `php:8.1.22RC1-apache-bookworm` - linux; ppc64le
