...
```console
$ docker pull php@sha256:19b6f6bdef2f3e58322d3ffd344ab1e10dd0879ffefa326a82cd9ff5645ec99e
```
...
### `php:8.2.1-cli-buster` - linux; amd64
...
### `php:8.2.1-cli-buster` - linux; arm variant v7
...
### `php:8.2.1-cli-buster` - linux; arm64 variant v8
...
### `php:8.2.1-cli-buster` - linux; 386
