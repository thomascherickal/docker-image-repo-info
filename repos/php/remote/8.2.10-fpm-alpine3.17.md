...
```console
$ docker pull php@sha256:5a0c0da18138b45a3c54da18675785a73cd73a1423d972f38e8bd0560a726f48
```
...
### `php:8.2.10-fpm-alpine3.17` - linux; arm64 variant v8
...
### `php:8.2.10-fpm-alpine3.17` - linux; 386
