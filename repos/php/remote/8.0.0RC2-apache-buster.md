...
```console
$ docker pull php@sha256:ea48431bbd1ea6c78322e7e136696494e5a3a2931dd471bdd52a490c5f3b9a6b
```
...
### `php:8.0.0RC2-apache-buster` - linux; amd64
...
### `php:8.0.0RC2-apache-buster` - linux; arm variant v7
...
### `php:8.0.0RC2-apache-buster` - linux; 386
...
### `php:8.0.0RC2-apache-buster` - linux; mips64le
