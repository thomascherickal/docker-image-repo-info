...
```console
$ docker pull php@sha256:2cbb073f96acca960394cbc98dca4e34223a36138e760241972073582a73726a
```
...
```console
$ docker pull php@sha256:2a9d1cae5d835775eaff32f010ea6208291c4b7fc9c9080eb7600536492ef40f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.9 MB (28857537 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb76cd00c5686d28a9f49f03a44a91c6f3dda4dbea3d3d0049e71bae452b53ba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
