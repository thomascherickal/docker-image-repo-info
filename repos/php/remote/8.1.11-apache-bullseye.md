...
### `php:8.1.11-apache-bullseye` - linux; amd64
...
### `php:8.1.11-apache-bullseye` - linux; arm variant v5
...
### `php:8.1.11-apache-bullseye` - linux; arm variant v7
...
### `php:8.1.11-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.1.11-apache-bullseye` - linux; 386
...
### `php:8.1.11-apache-bullseye` - linux; mips64le
...
### `php:8.1.11-apache-bullseye` - linux; ppc64le
...
### `php:8.1.11-apache-bullseye` - linux; s390x
