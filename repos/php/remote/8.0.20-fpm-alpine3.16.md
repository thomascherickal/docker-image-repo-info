...
```console
$ docker pull php@sha256:f5714b02e597ff81de25fff53ad0b5b712280d37140801f8c0cf2872f20f1264
```
...
### `php:8.0.20-fpm-alpine3.16` - linux; arm variant v7
...
### `php:8.0.20-fpm-alpine3.16` - linux; arm64 variant v8
...
### `php:8.0.20-fpm-alpine3.16` - linux; s390x
