...
```console
$ docker pull php@sha256:38e877ca5d80eaa833e2123d521858b120a33a78b34112dcd4f2736dd4a0dd6a
```
...
### `php:8.2.8-alpine` - linux; arm variant v6
...
### `php:8.2.8-alpine` - linux; arm variant v7
...
### `php:8.2.8-alpine` - linux; arm64 variant v8
