...
```console
$ docker pull php@sha256:f4416381e35a6709805b59fc47b19936a5db47a72927258e977203b53afd9f75
```
...
### `php:8.0.13-zts` - linux; arm variant v5
...
### `php:8.0.13-zts` - linux; arm variant v7
...
### `php:8.0.13-zts` - linux; arm64 variant v8
