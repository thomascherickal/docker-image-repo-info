...
### `php:8.3.0-bookworm` - linux; amd64
...
### `php:8.3.0-bookworm` - linux; arm variant v5
...
### `php:8.3.0-bookworm` - linux; arm variant v7
...
### `php:8.3.0-bookworm` - linux; arm64 variant v8
...
### `php:8.3.0-bookworm` - linux; mips64le
...
### `php:8.3.0-bookworm` - linux; ppc64le
...
### `php:8.3.0-bookworm` - linux; s390x
