...
```console
$ docker pull php@sha256:5485a29040e6a70fb24e1bec44d9316196314205b2459cb2a274fe3397f14ab9
```
...
### `php:7.3.21-fpm` - linux; arm variant v5
...
### `php:7.3.21-fpm` - linux; arm64 variant v8
