...
```console
$ docker pull php@sha256:dc36ef509d33223e7c3a9f27069634408097deab09edd31668d796f11e15e797
```
...
### `php:8.0.19-fpm-alpine` - linux; arm variant v7
...
### `php:8.0.19-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.0.19-fpm-alpine` - linux; 386
...
### `php:8.0.19-fpm-alpine` - linux; ppc64le
