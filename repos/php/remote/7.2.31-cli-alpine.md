...
```console
$ docker pull php@sha256:dc66bf7f81fea797e4eda2d57187395d7c462a030035fdf7514faf5e3f8682f7
```
...
### `php:7.2.31-cli-alpine` - linux; arm variant v6
...
### `php:7.2.31-cli-alpine` - linux; s390x
