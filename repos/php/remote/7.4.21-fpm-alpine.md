## `php:7.4.21-fpm-alpine`

```console
$ docker pull php@sha256:fe617434cfc0f92fd4300cd04df94c142dcf888657dc63493488e9e44a1c3535
```
...
### `php:7.4.21-fpm-alpine` - linux; arm variant v6
...
### `php:7.4.21-fpm-alpine` - linux; arm variant v7
...
### `php:7.4.21-fpm-alpine` - linux; arm64 variant v8
