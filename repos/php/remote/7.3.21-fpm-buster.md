...
### `php:7.3.21-fpm-buster` - linux; arm variant v5
...
### `php:7.3.21-fpm-buster` - linux; arm64 variant v8
...
### `php:7.3.21-fpm-buster` - linux; mips64le
...
### `php:7.3.21-fpm-buster` - linux; ppc64le
