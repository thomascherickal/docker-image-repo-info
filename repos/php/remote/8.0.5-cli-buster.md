...
### `php:8.0.5-cli-buster` - linux; amd64
...
### `php:8.0.5-cli-buster` - linux; arm variant v5
...
### `php:8.0.5-cli-buster` - linux; arm variant v7
...
### `php:8.0.5-cli-buster` - linux; arm64 variant v8
...
### `php:8.0.5-cli-buster` - linux; 386
...
### `php:8.0.5-cli-buster` - linux; mips64le
...
### `php:8.0.5-cli-buster` - linux; ppc64le
...
### `php:8.0.5-cli-buster` - linux; s390x
