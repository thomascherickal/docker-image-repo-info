...
### `php:7.4.3-zts-buster` - linux; amd64
...
### `php:7.4.3-zts-buster` - linux; arm variant v5
...
### `php:7.4.3-zts-buster` - linux; arm variant v7
...
### `php:7.4.3-zts-buster` - linux; arm64 variant v8
...
### `php:7.4.3-zts-buster` - linux; 386
...
### `php:7.4.3-zts-buster` - linux; ppc64le
