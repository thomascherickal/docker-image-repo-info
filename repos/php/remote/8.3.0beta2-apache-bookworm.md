...
```console
$ docker pull php@sha256:d2b0394432a68c267d995655bc06200f5945fa04cb208c8e0180c6c557ad4111
```
...
### `php:8.3.0beta2-apache-bookworm` - linux; amd64
...
### `php:8.3.0beta2-apache-bookworm` - linux; arm variant v5
...
### `php:8.3.0beta2-apache-bookworm` - linux; arm variant v7
...
### `php:8.3.0beta2-apache-bookworm` - linux; arm64 variant v8
...
### `php:8.3.0beta2-apache-bookworm` - linux; 386
...
### `php:8.3.0beta2-apache-bookworm` - linux; ppc64le
...
### `php:8.3.0beta2-apache-bookworm` - linux; s390x
