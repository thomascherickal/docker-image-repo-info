...
```console
$ docker pull php@sha256:b9a65931d5b0284ff4d80fbdc1bb01905765b3283de827b109f9dd3970959bbb
```
...
### `php:8.1.1-fpm` - linux; arm variant v5
...
### `php:8.1.1-fpm` - linux; arm variant v7
...
### `php:8.1.1-fpm` - linux; arm64 variant v8
