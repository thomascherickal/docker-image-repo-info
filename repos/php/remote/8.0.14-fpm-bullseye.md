...
### `php:8.0.14-fpm-bullseye` - linux; amd64
...
### `php:8.0.14-fpm-bullseye` - linux; arm variant v5
...
### `php:8.0.14-fpm-bullseye` - linux; arm variant v7
...
### `php:8.0.14-fpm-bullseye` - linux; arm64 variant v8
...
### `php:8.0.14-fpm-bullseye` - linux; 386
...
### `php:8.0.14-fpm-bullseye` - linux; mips64le
...
### `php:8.0.14-fpm-bullseye` - linux; ppc64le
...
### `php:8.0.14-fpm-bullseye` - linux; s390x
