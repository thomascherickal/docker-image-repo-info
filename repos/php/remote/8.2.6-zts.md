...
```console
$ docker pull php@sha256:8b55e685abbf9ffdccac1cd141fe81d1e5ef0857f9eac4bee2ac7e33fd730cb4
```
...
### `php:8.2.6-zts` - linux; arm variant v5
...
### `php:8.2.6-zts` - linux; arm variant v7
...
### `php:8.2.6-zts` - linux; arm64 variant v8
