...
```console
$ docker pull php@sha256:5687a33e2d6663796a01390f46abda83e07098c9c16285751fd8b9d63124c6b4
```
...
### `php:8.1.5-fpm-alpine3.14` - linux; amd64
...
### `php:8.1.5-fpm-alpine3.14` - linux; arm variant v6
...
### `php:8.1.5-fpm-alpine3.14` - linux; arm64 variant v8
...
### `php:8.1.5-fpm-alpine3.14` - linux; 386
...
### `php:8.1.5-fpm-alpine3.14` - linux; s390x
