...
```console
$ docker pull php@sha256:3bb7fdfc812f2aa752616963b1ef6f7ff259691ec0366c601102df2b82570d92
```
...
### `php:8.1.22-zts-bookworm` - linux; amd64
...
### `php:8.1.22-zts-bookworm` - linux; arm variant v5
...
### `php:8.1.22-zts-bookworm` - linux; arm variant v7
...
### `php:8.1.22-zts-bookworm` - linux; arm64 variant v8
...
### `php:8.1.22-zts-bookworm` - linux; 386
...
### `php:8.1.22-zts-bookworm` - linux; mips64le
...
### `php:8.1.22-zts-bookworm` - linux; ppc64le
...
### `php:8.1.22-zts-bookworm` - linux; s390x
