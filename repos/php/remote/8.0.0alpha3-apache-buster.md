...
```console
$ docker pull php@sha256:495c1484b7def528a22cf59ae775c1ec3c8096084423eac5fa40e0969a845bdb
```
...
### `php:8.0.0alpha3-apache-buster` - linux; amd64
...
### `php:8.0.0alpha3-apache-buster` - linux; arm64 variant v8
...
### `php:8.0.0alpha3-apache-buster` - linux; ppc64le
