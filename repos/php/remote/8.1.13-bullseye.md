...
### `php:8.1.13-bullseye` - linux; amd64
...
### `php:8.1.13-bullseye` - linux; arm variant v5
...
### `php:8.1.13-bullseye` - linux; arm variant v7
...
### `php:8.1.13-bullseye` - linux; arm64 variant v8
...
### `php:8.1.13-bullseye` - linux; mips64le
...
### `php:8.1.13-bullseye` - linux; ppc64le
...
### `php:8.1.13-bullseye` - linux; s390x
