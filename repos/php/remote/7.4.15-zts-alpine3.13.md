...
```console
$ docker pull php@sha256:f4d12f32c67e4831136600efec603b363944bfb1f273cc67719058584c377d6d
```
...
### `php:7.4.15-zts-alpine3.13` - linux; amd64
...
### `php:7.4.15-zts-alpine3.13` - linux; arm64 variant v8
...
### `php:7.4.15-zts-alpine3.13` - linux; 386
...
### `php:7.4.15-zts-alpine3.13` - linux; ppc64le
...
### `php:7.4.15-zts-alpine3.13` - linux; s390x
