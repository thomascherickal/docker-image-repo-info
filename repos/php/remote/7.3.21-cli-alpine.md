...
```console
$ docker pull php@sha256:2af1f675ada127c1f769bc5a4a3e057b816d004d9b506d4eb44d41715ae8e66f
```
...
### `php:7.3.21-cli-alpine` - linux; arm variant v6
...
### `php:7.3.21-cli-alpine` - linux; ppc64le
...
### `php:7.3.21-cli-alpine` - linux; s390x
