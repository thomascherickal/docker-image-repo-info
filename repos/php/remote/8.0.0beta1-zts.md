...
```console
$ docker pull php@sha256:bbd0f1b216b73b5c6b8aa3f23b78380995253f1e323c643dda2b4f3a1313de5d
```
...
### `php:8.0.0beta1-zts` - linux; arm variant v5
...
### `php:8.0.0beta1-zts` - linux; arm64 variant v8
...
### `php:8.0.0beta1-zts` - linux; mips64le
...
### `php:8.0.0beta1-zts` - linux; ppc64le
...
### `php:8.0.0beta1-zts` - linux; s390x
