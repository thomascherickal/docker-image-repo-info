...
```console
$ docker pull php@sha256:84b98836d7f4da672586d2894d1443c570cced9d55f4c85b29f8c8fa05a8e325
```
...
### `php:8.1.21-cli-bookworm` - linux; mips64le
...
### `php:8.1.21-cli-bookworm` - linux; ppc64le
...
### `php:8.1.21-cli-bookworm` - linux; s390x
