...
```console
$ docker pull php@sha256:edbf770968633f074953329f7be755d410ddf48de78c24fbf4472751380b7947
```
...
### `php:8.2.13-bookworm` - linux; amd64
...
### `php:8.2.13-bookworm` - linux; arm variant v5
...
### `php:8.2.13-bookworm` - linux; arm variant v7
...
### `php:8.2.13-bookworm` - linux; arm64 variant v8
...
### `php:8.2.13-bookworm` - linux; mips64le
...
### `php:8.2.13-bookworm` - linux; ppc64le
...
### `php:8.2.13-bookworm` - linux; s390x
