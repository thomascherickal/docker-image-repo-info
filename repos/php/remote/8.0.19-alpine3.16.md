...
### `php:8.0.19-alpine3.16` - linux; amd64
...
### `php:8.0.19-alpine3.16` - linux; arm variant v7
...
### `php:8.0.19-alpine3.16` - linux; arm64 variant v8
...
### `php:8.0.19-alpine3.16` - linux; 386
...
### `php:8.0.19-alpine3.16` - linux; ppc64le
...
### `php:8.0.19-alpine3.16` - linux; s390x
