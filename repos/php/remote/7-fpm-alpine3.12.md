...
```console
$ docker pull php@sha256:694337e4d11816fae1b592a4ac1795d6039e1e503ef9269493ee3833a36b131e
```
...
```console
$ docker pull php@sha256:fa69fab86c60ca1df51443cd112ec13eb87c9dd320631d7701a0921cef48752d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.9 MB (27935016 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a78a2f1967cbfdab57c45c1e9f574a1960b4c6c3d11f6ac906fbb1bc400f493`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
