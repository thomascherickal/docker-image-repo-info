...
```console
$ docker pull php@sha256:24b9e239511b12e86411bdcc65a0088bc41d8a2add2c3b7e0b0253b5bef5771a
```
...
### `php:7.4.6-apache` - linux; arm variant v5
...
### `php:7.4.6-apache` - linux; arm variant v7
...
### `php:7.4.6-apache` - linux; arm64 variant v8
...
### `php:7.4.6-apache` - linux; mips64le
