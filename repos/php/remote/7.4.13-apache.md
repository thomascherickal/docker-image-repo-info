...
### `php:7.4.13-apache` - linux; arm variant v5
...
### `php:7.4.13-apache` - linux; arm variant v7
...
### `php:7.4.13-apache` - linux; arm64 variant v8
...
### `php:7.4.13-apache` - linux; mips64le
...
### `php:7.4.13-apache` - linux; ppc64le
