## `php:8.0.20-zts-alpine3.16`

```console
$ docker pull php@sha256:d9f2b14de806dd4755fce79e63dc7bf9b6ebc1899a4d9f120bf096ebc7fe9f39
```
...
### `php:8.0.20-zts-alpine3.16` - linux; amd64
...
### `php:8.0.20-zts-alpine3.16` - linux; arm variant v6
...
### `php:8.0.20-zts-alpine3.16` - linux; arm variant v7
...
### `php:8.0.20-zts-alpine3.16` - linux; arm64 variant v8
...
### `php:8.0.20-zts-alpine3.16` - linux; 386
...
### `php:8.0.20-zts-alpine3.16` - linux; s390x
