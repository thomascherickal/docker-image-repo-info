...
```console
$ docker pull php@sha256:8e11ae6314e6d2d2a2474b84e03da6d43ea9805b1a8ed5f8d2447aa4e48a889b
```
...
### `php:7.4.32-fpm-buster` - linux; amd64
...
### `php:7.4.32-fpm-buster` - linux; arm variant v7
...
### `php:7.4.32-fpm-buster` - linux; arm64 variant v8
...
### `php:7.4.32-fpm-buster` - linux; 386
