...
### `php:8.2.3-zts-alpine` - linux; amd64
...
### `php:8.2.3-zts-alpine` - linux; arm variant v6
...
### `php:8.2.3-zts-alpine` - linux; arm variant v7
...
### `php:8.2.3-zts-alpine` - linux; arm64 variant v8
...
### `php:8.2.3-zts-alpine` - linux; 386
...
### `php:8.2.3-zts-alpine` - linux; ppc64le
...
### `php:8.2.3-zts-alpine` - linux; s390x
