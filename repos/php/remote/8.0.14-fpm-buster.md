...
```console
$ docker pull php@sha256:0bae8157e1ed7a363dde6634f4ab7e2982232a28bee06ea24b78f10557a02078
```
...
```console
$ docker pull php@sha256:897dcf16ef69e8c9483778d7caed767bba36afb7fcf7f93f30ed5a1300bc305d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.3 MB (144266008 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5fb8f0a01f560263b10734e4a29e816872001990a9c2463c8eab1f205c178c80`
...
```console
$ docker pull php@sha256:537a56d127ef101ad5d012e4413951d47e20931b4e607ab9b2f022dad0cfaf9e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.9 MB (119931889 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2aed7569e1d7d350a4b38c1c99db19accbba955eeb42aecb925a42a8e2aa848d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull php@sha256:65b8a046d8ac6c318974e209f0d11fd10643208ecacd791086b57d4345e15719
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.0 MB (150000606 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cfe41dace00c898f43ef8c5d0d0e5c16c1e728c31270841965cde2d1c3b374ab`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull php@sha256:d2fa04f88733e297b5e279fa2e9d75c3719e9435cef80e509a0b02a920370bea
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **126.7 MB (126657773 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e215bdd92ab08ec9c345a5960f08349b13afe93598b7e71e19eb8e8eb01306f4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN docker-php-ext-enable sodium
# Tue, 21 Dec 2021 08:31:44 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Tue, 21 Dec 2021 08:31:44 GMT
WORKDIR /var/www/html
# Tue, 21 Dec 2021 08:31:46 GMT
RUN set -eux; 	cd /usr/local/etc; 	if [ -d php-fpm.d ]; then 		sed 's!=NONE/!=!g' php-fpm.conf.default | tee php-fpm.conf > /dev/null; 		cp php-fpm.d/www.conf.default php-fpm.d/www.conf; 	else 		mkdir php-fpm.d; 		cp php-fpm.conf.default php-fpm.d/www.conf; 		{ 			echo '[global]'; 			echo 'include=etc/php-fpm.d/*.conf'; 		} | tee php-fpm.conf; 	fi; 	{ 		echo '[global]'; 		echo 'error_log = /proc/self/fd/2'; 		echo; echo '; https://github.com/docker-library/php/pull/725#issuecomment-443540114'; echo 'log_limit = 8192'; 		echo; 		echo '[www]'; 		echo '; if we send this to /proc/self/fd/1, it never appears'; 		echo 'access.log = /proc/self/fd/2'; 		echo; 		echo 'clear_env = no'; 		echo; 		echo '; Ensure worker stdout and stderr are sent to the main error log.'; 		echo 'catch_workers_output = yes'; 		echo 'decorate_workers_output = no'; 	} | tee php-fpm.d/docker.conf; 	{ 		echo '[global]'; 		echo 'daemonize = no'; 		echo; 		echo '[www]'; 		echo 'listen = 9000'; 	} | tee php-fpm.d/zz-docker.conf
# Tue, 21 Dec 2021 08:31:46 GMT
STOPSIGNAL SIGQUIT
# Tue, 21 Dec 2021 08:31:47 GMT
EXPOSE 9000
# Tue, 21 Dec 2021 08:31:47 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:cc4a129bfc427020ea9cb4b4e32105ed6f925a8224cdeffe771fde61872d3fc1`  
		...
		Size: 492.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5823a0ea4f3d5c7ca16b50afd0751740a553079c3768b023c131f60a08016be4`  
		Last Modified: Tue, 21 Dec 2021 11:33:31 GMT  
		Size: 28.2 MB (28242523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:402ea3367bf99e80dd8ead2b64af376d0fc1fa00003578434d7fc11e87718f90`  
		Last Modified: Tue, 21 Dec 2021 11:33:11 GMT  
		Size: 2.3 KB (2307 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc5515644e9844bb9abd8a7bf54cb7198761caae1fe0ccf91aa492f435e31155`  
		Last Modified: Tue, 21 Dec 2021 11:33:10 GMT  
		Size: 249.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92d4544d023ac4634c8926f3fc86b5f55a6d90080d6ec15ddd6778084a03c169`  
		Last Modified: Tue, 21 Dec 2021 11:33:10 GMT  
		Size: 8.6 KB (8576 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
