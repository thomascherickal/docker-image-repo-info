...
### `php:8.1.12-bullseye` - linux; amd64
...
### `php:8.1.12-bullseye` - linux; arm variant v5
...
### `php:8.1.12-bullseye` - linux; arm variant v7
...
### `php:8.1.12-bullseye` - linux; arm64 variant v8
...
### `php:8.1.12-bullseye` - linux; mips64le
...
### `php:8.1.12-bullseye` - linux; ppc64le
...
### `php:8.1.12-bullseye` - linux; s390x
