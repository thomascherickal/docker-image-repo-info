...
```console
$ docker pull php@sha256:88a975804bb7fd9819f426760c78d57302e2d8b1afa690395fac22a568ebb270
```
...
### `php:8.2.8-fpm-bookworm` - linux; mips64le
...
### `php:8.2.8-fpm-bookworm` - linux; ppc64le
...
### `php:8.2.8-fpm-bookworm` - linux; s390x
