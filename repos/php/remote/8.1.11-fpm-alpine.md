...
```console
$ docker pull php@sha256:48606cdca84b5416785550a9c69a5b4ce7d834399cde9e40ef40aad87a7ff63b
```
...
### `php:8.1.11-fpm-alpine` - linux; amd64
...
### `php:8.1.11-fpm-alpine` - linux; arm variant v6

```console
$ docker pull php@sha256:2d4fcba82b969205a9695d2d5ddf053937914589d3551ecd59d50f776f167e43
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.4 MB (27415424 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e79b0f85520879a22318d5fbca01d5e6eb60b917942188b0f4e0b57e292b9699`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.1.11-fpm-alpine` - linux; arm variant v7

```console
$ docker pull php@sha256:8f56948f498f49c3d55b488f4d0f5d37f183b2ede1ae19d19755278ff8418891
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.6 MB (26615118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dac823868e88f62b9b196ea707a344101c726f5d6e965fc011d42bdbc7c511bd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.1.11-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull php@sha256:2bd45a8346f4b32d65943d80b7dea6e95014258ee8a89fecbe2cf759e05aa26f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.7 MB (28705906 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa6ab1df37eccb2a48ee595752079a71fb07c01456e99d1fc683abfca08a32af`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.1.11-fpm-alpine` - linux; 386
...
### `php:8.1.11-fpm-alpine` - linux; ppc64le
...
### `php:8.1.11-fpm-alpine` - linux; s390x
