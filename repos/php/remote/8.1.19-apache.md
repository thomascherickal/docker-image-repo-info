...
```console
$ docker pull php@sha256:1e4b34884c7f70d333f57eae5222606e3e4a6f86b75a2bdbd80314305e5c26f1
```
...
### `php:8.1.19-apache` - linux; arm variant v5
...
### `php:8.1.19-apache` - linux; arm variant v7
...
### `php:8.1.19-apache` - linux; arm64 variant v8
...
### `php:8.1.19-apache` - linux; mips64le
...
### `php:8.1.19-apache` - linux; ppc64le
