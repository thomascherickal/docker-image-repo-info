...
```console
$ docker pull php@sha256:2aaba40c65875c343ca397e0f7e8723b3c738323625e1e6e012fd136dca68198
```
...
### `php:7.4.26-fpm-bullseye` - linux; amd64
...
### `php:7.4.26-fpm-bullseye` - linux; arm variant v7
...
### `php:7.4.26-fpm-bullseye` - linux; 386
...
### `php:7.4.26-fpm-bullseye` - linux; ppc64le
