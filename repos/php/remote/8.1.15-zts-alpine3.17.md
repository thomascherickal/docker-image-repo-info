...
```console
$ docker pull php@sha256:9bf4fc02ed721e176344113313d1518557b33e9c0cd5e02c72289cfded7f1f6b
```
...
### `php:8.1.15-zts-alpine3.17` - linux; amd64
...
### `php:8.1.15-zts-alpine3.17` - linux; arm variant v7
...
### `php:8.1.15-zts-alpine3.17` - linux; arm64 variant v8
...
### `php:8.1.15-zts-alpine3.17` - linux; 386
...
### `php:8.1.15-zts-alpine3.17` - linux; s390x
