...
```console
$ docker pull php@sha256:a673597c7958443a32ce51e97f2dc744a8ab5e95aa21ac4acb9c6630a730b9cb
```
...
```console
$ docker pull php@sha256:4846b86b2c99477b5c22f99a1299db754b884a201857ebb92afe623518fcb558
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.0 MB (161967332 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5bc52f60aec8f6e9e6e7a497b8a4dfedb803a02c65a2e8c1b44a69c88975de55`
...
```console
$ docker pull php@sha256:1e7a8a3eb365a9588b1c852828e0d0922bd0c4aa6bd17c70b2518caf4748d22c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.1 MB (140106173 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:abcf7de88fdb5910369ba503a0c94ed4d9934c5034a202e9c1bbb6522952d835`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 07 Sep 2023 01:49:17 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Thu, 07 Sep 2023 01:58:22 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--enable-fpm 		--with-fpm-user=www-data 		--with-fpm-group=www-data 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Thu, 07 Sep 2023 01:58:22 GMT
COPY multi:869bde9dbeae74886a05c9e2107b3e3b4877116db8c6d9adbaff2719f9fb5262 in /usr/local/bin/ 
# Thu, 07 Sep 2023 01:58:23 GMT
RUN docker-php-ext-enable sodium
# Thu, 07 Sep 2023 01:58:23 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 07 Sep 2023 01:58:23 GMT
WORKDIR /var/www/html
# Thu, 07 Sep 2023 01:58:24 GMT
RUN set -eux; 	cd /usr/local/etc; 	if [ -d php-fpm.d ]; then 		sed 's!=NONE/!=!g' php-fpm.conf.default | tee php-fpm.conf > /dev/null; 		cp php-fpm.d/www.conf.default php-fpm.d/www.conf; 	else 		mkdir php-fpm.d; 		cp php-fpm.conf.default php-fpm.d/www.conf; 		{ 			echo '[global]'; 			echo 'include=etc/php-fpm.d/*.conf'; 		} | tee php-fpm.conf; 	fi; 	{ 		echo '[global]'; 		echo 'error_log = /proc/self/fd/2'; 		echo; echo '; https://github.com/docker-library/php/pull/725#issuecomment-443540114'; echo 'log_limit = 8192'; 		echo; 		echo '[www]'; 		echo '; php-fpm closes STDOUT on startup, so sending logs to /proc/self/fd/1 does not work.'; 		echo '; https://bugs.php.net/bug.php?id=73886'; 		echo 'access.log = /proc/self/fd/2'; 		echo; 		echo 'clear_env = no'; 		echo; 		echo '; Ensure worker stdout and stderr are sent to the main error log.'; 		echo 'catch_workers_output = yes'; 		echo 'decorate_workers_output = no'; 	} | tee php-fpm.d/docker.conf; 	{ 		echo '[global]'; 		echo 'daemonize = no'; 		echo; 		echo '[www]'; 		echo 'listen = 9000'; 	} | tee php-fpm.d/zz-docker.conf; 	mkdir -p "$PHP_INI_DIR/conf.d"; 	{ 		echo '; https://github.com/docker-library/php/issues/878#issuecomment-938595965'; 		echo 'fastcgi.logging = Off'; 	} > "$PHP_INI_DIR/conf.d/docker-fpm.ini"
# Thu, 07 Sep 2023 01:58:24 GMT
STOPSIGNAL SIGQUIT
# Thu, 07 Sep 2023 01:58:24 GMT
...
-	Layers:
	...
	-	`sha256:8d6ab4f412b968ac57721ef7b607a771360fb8bf35aecc98b1f7ea10dd76a92d`  
		...
		Size: 492.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0381a57e2e3f92bf14381d92df31b3cc20cd325034efb7f750aeaa16dcb2c88e`  
		Last Modified: Thu, 07 Sep 2023 02:48:25 GMT  
		Size: 25.1 MB (25125823 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f50ec732903052f22181ead9795cfd5b68e4075ac1509c0e156981188470b66`  
		Last Modified: Thu, 07 Sep 2023 02:48:20 GMT  
		Size: 2.4 KB (2449 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36c8159915de3e51a5f337bb8f520ae62681fabb093b6d335c37a49cf3c1b8bf`  
		Last Modified: Thu, 07 Sep 2023 02:48:20 GMT  
		Size: 246.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9220758ecf3d5d1553f4b744b1c4bcf17a1ac80264625d8807050bb5df5a97be`  
		Last Modified: Thu, 07 Sep 2023 02:48:20 GMT  
...
```console
$ docker pull php@sha256:7b48867a68fbf622f2a85b27f90a03141bb09896d84f683b2aad07db2a576765
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **132.5 MB (132525583 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7fa257a358f2b105abea5cf41fc5ca63faa9049b856c16f3da9c6ea3fa8d2d10`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull php@sha256:a0661b5c282fffdbcd9e4d9f926493cd75288cd7505e38785e1512ed17edb2a0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.0 MB (155963635 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c15a871c73e3b840ba4d3fac3fdc48a674ce27273f391c9810277fcdf751f210`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull php@sha256:50a3c18a5751e8efdf3564ab07c5ed529ade646162844dec9b07c00ec465955a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.5 MB (164528972 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:43c7d2764f64f02925c15f137614b8adea904b0a010fcba1f6b6886727818292`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull php@sha256:0b018545698bffc769fa208fc816154ac63fe9368f9f922862faf80bd60c7232
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.1 MB (139130446 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63bb5de262948221da7a296388c4461fbbece119371810831bfcf96876a0fd30`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull php@sha256:7fe40896f44748ad7700d4d16bf6c383fa73ade057571e3c2ed9f8392d3bea49
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.9 MB (161939710 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7eedce195a0e642ba5147c3de44845d055c7f879be99e9ca3bfb288d283b91d0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull php@sha256:701d5f5f63ad5e3600d06764001f271707e3c8f01ed356416aaa927edee12a66
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.2 MB (139242127 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e6adc819457a1f8ccd8d74a35bb8ff998c5896591e070a1e22f45e142449d522`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
