...
```console
$ docker pull php@sha256:fcd9ef4f47f692b05626f9451955f3973098fdc4e2e7810cfa832896fc7e5d4c
```
...
### `php:8.1.8RC1-apache-bullseye` - linux; amd64
...
### `php:8.1.8RC1-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.1.8RC1-apache-bullseye` - linux; mips64le
...
### `php:8.1.8RC1-apache-bullseye` - linux; ppc64le
