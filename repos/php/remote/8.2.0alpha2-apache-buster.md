...
```console
$ docker pull php@sha256:2a0363180b31a324138ef22dd90db52cff0a888c3ed1d933ccf15464bbc6c0b8
```
...
### `php:8.2.0alpha2-apache-buster` - linux; amd64
...
### `php:8.2.0alpha2-apache-buster` - linux; arm64 variant v8
...
### `php:8.2.0alpha2-apache-buster` - linux; mips64le
...
### `php:8.2.0alpha2-apache-buster` - linux; ppc64le
