...
### `php:8.0.9-apache-bullseye` - linux; arm variant v7
...
### `php:8.0.9-apache-bullseye` - linux; 386
...
### `php:8.0.9-apache-bullseye` - linux; ppc64le
...
### `php:8.0.9-apache-bullseye` - linux; s390x
