...
### `php:8.1.0beta3-apache` - linux; amd64
...
### `php:8.1.0beta3-apache` - linux; arm variant v5
...
### `php:8.1.0beta3-apache` - linux; arm variant v7
...
### `php:8.1.0beta3-apache` - linux; arm64 variant v8
...
### `php:8.1.0beta3-apache` - linux; 386
...
### `php:8.1.0beta3-apache` - linux; mips64le
...
### `php:8.1.0beta3-apache` - linux; ppc64le
...
### `php:8.1.0beta3-apache` - linux; s390x
