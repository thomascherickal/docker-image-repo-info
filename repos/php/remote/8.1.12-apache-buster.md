...
### `php:8.1.12-apache-buster` - linux; amd64
...
### `php:8.1.12-apache-buster` - linux; arm variant v7
...
### `php:8.1.12-apache-buster` - linux; arm64 variant v8
...
### `php:8.1.12-apache-buster` - linux; 386
