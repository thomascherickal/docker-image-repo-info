...
```console
$ docker pull php@sha256:d59f78384db4560518a23a83ea09a647c0f2fe97faba5c8400d78a47e1829a6b
```
...
### `php:8.0.2-alpine` - linux; arm variant v6
...
### `php:8.0.2-alpine` - linux; arm variant v7
...
### `php:8.0.2-alpine` - linux; arm64 variant v8
