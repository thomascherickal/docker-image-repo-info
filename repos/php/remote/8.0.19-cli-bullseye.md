...
### `php:8.0.19-cli-bullseye` - linux; arm variant v7
...
### `php:8.0.19-cli-bullseye` - linux; arm64 variant v8
...
### `php:8.0.19-cli-bullseye` - linux; 386
...
### `php:8.0.19-cli-bullseye` - linux; mips64le
...
### `php:8.0.19-cli-bullseye` - linux; ppc64le
