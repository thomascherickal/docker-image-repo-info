...
### `php:8.0.9-alpine3.13` - linux; amd64
...
### `php:8.0.9-alpine3.13` - linux; arm variant v7
...
### `php:8.0.9-alpine3.13` - linux; arm64 variant v8
...
### `php:8.0.9-alpine3.13` - linux; 386
...
### `php:8.0.9-alpine3.13` - linux; ppc64le
...
### `php:8.0.9-alpine3.13` - linux; s390x
