...
```console
$ docker pull php@sha256:3c8d2870d1d8beab9bf38e0fa353050dedc7972f3a352a0f1e20476cc096e6fb
```
...
### `php:8.0.18-cli-alpine` - linux; amd64
...
### `php:8.0.18-cli-alpine` - linux; arm variant v6
...
### `php:8.0.18-cli-alpine` - linux; arm64 variant v8
...
### `php:8.0.18-cli-alpine` - linux; 386
...
### `php:8.0.18-cli-alpine` - linux; s390x
