...
```console
$ docker pull php@sha256:9ffa3861f541b1dbbc1da11a8cb53846e31415de2e28c190963a9275d60fd2af
```
...
### `php:7-fpm-alpine3.16` - linux; amd64

```console
$ docker pull php@sha256:08b4f7563e8b677df63c4d203cdd5a6746ee8d23c2b89ebe689bbef4216a392d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.4 MB (26430291 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1773acf798e7deb2497000621df8055cf584e74347a54151ed92c902670c5db4`
...
### `php:7-fpm-alpine3.16` - linux; arm variant v6

```console
$ docker pull php@sha256:d051c9321b144d5fb5e2b70ee62ec74f566543aa0cb3542fb5c42366168cac6e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.5 MB (25493418 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f3adbe754ff019e904f60f0b09f777ad7988cb33111513e1e48cef44ca002cf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7-fpm-alpine3.16` - linux; arm variant v7

```console
$ docker pull php@sha256:c1e1498e0839a34f377d962f9487fa24149bbbb67aef5dbaf38f58cf8a5f0093
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **24.5 MB (24532478 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70f41e97c71c936e416726858533279ad67c966dbbca8439ad0e1645b92d02ee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7-fpm-alpine3.16` - linux; arm64 variant v8

```console
$ docker pull php@sha256:f39f52fb53bde28ff2eed97673fe5f10b9b84426b54f602a6f5490533a164ce3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.2 MB (26151679 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dd9cc1ea3496a244b8e86eb942d6ca07f5a6e7467a3d63e68686f77ba600da54`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7-fpm-alpine3.16` - linux; 386

```console
$ docker pull php@sha256:44a2b7220f51948c2692fb7918011cf6873e91e427c44755a9612aa894928df4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.8 MB (26844789 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f0770882fd6baee612ab8e99b7c99e0f24b2b50c097b4b3d04a9c552acc65e78`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7-fpm-alpine3.16` - linux; ppc64le

```console
$ docker pull php@sha256:30ed0b792df3a89007d2548f57e7c4cc77b75bb3c7a48de5c1351f92c4487daa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.2 MB (27235779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ddc86a41e9b978d169b97817ac204c623e54167140cb3fd0297b36583c992393`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7-fpm-alpine3.16` - linux; s390x

```console
$ docker pull php@sha256:fad1477cfb1bc6547acf90f068966209ab126538bbfa3b2f172aa266b749d13a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.9 MB (25866748 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:806134bb0554b31d5670b289b681d83f82a1d3911701dca625043137425fcb72`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
