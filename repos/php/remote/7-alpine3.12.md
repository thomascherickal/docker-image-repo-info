...
```console
$ docker pull php@sha256:95a200587eec1a0184dde066242ccbba61ca09e6ef843eefb7832e92c619dd69
```
...
```console
$ docker pull php@sha256:77170b2e04673a25a59d1bb350f8e412efba74b47aba162080dae5413866ac10
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.8 MB (27825099 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d27a36ad002329437bfc872f1d43a5e63e408b088f64cd1b2ebff00407e3d36`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
```console
$ docker pull php@sha256:f80ef9d20a5b73b54161ccdb9ab38da4ae9d7eea3be04de9dc184b48310c8547
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.8 MB (28759233 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:baf8903b7934dd7b9b95ff59f325727e0f72ed44e4e53288d118c75209d9d1e5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
