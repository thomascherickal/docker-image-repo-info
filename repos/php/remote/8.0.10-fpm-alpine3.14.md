...
```console
$ docker pull php@sha256:78b82d42d4c508604008e2f7dc8d9ff118f443329024c72bc695b1a4c9ba0324
```
...
### `php:8.0.10-fpm-alpine3.14` - linux; amd64
...
### `php:8.0.10-fpm-alpine3.14` - linux; arm variant v6
...
### `php:8.0.10-fpm-alpine3.14` - linux; arm variant v7
...
### `php:8.0.10-fpm-alpine3.14` - linux; arm64 variant v8
...
### `php:8.0.10-fpm-alpine3.14` - linux; s390x
