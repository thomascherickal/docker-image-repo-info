...
### `php:8.1.20-fpm-bookworm` - linux; amd64
...
### `php:8.1.20-fpm-bookworm` - linux; arm variant v5
...
### `php:8.1.20-fpm-bookworm` - linux; arm variant v7
...
### `php:8.1.20-fpm-bookworm` - linux; arm64 variant v8
...
### `php:8.1.20-fpm-bookworm` - linux; 386
...
### `php:8.1.20-fpm-bookworm` - linux; mips64le
...
### `php:8.1.20-fpm-bookworm` - linux; ppc64le
...
### `php:8.1.20-fpm-bookworm` - linux; s390x
