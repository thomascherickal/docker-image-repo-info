...
### `php:7.4.29-fpm-bullseye` - linux; amd64
...
### `php:7.4.29-fpm-bullseye` - linux; arm variant v5
...
### `php:7.4.29-fpm-bullseye` - linux; arm variant v7
...
### `php:7.4.29-fpm-bullseye` - linux; arm64 variant v8
...
### `php:7.4.29-fpm-bullseye` - linux; 386
...
### `php:7.4.29-fpm-bullseye` - linux; mips64le
...
### `php:7.4.29-fpm-bullseye` - linux; ppc64le
...
### `php:7.4.29-fpm-bullseye` - linux; s390x
