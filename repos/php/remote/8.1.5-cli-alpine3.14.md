...
```console
$ docker pull php@sha256:5a987966a72f8a3d117b4ff0098ec3a9fab77c785539da0621cdc99671bdcb35
```
...
### `php:8.1.5-cli-alpine3.14` - linux; amd64
...
### `php:8.1.5-cli-alpine3.14` - linux; arm variant v6
...
### `php:8.1.5-cli-alpine3.14` - linux; arm64 variant v8
...
### `php:8.1.5-cli-alpine3.14` - linux; 386
...
### `php:8.1.5-cli-alpine3.14` - linux; s390x
