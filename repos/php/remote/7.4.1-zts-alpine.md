...
```console
$ docker pull php@sha256:f46d3ea2fd37fa6dd4ec634bf0509c3e94bbc9315f8817acdd9c23277a428e6c
```
...
### `php:7.4.1-zts-alpine` - linux; arm64 variant v8
...
### `php:7.4.1-zts-alpine` - linux; ppc64le
