...
```console
$ docker pull php@sha256:2fdb523870a605901e670cd6baaabc510c50c91aeec2e48c05a4d78febad2be4
```
...
### `php:8.1.11-zts` - linux; arm variant v5
...
### `php:8.1.11-zts` - linux; arm variant v7
...
### `php:8.1.11-zts` - linux; arm64 variant v8
