...
### `php:7.4.19-alpine3.12` - linux; amd64
...
### `php:7.4.19-alpine3.12` - linux; arm variant v7
...
### `php:7.4.19-alpine3.12` - linux; arm64 variant v8
...
### `php:7.4.19-alpine3.12` - linux; 386
...
### `php:7.4.19-alpine3.12` - linux; ppc64le
...
### `php:7.4.19-alpine3.12` - linux; s390x
