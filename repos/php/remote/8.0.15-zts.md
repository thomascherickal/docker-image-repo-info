...
```console
$ docker pull php@sha256:dc4393056c534707a81e5aa89f4a846d6ef5aea53aaeb3e3751f49737795acdb
```
...
### `php:8.0.15-zts` - linux; arm variant v5
...
### `php:8.0.15-zts` - linux; arm variant v7
...
### `php:8.0.15-zts` - linux; arm64 variant v8
