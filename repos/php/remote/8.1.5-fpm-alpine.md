...
```console
$ docker pull php@sha256:9871d8db1f3fd4211d900a988451b70517015e5409825e99d685d10f3d8c3159
```
...
### `php:8.1.5-fpm-alpine` - linux; amd64
...
### `php:8.1.5-fpm-alpine` - linux; arm variant v6
...
### `php:8.1.5-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.1.5-fpm-alpine` - linux; 386
...
### `php:8.1.5-fpm-alpine` - linux; s390x
