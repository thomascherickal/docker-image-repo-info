...
### `php:8.0.22-cli-alpine` - linux; amd64
...
### `php:8.0.22-cli-alpine` - linux; arm variant v6
...
### `php:8.0.22-cli-alpine` - linux; arm variant v7
...
### `php:8.0.22-cli-alpine` - linux; arm64 variant v8
...
### `php:8.0.22-cli-alpine` - linux; 386
...
### `php:8.0.22-cli-alpine` - linux; ppc64le
...
### `php:8.0.22-cli-alpine` - linux; s390x
