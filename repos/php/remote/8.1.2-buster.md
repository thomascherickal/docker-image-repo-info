...
```console
$ docker pull php@sha256:ff108ba37461de044900412bc980e550f5cbcba0dcd1d9dbd6808250f742198a
```
...
### `php:8.1.2-buster` - linux; arm variant v5
...
### `php:8.1.2-buster` - linux; arm variant v7
...
### `php:8.1.2-buster` - linux; arm64 variant v8
...
### `php:8.1.2-buster` - linux; mips64le
...
### `php:8.1.2-buster` - linux; ppc64le
