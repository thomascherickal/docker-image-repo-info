...
```console
$ docker pull php@sha256:18224968e3b5f4c89075d4d59afdd1dd41171711aa444322a01b2a10c41aaf57
```
...
### `php:8.3.0alpha3-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.3.0alpha3-apache-bullseye` - linux; 386
...
### `php:8.3.0alpha3-apache-bullseye` - linux; mips64le
...
### `php:8.3.0alpha3-apache-bullseye` - linux; ppc64le
