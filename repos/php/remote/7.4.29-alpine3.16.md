...
### `php:7.4.29-alpine3.16` - linux; amd64
...
### `php:7.4.29-alpine3.16` - linux; arm variant v7
...
### `php:7.4.29-alpine3.16` - linux; arm64 variant v8
...
### `php:7.4.29-alpine3.16` - linux; 386
...
### `php:7.4.29-alpine3.16` - linux; ppc64le
...
### `php:7.4.29-alpine3.16` - linux; s390x
