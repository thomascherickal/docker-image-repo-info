...
```console
$ docker pull php@sha256:f78a55d5515c610473dfc589887dd182bedd68e9987ad748c8e58d433ebc5844
```
...
### `php:7.2.30-apache` - linux; arm variant v5
...
### `php:7.2.30-apache` - linux; arm variant v7
...
### `php:7.2.30-apache` - linux; arm64 variant v8
...
### `php:7.2.30-apache` - linux; ppc64le
