...
```console
$ docker pull php@sha256:599f01ae5f59b29426a5d8b7638ad4d5953abbe8021d3431dead60a5dff54f1a
```
...
### `php:8.1.6-cli-bullseye` - linux; amd64
...
### `php:8.1.6-cli-bullseye` - linux; arm variant v5
...
### `php:8.1.6-cli-bullseye` - linux; arm variant v7
...
### `php:8.1.6-cli-bullseye` - linux; arm64 variant v8
...
### `php:8.1.6-cli-bullseye` - linux; 386
...
### `php:8.1.6-cli-bullseye` - linux; mips64le
...
### `php:8.1.6-cli-bullseye` - linux; ppc64le
...
### `php:8.1.6-cli-bullseye` - linux; s390x
