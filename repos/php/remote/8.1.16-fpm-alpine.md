...
### `php:8.1.16-fpm-alpine` - linux; amd64
...
### `php:8.1.16-fpm-alpine` - linux; arm variant v6
...
### `php:8.1.16-fpm-alpine` - linux; arm variant v7
...
### `php:8.1.16-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.1.16-fpm-alpine` - linux; 386
...
### `php:8.1.16-fpm-alpine` - linux; ppc64le
...
### `php:8.1.16-fpm-alpine` - linux; s390x
