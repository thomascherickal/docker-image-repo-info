...
### `php:7.3.22-fpm-alpine3.12` - linux; amd64
...
### `php:7.3.22-fpm-alpine3.12` - linux; arm variant v7
...
### `php:7.3.22-fpm-alpine3.12` - linux; arm64 variant v8
...
### `php:7.3.22-fpm-alpine3.12` - linux; 386
...
### `php:7.3.22-fpm-alpine3.12` - linux; ppc64le
