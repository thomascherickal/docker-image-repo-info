...
### `php:7.4.33-zts-alpine` - linux; amd64
...
### `php:7.4.33-zts-alpine` - linux; arm variant v6
...
### `php:7.4.33-zts-alpine` - linux; arm variant v7
...
### `php:7.4.33-zts-alpine` - linux; arm64 variant v8
...
### `php:7.4.33-zts-alpine` - linux; 386
...
### `php:7.4.33-zts-alpine` - linux; ppc64le
...
### `php:7.4.33-zts-alpine` - linux; s390x
