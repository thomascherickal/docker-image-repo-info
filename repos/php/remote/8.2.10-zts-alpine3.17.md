...
```console
$ docker pull php@sha256:637943c075b512635462f17e76e6e785d117f18f54413196f7d35287523b9da0
```
...
### `php:8.2.10-zts-alpine3.17` - linux; arm64 variant v8
...
### `php:8.2.10-zts-alpine3.17` - linux; 386
