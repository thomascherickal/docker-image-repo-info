...
```console
$ docker pull php@sha256:c94caacf30e4c208974d547ed9c51cbe700ca367684e91e033765ddf03b445cd
```
...
### `php:8.0.9-zts-bullseye` - linux; arm variant v7
...
### `php:8.0.9-zts-bullseye` - linux; 386
...
### `php:8.0.9-zts-bullseye` - linux; ppc64le
...
### `php:8.0.9-zts-bullseye` - linux; s390x
