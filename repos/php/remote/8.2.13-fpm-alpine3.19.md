...
### `php:8.2.13-fpm-alpine3.19` - linux; amd64
...
### `php:8.2.13-fpm-alpine3.19` - linux; arm variant v7
...
### `php:8.2.13-fpm-alpine3.19` - linux; arm64 variant v8
...
### `php:8.2.13-fpm-alpine3.19` - linux; 386
...
### `php:8.2.13-fpm-alpine3.19` - linux; ppc64le
