...
```console
$ docker pull php@sha256:2d4dcbb94b473116240b58a9bd04ed3df86bffb6d73e0aaba194eda1d230f366
```
...
### `php:8.1.14-cli` - linux; arm variant v5
...
### `php:8.1.14-cli` - linux; arm variant v7
...
### `php:8.1.14-cli` - linux; arm64 variant v8
