...
```console
$ docker pull php@sha256:6d40e9121bed52f41eb8e1f286dab1fbfe4689883a619b9bde95ebc4423aacd0
```
...
### `php:8.1.23-zts-alpine3.17` - linux; amd64
...
### `php:8.1.23-zts-alpine3.17` - linux; ppc64le
