...
### `php:7.4.19-fpm-alpine` - linux; amd64
...
### `php:7.4.19-fpm-alpine` - linux; arm variant v7
...
### `php:7.4.19-fpm-alpine` - linux; arm64 variant v8
...
### `php:7.4.19-fpm-alpine` - linux; 386
...
### `php:7.4.19-fpm-alpine` - linux; ppc64le
...
### `php:7.4.19-fpm-alpine` - linux; s390x
