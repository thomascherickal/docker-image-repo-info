...
```console
$ docker pull php@sha256:5d8d449e44a653481b2880dcfbee8752250c3fa85ad325f8ba312ba8d56b5fe2
```
...
### `php:8.2.8-fpm-alpine` - linux; amd64
...
### `php:8.2.8-fpm-alpine` - linux; arm variant v7
...
### `php:8.2.8-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.2.8-fpm-alpine` - linux; 386
