...
### `pypy:3.6-7.3.1-buster` - linux; amd64
...
### `pypy:3.6-7.3.1-buster` - linux; arm64 variant v8
...
### `pypy:3.6-7.3.1-buster` - linux; 386
...
### `pypy:3.6-7.3.1-buster` - linux; ppc64le
...
### `pypy:3.6-7.3.1-buster` - linux; s390x
