...
### `pypy:3-7.3.6-slim-buster` - linux; amd64
...
### `pypy:3-7.3.6-slim-buster` - linux; arm64 variant v8
...
### `pypy:3-7.3.6-slim-buster` - linux; 386
...
### `pypy:3-7.3.6-slim-buster` - linux; s390x
