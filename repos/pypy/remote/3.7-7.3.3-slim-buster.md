...
```console
$ docker pull pypy@sha256:fdf67fe398106c996a435d8fdd9f99035dea76a2ff7423ddbd250d3ce157b00f
```
...
```console
$ docker pull pypy@sha256:2e3d4584008cf54329eb5034bbc79be8514553a27a448f0f5b4e8dfbdc8a527f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **62.9 MB (62869404 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de26f4d9ac57b1a98156ec09ce5441e21199a2c17e64535122434ef265f8b49e`
-	Default Command: `["pypy3"]`
