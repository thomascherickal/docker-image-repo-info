...
### `redis:7.0.0-alpine3.16` - linux; arm variant v6
...
### `redis:7.0.0-alpine3.16` - linux; arm64 variant v8
...
### `redis:7.0.0-alpine3.16` - linux; ppc64le
...
### `redis:7.0.0-alpine3.16` - linux; s390x
