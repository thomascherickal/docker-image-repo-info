...
### `redis:7-alpine3.15` - linux; amd64
...
### `redis:7-alpine3.15` - linux; arm variant v6
...
### `redis:7-alpine3.15` - linux; arm variant v7
...
### `redis:7-alpine3.15` - linux; s390x
