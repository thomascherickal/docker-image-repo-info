...
```console
$ docker pull redis@sha256:a591513a3aad12a6b73decb7cd00058dfba199258193991cc743181e005dc384
```
...
### `redis:6.2.11-alpine3.17` - linux; amd64
...
### `redis:6.2.11-alpine3.17` - linux; arm variant v6
...
### `redis:6.2.11-alpine3.17` - linux; arm variant v7
...
### `redis:6.2.11-alpine3.17` - linux; arm64 variant v8
...
### `redis:6.2.11-alpine3.17` - linux; 386
...
### `redis:6.2.11-alpine3.17` - linux; ppc64le
...
### `redis:6.2.11-alpine3.17` - linux; s390x
