...
### `redis:7.2.3-alpine3.19` - linux; amd64
...
### `redis:7.2.3-alpine3.19` - unknown; unknown
...
### `redis:7.2.3-alpine3.19` - linux; arm variant v6
...
### `redis:7.2.3-alpine3.19` - linux; arm variant v7
...
### `redis:7.2.3-alpine3.19` - linux; arm64 variant v8
...
### `redis:7.2.3-alpine3.19` - linux; 386
...
### `redis:7.2.3-alpine3.19` - linux; ppc64le
...
### `redis:7.2.3-alpine3.19` - linux; s390x
