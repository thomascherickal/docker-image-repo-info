...
### `redis:6.2.8-alpine3.17` - linux; amd64
...
### `redis:6.2.8-alpine3.17` - linux; arm variant v6
...
### `redis:6.2.8-alpine3.17` - linux; arm variant v7
...
### `redis:6.2.8-alpine3.17` - linux; arm64 variant v8
...
### `redis:6.2.8-alpine3.17` - linux; 386
...
### `redis:6.2.8-alpine3.17` - linux; ppc64le
...
### `redis:6.2.8-alpine3.17` - linux; s390x
