...
### `mariadb:11.2.1-rc-jammy` - linux; amd64
...
### `mariadb:11.2.1-rc-jammy` - linux; arm64 variant v8
...
### `mariadb:11.2.1-rc-jammy` - linux; ppc64le
...
### `mariadb:11.2.1-rc-jammy` - linux; s390x
