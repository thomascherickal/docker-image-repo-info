...
- Image ID: `sha256:eddf1dd9da934ab6eb3198b92574628d6d236b322b5395c08e33e4dcd65f9caa`
- Created: `2021-09-23T18:19:50.002499073Z`
- Virtual Size: ~ 811.00 Mb  
...
- Environment:
  ...
  - `CONVERTIGO_VERSION=7.9.5`
  - `CONVERTIGO_WAR_URL=https://github.com/convertigo/convertigo/releases/download/7.9.5/convertigo-7.9.5.war`
...
### `dpkg` source package: `sudo=1.9.5p2-3`
...
```console
$ apt-get source -qq --print-uris sudo=1.9.5p2-3
'http://deb.debian.org/debian/pool/main/s/sudo/sudo_1.9.5p2-3.dsc' sudo_1.9.5p2-3.dsc 2142 SHA256:c83ac95dc2ba1226470042e3477422935f6b90f30d33cd42094af922a1af572e
'http://deb.debian.org/debian/pool/main/s/sudo/sudo_1.9.5p2.orig.tar.gz' sudo_1.9.5p2.orig.tar.gz 4012277 SHA256:539e2ef43c8a55026697fb0474ab6a925a11206b5aa58710cb42a0e1c81f0978
'http://deb.debian.org/debian/pool/main/s/sudo/sudo_1.9.5p2-3.debian.tar.xz' sudo_1.9.5p2-3.debian.tar.xz 26276 SHA256:cd12a37fc0f21d83205ae827ad4e1cd329ffcc159644efd6335e7e6f80235612
```

Other potentially useful URLs:

- https://sources.debian.net/src/sudo/1.9.5p2-3/ (for browsing the source)
- https://sources.debian.net/src/sudo/1.9.5p2-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/sudo/1.9.5p2-3/ (for access to the source package after it no longer exists in the archive)
