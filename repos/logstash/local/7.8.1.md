...
- Created: `2020-07-21T19:30:59.873572197Z`
- Virtual Size: ~ 784.55 Mb  
...
### `rpm` package: `java-11-openjdk-11.0.7.10-4.el7_8.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-11.0.7.10-4.el7_8
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.7.10-4.el7_8.src.rpm
```

### `rpm` package: `java-11-openjdk-devel-11.0.7.10-4.el7_8.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-devel-11.0.7.10-4.el7_8
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.7.10-4.el7_8.src.rpm
...
### `rpm` package: `java-11-openjdk-headless-11.0.7.10-4.el7_8.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-headless-11.0.7.10-4.el7_8
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.7.10-4.el7_8.src.rpm
...
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/systemd-219-73.el7_8.8.src.rpm
```
