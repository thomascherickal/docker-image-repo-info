...
- Created: `2020-02-26T16:17:27.52324477Z`
...
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/fribidi-1.0.2-1.el7_7.1.src.rpm
```
...
### `rpm` package: `hwdata-0.252-9.3.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls hwdata-0.252-9.3.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/hwdata-0.252-9.3.el7.src.rpm
```
...
### `rpm` package: `java-1.8.0-openjdk-1.8.0.242.b08-0.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-1.8.0-openjdk-1.8.0.242.b08-0.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-1.8.0-openjdk-1.8.0.242.b08-0.el7_7.src.rpm
```

### `rpm` package: `java-1.8.0-openjdk-devel-1.8.0.242.b08-0.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-1.8.0-openjdk-devel-1.8.0.242.b08-0.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-1.8.0-openjdk-1.8.0.242.b08-0.el7_7.src.rpm
...
### `rpm` package: `java-1.8.0-openjdk-headless-1.8.0.242.b08-0.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-1.8.0-openjdk-headless-1.8.0.242.b08-0.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-1.8.0-openjdk-1.8.0.242.b08-0.el7_7.src.rpm
...
### `rpm` package: `mesa-libEGL-18.3.4-6.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls mesa-libEGL-18.3.4-6.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/mesa-18.3.4-6.el7_7.src.rpm
```

### `rpm` package: `mesa-libGL-18.3.4-6.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls mesa-libGL-18.3.4-6.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/mesa-18.3.4-6.el7_7.src.rpm
...
### `rpm` package: `mesa-libgbm-18.3.4-6.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls mesa-libgbm-18.3.4-6.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/mesa-18.3.4-6.el7_7.src.rpm
...
### `rpm` package: `mesa-libglapi-18.3.4-6.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls mesa-libglapi-18.3.4-6.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/mesa-18.3.4-6.el7_7.src.rpm
...
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/pango-1.42.4-4.el7_7.src.rpm
```
