...
- Created: `2022-01-06T20:50:51.370414152Z`
- Virtual Size: ~ 913.33 Mb  
...
```console
$ dnf --quiet download --source --url atk-2.28.1-2.el7
...
```console
$ dnf --quiet download --source --url cairo-1.15.12-4.el7
...
```console
$ dnf --quiet download --source --url copy-jdk-configs-3.3-10.el7_5.noarch
...
```console
$ dnf --quiet download --source --url cups-libs-1.6.3-51.el7
...
```console
$ dnf --quiet download --source --url fribidi-1.0.2-1.el7_7.1
...
```console
$ dnf --quiet download --source --url gdk-pixbuf2-2.36.12-3.el7
...
```console
$ dnf --quiet download --source --url giflib-4.1.6-9.el7
...
```console
$ dnf --quiet download --source --url graphite2-1.3.10-1.el7_3
...
```console
$ dnf --quiet download --source --url gtk-update-icon-cache-3.22.30-6.el7
...
```console
$ dnf --quiet download --source --url gtk2-2.24.31-1.el7
...
```console
$ dnf --quiet download --source --url harfbuzz-1.7.5-2.el7
...
```console
$ dnf --quiet download --source --url hicolor-icon-theme-0.12-7.el7.noarch
...
```console
$ dnf --quiet download --source --url hwdata-0.252-9.7.el7
...
```console
$ dnf --quiet download --source --url jasper-libs-1.900.1-33.el7
...
```console
$ dnf --quiet download --source --url java-1.8.0-openjdk-1.8.0.282.b08-1.el7_9
...
```console
$ dnf --quiet download --source --url java-1.8.0-openjdk-devel-1.8.0.282.b08-1.el7_9
http://vault.centos.org/centos/7/updates/Source/SPackages/java-1.8.0-openjdk-1.8.0.282.b08-1.el7_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url java-1.8.0-openjdk-headless-1.8.0.282.b08-1.el7_9
http://vault.centos.org/centos/7/updates/Source/SPackages/java-1.8.0-openjdk-1.8.0.282.b08-1.el7_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url javapackages-tools-3.4.1-11.el7.noarch
...
```console
$ dnf --quiet download --source --url jbigkit-libs-2.0-11.el7
...
```console
$ dnf --quiet download --source --url libICE-1.0.9-9.el7
...
```console
$ dnf --quiet download --source --url libSM-1.2.2-2.el7
...
```console
$ dnf --quiet download --source --url libXcomposite-0.4.4-4.1.el7
...
```console
$ dnf --quiet download --source --url libXcursor-1.1.15-1.el7
...
```console
$ dnf --quiet download --source --url libXdamage-1.1.4-4.1.el7
...
```console
$ dnf --quiet download --source --url libXfixes-5.0.3-1.el7
...
```console
$ dnf --quiet download --source --url libXft-2.3.2-2.el7
...
```console
$ dnf --quiet download --source --url libXinerama-1.1.3-2.1.el7
...
```console
$ dnf --quiet download --source --url libXrandr-1.5.1-2.el7
...
```console
$ dnf --quiet download --source --url libXxf86vm-1.1.4-1.el7
...
```console
$ dnf --quiet download --source --url libdrm-2.4.97-2.el7
...
```console
$ dnf --quiet download --source --url libfontenc-1.1.3-3.el7
...
```console
$ dnf --quiet download --source --url libglvnd-1.0.1-0.8.git5baa1e5.el7
...
```console
$ dnf --quiet download --source --url libglvnd-egl-1.0.1-0.8.git5baa1e5.el7
http://vault.centos.org/centos/7/os/Source/SPackages/libglvnd-1.0.1-0.8.git5baa1e5.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url libglvnd-glx-1.0.1-0.8.git5baa1e5.el7
http://vault.centos.org/centos/7/os/Source/SPackages/libglvnd-1.0.1-0.8.git5baa1e5.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url libjpeg-turbo-1.2.90-8.el7
...
```console
$ dnf --quiet download --source --url libpciaccess-0.14-1.el7
...
```console
$ dnf --quiet download --source --url libthai-0.1.14-9.el7
...
```console
$ dnf --quiet download --source --url libtiff-4.0.3-35.el7
...
```console
$ dnf --quiet download --source --url libwayland-client-1.15.0-1.el7
...
```console
$ dnf --quiet download --source --url libwayland-server-1.15.0-1.el7
http://vault.centos.org/centos/7/os/Source/SPackages/wayland-1.15.0-1.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url libxshmfence-1.2-1.el7
...
```console
$ dnf --quiet download --source --url libxslt-1.1.28-6.el7
...
```console
$ dnf --quiet download --source --url lksctp-tools-1.0.17-2.el7
...
```console
$ dnf --quiet download --source --url mesa-libEGL-18.3.4-12.el7_9
...
```console
$ dnf --quiet download --source --url mesa-libGL-18.3.4-12.el7_9
http://vault.centos.org/centos/7/updates/Source/SPackages/mesa-18.3.4-12.el7_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url mesa-libgbm-18.3.4-12.el7_9
http://vault.centos.org/centos/7/updates/Source/SPackages/mesa-18.3.4-12.el7_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url mesa-libglapi-18.3.4-12.el7_9
http://vault.centos.org/centos/7/updates/Source/SPackages/mesa-18.3.4-12.el7_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url pango-1.42.4-4.el7_7
...
```console
$ dnf --quiet download --source --url pcsc-lite-libs-1.8.8-8.el7
...
```console
$ dnf --quiet download --source --url pixman-0.34.0-1.el7
...
```console
$ dnf --quiet download --source --url python-javapackages-3.4.1-11.el7.noarch
http://vault.centos.org/centos/7/os/Source/SPackages/javapackages-tools-3.4.1-11.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url python-lxml-3.2.1-4.el7
...
```console
$ dnf --quiet download --source --url systemd-219-78.el7_9.3
...
```console
$ dnf --quiet download --source --url systemd-libs-219-78.el7_9.3
http://vault.centos.org/centos/7/updates/Source/SPackages/systemd-219-78.el7_9.3.src.rpm
```
...
```console
$ dnf --quiet download --source --url ttmkfdir-3.0.9-42.el7
...
### `rpm` package: `tzdata-java-2021e-1.el7.noarch`
...
```console
$ dnf --quiet download --source --url tzdata-java-2021e-1.el7.noarch
http://vault.centos.org/centos/7/updates/Source/SPackages/tzdata-2021e-1.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url xorg-x11-font-utils-7.5-21.el7
...
```console
$ dnf --quiet download --source --url xorg-x11-fonts-Type1-7.5-9.el7.noarch
