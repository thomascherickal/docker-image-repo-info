...
```console
$ docker pull ghost@sha256:edf1cc59d55cfcc9b17595728d978c3da540b281811db2b9dad0f827eef5f8e9
```
...
### `ghost:3.39.0-alpine` - linux; arm variant v6
...
### `ghost:3.39.0-alpine` - linux; arm64 variant v8
