...
### `ghost:5.75.1-alpine` - linux; amd64
...
### `ghost:5.75.1-alpine` - unknown; unknown
...
### `ghost:5.75.1-alpine` - linux; arm variant v6
...
### `ghost:5.75.1-alpine` - linux; arm variant v7
...
### `ghost:5.75.1-alpine` - linux; arm64 variant v8
