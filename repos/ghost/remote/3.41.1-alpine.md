...
```console
$ docker pull ghost@sha256:4e58a898ed9ca88573749091eb0f9bc4fb755d57114cad9e234f376a1eee2292
```
...
### `ghost:3.41.1-alpine` - linux; arm variant v6
...
### `ghost:3.41.1-alpine` - linux; arm variant v7
