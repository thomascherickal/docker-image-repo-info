...
```console
$ docker pull erlang@sha256:281c4157c6059bf364ba087a6329dcde6b63f2f6579bf28c95b0c777b480669f
```
...
### `erlang:24.3.4.12` - linux; arm variant v7
...
### `erlang:24.3.4.12` - linux; ppc64le
