...
```console
$ docker pull erlang@sha256:f21762ac544c91c8184ff7e9e44e6e1b200bda8124d1695db03c29dca5d1c7ee
```
...
### `erlang:22.3.4.12` - linux; arm variant v7
...
### `erlang:22.3.4.12` - linux; arm64 variant v8
...
### `erlang:22.3.4.12` - linux; ppc64le
