...
### `erlang:23.1.5-slim` - linux; amd64
...
### `erlang:23.1.5-slim` - linux; arm64 variant v8
...
### `erlang:23.1.5-slim` - linux; ppc64le
...
### `erlang:23.1.5-slim` - linux; s390x
