...
- Created: `2021-01-26T19:23:08.612405468Z`
...
- Environment:
  ...
  - `OTP_VERSION=22.3.4.15`
  - `REBAR3_VERSION=3.14.3`
  - `REBAR_VERSION=2.6.4`
- Labels:
  - `org.opencontainers.image.version=22.3.4.15`
...
- http://snapshot.debian.org/package/libmaxminddb/1.3.2-1/
