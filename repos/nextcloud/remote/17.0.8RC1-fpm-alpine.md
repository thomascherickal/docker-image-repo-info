...
```console
$ docker pull nextcloud@sha256:cd54781b2a0c1857491a552d4700b3c40a427ef860396f7aa60670408862eb54
```
...
### `nextcloud:17.0.8RC1-fpm-alpine` - linux; amd64
...
### `nextcloud:17.0.8RC1-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:17.0.8RC1-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:17.0.8RC1-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:17.0.8RC1-fpm-alpine` - linux; 386
...
### `nextcloud:17.0.8RC1-fpm-alpine` - linux; s390x
