...
### `nextcloud:20.0.6-fpm` - linux; amd64
...
### `nextcloud:20.0.6-fpm` - linux; arm variant v5
...
### `nextcloud:20.0.6-fpm` - linux; arm variant v7
...
### `nextcloud:20.0.6-fpm` - linux; arm64 variant v8
...
### `nextcloud:20.0.6-fpm` - linux; 386
...
### `nextcloud:20.0.6-fpm` - linux; mips64le
...
### `nextcloud:20.0.6-fpm` - linux; ppc64le
...
### `nextcloud:20.0.6-fpm` - linux; s390x
