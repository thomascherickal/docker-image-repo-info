## `nextcloud:18.0.0-rc-fpm`

```console
$ docker pull nextcloud@sha256:ccf34f99b832782a2048e9b9df466222f64d81eda8777fc59d2cbc537f86c4af
```
...
### `nextcloud:18.0.0-rc-fpm` - linux; amd64
...
### `nextcloud:18.0.0-rc-fpm` - linux; arm variant v7
...
### `nextcloud:18.0.0-rc-fpm` - linux; arm64 variant v8
...
### `nextcloud:18.0.0-rc-fpm` - linux; 386
...
### `nextcloud:18.0.0-rc-fpm` - linux; ppc64le
