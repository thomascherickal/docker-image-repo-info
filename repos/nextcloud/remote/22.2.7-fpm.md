...
### `nextcloud:22.2.7-fpm` - linux; amd64
...
### `nextcloud:22.2.7-fpm` - linux; arm variant v5
...
### `nextcloud:22.2.7-fpm` - linux; arm variant v7
...
### `nextcloud:22.2.7-fpm` - linux; arm64 variant v8
...
### `nextcloud:22.2.7-fpm` - linux; mips64le
...
### `nextcloud:22.2.7-fpm` - linux; ppc64le
...
### `nextcloud:22.2.7-fpm` - linux; s390x
