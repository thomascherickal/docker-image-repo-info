...
### `nextcloud:24.0.2-fpm` - linux; amd64
...
### `nextcloud:24.0.2-fpm` - linux; arm variant v5
...
### `nextcloud:24.0.2-fpm` - linux; arm variant v7
...
### `nextcloud:24.0.2-fpm` - linux; arm64 variant v8
...
### `nextcloud:24.0.2-fpm` - linux; 386
...
### `nextcloud:24.0.2-fpm` - linux; mips64le
...
### `nextcloud:24.0.2-fpm` - linux; ppc64le
...
### `nextcloud:24.0.2-fpm` - linux; s390x
