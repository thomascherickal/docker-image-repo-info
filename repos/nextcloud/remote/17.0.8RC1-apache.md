...
### `nextcloud:17.0.8RC1-apache` - linux; amd64
...
### `nextcloud:17.0.8RC1-apache` - linux; arm variant v5
...
### `nextcloud:17.0.8RC1-apache` - linux; arm variant v7
...
### `nextcloud:17.0.8RC1-apache` - linux; arm64 variant v8
...
### `nextcloud:17.0.8RC1-apache` - linux; 386
...
### `nextcloud:17.0.8RC1-apache` - linux; mips64le
...
### `nextcloud:17.0.8RC1-apache` - linux; ppc64le
...
### `nextcloud:17.0.8RC1-apache` - linux; s390x
