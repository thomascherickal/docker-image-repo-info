...
### `nextcloud:19.0.3RC1-fpm` - linux; amd64
...
### `nextcloud:19.0.3RC1-fpm` - linux; arm variant v5
...
### `nextcloud:19.0.3RC1-fpm` - linux; arm64 variant v8
...
### `nextcloud:19.0.3RC1-fpm` - linux; 386
...
### `nextcloud:19.0.3RC1-fpm` - linux; ppc64le
...
### `nextcloud:19.0.3RC1-fpm` - linux; s390x
