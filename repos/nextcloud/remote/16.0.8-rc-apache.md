...
### `nextcloud:16.0.8-rc-apache` - linux; amd64
...
### `nextcloud:16.0.8-rc-apache` - linux; arm variant v5
...
### `nextcloud:16.0.8-rc-apache` - linux; arm variant v7
...
### `nextcloud:16.0.8-rc-apache` - linux; arm64 variant v8
...
### `nextcloud:16.0.8-rc-apache` - linux; 386
...
### `nextcloud:16.0.8-rc-apache` - linux; ppc64le
