## `nextcloud:24.0.8-fpm-alpine`

```console
$ docker pull nextcloud@sha256:24f7eaa406a794adf40a612088c4d59ef118850af8dfac1b4d4de663067fa3a4
```
...
### `nextcloud:24.0.8-fpm-alpine` - linux; amd64
...
### `nextcloud:24.0.8-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:24.0.8-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:24.0.8-fpm-alpine` - linux; 386
...
### `nextcloud:24.0.8-fpm-alpine` - linux; ppc64le
