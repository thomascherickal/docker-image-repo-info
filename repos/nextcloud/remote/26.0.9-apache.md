...
### `nextcloud:26.0.9-apache` - linux; amd64
...
### `nextcloud:26.0.9-apache` - linux; arm variant v5
...
### `nextcloud:26.0.9-apache` - linux; arm variant v7
...
### `nextcloud:26.0.9-apache` - linux; arm64 variant v8
...
### `nextcloud:26.0.9-apache` - linux; 386
...
### `nextcloud:26.0.9-apache` - linux; mips64le
...
### `nextcloud:26.0.9-apache` - linux; ppc64le
...
### `nextcloud:26.0.9-apache` - linux; s390x
