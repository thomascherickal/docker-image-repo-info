...
```console
$ docker pull nextcloud@sha256:db34bd97f05308a17d6f7fddc52d26fe97d808f559f65e0d576fe9f231a5bf83
```
...
### `nextcloud:21.0.0beta4-fpm-alpine` - linux; amd64
...
### `nextcloud:21.0.0beta4-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:21.0.0beta4-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:21.0.0beta4-fpm-alpine` - linux; 386
...
### `nextcloud:21.0.0beta4-fpm-alpine` - linux; s390x
