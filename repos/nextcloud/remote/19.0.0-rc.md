...
### `nextcloud:19.0.0-rc` - linux; amd64
...
### `nextcloud:19.0.0-rc` - linux; arm variant v5
...
### `nextcloud:19.0.0-rc` - linux; arm variant v7
...
### `nextcloud:19.0.0-rc` - linux; arm64 variant v8
...
### `nextcloud:19.0.0-rc` - linux; mips64le
...
### `nextcloud:19.0.0-rc` - linux; ppc64le
...
### `nextcloud:19.0.0-rc` - linux; s390x
