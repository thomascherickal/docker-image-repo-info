...
### `nextcloud:25.0.12-fpm-alpine` - linux; amd64
...
### `nextcloud:25.0.12-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:25.0.12-fpm-alpine` - linux; 386
...
### `nextcloud:25.0.12-fpm-alpine` - linux; ppc64le
