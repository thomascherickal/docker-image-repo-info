...
```console
$ docker pull nextcloud@sha256:617fb4c426fe916c6cd8413f2774536b8bd1644c6586d510b4c4e0f182e69861
```
...
### `nextcloud:25.0.5-apache` - linux; amd64
...
### `nextcloud:25.0.5-apache` - linux; arm variant v5
...
### `nextcloud:25.0.5-apache` - linux; arm variant v7
...
### `nextcloud:25.0.5-apache` - linux; arm64 variant v8
...
### `nextcloud:25.0.5-apache` - linux; 386
...
### `nextcloud:25.0.5-apache` - linux; mips64le
...
### `nextcloud:25.0.5-apache` - linux; ppc64le
...
### `nextcloud:25.0.5-apache` - linux; s390x
