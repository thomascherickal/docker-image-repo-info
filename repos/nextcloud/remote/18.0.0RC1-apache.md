...
### `nextcloud:18.0.0RC1-apache` - linux; amd64
...
### `nextcloud:18.0.0RC1-apache` - linux; arm variant v5
...
### `nextcloud:18.0.0RC1-apache` - linux; arm variant v7
...
### `nextcloud:18.0.0RC1-apache` - linux; arm64 variant v8
...
### `nextcloud:18.0.0RC1-apache` - linux; 386
...
### `nextcloud:18.0.0RC1-apache` - linux; ppc64le
