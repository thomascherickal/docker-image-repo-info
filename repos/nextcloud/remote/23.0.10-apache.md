...
### `nextcloud:23.0.10-apache` - linux; amd64
...
### `nextcloud:23.0.10-apache` - linux; arm variant v5
...
### `nextcloud:23.0.10-apache` - linux; arm variant v7
...
### `nextcloud:23.0.10-apache` - linux; arm64 variant v8
...
### `nextcloud:23.0.10-apache` - linux; 386
...
### `nextcloud:23.0.10-apache` - linux; mips64le
...
### `nextcloud:23.0.10-apache` - linux; ppc64le
...
### `nextcloud:23.0.10-apache` - linux; s390x
