...
### `nextcloud:17.0.3-rc-fpm-alpine` - linux; amd64
...
### `nextcloud:17.0.3-rc-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:17.0.3-rc-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:17.0.3-rc-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:17.0.3-rc-fpm-alpine` - linux; 386
...
### `nextcloud:17.0.3-rc-fpm-alpine` - linux; ppc64le
