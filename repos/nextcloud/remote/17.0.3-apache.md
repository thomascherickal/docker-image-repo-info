...
```console
$ docker pull nextcloud@sha256:2098dc7aba71605e55a2eb6fd1bab7516dc1cd9ee47bf99b14ed082141b4960f
```
...
### `nextcloud:17.0.3-apache` - linux; amd64
...
### `nextcloud:17.0.3-apache` - linux; arm variant v5
...
### `nextcloud:17.0.3-apache` - linux; arm variant v7
...
### `nextcloud:17.0.3-apache` - linux; arm64 variant v8
...
### `nextcloud:17.0.3-apache` - linux; 386
...
### `nextcloud:17.0.3-apache` - linux; ppc64le
