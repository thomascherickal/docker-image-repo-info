...
```console
$ docker pull nextcloud@sha256:ced3b85a04bf31097566355f884d6a0848db398fc81f26c8e369cdb2f19afd0e
```
...
### `nextcloud:17.0.8-rc-apache` - linux; amd64
...
### `nextcloud:17.0.8-rc-apache` - linux; arm variant v5
...
### `nextcloud:17.0.8-rc-apache` - linux; arm variant v7
...
### `nextcloud:17.0.8-rc-apache` - linux; arm64 variant v8
...
### `nextcloud:17.0.8-rc-apache` - linux; 386
...
### `nextcloud:17.0.8-rc-apache` - linux; mips64le
...
### `nextcloud:17.0.8-rc-apache` - linux; s390x
