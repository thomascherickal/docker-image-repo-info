...
### `nextcloud:21.0.0beta2-apache` - linux; amd64
...
### `nextcloud:21.0.0beta2-apache` - linux; arm variant v7
...
### `nextcloud:21.0.0beta2-apache` - linux; arm64 variant v8
...
### `nextcloud:21.0.0beta2-apache` - linux; 386
...
### `nextcloud:21.0.0beta2-apache` - linux; ppc64le
...
### `nextcloud:21.0.0beta2-apache` - linux; s390x
