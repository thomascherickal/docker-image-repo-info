...
```console
$ docker pull nextcloud@sha256:401fd840fc27f5f99c693c27379f598070f6d389c9ce21100003dc910431d5ce
```
...
### `nextcloud:24.0.3-fpm-alpine` - linux; amd64
...
### `nextcloud:24.0.3-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:24.0.3-fpm-alpine` - linux; s390x
