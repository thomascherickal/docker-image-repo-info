...
### `nextcloud:18.0.0-beta-apache` - linux; amd64
...
### `nextcloud:18.0.0-beta-apache` - linux; arm variant v5
...
### `nextcloud:18.0.0-beta-apache` - linux; arm variant v7
...
### `nextcloud:18.0.0-beta-apache` - linux; arm64 variant v8
...
### `nextcloud:18.0.0-beta-apache` - linux; 386
...
### `nextcloud:18.0.0-beta-apache` - linux; ppc64le
