...
```console
$ docker pull nextcloud@sha256:f425051d72f6ffb2f9de1d3addbe04447727bc726c6aa29cbb9ad052a0156928
```
...
### `nextcloud:27.1.0-apache` - linux; amd64
...
### `nextcloud:27.1.0-apache` - linux; arm variant v5
...
### `nextcloud:27.1.0-apache` - linux; arm variant v7
...
### `nextcloud:27.1.0-apache` - linux; arm64 variant v8
...
### `nextcloud:27.1.0-apache` - linux; 386
...
### `nextcloud:27.1.0-apache` - linux; mips64le
...
### `nextcloud:27.1.0-apache` - linux; ppc64le
...
### `nextcloud:27.1.0-apache` - linux; s390x
