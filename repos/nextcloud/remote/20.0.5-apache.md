...
```console
$ docker pull nextcloud@sha256:5475f205d22acd8e96f2b4700c69c81913ef6352bc3551cdfd13cf2fcfcdfc57
```
...
### `nextcloud:20.0.5-apache` - linux; amd64
...
### `nextcloud:20.0.5-apache` - linux; arm variant v5
...
### `nextcloud:20.0.5-apache` - linux; arm variant v7
...
### `nextcloud:20.0.5-apache` - linux; arm64 variant v8
...
### `nextcloud:20.0.5-apache` - linux; 386
...
### `nextcloud:20.0.5-apache` - linux; mips64le
...
### `nextcloud:20.0.5-apache` - linux; ppc64le
