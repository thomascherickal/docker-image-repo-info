...
### `nextcloud:20.0.2-apache` - linux; amd64
...
### `nextcloud:20.0.2-apache` - linux; arm variant v5
...
### `nextcloud:20.0.2-apache` - linux; arm variant v7
...
### `nextcloud:20.0.2-apache` - linux; arm64 variant v8
...
### `nextcloud:20.0.2-apache` - linux; 386
...
### `nextcloud:20.0.2-apache` - linux; mips64le
...
### `nextcloud:20.0.2-apache` - linux; ppc64le
...
### `nextcloud:20.0.2-apache` - linux; s390x
