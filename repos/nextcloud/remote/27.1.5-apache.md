...
### `nextcloud:27.1.5-apache` - linux; amd64
...
### `nextcloud:27.1.5-apache` - linux; arm variant v5
...
### `nextcloud:27.1.5-apache` - linux; arm variant v7
...
### `nextcloud:27.1.5-apache` - linux; arm64 variant v8
...
### `nextcloud:27.1.5-apache` - linux; 386
...
### `nextcloud:27.1.5-apache` - linux; mips64le
...
### `nextcloud:27.1.5-apache` - linux; ppc64le
...
### `nextcloud:27.1.5-apache` - linux; s390x
