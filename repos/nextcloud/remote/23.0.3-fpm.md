...
### `nextcloud:23.0.3-fpm` - linux; amd64
...
### `nextcloud:23.0.3-fpm` - linux; arm variant v5
...
### `nextcloud:23.0.3-fpm` - linux; arm variant v7
...
### `nextcloud:23.0.3-fpm` - linux; arm64 variant v8
...
### `nextcloud:23.0.3-fpm` - linux; 386
...
### `nextcloud:23.0.3-fpm` - linux; mips64le
...
### `nextcloud:23.0.3-fpm` - linux; ppc64le
...
### `nextcloud:23.0.3-fpm` - linux; s390x
