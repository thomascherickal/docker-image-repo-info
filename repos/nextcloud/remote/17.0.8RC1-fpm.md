...
### `nextcloud:17.0.8RC1-fpm` - linux; amd64
...
### `nextcloud:17.0.8RC1-fpm` - linux; arm variant v5
...
### `nextcloud:17.0.8RC1-fpm` - linux; arm variant v7
...
### `nextcloud:17.0.8RC1-fpm` - linux; arm64 variant v8
...
### `nextcloud:17.0.8RC1-fpm` - linux; 386
...
### `nextcloud:17.0.8RC1-fpm` - linux; mips64le
...
### `nextcloud:17.0.8RC1-fpm` - linux; ppc64le
...
### `nextcloud:17.0.8RC1-fpm` - linux; s390x
