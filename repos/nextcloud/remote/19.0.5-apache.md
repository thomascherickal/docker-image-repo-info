...
### `nextcloud:19.0.5-apache` - linux; amd64
...
### `nextcloud:19.0.5-apache` - linux; arm variant v7
...
### `nextcloud:19.0.5-apache` - linux; arm64 variant v8
...
### `nextcloud:19.0.5-apache` - linux; ppc64le
