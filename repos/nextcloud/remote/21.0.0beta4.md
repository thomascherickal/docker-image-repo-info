...
```console
$ docker pull nextcloud@sha256:04749c10799a5172d48b141b2fb5125e27db79a26cc2bba5fc0619ea696d6897
```
...
### `nextcloud:21.0.0beta4` - linux; amd64
...
### `nextcloud:21.0.0beta4` - linux; arm variant v5
...
### `nextcloud:21.0.0beta4` - linux; arm variant v7
...
### `nextcloud:21.0.0beta4` - linux; 386
...
### `nextcloud:21.0.0beta4` - linux; mips64le
...
### `nextcloud:21.0.0beta4` - linux; s390x
