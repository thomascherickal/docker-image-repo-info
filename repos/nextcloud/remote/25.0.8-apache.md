...
### `nextcloud:25.0.8-apache` - linux; arm64 variant v8
...
### `nextcloud:25.0.8-apache` - linux; 386
...
### `nextcloud:25.0.8-apache` - linux; mips64le
...
### `nextcloud:25.0.8-apache` - linux; ppc64le
...
### `nextcloud:25.0.8-apache` - linux; s390x
