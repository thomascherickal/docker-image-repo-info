...
```console
$ docker pull nextcloud@sha256:c12c776cb4b1b7b04813f4c4c5198d2c1bf67997467546df79823887105cc6b9
```
...
### `nextcloud:19.0-beta-apache` - linux; amd64
...
### `nextcloud:19.0-beta-apache` - linux; arm variant v5
...
### `nextcloud:19.0-beta-apache` - linux; arm variant v7
...
### `nextcloud:19.0-beta-apache` - linux; arm64 variant v8
...
### `nextcloud:19.0-beta-apache` - linux; 386
...
### `nextcloud:19.0-beta-apache` - linux; mips64le
...
### `nextcloud:19.0-beta-apache` - linux; ppc64le
...
### `nextcloud:19.0-beta-apache` - linux; s390x
