...
```console
$ docker pull nextcloud@sha256:77170e30f5326b1bc117ed5e09dd7180008c34105575e29415dca02e235b06c7
```
...
### `nextcloud:21.0.6-fpm` - linux; amd64
...
### `nextcloud:21.0.6-fpm` - linux; 386
...
### `nextcloud:21.0.6-fpm` - linux; s390x
