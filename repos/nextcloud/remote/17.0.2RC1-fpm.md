...
### `nextcloud:17.0.2RC1-fpm` - linux; amd64
...
### `nextcloud:17.0.2RC1-fpm` - linux; arm variant v5
...
### `nextcloud:17.0.2RC1-fpm` - linux; arm variant v7
...
### `nextcloud:17.0.2RC1-fpm` - linux; arm64 variant v8
...
### `nextcloud:17.0.2RC1-fpm` - linux; 386
...
### `nextcloud:17.0.2RC1-fpm` - linux; ppc64le
