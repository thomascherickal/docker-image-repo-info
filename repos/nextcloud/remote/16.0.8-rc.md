...
### `nextcloud:16.0.8-rc` - linux; amd64
...
### `nextcloud:16.0.8-rc` - linux; arm variant v5
...
### `nextcloud:16.0.8-rc` - linux; arm variant v7
...
### `nextcloud:16.0.8-rc` - linux; arm64 variant v8
...
### `nextcloud:16.0.8-rc` - linux; ppc64le
