...
### `nextcloud:16.0.8RC1-fpm-alpine` - linux; amd64
...
### `nextcloud:16.0.8RC1-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:16.0.8RC1-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:16.0.8RC1-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:16.0.8RC1-fpm-alpine` - linux; 386
...
### `nextcloud:16.0.8RC1-fpm-alpine` - linux; ppc64le
