...
### `nextcloud:15.0.14-rc-fpm` - linux; amd64
...
### `nextcloud:15.0.14-rc-fpm` - linux; arm variant v5
...
### `nextcloud:15.0.14-rc-fpm` - linux; arm variant v7
...
### `nextcloud:15.0.14-rc-fpm` - linux; arm64 variant v8
...
### `nextcloud:15.0.14-rc-fpm` - linux; 386
...
### `nextcloud:15.0.14-rc-fpm` - linux; ppc64le
