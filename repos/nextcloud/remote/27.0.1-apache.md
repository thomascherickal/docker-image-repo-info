...
### `nextcloud:27.0.1-apache` - linux; amd64
...
### `nextcloud:27.0.1-apache` - linux; arm variant v7
...
### `nextcloud:27.0.1-apache` - linux; mips64le
...
### `nextcloud:27.0.1-apache` - linux; ppc64le
