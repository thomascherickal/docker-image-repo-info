## `nextcloud:24.0.2-fpm-alpine`

```console
$ docker pull nextcloud@sha256:bee9ecbc3b2668847665fc106b3bfaf79e99bc33872c60fd0644b818785facfa
```
...
### `nextcloud:24.0.2-fpm-alpine` - linux; amd64
...
### `nextcloud:24.0.2-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:24.0.2-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:24.0.2-fpm-alpine` - linux; 386
...
### `nextcloud:24.0.2-fpm-alpine` - linux; s390x
