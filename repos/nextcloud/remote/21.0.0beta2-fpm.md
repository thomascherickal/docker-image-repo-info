...
```console
$ docker pull nextcloud@sha256:9618ea4cbf3ea122c7a57b40bb50d722852c7d252ed26b53a869276c897250ea
```
...
### `nextcloud:21.0.0beta2-fpm` - linux; amd64
...
### `nextcloud:21.0.0beta2-fpm` - linux; arm variant v7
...
### `nextcloud:21.0.0beta2-fpm` - linux; arm64 variant v8
...
### `nextcloud:21.0.0beta2-fpm` - linux; 386
...
### `nextcloud:21.0.0beta2-fpm` - linux; s390x
