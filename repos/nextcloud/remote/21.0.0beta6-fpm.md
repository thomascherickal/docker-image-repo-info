...
### `nextcloud:21.0.0beta6-fpm` - linux; arm variant v5
...
### `nextcloud:21.0.0beta6-fpm` - linux; arm64 variant v8
...
### `nextcloud:21.0.0beta6-fpm` - linux; ppc64le
...
### `nextcloud:21.0.0beta6-fpm` - linux; s390x
