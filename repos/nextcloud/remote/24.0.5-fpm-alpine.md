...
### `nextcloud:24.0.5-fpm-alpine` - linux; amd64
...
### `nextcloud:24.0.5-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:24.0.5-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:24.0.5-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:24.0.5-fpm-alpine` - linux; 386
...
### `nextcloud:24.0.5-fpm-alpine` - linux; ppc64le
...
### `nextcloud:24.0.5-fpm-alpine` - linux; s390x
