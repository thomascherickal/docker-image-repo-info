...
### `nextcloud:19.0.0beta6-fpm` - linux; amd64
...
### `nextcloud:19.0.0beta6-fpm` - linux; arm variant v5
...
### `nextcloud:19.0.0beta6-fpm` - linux; arm variant v7
...
### `nextcloud:19.0.0beta6-fpm` - linux; arm64 variant v8
...
### `nextcloud:19.0.0beta6-fpm` - linux; 386
...
### `nextcloud:19.0.0beta6-fpm` - linux; mips64le
...
### `nextcloud:19.0.0beta6-fpm` - linux; ppc64le
...
### `nextcloud:19.0.0beta6-fpm` - linux; s390x
