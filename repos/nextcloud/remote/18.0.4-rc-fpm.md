...
### `nextcloud:18.0.4-rc-fpm` - linux; amd64
...
### `nextcloud:18.0.4-rc-fpm` - linux; arm variant v5
...
### `nextcloud:18.0.4-rc-fpm` - linux; arm variant v7
...
### `nextcloud:18.0.4-rc-fpm` - linux; arm64 variant v8
...
### `nextcloud:18.0.4-rc-fpm` - linux; 386
...
### `nextcloud:18.0.4-rc-fpm` - linux; mips64le
...
### `nextcloud:18.0.4-rc-fpm` - linux; ppc64le
...
### `nextcloud:18.0.4-rc-fpm` - linux; s390x
