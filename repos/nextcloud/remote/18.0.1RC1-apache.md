...
```console
$ docker pull nextcloud@sha256:ebf52043e6a5e5ba8ffa81ac4fd5dec94f913f37b69280c7c4de79f635b22c2f
```
...
### `nextcloud:18.0.1RC1-apache` - linux; amd64
...
### `nextcloud:18.0.1RC1-apache` - linux; arm variant v5
...
### `nextcloud:18.0.1RC1-apache` - linux; arm variant v7
...
### `nextcloud:18.0.1RC1-apache` - linux; arm64 variant v8
...
### `nextcloud:18.0.1RC1-apache` - linux; ppc64le
