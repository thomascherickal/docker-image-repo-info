...
### `nextcloud:19.0.0-beta` - linux; amd64
...
### `nextcloud:19.0.0-beta` - linux; arm variant v5
...
### `nextcloud:19.0.0-beta` - linux; arm variant v7
...
### `nextcloud:19.0.0-beta` - linux; arm64 variant v8
...
### `nextcloud:19.0.0-beta` - linux; 386
...
### `nextcloud:19.0.0-beta` - linux; mips64le
...
### `nextcloud:19.0.0-beta` - linux; ppc64le
...
### `nextcloud:19.0.0-beta` - linux; s390x
