...
### `nextcloud:24.0.0-apache` - linux; amd64
...
### `nextcloud:24.0.0-apache` - linux; arm variant v5
...
### `nextcloud:24.0.0-apache` - linux; arm variant v7
...
### `nextcloud:24.0.0-apache` - linux; arm64 variant v8
...
### `nextcloud:24.0.0-apache` - linux; 386
...
### `nextcloud:24.0.0-apache` - linux; mips64le
...
### `nextcloud:24.0.0-apache` - linux; ppc64le
...
### `nextcloud:24.0.0-apache` - linux; s390x
