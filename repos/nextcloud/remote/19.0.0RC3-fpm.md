...
```console
$ docker pull nextcloud@sha256:e11d125a45e04b128e7094877417b2df9118d906f5c34368ed6b0e20e1cd170a
```
...
### `nextcloud:19.0.0RC3-fpm` - linux; amd64
...
### `nextcloud:19.0.0RC3-fpm` - linux; arm variant v5
...
### `nextcloud:19.0.0RC3-fpm` - linux; arm variant v7
...
### `nextcloud:19.0.0RC3-fpm` - linux; arm64 variant v8
...
### `nextcloud:19.0.0RC3-fpm` - linux; 386
...
### `nextcloud:19.0.0RC3-fpm` - linux; mips64le
...
### `nextcloud:19.0.0RC3-fpm` - linux; ppc64le
...
### `nextcloud:19.0.0RC3-fpm` - linux; s390x
