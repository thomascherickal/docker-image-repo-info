...
```console
$ docker pull nextcloud@sha256:28cfe25afef0578118870d2456e9c5be600ce24b5db004aa1f6bdacb4a233fa7
```
...
### `nextcloud:18.0.7-rc-fpm` - linux; amd64
...
### `nextcloud:18.0.7-rc-fpm` - linux; arm variant v5
...
### `nextcloud:18.0.7-rc-fpm` - linux; arm variant v7
...
### `nextcloud:18.0.7-rc-fpm` - linux; arm64 variant v8
...
### `nextcloud:18.0.7-rc-fpm` - linux; 386
...
### `nextcloud:18.0.7-rc-fpm` - linux; mips64le
...
### `nextcloud:18.0.7-rc-fpm` - linux; s390x
