...
```console
$ docker pull nextcloud@sha256:ab28bda193befdb071951063dcd2e1b4cdc420a723fe41c53ba423decc5c16b8
```
...
### `nextcloud:16.0.8-fpm-alpine` - linux; amd64
...
### `nextcloud:16.0.8-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:16.0.8-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:16.0.8-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:16.0.8-fpm-alpine` - linux; 386
...
### `nextcloud:16.0.8-fpm-alpine` - linux; ppc64le
