...
```console
$ docker pull nextcloud@sha256:c5bca239c55e6cd321cc0133ac268a0a14830cc63047791072284390d2743cc4
```
...
### `nextcloud:21.0.8-fpm-alpine` - linux; amd64
...
### `nextcloud:21.0.8-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:21.0.8-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:21.0.8-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:21.0.8-fpm-alpine` - linux; 386
...
### `nextcloud:21.0.8-fpm-alpine` - linux; ppc64le
...
### `nextcloud:21.0.8-fpm-alpine` - linux; s390x
