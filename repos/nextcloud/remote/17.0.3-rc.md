...
### `nextcloud:17.0.3-rc` - linux; amd64
...
### `nextcloud:17.0.3-rc` - linux; arm variant v5
...
### `nextcloud:17.0.3-rc` - linux; arm variant v7
...
### `nextcloud:17.0.3-rc` - linux; arm64 variant v8
...
### `nextcloud:17.0.3-rc` - linux; ppc64le
