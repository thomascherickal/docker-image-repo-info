...
### `nextcloud:19.0.4-rc` - linux; amd64
...
### `nextcloud:19.0.4-rc` - linux; arm variant v5
...
### `nextcloud:19.0.4-rc` - linux; arm variant v7
...
### `nextcloud:19.0.4-rc` - linux; arm64 variant v8
...
### `nextcloud:19.0.4-rc` - linux; mips64le
...
### `nextcloud:19.0.4-rc` - linux; ppc64le
...
### `nextcloud:19.0.4-rc` - linux; s390x
