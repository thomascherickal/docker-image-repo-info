...
```console
$ docker pull nextcloud@sha256:af9fdb9e1752290a25c3b0da236cb6bc30c907b3c76a753f0389fa8ee22095ba
```
...
### `nextcloud:15.0.14RC1-fpm` - linux; amd64
...
### `nextcloud:15.0.14RC1-fpm` - linux; arm variant v5
...
### `nextcloud:15.0.14RC1-fpm` - linux; arm variant v7
...
### `nextcloud:15.0.14RC1-fpm` - linux; arm64 variant v8
...
### `nextcloud:15.0.14RC1-fpm` - linux; 386
