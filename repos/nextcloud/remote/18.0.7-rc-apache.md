...
### `nextcloud:18.0.7-rc-apache` - linux; amd64
...
### `nextcloud:18.0.7-rc-apache` - linux; arm variant v5
...
### `nextcloud:18.0.7-rc-apache` - linux; arm variant v7
...
### `nextcloud:18.0.7-rc-apache` - linux; arm64 variant v8
...
### `nextcloud:18.0.7-rc-apache` - linux; 386
...
### `nextcloud:18.0.7-rc-apache` - linux; mips64le
...
### `nextcloud:18.0.7-rc-apache` - linux; ppc64le
...
### `nextcloud:18.0.7-rc-apache` - linux; s390x
