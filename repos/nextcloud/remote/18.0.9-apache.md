...
### `nextcloud:18.0.9-apache` - linux; amd64
...
### `nextcloud:18.0.9-apache` - linux; arm64 variant v8
...
### `nextcloud:18.0.9-apache` - linux; mips64le
...
### `nextcloud:18.0.9-apache` - linux; ppc64le
