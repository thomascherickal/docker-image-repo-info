...
- Image ID: `sha256:f41101a69444b05491fbf4bbadd49e3667cfb800f36dc6b7cf324d70a96d6a85`
- Created: `2020-08-04T23:26:12.495823109Z`
- Virtual Size: ~ 838.12 Mb  
...
### `dpkg` source package: `automake-1.16=1:1.16.2-3`
...
```console
$ apt-get source -qq --print-uris automake-1.16=1:1.16.2-3
'http://deb.debian.org/debian/pool/main/a/automake-1.16/automake-1.16_1.16.2-3.dsc' automake-1.16_1.16.2-3.dsc 2561 SHA256:33c6b13c60d8af77d9dcfe40b6e85da41c0fb3d8c3f3d94b05e02346fe2fa85a
...
'http://deb.debian.org/debian/pool/main/a/automake-1.16/automake-1.16_1.16.2-3.debian.tar.xz' automake-1.16_1.16.2-3.debian.tar.xz 12296 SHA256:b4b7279c5e19392df9b0b50c01b70b1f44c29f547c0313ea4f3f09f0801b02ff
```

Other potentially useful URLs:

- https://sources.debian.net/src/automake-1.16/1:1.16.2-3/ (for browsing the source)
- https://sources.debian.net/src/automake-1.16/1:1.16.2-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/automake-1.16/1:1.16.2-3/ (for access to the source package after it no longer exists in the archive)
...
- `binutils=2.35-1`
- `binutils-common:amd64=2.35-1`
- `binutils-x86-64-linux-gnu=2.35-1`
- `libbinutils:amd64=2.35-1`
- `libctf-nobfd0:amd64=2.35-1`
- `libctf0:amd64=2.35-1`
...
```console
$ apt-get source -qq --print-uris binutils=2.35-1
'http://deb.debian.org/debian/pool/main/b/binutils/binutils_2.35-1.dsc' binutils_2.35-1.dsc 11241 SHA256:55cebfa451b365aa2afd80c9adee006434735a4e42df458b0f50f79675850eae
'http://deb.debian.org/debian/pool/main/b/binutils/binutils_2.35.orig.tar.xz' binutils_2.35.orig.tar.xz 22023172 SHA256:0b9d64c19dff62a3dff1211a79f61bfb949c6dd55a15eb129585cfed358a4b7c
'http://deb.debian.org/debian/pool/main/b/binutils/binutils_2.35-1.debian.tar.xz' binutils_2.35-1.debian.tar.xz 93476 SHA256:0ac4d35d0ef804cb6eb0c42cd1eb9bea158c06945f142fd73bf0254822410801
```

Other potentially useful URLs:

- https://sources.debian.net/src/binutils/2.35-1/ (for browsing the source)
- https://sources.debian.net/src/binutils/2.35-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/binutils/2.35-1/ (for access to the source package after it no longer exists in the archive)
...
- `libcurl4-openssl-dev:amd64=7.68.0-1+b1`
...
- http://snapshot.debian.org/package/gcc-defaults/1.185.1/
...
- http://snapshot.debian.org/package/git/1:2.27.0-1/
...
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.64.4-1.dsc' glib2.0_2.64.4-1.dsc 3328 SHA256:0cb06c20a4a7da393d7d17cd1fee0ecbe0efd41d3948a52442d003754fecc482
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.64.4.orig.tar.xz' glib2.0_2.64.4.orig.tar.xz 4779456 SHA256:f7e0b325b272281f0462e0f7fff25a833820cac19911ff677251daf6d87bce50
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.64.4-1.debian.tar.xz' glib2.0_2.64.4-1.debian.tar.xz 93700 SHA256:40db69d7d2013fb2a04017163dd16525f9c4c3a44d48e400ff8fa00083eaf7c5
```

Other potentially useful URLs:

- https://sources.debian.net/src/glib2.0/2.64.4-1/ (for browsing the source)
- https://sources.debian.net/src/glib2.0/2.64.4-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/glib2.0/2.64.4-1/ (for access to the source package after it no longer exists in the archive)
...
- `libgnutls-dane0:amd64=3.6.14-2+b1`
- `libgnutls-openssl27:amd64=3.6.14-2+b1`
- `libgnutls28-dev:amd64=3.6.14-2+b1`
- `libgnutls30:amd64=3.6.14-2+b1`
- `libgnutlsxx28:amd64=3.6.14-2+b1`
...
- `libharfbuzz0b:amd64=2.6.4-1+b1`
...
### `dpkg` source package: `icu=67.1-3`

Binary Packages:

- `icu-devtools=67.1-3`
- `libicu-dev:amd64=67.1-3`
- `libicu67:amd64=67.1-3`
...
```console
$ apt-get source -qq --print-uris icu=67.1-3
'http://deb.debian.org/debian/pool/main/i/icu/icu_67.1-3.dsc' icu_67.1-3.dsc 2219 SHA256:0a574a9a42191ebc8206cc34866691feeac288cce61dc9f986f4d5650ccfe293
...
'http://deb.debian.org/debian/pool/main/i/icu/icu_67.1-3.debian.tar.xz' icu_67.1-3.debian.tar.xz 24076 SHA256:afdaf67e22b0d09b7431a6879dc77cb489c721a459857f5ce4e0b86b4d3d2ac1
```

Other potentially useful URLs:

- https://sources.debian.net/src/icu/67.1-3/ (for browsing the source)
- https://sources.debian.net/src/icu/67.1-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/icu/67.1-3/ (for access to the source package after it no longer exists in the archive)
...
- `imagemagick-6.q16=8:6.9.11.24+dfsg-1`
- `libmagickcore-6-arch-config:amd64=8:6.9.11.24+dfsg-1`
- `libmagickcore-6-headers=8:6.9.11.24+dfsg-1`
- `libmagickcore-6.q16-6:amd64=8:6.9.11.24+dfsg-1`
- `libmagickcore-6.q16-6-extra:amd64=8:6.9.11.24+dfsg-1`
- `libmagickcore-6.q16-dev:amd64=8:6.9.11.24+dfsg-1`
- `libmagickcore-dev=8:6.9.11.24+dfsg-1`
- `libmagickwand-6-headers=8:6.9.11.24+dfsg-1`
- `libmagickwand-6.q16-6:amd64=8:6.9.11.24+dfsg-1`
- `libmagickwand-6.q16-dev:amd64=8:6.9.11.24+dfsg-1`
...
'http://deb.debian.org/debian/pool/main/libe/libexif/libexif_0.6.22-2.dsc' libexif_0.6.22-2.dsc 2079 SHA256:6d8a8c0c987b610959c250c912e4995103de141178a7ddb2030f9e8c6f22baf1
...
'http://deb.debian.org/debian/pool/main/libe/libexif/libexif_0.6.22-2.debian.tar.xz' libexif_0.6.22-2.debian.tar.xz 12016 SHA256:bfb1beff5dcff9aadaef3bbeb5592a1f20d7d66a75161c56bfa53c433655f0b8
```

Other potentially useful URLs:

- https://sources.debian.net/src/libexif/0.6.22-2/ (for browsing the source)
- https://sources.debian.net/src/libexif/0.6.22-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libexif/0.6.22-2/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/libr/librsvg/librsvg_2.48.7-1.dsc' librsvg_2.48.7-1.dsc 2914 SHA256:5e5ac23273073426db86af94e3bfa958b245c088d41d8b5b610c7044476fce22
'http://deb.debian.org/debian/pool/main/libr/librsvg/librsvg_2.48.7.orig.tar.xz' librsvg_2.48.7.orig.tar.xz 15097208 SHA256:35de5d93e262fcd85fa4529cee147687d21c6e092f223c293921eaaf57e2fec0
'http://deb.debian.org/debian/pool/main/libr/librsvg/librsvg_2.48.7-1.debian.tar.xz' librsvg_2.48.7-1.debian.tar.xz 24148 SHA256:8a5b5bcf500dbf361adf2448a926c7ebf75552b49497d78fa5c90cb39ac6ce64
```

Other potentially useful URLs:

- https://sources.debian.net/src/librsvg/2.48.7-1/ (for browsing the source)
- https://sources.debian.net/src/librsvg/2.48.7-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/librsvg/2.48.7-1/ (for access to the source package after it no longer exists in the archive)
...
- `libx11-6:amd64=2:1.6.9-2+b1`
- `libx11-data=2:1.6.9-2`
- `libx11-dev:amd64=2:1.6.9-2+b1`
...
- `libxml2:amd64=2.9.10+dfsg-5+b1`
- `libxml2-dev:amd64=2.9.10+dfsg-5+b1`
...
'http://deb.debian.org/debian/pool/main/libx/libxml2/libxml2_2.9.10+dfsg-5.dsc' libxml2_2.9.10+dfsg-5.dsc 2982 SHA256:95f66df911ac4ff2b1d232b5f6613a968f91a55eb4554ed8aee65c4ae58ca42b
...
'http://deb.debian.org/debian/pool/main/libx/libxml2/libxml2_2.9.10+dfsg-5.debian.tar.xz' libxml2_2.9.10+dfsg-5.debian.tar.xz 28736 SHA256:d2de33926b5f8093766050af3ad362a415f285c2339a675886f7b3aff3d220bf
```

Other potentially useful URLs:

- https://sources.debian.net/src/libxml2/2.9.10+dfsg-5/ (for browsing the source)
- https://sources.debian.net/src/libxml2/2.9.10+dfsg-5/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libxml2/2.9.10+dfsg-5/ (for access to the source package after it no longer exists in the archive)
...
```console
$ apt-get source -qq --print-uris linux=5.7.10-1
'http://deb.debian.org/debian/pool/main/l/linux/linux_5.7.10-1.dsc' linux_5.7.10-1.dsc 194787 SHA256:39c39c770e7d37de08c77d12a6ad3e120072c14dcf8cbe58a0056329a4493e97
'http://deb.debian.org/debian/pool/main/l/linux/linux_5.7.10.orig.tar.xz' linux_5.7.10.orig.tar.xz 117333340 SHA256:6a145f3ac38a4c0617667d5db1d9b8732ac90d3ddcd234ed881f1e70c33bc73c
'http://deb.debian.org/debian/pool/main/l/linux/linux_5.7.10-1.debian.tar.xz' linux_5.7.10-1.debian.tar.xz 1224452 SHA256:e16eaada49fb81fab64ab53908da39f3d062ff23284aaef4ed6e30058c8f18ad
```

Other potentially useful URLs:

- https://sources.debian.net/src/linux/5.7.10-1/ (for browsing the source)
- https://sources.debian.net/src/linux/5.7.10-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/linux/5.7.10-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mariadb-10.3=1:10.3.23-1`

Binary Packages:

- `libmariadb-dev=1:10.3.23-1`
- `libmariadb-dev-compat:amd64=1:10.3.23-1`
- `libmariadb3:amd64=1:10.3.23-1`
- `mariadb-common=1:10.3.23-1`
...
- http://snapshot.debian.org/package/mercurial/5.4.1-1/
...
'http://deb.debian.org/debian/pool/main/p/postgresql-12/postgresql-12_12.3-1.dsc' postgresql-12_12.3-1.dsc 3621 SHA256:ea35b1628113fc33fd03a5fb0f4f2f1a8121e5f728bd33ec3c8bf4f403637904
'http://deb.debian.org/debian/pool/main/p/postgresql-12/postgresql-12_12.3.orig.tar.bz2' postgresql-12_12.3.orig.tar.bz2 20439892 SHA256:94ed64a6179048190695c86ec707cc25d016056ce10fc9d229267d9a8f1dcf41
'http://deb.debian.org/debian/pool/main/p/postgresql-12/postgresql-12_12.3-1.debian.tar.xz' postgresql-12_12.3-1.debian.tar.xz 23036 SHA256:aafefe46e7ba9df537920af048d2300c9ca9f7248d38c89fe4734bddc508ec47
```

Other potentially useful URLs:

- https://sources.debian.net/src/postgresql-12/12.3-1/ (for browsing the source)
- https://sources.debian.net/src/postgresql-12/12.3-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/postgresql-12/12.3-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/p/python3-stdlib-extensions/python3-stdlib-extensions_3.8.5-1.dsc' python3-stdlib-extensions_3.8.5-1.dsc 2524 SHA256:7d755665c29938c4f1f39ef133701865abd47118f078a9153d136453277a785d
'http://deb.debian.org/debian/pool/main/p/python3-stdlib-extensions/python3-stdlib-extensions_3.8.5.orig.tar.xz' python3-stdlib-extensions_3.8.5.orig.tar.xz 1074164 SHA256:b8cae96587edc5ec8f7dc2d97ace0e1569c3137e206b9db6e720eef186c3deb9
'http://deb.debian.org/debian/pool/main/p/python3-stdlib-extensions/python3-stdlib-extensions_3.8.5-1.debian.tar.xz' python3-stdlib-extensions_3.8.5-1.debian.tar.xz 17896 SHA256:c9374aa01e08a4a41cd979300f0f12fc5348672a2425cc11ca3c0bead3c011b0
```

Other potentially useful URLs:

- https://sources.debian.net/src/python3-stdlib-extensions/3.8.5-1/ (for browsing the source)
- https://sources.debian.net/src/python3-stdlib-extensions/3.8.5-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python3-stdlib-extensions/3.8.5-1/ (for access to the source package after it no longer exists in the archive)
...
- `libblkid-dev:amd64=2.36-2`
- `libblkid1:amd64=2.36-2`
- `libmount-dev:amd64=2.36-2`
- `libmount1:amd64=2.36-2`
- `libuuid1:amd64=2.36-2`
- `uuid-dev:amd64=2.36-2`
