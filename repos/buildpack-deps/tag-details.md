...
```console
$ docker pull buildpack-deps@sha256:924019c45b28fb138bc800ca0d389436173d95f5611fbe9adfcc271b428d49ce
```
...
```console
$ docker pull buildpack-deps@sha256:92065d431ca63f3fd0f762c7978fee95b4e2467a956872c5a2a2e1831755779d
```
...
```console
$ docker pull buildpack-deps@sha256:fdc7fa906fbcc894d1cb503ee20e1ec58b125aa337389eda2a4ddf0b903fac78
```
...
```console
$ docker pull buildpack-deps@sha256:fbe474ce7c2bc84f53d1466fa11181cec54bf92640cc509f38692ffc7e539a5f
```
...
```console
$ docker pull buildpack-deps@sha256:510227878002e8c5478fab8b347b23b76ca153c8142fe79322100d4ac3e69bdd
```
...
```console
$ docker pull buildpack-deps@sha256:283ce72cb18185628d67417dd86c426dfb0c82e2eadd60512f4bccabd313bc9c
```
...
```console
$ docker pull buildpack-deps@sha256:b950faeb40fa9cd7152f8272ccd087e7b98c5f7407dedb32f079bf9a453007c2
```
...
```console
$ docker pull buildpack-deps@sha256:c61bc9ddb07ae12f0fe15074c296f69f98f8df87ddbd85fe591ef91c7103af72
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **347.1 MB (347090383 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b2fdf61bf7da4f98ff50562c5979008a5a6047c598219298c4425f52a45446dd`
-	Default Command: `["bash"]`
...
-	Layers:
	...
	-	`sha256:078aef1e51356ae4c36a96958de308109bcf837c427b8419820646e4fcb45528`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f369df58d33dbf70162bcfe07d395e297e455b239a2ba9b5782025519ba8fb88`  
		Last Modified: Wed, 05 Oct 2022 00:21:40 GMT  
		Size: 213.4 MB (213414677 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull buildpack-deps@sha256:ca693cee2d4305a9edfe1215177fe7bce3fec775aaf9f12a28262dbb1c9a2667
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **312.4 MB (312418079 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7701a1183713de3a8c1d0a68352ebc3d189b43e8268d017a7adc512ad72d67a3`
-	Default Command: `["bash"]`
...
-	Layers:
	...
	-	`sha256:ff33f2f178d309eb3e2d7fb3457599b55e7731e1d8af441d100e4eb4c7e1b8a3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7be1a4e974c1d6e566e23f56c5816a9e132401dc1ed192d0669cf5dea70d01d8`  
		Last Modified: Wed, 05 Oct 2022 00:32:10 GMT  
		Size: 184.5 MB (184486099 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull buildpack-deps@sha256:126f5c7e09be8d7b1e64a6f07e164ac91ea8b7f9980edb7f4f14c3c306ec6011
```
...
```console
$ docker pull buildpack-deps@sha256:2d7e6a1d794302d7fd75956d6e4cfc4efaa23fcebb539d1be1fbc365840893ca
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **72.1 MB (72143015 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36940c69be05df41c20919cd9755d4d0dea2e299e49ca326d69561056cc61a21`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:e5553e29ebea8dccbd73470b358538b6cdfaa9807f802afb23b070382009396b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **69.2 MB (69192506 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3b7f6e2c540cfc5d73d3b914128996bdd8d3b46f594655f6e53f361fd1eff469`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:653cd4c51d2a0e8d9e4eb377cf5cb3dfe3e6a90a579e08fee49742355a26e3ea
```
...
```console
$ docker pull buildpack-deps@sha256:d8408397c3b9d07fd959cd5e674478e187bd362e513a378ac15268250170631f
```
...
```console
$ docker pull buildpack-deps@sha256:aaa806a841318433adf09e546a1688f3e987016cf1e5b66876a0ab7e4ddc1495
```
