...
```console
$ docker pull buildpack-deps@sha256:a5f74018b8a51a6900bed28b7e3cbb71e0a15a95ff86f3c381dd75583e0e8e00
```
...
```console
$ docker pull buildpack-deps@sha256:4b53716f1b6f2bd3039707fa25a200b793825825f4f7d1adb4e3d534ac0d9d0d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **81.1 MB (81100026 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cbed96d2ebf25728c8b52b136ad9314cc1dabb3b82f97c633beb27d7b3786b80`
-	Default Command: `["\/bin\/bash"]`
...
```console
$ docker pull buildpack-deps@sha256:3748f32634d3f691bcd9ae55c15643d8fc6849500e4a2c36818059aaf39c2588
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **70.5 MB (70512232 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a79ef106df091322428d9c05b3e85e895b780ced6ab4d9968d286f976467a201`
-	Default Command: `["\/bin\/bash"]`
...
```console
$ docker pull buildpack-deps@sha256:1669f2fa9963c07f6893a045acd0776b56fb8678cce716daae95921b53f1367c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **94.2 MB (94161271 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b26be232a6800b7cd13b4446a454079c81ab713cc80c54cc9e845a887e2b6c8f`
-	Default Command: `["\/bin\/bash"]`
...
```console
$ docker pull buildpack-deps@sha256:a6db238940e363aa236913953f5351017c190870219191e7af103affea909fd0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **79.0 MB (78962433 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a04761b2bcd98eb697e845836d65f569f8bddd7fe2762864f59669afcba5b2b4`
-	Default Command: `["\/bin\/bash"]`
...
```console
$ docker pull buildpack-deps@sha256:e78655f5d2fd2ce23a8b3e04c4d0efd3d5a7f59c501d02729723c5a3f6ef37fa
```
...
```console
$ docker pull buildpack-deps@sha256:9c11db7f74908b61102b3902b8d8d25ca773b6ff22614640c3bb3801dd7abeb0
```
...
```console
$ docker pull buildpack-deps@sha256:8508deb3630d0722268f2a1a70adb258b66a3ff1de754fc626306d763f9a87bb
```
...
```console
$ docker pull buildpack-deps@sha256:46f8e9d74a5c6c14eba9312cfaee2db86d14e6a33f3d9d8e38899255af6bd95a
```
...
```console
$ docker pull buildpack-deps@sha256:c69c0ec67c855ccd030b3a9ebbadbfb16c102e899285919c73f8703d82706269
```
...
```console
$ docker pull buildpack-deps@sha256:23df2b22fc280a2684a599aa26b4146ccf02cc9cdf1ac75fa86085dbff9298a1
```
...
```console
$ docker pull buildpack-deps@sha256:cd163b88481d407880dfcfae7929ff35fe88a3517b7e9306a8ab1750b053d124
```
...
```console
$ docker pull buildpack-deps@sha256:1bb00264e12f96c0d59c9c11372048bd5ce19a8e68acd8fdf4e57f348ccd834a
```
...
```console
$ docker pull buildpack-deps@sha256:865d318a50e9eb9d19e582837728444bd6830c674a9c75cd77b91be8391bae32
```
