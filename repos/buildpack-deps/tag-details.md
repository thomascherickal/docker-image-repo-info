...
```console
$ docker pull buildpack-deps@sha256:2e52fa2c940a4a655f0e13a7afe610c822f4a48161d0e66a042465030cfb112f
```
...
```console
$ docker pull buildpack-deps@sha256:3665f214cc7a833c3bbd719b8cb29ccfe77232df1a05c7018f1cdd7fa0a79597
```
