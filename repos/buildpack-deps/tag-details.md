...
```console
$ docker pull buildpack-deps@sha256:3b917599f261354858b40fc2543d35a2657e6d097a01adbe7433995c24dc63cf
```
...
```console
$ docker pull buildpack-deps@sha256:948338716b46f8bdab1d55346fc1005f10a04fb9d9ffed43c54c2968cd9738cc
```
