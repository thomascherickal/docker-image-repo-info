...
- Created: `2022-10-27T17:54:34.681418701Z`
- Virtual Size: ~ 535.44 Mb  
...
### `rpm` package: `mysql-community-server-minimal-8.0.31-1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2022, Oracle and/or its affiliates. Under GPLv2 license as shown in the Description field.

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `mysql-shell-8.0.31-1.el8.x86_64`
...
### `rpm` package: `python39-libs-3.9.7-1.module+el8.6.0+20625+ee813db2.x86_64`
