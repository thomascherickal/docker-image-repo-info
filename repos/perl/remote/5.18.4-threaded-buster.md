...
```console
$ docker pull perl@sha256:520c27774d4ac7e3367e64f8d399f40f69f1ff2f208341d4cab7282cd18502ff
```
...
### `perl:5.18.4-threaded-buster` - linux; amd64
...
### `perl:5.18.4-threaded-buster` - linux; arm variant v7

```console
$ docker pull perl@sha256:0ce5041fe46c4fcd53401d0b55ac4fdb34f397c233523690d535dbcfb7fe17ba
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **290.0 MB (289984323 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17a4a2fbd1f8c3eaf80ff668d46b4e786cc9fae8d6adf618e4f3bf248b2ca92f`
-	Default Command: `["perl5.18.4","-de0"]`
...
-	Layers:
	...
	-	`sha256:d0a7f055ba25c609bd840ede0f2f29199e93031684d98201a390ed1102b399fa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5366a13dfd146598ce8b9097d5452843b23bfed2a13f35e6b60e7cc97dd10c65`  
		Last Modified: Fri, 28 May 2021 14:10:04 GMT  
		Size: 11.7 MB (11667191 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.18.4-threaded-buster` - linux; arm64 variant v8
...
### `perl:5.18.4-threaded-buster` - linux; 386
...
### `perl:5.18.4-threaded-buster` - linux; ppc64le
...
### `perl:5.18.4-threaded-buster` - linux; s390x
