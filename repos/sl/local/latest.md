...
```console
$ dnf --quiet download --source --url basesystem-10.0-7.el7.noarch
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/bash-4.2.46-35.el7_9.src.rpm
```
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/bind-9.11.4-26.P2.el7_9.15.src.rpm
```

### `rpm` package: `bind-license-9.11.4-26.P2.el7_9.15.noarch`
...
```console
$ dnf --quiet download --source --url bind-license-9.11.4-26.P2.el7_9.15.noarch
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/bind-9.11.4-26.P2.el7_9.15.src.rpm
```
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/binutils-2.27-44.base.el7_9.1.src.rpm
```
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/ca-certificates-2023.2.60_v7.0.306-72.el7_9.src.rpm
```
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/coreutils-8.22-24.el7_9.2.src.rpm
```
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/lvm2-2.02.187-6.el7_9.5.src.rpm
```
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/diffutils-3.3-6.el7_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url file-5.11-37.el7
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/util-linux-2.23.2-65.el7_9.1.src.rpm
```
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/libssh2-1.8.0-4.el7_9.1.src.rpm
```
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/libxml2-2.9.1-6.el7_9.6.src.rpm
```
...
```console
$ dnf --quiet download --source --url lzo-2.06-8.el7
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/nspr-4.35.0-1.el7_9.src.rpm
```
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/nss-3.90.0-2.el7_9.src.rpm
```
...
### `rpm` package: `nss-softokn-3.90.0-6.el7_9.x86_64`
...
```console
$ dnf --quiet download --source --url nss-softokn-3.90.0-6.el7_9
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/nss-softokn-3.90.0-6.el7_9.src.rpm
```

### `rpm` package: `nss-softokn-freebl-3.90.0-6.el7_9.x86_64`
...
```console
$ dnf --quiet download --source --url nss-softokn-freebl-3.90.0-6.el7_9
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/nss-softokn-3.90.0-6.el7_9.src.rpm
```
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/nss-util-3.90.0-1.el7_9.src.rpm
```
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/openssl-1.0.2k-26.el7_9.src.rpm
```
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/rpm-4.11.3-48.el7_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url sl-release-7.9-1.sl7
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/tzdata-2023c-1.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url yum-3.4.3-168.sl7.noarch
...
```console
$ dnf --quiet download --source --url yum-conf-repos-1.0-1.el7.noarch
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/SL/yum-conf-repos-1.0-1.el7.src.rpm
...
http://ftp.scientificlinux.org/linux/scientific/7/SRPMS/vendor/zlib-1.2.7-21.el7_9.src.rpm
```
