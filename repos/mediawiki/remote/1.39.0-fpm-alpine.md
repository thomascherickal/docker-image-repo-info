...
### `mediawiki:1.39.0-fpm-alpine` - linux; amd64
...
### `mediawiki:1.39.0-fpm-alpine` - linux; arm variant v6
...
### `mediawiki:1.39.0-fpm-alpine` - linux; arm variant v7
...
### `mediawiki:1.39.0-fpm-alpine` - linux; arm64 variant v8
...
### `mediawiki:1.39.0-fpm-alpine` - linux; 386
...
### `mediawiki:1.39.0-fpm-alpine` - linux; ppc64le
