## `mediawiki:1.37.3-fpm-alpine`

```console
$ docker pull mediawiki@sha256:90f2cf9ba8eece6b1192634bd98667f15c18f6b7643ced3127846f5107253b71
```
...
### `mediawiki:1.37.3-fpm-alpine` - linux; amd64
...
### `mediawiki:1.37.3-fpm-alpine` - linux; arm variant v6
...
### `mediawiki:1.37.3-fpm-alpine` - linux; arm variant v7
...
### `mediawiki:1.37.3-fpm-alpine` - linux; arm64 variant v8
...
### `mediawiki:1.37.3-fpm-alpine` - linux; 386
...
### `mediawiki:1.37.3-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:24324048357d22912c7aa5bcf90ff5933b40629555e8a2e88ee428ace71730c8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.6 MB (159605638 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd2d205b566963a9c6dc1ebe76930ac5f5f3d7d7be074b86116bf04f29a5cebe`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 10 Aug 2022 07:04:34 GMT
ENV MEDIAWIKI_VERSION=1.37.3
# Wed, 10 Aug 2022 07:04:59 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Wed, 10 Aug 2022 07:05:05 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:af956241e0967ea96ad3623f9e1a556e856bab4c31c560bc853f68a09c77c7a3`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd2c58b2709b14c087a151e9b729a91bed378a09feca2ce35957ad11a3d835e6`  
		Last Modified: Wed, 10 Aug 2022 07:08:14 GMT  
		Size: 51.8 MB (51768676 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
