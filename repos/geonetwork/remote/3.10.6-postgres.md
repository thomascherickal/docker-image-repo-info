...
```console
$ docker pull geonetwork@sha256:6df207cf002b1a2950d4e62e02947e0440bc737533cf02b0db007e49f1fcdd91
```
...
```console
$ docker pull geonetwork@sha256:164faf98d6434c581dbe1d5774811c7cefffeb0c004f26bdb8ce15aad9f83da3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **528.7 MB (528652808 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7efa8c18d4831873a3df37b6541e660d8c4cc306c7c95d6e689c83b4f0b310a0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 17 Jun 2021 01:25:09 GMT
WORKDIR /usr/local/tomcat/webapps
# Thu, 17 Jun 2021 01:25:32 GMT
RUN curl -fSL -o $GN_FILE      https://sourceforge.net/projects/geonetwork/files/GeoNetwork_opensource/v${GN_VERSION}/${GN_FILE}/download &&      echo "$GN_DOWNLOAD_MD5 *${GN_FILE}" | md5sum -c &&      mkdir -p geonetwork &&      unzip -e $GN_FILE -d geonetwork &&      rm $GN_FILE
# Thu, 17 Jun 2021 01:25:33 GMT
COPY file:0804862fd42c05f06dfa65cb1e5dad9a956d8ac6a3ddd4d962847ba159f5cfe6 in /entrypoint.sh 
# Thu, 17 Jun 2021 01:25:33 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 17 Jun 2021 01:25:34 GMT
CMD ["catalina.sh" "run"]
# Thu, 17 Jun 2021 01:25:48 GMT
RUN apt-get update && apt-get install -y postgresql-client &&     rm -rf /var/lib/apt/lists/*
# Thu, 17 Jun 2021 01:25:49 GMT
RUN sed -i -e 's#<import resource="../config-db/${geonetwork.db.type:h2}.xml"/>#<!--<import resource="../config-db/${geonetwork.db.type:h2}.xml"/-->#g' $CATALINA_HOME/webapps/geonetwork/WEB-INF/config-node/srv.xml && sed -i -e 's#<!--<import resource="../config-db/postgres.xml"/>-->#<import resource="../config-db/postgres.xml"/>#g' $CATALINA_HOME/webapps/geonetwork/WEB-INF/config-node/srv.xml
# Thu, 17 Jun 2021 01:25:49 GMT
COPY file:83f69d2041e5fb378033b0db57e096c81ba0725102ab4da4f089685e748fcce3 in /usr/local/tomcat/webapps/geonetwork/WEB-INF/config-db/jdbc.properties 
# Thu, 17 Jun 2021 01:25:49 GMT
...
-	Layers:
	...
	-	`sha256:f3fcebbddcc24129050f80a6e12203071967dbdb000ab7e9b1c29e705b8223cb`  
		...
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c57812027d9d6df5b80e37147f889046cf684a14d82c19b323c853a6709a7cc1`  
		Last Modified: Thu, 17 Jun 2021 01:27:50 GMT  
		Size: 276.3 MB (276302151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f62c687a8a9206670f663d9b47756ac65bdfb15b2e15545141e38a2c1b9da35`  
		Last Modified: Thu, 17 Jun 2021 01:27:27 GMT  
		Size: 249.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4b8f8a319b48b8dd3e9cf1e0dfd73fe168e29c0c9e74aad7ef230e50351aba7`  
		Last Modified: Thu, 17 Jun 2021 01:28:05 GMT  
		Size: 11.4 MB (11420812 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dbe6190b5b440c84a2d46d39e74a3101b91dbd97e3bf0c59d0760a4d6ee7536`  
		Last Modified: Thu, 17 Jun 2021 01:28:02 GMT  
		Size: 1.3 KB (1265 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37cfe34984f83d12f9b0cc288d2b62d22de6a1e904d4e0159257545001904e5d`  
		Last Modified: Thu, 17 Jun 2021 01:28:02 GMT  
		Size: 1.1 KB (1124 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d5dcfd4510f54168da34f5e4ddf4a8f3e1e493ed648c4dfbacc2383d7482360`  
		Last Modified: Thu, 17 Jun 2021 01:28:02 GMT  
		Size: 974.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
