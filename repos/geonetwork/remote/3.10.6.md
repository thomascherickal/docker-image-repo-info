...
```console
$ docker pull geonetwork@sha256:2a8b4d9f247f4ffecbac91f553fb84ba31ec84bbf747228cc6ec8a433e61a341
```
...
```console
$ docker pull geonetwork@sha256:dc6be7310c68acc26979e9ed7a93ebc0d4a4a659fb4ae9f8661b8c82f0a0fb68
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **517.2 MB (517228633 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7767d41e49be029fa768fddb7b45088798ecacee0876b5f279f93f676b5a182d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
