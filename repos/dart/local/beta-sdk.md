...
- Created: `2022-01-12T22:19:58.882593542Z`
- Virtual Size: ~ 768.93 Mb  
...
### `dpkg` source package: `fstrm=0.4.0-1`
...
```console
$ apt-get source -qq --print-uris fstrm=0.4.0-1
'http://deb.debian.org/debian/pool/main/f/fstrm/fstrm_0.4.0-1.dsc' fstrm_0.4.0-1.dsc 1828 SHA256:953b412c2797a0a1315339917a75909fab43aa41b81f7b04bc9be790ed3cff25
'http://deb.debian.org/debian/pool/main/f/fstrm/fstrm_0.4.0.orig.tar.gz' fstrm_0.4.0.orig.tar.gz 194789 SHA256:2c84ff059d5850078d3d85927fd2e8f8a1cbe76bcf91cb125cfbbbd89ec5afc0
'http://deb.debian.org/debian/pool/main/f/fstrm/fstrm_0.4.0-1.debian.tar.xz' fstrm_0.4.0-1.debian.tar.xz 3232 SHA256:6d9dcd4a58ff8fbf0846b6a7f07a7a100eed0dbc3496e585cfcfb66653f831ac
```

Other potentially useful URLs:

- https://sources.debian.net/src/fstrm/0.4.0-1/ (for browsing the source)
- https://sources.debian.net/src/fstrm/0.4.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/fstrm/0.4.0-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `lmdb=0.9.22-1`
...
```console
$ apt-get source -qq --print-uris lmdb=0.9.22-1
'http://deb.debian.org/debian/pool/main/l/lmdb/lmdb_0.9.22-1.dsc' lmdb_0.9.22-1.dsc 2118 SHA256:f4f05e6770c08f4e09c0e714138f43e9f9ef3dcb9d88155e1a9d5b151c136041
'http://deb.debian.org/debian/pool/main/l/lmdb/lmdb_0.9.22.orig.tar.gz' lmdb_0.9.22.orig.tar.gz 143468 SHA256:f3927859882eb608868c8c31586bb7eb84562a40a6bf5cc3e13b6b564641ea28
'http://deb.debian.org/debian/pool/main/l/lmdb/lmdb_0.9.22-1.debian.tar.xz' lmdb_0.9.22-1.debian.tar.xz 5968 SHA256:575f46a5f3207639195831788992626d89bab7f236f984eacea03be380c8404f
```

Other potentially useful URLs:

- https://sources.debian.net/src/lmdb/0.9.22-1/ (for browsing the source)
- https://sources.debian.net/src/lmdb/0.9.22-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/lmdb/0.9.22-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `protobuf-c=1.3.1-1`
...
```console
$ apt-get source -qq --print-uris protobuf-c=1.3.1-1
'http://deb.debian.org/debian/pool/main/p/protobuf-c/protobuf-c_1.3.1-1.dsc' protobuf-c_1.3.1-1.dsc 2093 SHA256:4a66e6dd6160c23cb6a62d9192bab2655f4e80960abc080c0e5531d4baa0b1e3
'http://deb.debian.org/debian/pool/main/p/protobuf-c/protobuf-c_1.3.1.orig.tar.gz' protobuf-c_1.3.1.orig.tar.gz 498779 SHA256:51472d3a191d6d7b425e32b612e477c06f73fe23e07f6a6a839b11808e9d2267
'http://deb.debian.org/debian/pool/main/p/protobuf-c/protobuf-c_1.3.1-1.debian.tar.xz' protobuf-c_1.3.1-1.debian.tar.xz 4340 SHA256:b9de439ec045ee57079df8cf638bce424d4d35deb79ec7e9dd09aafb8c4ec70d
```

Other potentially useful URLs:

- https://sources.debian.net/src/protobuf-c/1.3.1-1/ (for browsing the source)
- https://sources.debian.net/src/protobuf-c/1.3.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/protobuf-c/1.3.1-1/ (for access to the source package after it no longer exists in the archive)
