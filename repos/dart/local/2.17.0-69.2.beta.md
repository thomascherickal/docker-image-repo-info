...
- Created: `2022-02-15T23:19:42.799884973Z`
- Virtual Size: ~ 747.03 Mb  
...
### `dpkg` source package: `bind9=1:9.16.22-1~deb11u1`

Binary Packages:

- `bind9-dnsutils=1:9.16.22-1~deb11u1`
- `bind9-host=1:9.16.22-1~deb11u1`
- `bind9-libs:amd64=1:9.16.22-1~deb11u1`
- `dnsutils=1:9.16.22-1~deb11u1`
...
```console
$ apt-get source -qq --print-uris bind9=1:9.16.22-1~deb11u1
'http://deb.debian.org/debian/pool/main/b/bind9/bind9_9.16.22-1%7edeb11u1.dsc' bind9_9.16.22-1~deb11u1.dsc 3024 SHA256:0a094f1f5159fc2aa0d7c8552dc3d4ae55a3c3187ab5b1c51ee4d99df299c74b
'http://deb.debian.org/debian/pool/main/b/bind9/bind9_9.16.22.orig.tar.xz' bind9_9.16.22.orig.tar.xz 5059000 SHA256:65e7b2af6479db346e2fc99bcfb6ec3240066468e09dbec575ebc7c57d994061
'http://deb.debian.org/debian/pool/main/b/bind9/bind9_9.16.22-1%7edeb11u1.debian.tar.xz' bind9_9.16.22-1~deb11u1.debian.tar.xz 78052 SHA256:19c381ca044a92b469b17344052f8c17d000dd07ca462694d56a86dde38abb58
```

Other potentially useful URLs:

- https://sources.debian.net/src/bind9/1:9.16.22-1~deb11u1/ (for browsing the source)
- https://sources.debian.net/src/bind9/1:9.16.22-1~deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/bind9/1:9.16.22-1~deb11u1/ (for access to the source package after it no longer exists in the archive)
