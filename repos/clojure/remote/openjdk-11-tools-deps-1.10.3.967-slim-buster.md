...
```console
$ docker pull clojure@sha256:da2042e9065000cab8ec720c2206a11348c3019a378160b46349bfec2e07913b
```
...
### `clojure:openjdk-11-tools-deps-1.10.3.967-slim-buster` - linux; amd64
