...
```console
$ docker pull ruby@sha256:2e32f80ec2551be237da46f95da1735f80aafd002346ab132a7c4ef807a816c4
```
...
### `ruby:3.0.2-alpine3.12` - linux; arm variant v7
...
### `ruby:3.0.2-alpine3.12` - linux; arm64 variant v8
