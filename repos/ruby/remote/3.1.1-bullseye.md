...
### `ruby:3.1.1-bullseye` - linux; amd64
...
### `ruby:3.1.1-bullseye` - linux; arm variant v5
...
### `ruby:3.1.1-bullseye` - linux; arm variant v7
...
### `ruby:3.1.1-bullseye` - linux; arm64 variant v8
...
### `ruby:3.1.1-bullseye` - linux; mips64le
...
### `ruby:3.1.1-bullseye` - linux; ppc64le
...
### `ruby:3.1.1-bullseye` - linux; s390x
