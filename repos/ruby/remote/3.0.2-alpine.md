...
```console
$ docker pull ruby@sha256:d759408e63d77f997ff91b44a27e5b23b25e7b57802cd4dab69ced91a53b05b5
```
...
### `ruby:3.0.2-alpine` - linux; arm variant v7
...
### `ruby:3.0.2-alpine` - linux; arm64 variant v8
...
### `ruby:3.0.2-alpine` - linux; ppc64le
