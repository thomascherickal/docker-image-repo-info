...
### `ruby:2.7.7-alpine3.15` - linux; amd64
...
### `ruby:2.7.7-alpine3.15` - linux; arm variant v6
...
### `ruby:2.7.7-alpine3.15` - linux; arm variant v7
...
### `ruby:2.7.7-alpine3.15` - linux; arm64 variant v8
...
### `ruby:2.7.7-alpine3.15` - linux; 386
...
### `ruby:2.7.7-alpine3.15` - linux; ppc64le
...
### `ruby:2.7.7-alpine3.15` - linux; s390x
