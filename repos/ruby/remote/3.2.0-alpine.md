...
### `ruby:3.2.0-alpine` - linux; arm variant v6
...
### `ruby:3.2.0-alpine` - linux; arm variant v7
...
### `ruby:3.2.0-alpine` - linux; arm64 variant v8
...
### `ruby:3.2.0-alpine` - linux; ppc64le
