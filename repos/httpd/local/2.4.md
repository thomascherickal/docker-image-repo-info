...
- Created: `2023-11-01T02:33:42.568487292Z`
...
```console
$ apt-get source -qq --print-uris lua5.2=5.2.4-3
'http://deb.debian.org/debian/pool/main/l/lua5.2/lua5.2_5.2.4-3.dsc' lua5.2_5.2.4-3.dsc 2121 SHA256:c342cc4933c29909eccf6dcdadcdd87f27cae0a9fccdd2eef325b47120be925a
...
'http://deb.debian.org/debian/pool/main/l/lua5.2/lua5.2_5.2.4-3.debian.tar.xz' lua5.2_5.2.4-3.debian.tar.xz 10184 SHA256:04909c374548ace666e31404419baab78d4e1e38147a95ec1c25636363ebbf6c
```

Other potentially useful URLs:

- https://sources.debian.net/src/lua5.2/5.2.4-3/ (for browsing the source)
- https://sources.debian.net/src/lua5.2/5.2.4-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/lua5.2/5.2.4-3/ (for access to the source package after it no longer exists in the archive)
