...
```console
$ docker pull flink@sha256:aca5a6e8dc0df70e917a667606eacb1230e5762240928a99031499838ad00756
```
...
```console
$ docker pull flink@sha256:040d853230193f6a1508ce33facf112442cd681a9d2d59c67e330e48a960dc16
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **480.5 MB (480471056 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:884c02b3c65829483caf10dfab7317c38562043a4dd90efeceb2a3c73c38db46`
...
# Tue, 12 Jul 2022 16:25:39 GMT
RUN groupadd --system --gid=9999 flink &&     useradd --system --home-dir $FLINK_HOME --uid=9999 --gid=flink flink
# Tue, 12 Jul 2022 16:25:39 GMT
WORKDIR /opt/flink
# Tue, 12 Jul 2022 16:26:39 GMT
...
-	Layers:
	...
	-	`sha256:480775521b091ce275db52ff14092bca5e1479a8d1620890ae972ed3b7602047`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b2e343813c29fc21f8dd4457dccb7cfac64252da6e877791ba947f0582db6c1`  
		Last Modified: Tue, 12 Jul 2022 16:45:41 GMT  
		Size: 4.6 KB (4602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7bc6d192dae08eb5b03a21ea831f26c6f5f70ed425c3a751df9b3f1b57ed05b`  
		Last Modified: Tue, 12 Jul 2022 16:45:41 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d446d4e3e804aaddcddaf83f37695f78ce69626111b31edfb55dc61abdf33be`  
		Last Modified: Tue, 12 Jul 2022 16:45:58 GMT  
		Size: 359.8 MB (359759545 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bb93709641d73351ff06e03bedaed8e1bffb2641c2542a46afa313096f84dba`  
		Last Modified: Tue, 12 Jul 2022 16:45:41 GMT  
...
```console
$ docker pull flink@sha256:a5ad155a1cebbff4274ee0a52adda4745d6ef8f313e30f7383283c31e87d2c16
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **477.7 MB (477707681 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3679bfc09e139c6ce21a50e57ea14b66b5c75d9c2e918e14f8d2c977abe372b4`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["help"]`
...
RUN set -ex;   wget -nv -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$(dpkg --print-architecture)";   wget -nv -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$(dpkg --print-architecture).asc";   export GNUPGHOME="$(mktemp -d)";   for server in ha.pool.sks-keyservers.net $(shuf -e                           hkp://p80.pool.sks-keyservers.net:80                           keyserver.ubuntu.com                           hkp://keyserver.ubuntu.com:80                           pgp.mit.edu) ; do       gpg --batch --keyserver "$server" --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4 && break || : ;   done &&   gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu;   gpgconf --kill all;   rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc;   chmod +x /usr/local/bin/gosu;   gosu nobody true
# Tue, 12 Jul 2022 17:56:33 GMT
ENV FLINK_TGZ_URL=https://www.apache.org/dyn/closer.cgi?action=download&filename=flink/flink-1.14.5/flink-1.14.5-bin-scala_2.12.tgz FLINK_ASC_URL=https://www.apache.org/dist/flink/flink-1.14.5/flink-1.14.5-bin-scala_2.12.tgz.asc GPG_KEY=EB3FE0FA3282FAF822E434AE3C2C9FFB59DF9F3E CHECK_GPG=true
# Tue, 12 Jul 2022 17:56:34 GMT
ENV FLINK_HOME=/opt/flink
# Tue, 12 Jul 2022 17:56:35 GMT
ENV PATH=/opt/flink/bin:/usr/local/openjdk-8/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 12 Jul 2022 17:56:36 GMT
RUN groupadd --system --gid=9999 flink &&     useradd --system --home-dir $FLINK_HOME --uid=9999 --gid=flink flink
# Tue, 12 Jul 2022 17:56:37 GMT
WORKDIR /opt/flink
# Tue, 12 Jul 2022 17:57:40 GMT
RUN set -ex;   wget -nv -O flink.tgz "$FLINK_TGZ_URL";     if [ "$CHECK_GPG" = "true" ]; then     wget -nv -O flink.tgz.asc "$FLINK_ASC_URL";     export GNUPGHOME="$(mktemp -d)";     for server in ha.pool.sks-keyservers.net $(shuf -e                             hkp://p80.pool.sks-keyservers.net:80                             keyserver.ubuntu.com                             hkp://keyserver.ubuntu.com:80                             pgp.mit.edu) ; do         gpg --batch --keyserver "$server" --recv-keys "$GPG_KEY" && break || : ;     done &&     gpg --batch --verify flink.tgz.asc flink.tgz;     gpgconf --kill all;     rm -rf "$GNUPGHOME" flink.tgz.asc;   fi;     tar -xf flink.tgz --strip-components=1;   rm flink.tgz;     chown -R flink:flink .;
# Tue, 12 Jul 2022 17:57:41 GMT
COPY file:e308297ef6ffd9c3cff00834ffd8c0f8baacafe7ea8ed0b19a897eb03baceb28 in / 
# Tue, 12 Jul 2022 17:57:41 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Tue, 12 Jul 2022 17:57:42 GMT
EXPOSE 6123 8081
# Tue, 12 Jul 2022 17:57:43 GMT
CMD ["help"]
```
...
-	Layers:
	...
	-	`sha256:14d854c1c116fa3bd3ba9398166cf525a1c305e250485efc16bc730e1caf728b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:957afa50b0832f1de7fdc0c9e78071f34bded71352803f6645e07de510fd304e`  
		Last Modified: Tue, 12 Jul 2022 18:04:55 GMT  
		Size: 4.5 KB (4519 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9796023ded9709f97182d8a56b17b9d3381d347090f71d1d9b9d7cce9a52fb18`  
		Last Modified: Tue, 12 Jul 2022 18:04:54 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d42c4921bb7ca1cc094dda197149cf8b37317d7ff42ecc930c3605a4baf57e3`  
		Last Modified: Tue, 12 Jul 2022 18:05:31 GMT  
		Size: 359.8 MB (359758996 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf56fbeb871c846cd1954a015555fa1e14d5d07e896a36bf3e6425332bccf8fb`  
		Last Modified: Tue, 12 Jul 2022 18:04:54 GMT  
		Size: 1.9 KB (1945 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
