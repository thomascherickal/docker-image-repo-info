...
```console
$ docker pull mongo@sha256:fce7aff535620039a3e9f12b3ee4265fadd360bd149a4c32da58420958c22487
```
...
### `mongo:latest` - windows version 10.0.20348.1668; amd64
...
### `mongo:latest` - windows version 10.0.17763.4252; amd64
