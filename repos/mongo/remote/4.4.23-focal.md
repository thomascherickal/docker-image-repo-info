...
```console
$ docker pull mongo@sha256:946d8c2dedf44df7bdd7a2889e5483bc4f9409e526c6cfda5afd7e6be92c9c49
```
...
### `mongo:4.4.23-focal` - linux; amd64
...
### `mongo:4.4.23-focal` - linux; arm64 variant v8
