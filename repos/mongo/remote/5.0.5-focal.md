...
```console
$ docker pull mongo@sha256:9437835fe4b5147fcc44ecbf6433d440ddfaf47d52f0383ecea0e655e3ba0287
```
...
### `mongo:5.0.5-focal` - linux; arm64 variant v8
