...
- Created: `2022-09-29T21:20:35.306715871Z`
- Virtual Size: ~ 697.86 Mb  
...
### `dpkg` source package: `mongodb-org=5.0.13`

Binary Packages:

- `mongodb-org=5.0.13`
- `mongodb-org-database=5.0.13`
- `mongodb-org-database-tools-extra=5.0.13`
- `mongodb-org-mongos=5.0.13`
- `mongodb-org-server=5.0.13`
- `mongodb-org-shell=5.0.13`
- `mongodb-org-tools=5.0.13`
