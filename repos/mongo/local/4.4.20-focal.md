...
- Created: `2023-04-18T02:45:29.392012142Z`
- Virtual Size: ~ 431.53 Mb  
...
### `dpkg` source package: `mongodb-org=4.4.20`

Binary Packages:

- `mongodb-org=4.4.20`
- `mongodb-org-database-tools-extra=4.4.20`
- `mongodb-org-mongos=4.4.20`
- `mongodb-org-server=4.4.20`
- `mongodb-org-shell=4.4.20`
- `mongodb-org-tools=4.4.20`
