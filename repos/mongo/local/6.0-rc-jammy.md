...
- Created: `2023-07-04T18:37:04.202417812Z`
- Virtual Size: ~ 653.67 Mb  
...
### `dpkg` source package: `mongodb-org=6.0.8~rc0`

Binary Packages:

- `mongodb-org=6.0.8~rc0`
- `mongodb-org-mongos=6.0.8~rc0`
- `mongodb-org-server=6.0.8~rc0`
- `mongodb-org-shell=6.0.8~rc0`
- `mongodb-org-tools=6.0.8~rc0`
...
### `dpkg` source package: `mongodb-org=7.0.0~rc6`

Binary Packages:

- `mongodb-org-database=7.0.0~rc6`
- `mongodb-org-database-tools-extra=7.0.0~rc6`
