...
- Created: `2021-06-10T21:39:22.956218084Z`
...
### `dpkg` source package: `mongodb-org=5.0.0~rc1`

Binary Packages:

- `mongodb-org=5.0.0~rc1`
- `mongodb-org-database-tools-extra=5.0.0~rc1`
- `mongodb-org-mongos=5.0.0~rc1`
- `mongodb-org-server=5.0.0~rc1`
- `mongodb-org-shell=5.0.0~rc1`
- `mongodb-org-tools=5.0.0~rc1`
