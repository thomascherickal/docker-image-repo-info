...
- Created: `2023-05-31T02:13:55.665971168Z`
- Virtual Size: ~ 721.36 Mb  
...
### `dpkg` source package: `mongodb-org=7.0.0~rc2`

Binary Packages:

- `mongodb-org=7.0.0~rc2`
- `mongodb-org-database=7.0.0~rc2`
- `mongodb-org-database-tools-extra=7.0.0~rc2`
- `mongodb-org-mongos=7.0.0~rc2`
- `mongodb-org-server=7.0.0~rc2`
- `mongodb-org-shell=7.0.0~rc2`
- `mongodb-org-tools=7.0.0~rc2`
