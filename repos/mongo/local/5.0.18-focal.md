...
- Created: `2023-07-04T18:39:04.950616762Z`
- Virtual Size: ~ 662.78 Mb  
...
### `dpkg` source package: `mongodb-org=5.0.18`

Binary Packages:

- `mongodb-org=5.0.18`
- `mongodb-org-database=5.0.18`
- `mongodb-org-database-tools-extra=5.0.18`
- `mongodb-org-mongos=5.0.18`
- `mongodb-org-server=5.0.18`
- `mongodb-org-shell=5.0.18`
- `mongodb-org-tools=5.0.18`
