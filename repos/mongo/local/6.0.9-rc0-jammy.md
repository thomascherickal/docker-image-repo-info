...
- Created: `2023-08-03T01:38:22.43205404Z`
- Virtual Size: ~ 653.34 Mb  
...
### `dpkg` source package: `mongodb-org=6.0.9~rc0`

Binary Packages:

- `mongodb-org=6.0.9~rc0`
- `mongodb-org-mongos=6.0.9~rc0`
- `mongodb-org-server=6.0.9~rc0`
- `mongodb-org-shell=6.0.9~rc0`
- `mongodb-org-tools=6.0.9~rc0`
