...
### `dpkg` source package: `mongodb-org=7.0.0~rc7`

Binary Packages:

- `mongodb-org=7.0.0~rc7`
- `mongodb-org-database=7.0.0~rc7`
- `mongodb-org-database-tools-extra=7.0.0~rc7`
- `mongodb-org-mongos=7.0.0~rc7`
- `mongodb-org-server=7.0.0~rc7`
- `mongodb-org-shell=7.0.0~rc7`
- `mongodb-org-tools=7.0.0~rc7`
