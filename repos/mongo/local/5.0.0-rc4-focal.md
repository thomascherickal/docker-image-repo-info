...
- Created: `2021-06-26T02:58:58.320607591Z`
...
### `dpkg` source package: `mongodb-org=5.0.0~rc4`

Binary Packages:

- `mongodb-org=5.0.0~rc4`
- `mongodb-org-database=5.0.0~rc4`
- `mongodb-org-database-tools-extra=5.0.0~rc4`
- `mongodb-org-mongos=5.0.0~rc4`
- `mongodb-org-server=5.0.0~rc4`
- `mongodb-org-shell=5.0.0~rc4`
- `mongodb-org-tools=5.0.0~rc4`
