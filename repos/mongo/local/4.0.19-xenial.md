...
- Created: `2020-07-24T16:28:10.99925038Z`
- Virtual Size: ~ 420.22 Mb  
...
### `dpkg` source package: `mongodb-org=4.0.19`

Binary Packages:

- `mongodb-org=4.0.19`
- `mongodb-org-mongos=4.0.19`
- `mongodb-org-server=4.0.19`
- `mongodb-org-shell=4.0.19`
- `mongodb-org-tools=4.0.19`
