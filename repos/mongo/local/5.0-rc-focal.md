...
- Created: `2023-07-04T18:38:31.281762951Z`
- Virtual Size: ~ 662.95 Mb  
...
### `dpkg` source package: `mongodb-org=5.0.19~rc0`

Binary Packages:

- `mongodb-org=5.0.19~rc0`
- `mongodb-org-mongos=5.0.19~rc0`
- `mongodb-org-server=5.0.19~rc0`
- `mongodb-org-shell=5.0.19~rc0`
- `mongodb-org-tools=5.0.19~rc0`
