...
- Created: `2021-12-15T22:24:52.964874913Z`
- Virtual Size: ~ 388.01 Mb  
...
### `dpkg` source package: `mongodb-org=4.2.18~rc0`

Binary Packages:

- `mongodb-org=4.2.18~rc0`
- `mongodb-org-mongos=4.2.18~rc0`
- `mongodb-org-server=4.2.18~rc0`
- `mongodb-org-shell=4.2.18~rc0`
- `mongodb-org-tools=4.2.18~rc0`
