...
- Created: `2023-04-11T23:30:28.655797613Z`
- Virtual Size: ~ 655.54 Mb  
...
### `dpkg` source package: `mongodb-org=5.0.16`

Binary Packages:

- `mongodb-org=5.0.16`
- `mongodb-org-database=5.0.16`
- `mongodb-org-database-tools-extra=5.0.16`
- `mongodb-org-mongos=5.0.16`
- `mongodb-org-server=5.0.16`
- `mongodb-org-shell=5.0.16`
- `mongodb-org-tools=5.0.16`
