...
```console
$ docker pull adoptopenjdk@sha256:60078b1f48740d6087c9cecef750fe242afca32c5813efb71c1af86e5893f36c
```
...
### `adoptopenjdk:14-jdk-hotspot-windowsservercore` - windows version 10.0.14393.3750; amd64
...
### `adoptopenjdk:14-jdk-hotspot-windowsservercore` - windows version 10.0.17763.1282; amd64
