...
```console
$ docker pull adoptopenjdk@sha256:bd7c482ee0c73e4296482031663351a094144783f05012bacb0b31546998f63d
```
...
### `adoptopenjdk:14-jre-hotspot-windowsservercore` - windows version 10.0.17763.1817; amd64
...
### `adoptopenjdk:14-jre-hotspot-windowsservercore` - windows version 10.0.14393.4283; amd64
