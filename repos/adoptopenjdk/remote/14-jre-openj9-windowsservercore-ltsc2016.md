...
```console
$ docker pull adoptopenjdk@sha256:d3938600f57df3ea0d7792f22925422903890b403b0ea588aec9314433baf2cd
```
...
### `adoptopenjdk:14-jre-openj9-windowsservercore-ltsc2016` - windows version 10.0.14393.3686; amd64
