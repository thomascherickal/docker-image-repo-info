...
```console
$ docker pull golang@sha256:0c4028f241827951ee41df718abdb75769b63610f3b0e2350cf6fede68e24d6f
```
...
### `golang:1.20.3-bullseye` - linux; amd64
...
### `golang:1.20.3-bullseye` - linux; arm variant v5
...
### `golang:1.20.3-bullseye` - linux; arm variant v7
...
### `golang:1.20.3-bullseye` - linux; arm64 variant v8
...
### `golang:1.20.3-bullseye` - linux; 386
...
### `golang:1.20.3-bullseye` - linux; mips64le
...
### `golang:1.20.3-bullseye` - linux; ppc64le
...
### `golang:1.20.3-bullseye` - linux; s390x
