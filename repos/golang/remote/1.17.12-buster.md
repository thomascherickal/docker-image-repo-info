...
```console
$ docker pull golang@sha256:d839f455cbd9852d5fae94bbe8a9ecf5c8015c015875b3073c40cefef0f67745
```
...
### `golang:1.17.12-buster` - linux; ppc64le
...
### `golang:1.17.12-buster` - linux; s390x
