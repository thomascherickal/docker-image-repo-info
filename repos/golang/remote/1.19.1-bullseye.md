...
```console
$ docker pull golang@sha256:c41345ea7f7b10a980cb3a8d67943a0c5ca2c4f8bf277f523e09ffee2ea6241d
```
...
### `golang:1.19.1-bullseye` - linux; amd64
...
### `golang:1.19.1-bullseye` - linux; arm variant v5
...
### `golang:1.19.1-bullseye` - linux; arm variant v7
...
### `golang:1.19.1-bullseye` - linux; arm64 variant v8
...
### `golang:1.19.1-bullseye` - linux; 386
...
### `golang:1.19.1-bullseye` - linux; mips64le
...
### `golang:1.19.1-bullseye` - linux; ppc64le
...
### `golang:1.19.1-bullseye` - linux; s390x
