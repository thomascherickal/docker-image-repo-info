...
```console
$ docker pull golang@sha256:8bc7b5da6a20877926019b8d8eea174eae940cd510ed6f787e1bfabd13681b76
```
...
### `golang:1.16.6-stretch` - linux; amd64
...
### `golang:1.16.6-stretch` - linux; arm64 variant v8
...
### `golang:1.16.6-stretch` - linux; 386
