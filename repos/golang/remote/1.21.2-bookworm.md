...
```console
$ docker pull golang@sha256:a44d05d5de3474f8135462903bbf74a0fdb761aec455ff557c467339dc0b729b
```
...
### `golang:1.21.2-bookworm` - linux; amd64
...
### `golang:1.21.2-bookworm` - linux; arm variant v5
...
### `golang:1.21.2-bookworm` - linux; arm variant v7
...
### `golang:1.21.2-bookworm` - linux; arm64 variant v8
...
### `golang:1.21.2-bookworm` - linux; 386
...
### `golang:1.21.2-bookworm` - linux; mips64le
...
### `golang:1.21.2-bookworm` - linux; ppc64le
...
### `golang:1.21.2-bookworm` - linux; s390x
