...
### `golang:1.15.4-alpine3.12` - linux; amd64
...
### `golang:1.15.4-alpine3.12` - linux; arm variant v7
...
### `golang:1.15.4-alpine3.12` - linux; arm64 variant v8
...
### `golang:1.15.4-alpine3.12` - linux; 386
...
### `golang:1.15.4-alpine3.12` - linux; s390x
