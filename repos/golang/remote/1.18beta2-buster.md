...
### `golang:1.18beta2-buster` - linux; amd64
...
### `golang:1.18beta2-buster` - linux; arm variant v7
...
### `golang:1.18beta2-buster` - linux; mips64le
...
### `golang:1.18beta2-buster` - linux; ppc64le
