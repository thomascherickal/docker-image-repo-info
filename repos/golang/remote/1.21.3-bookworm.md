...
```console
$ docker pull golang@sha256:5bafbbb109f02aaf6b41ddc19f54919773c3006f1cbda1599112603367642f0e
```
...
### `golang:1.21.3-bookworm` - linux; amd64
...
### `golang:1.21.3-bookworm` - linux; arm64 variant v8
...
### `golang:1.21.3-bookworm` - linux; 386
...
### `golang:1.21.3-bookworm` - linux; mips64le
...
### `golang:1.21.3-bookworm` - linux; ppc64le
...
### `golang:1.21.3-bookworm` - linux; s390x
