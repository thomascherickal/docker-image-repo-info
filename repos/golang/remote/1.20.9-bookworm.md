...
```console
$ docker pull golang@sha256:a2db054ab61968964d1dcb45f730819a50fe9d8a998a45887e8110dad324499c
```
...
### `golang:1.20.9-bookworm` - linux; amd64
...
### `golang:1.20.9-bookworm` - linux; arm variant v5
...
### `golang:1.20.9-bookworm` - linux; arm variant v7
...
### `golang:1.20.9-bookworm` - linux; arm64 variant v8
...
### `golang:1.20.9-bookworm` - linux; 386
...
### `golang:1.20.9-bookworm` - linux; mips64le
...
### `golang:1.20.9-bookworm` - linux; ppc64le
