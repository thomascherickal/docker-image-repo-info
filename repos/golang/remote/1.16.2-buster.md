...
```console
$ docker pull golang@sha256:6bfcd5ee7f2fa81904c2f46017312f3991c2e1ab7f3283c9d233aec182c7dd75
```
...
### `golang:1.16.2-buster` - linux; amd64
...
### `golang:1.16.2-buster` - linux; arm variant v5
...
### `golang:1.16.2-buster` - linux; arm variant v7
...
### `golang:1.16.2-buster` - linux; arm64 variant v8
...
### `golang:1.16.2-buster` - linux; 386
...
### `golang:1.16.2-buster` - linux; mips64le
...
### `golang:1.16.2-buster` - linux; ppc64le
...
### `golang:1.16.2-buster` - linux; s390x
