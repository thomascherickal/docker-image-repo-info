...
### `golang:1.21.2-alpine` - linux; amd64
...
### `golang:1.21.2-alpine` - linux; arm variant v6
...
### `golang:1.21.2-alpine` - linux; arm variant v7
...
### `golang:1.21.2-alpine` - linux; arm64 variant v8
...
### `golang:1.21.2-alpine` - linux; 386
...
### `golang:1.21.2-alpine` - linux; ppc64le
...
### `golang:1.21.2-alpine` - linux; s390x
