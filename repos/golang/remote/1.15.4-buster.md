...
### `golang:1.15.4-buster` - linux; amd64
...
### `golang:1.15.4-buster` - linux; arm variant v7
...
### `golang:1.15.4-buster` - linux; arm64 variant v8
...
### `golang:1.15.4-buster` - linux; 386
...
### `golang:1.15.4-buster` - linux; mips64le
...
### `golang:1.15.4-buster` - linux; s390x
