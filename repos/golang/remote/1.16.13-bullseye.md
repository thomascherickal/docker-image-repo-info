...
### `golang:1.16.13-bullseye` - linux; amd64
...
### `golang:1.16.13-bullseye` - linux; arm variant v5
...
### `golang:1.16.13-bullseye` - linux; arm variant v7
...
### `golang:1.16.13-bullseye` - linux; arm64 variant v8
...
### `golang:1.16.13-bullseye` - linux; 386
...
### `golang:1.16.13-bullseye` - linux; mips64le
...
### `golang:1.16.13-bullseye` - linux; ppc64le
...
### `golang:1.16.13-bullseye` - linux; s390x
