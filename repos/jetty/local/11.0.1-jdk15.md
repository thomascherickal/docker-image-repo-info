...
- Created: `2021-03-02T00:15:20.031656012Z`
- Virtual Size: ~ 501.34 Mb  
...
- Environment:
  ...
  - `LANG=C.UTF-8`
  - `JAVA_VERSION=15.0.2`
  - `JETTY_VERSION=11.0.1`
  - `JETTY_HOME=/usr/local/jetty`
  - `JETTY_BASE=/var/lib/jetty`
  - `TMPDIR=/tmp/jetty`
  - `JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/11.0.1/jetty-home-11.0.1.tar.gz`
