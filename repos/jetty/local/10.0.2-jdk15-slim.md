...
- Created: `2021-04-11T01:38:54.885321158Z`
...
- Environment:
  ...
  - `LANG=C.UTF-8`
  - `JAVA_VERSION=15.0.2`
  - `JETTY_VERSION=10.0.2`
  - `JETTY_HOME=/usr/local/jetty`
  - `JETTY_BASE=/var/lib/jetty`
  - `TMPDIR=/tmp/jetty`
  - `JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/10.0.2/jetty-home-10.0.2.tar.gz`
