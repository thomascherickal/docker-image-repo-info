...
- Created: `2021-06-10T18:24:05.912187894Z`
- Virtual Size: ~ 316.92 Mb  
...
- Environment:
  ...
  - `JETTY_VERSION=11.0.4`
  - `JETTY_HOME=/usr/local/jetty`
  - `JETTY_BASE=/var/lib/jetty`
  - `TMPDIR=/tmp/jetty`
  - `JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/11.0.4/jetty-home-11.0.4.tar.gz`
