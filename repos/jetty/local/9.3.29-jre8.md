...
- Created: `2021-01-13T06:58:51.239639828Z`
- Virtual Size: ~ 290.52 Mb  
...
- Environment:
  ...
  - `JAVA_VERSION=8u275`
  - `JETTY_VERSION=9.3.29.v20201019`
  - `JETTY_HOME=/usr/local/jetty`
  - `JETTY_BASE=/var/lib/jetty`
  - `TMPDIR=/tmp/jetty`
  - `JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-distribution/9.3.29.v20201019/jetty-distribution-9.3.29.v20201019.tar.gz`
