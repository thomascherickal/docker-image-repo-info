...
- Created: `2020-01-23T03:13:14.607146112Z`
- Virtual Size: ~ 262.05 Mb  
...
- Environment:
  ...
  - `JETTY_VERSION=9.2.29.v20191105`
  - `JETTY_HOME=/usr/local/jetty`
  - `JETTY_BASE=/var/lib/jetty`
  - `TMPDIR=/tmp/jetty`
  - `JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-distribution/9.2.29.v20191105/jetty-distribution-9.2.29.v20191105.tar.gz`
