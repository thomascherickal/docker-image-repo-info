...
```console
$ docker pull openjdk@sha256:bccd1c83a76775a9527d8e80fc0ed158cbb6551e2d7b311b2c3c631545dc9d33
```
...
### `openjdk:11-jdk-bullseye` - linux; amd64
...
### `openjdk:11-jdk-bullseye` - linux; arm64 variant v8

```console
$ docker pull openjdk@sha256:ba0555e28b3b9ff28353e6ceaa7efd9d07fadb01047eaeed7eba41ee8bc6b810
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **330.2 MB (330210238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48e4690d429ddf69bcd13563465c825e1ef82d15885e8a3fa4f36b66d81d359e`
-	Default Command: `["jshell"]`
