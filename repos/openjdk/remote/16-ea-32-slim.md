## `openjdk:16-ea-32-slim`

```console
$ docker pull openjdk@sha256:18fcf8c8ea992a7e640557d7d68a4984110e2cf2e1879714fcb668bc38839e0e
```
...
### `openjdk:16-ea-32-slim` - linux; arm64 variant v8
