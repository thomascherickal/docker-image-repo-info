...
```console
$ docker pull openjdk@sha256:a79d8ef279edb6639d7d9d2f28850e6a0628f4dbff3674c2a37a65168c5245a1
```
...
### `openjdk:8-windowsservercore-ltsc2022` - windows version 10.0.20348.524; amd64
