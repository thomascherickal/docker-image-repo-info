## `openjdk:21-ea-33-jdk-bullseye`

```console
$ docker pull openjdk@sha256:1bda339a52548f54eae9a55a19221e325734bdf99367e74792cb10d4c8f8a574
```
...
### `openjdk:21-ea-33-jdk-bullseye` - linux; amd64
