## `openjdk:17-ea-24-jdk-slim`

```console
$ docker pull openjdk@sha256:2b33ed89550d418c41bf24ecd34955908c296dfc6444f2dcd4ab485c62f00ff7
```
...
### `openjdk:17-ea-24-jdk-slim` - linux; amd64
