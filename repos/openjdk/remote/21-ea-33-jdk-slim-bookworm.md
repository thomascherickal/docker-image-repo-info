## `openjdk:21-ea-33-jdk-slim-bookworm`

```console
$ docker pull openjdk@sha256:072c6c1a66697029df415afe5819fd3066394b37234603d98746232bf77a0cda
```
...
### `openjdk:21-ea-33-jdk-slim-bookworm` - linux; amd64
