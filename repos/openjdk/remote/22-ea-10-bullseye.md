## `openjdk:22-ea-10-bullseye`

```console
$ docker pull openjdk@sha256:014f82b7e1263ac294989239f739b0aca238289322d74b2cc1e1c9125543dd55
```
...
### `openjdk:22-ea-10-bullseye` - linux; amd64
