...
```console
$ docker pull openjdk@sha256:1bbcd579625eac17f3db3587f4ae6067ae019bbadbcd10717cbc5a70022011e6
```
...
### `openjdk:18-ea-18-jdk-oracle` - linux; amd64
...
### `openjdk:18-ea-18-jdk-oracle` - linux; arm64 variant v8
