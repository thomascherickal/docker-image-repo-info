## `openjdk:21-ea-18-oracle`

```console
$ docker pull openjdk@sha256:11f572172ded05aa7e3b7cc45e0d302643163087d82fc8d733f89d84b9527fa0
```
...
### `openjdk:21-ea-18-oracle` - linux; amd64
...
### `openjdk:21-ea-18-oracle` - linux; arm64 variant v8
