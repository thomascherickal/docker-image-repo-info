## `openjdk:20-ea-19-slim-buster`

```console
$ docker pull openjdk@sha256:f59d4b8a69e31f76c07305b09abc5caa538f08ad762a57e664bace16c9599ce4
```
...
### `openjdk:20-ea-19-slim-buster` - linux; amd64
