...
```console
$ docker pull openjdk@sha256:3b3c313f3ffaca9cad66a6c13cdbb330e310907632685db43f52be8264a4a7e8
```
...
### `openjdk:latest` - windows version 10.0.20348.643; amd64
...
### `openjdk:latest` - windows version 10.0.17763.2803; amd64
