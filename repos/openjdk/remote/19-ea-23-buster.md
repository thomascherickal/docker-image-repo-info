## `openjdk:19-ea-23-buster`

```console
$ docker pull openjdk@sha256:086c4060d3e7f296e4d39c1069a05e221983da9ba2d7250bc7d2c070744f1bba
```
...
### `openjdk:19-ea-23-buster` - linux; arm64 variant v8
