## `openjdk:21-ea-15-bullseye`

```console
$ docker pull openjdk@sha256:b22cd7ddafc514117b53551d787707dd777f46007cdb052e280e0858dba7adc1
```
...
### `openjdk:21-ea-15-bullseye` - linux; arm64 variant v8
