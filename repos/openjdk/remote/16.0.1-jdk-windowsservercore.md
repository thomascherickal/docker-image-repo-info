...
```console
$ docker pull openjdk@sha256:b73c9d1f690029fc6d8cf4934d1c6a448a4c97180a4e11e37490fdcc726f85c8
```
...
### `openjdk:16.0.1-jdk-windowsservercore` - windows version 10.0.17763.1935; amd64
...
### `openjdk:16.0.1-jdk-windowsservercore` - windows version 10.0.14393.4402; amd64
