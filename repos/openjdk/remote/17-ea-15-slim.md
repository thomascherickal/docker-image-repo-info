## `openjdk:17-ea-15-slim`

```console
$ docker pull openjdk@sha256:2f68017239f0cd16a29feb02e960a1a55430e622ae09b239887b076926ae6f93
```
...
### `openjdk:17-ea-15-slim` - linux; amd64
...
### `openjdk:17-ea-15-slim` - linux; arm64 variant v8
