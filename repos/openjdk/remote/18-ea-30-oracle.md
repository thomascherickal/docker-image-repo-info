## `openjdk:18-ea-30-oracle`

```console
$ docker pull openjdk@sha256:4065143366aff503767c830508f18cf5edbb06855faa9722dca07b9d4f4add48
```
...
### `openjdk:18-ea-30-oracle` - linux; amd64
...
### `openjdk:18-ea-30-oracle` - linux; arm64 variant v8
