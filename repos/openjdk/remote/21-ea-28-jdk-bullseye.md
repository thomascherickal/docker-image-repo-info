## `openjdk:21-ea-28-jdk-bullseye`

```console
$ docker pull openjdk@sha256:8b7508132a208c7c76ce8d2c76ce5ffcef053c1fafdcb540a97c8358d7f7f396
```
...
### `openjdk:21-ea-28-jdk-bullseye` - linux; amd64
