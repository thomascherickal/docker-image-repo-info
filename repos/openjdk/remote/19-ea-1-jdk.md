...
```console
$ docker pull openjdk@sha256:53585e5cef214c131b9b21609b6a8ad7933fe99c09d125e8667a50151bdc4c15
```
...
### `openjdk:19-ea-1-jdk` - linux; amd64
...
### `openjdk:19-ea-1-jdk` - linux; arm64 variant v8
...
### `openjdk:19-ea-1-jdk` - windows version 10.0.20348.350; amd64
...
### `openjdk:19-ea-1-jdk` - windows version 10.0.17763.2300; amd64
...
### `openjdk:19-ea-1-jdk` - windows version 10.0.14393.4770; amd64
