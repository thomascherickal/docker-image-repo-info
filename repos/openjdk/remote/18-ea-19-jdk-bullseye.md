...
```console
$ docker pull openjdk@sha256:b80bc155b0a3c842216247e8ab8fe7c24a8d19130a94beaaf9b0df797353d0d3
```
...
### `openjdk:18-ea-19-jdk-bullseye` - linux; amd64
...
### `openjdk:18-ea-19-jdk-bullseye` - linux; arm64 variant v8
