## `openjdk:17-ea-5-jdk-buster`

```console
$ docker pull openjdk@sha256:a983fa84aea0477d87b0d1d2e7ca192dc5bc41c078861528b58f19a6d9fb3eaa
```
...
### `openjdk:17-ea-5-jdk-buster` - linux; arm64 variant v8
