...
```console
$ docker pull openjdk@sha256:7df5823c07adfe8f5cbf0854417367a3a0b845950b5cad862511a707920db688
```
...
### `openjdk:8-jre-windowsservercore` - windows version 10.0.20348.288; amd64
