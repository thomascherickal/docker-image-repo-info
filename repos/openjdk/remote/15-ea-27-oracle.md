## `openjdk:15-ea-27-oracle`

```console
$ docker pull openjdk@sha256:06f4bb2225cea5271c9913c74fd8c671019df389c2f380a62c68990a896bcc5c
```
...
### `openjdk:15-ea-27-oracle` - linux; arm64 variant v8
