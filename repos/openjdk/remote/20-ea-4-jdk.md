...
### `openjdk:20-ea-4-jdk` - linux; amd64
...
### `openjdk:20-ea-4-jdk` - linux; arm64 variant v8
...
### `openjdk:20-ea-4-jdk` - windows version 10.0.20348.768; amd64
...
### `openjdk:20-ea-4-jdk` - windows version 10.0.17763.3046; amd64
