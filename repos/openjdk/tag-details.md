...
```console
$ docker pull openjdk@sha256:55642bcdd7030fe34df3262c1c94404b87b062923b5a4d1a6bf7ea048b89e63a
```
...
### `openjdk:22-ea-27-oraclelinux8` - linux; arm64 variant v8
...
### `openjdk:22-ea-27-slim` - linux; arm64 variant v8
